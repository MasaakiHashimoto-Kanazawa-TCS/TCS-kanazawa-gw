...
```
*/
type IfNotAnyOrNever<T, IfNotAnyOrNever, IfAny = any, IfNever = never> = If<
  IsAny<T>,
  IfAny,
...
type Merge<Destination, Source> = Destination extends unknown // For distributing `Destination`
  ...
  : never;
// Should never happen
type _Merge<Destination, Source> = Simplify<
...
}[KeysType] & // 3. Add the remaining keys not in `KeysType`
...
interface StrictVisitorObject {
  ...
  "RestElement:exit"?: (
    node: AssignmentTargetRest | BindingRestElement | FormalParameterRest,
  ) => void;
...
type VisitorObject = {
  [K in keyof StrictVisitorObject]?:
    ...
    | undefined;
} & Record<string, BivarianceHackHandler<(node: Node$1) => void> | undefined>;
//#endregion
 ...
 */
type Diagnostic = RequireAtLeastOne<
 ...
 */
declare function commentsExistBetween(
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getTokens<Options extends CountOptions | number | FilterFn | null | undefined>(
  node: Node,
 ...
 */
declare function getFirstToken<Options extends SkipOptions | number | FilterFn | null | undefined>(
  node: Node,
  skipOptions?: Options,
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getFirstTokens<
  Options extends CountOptions | number | FilterFn | null | undefined,
>(node: Node, countOptions?: Options): TokenResult<Options>[];
/**
 ...
 * @returns `Token` (or `Token | Comment` if `includeComments` is `true`), or `null` if none found.
 */
declare function getLastToken<Options extends SkipOptions | number | FilterFn | null | undefined>(
  node: Node,
  skipOptions?: Options,
): TokenResult<Options> | null;
/**
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getLastTokens<Options extends CountOptions | number | FilterFn | null | undefined>(
  node: Node,
  countOptions?: Options,
): TokenResult<Options>[];
/**
 ...
 * @returns `Token` (or `Token | Comment` if `includeComments` is `true`), or `null` if none found.
 */
declare function getTokenBefore<Options extends SkipOptions | number | FilterFn | null | undefined>(
 ...
 */
declare function getTokenOrCommentBefore(
  nodeOrToken: NodeOrToken,
  skip?: number,
): TokenOrComment | null;
/**
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getTokensBefore<
  Options extends CountOptions | number | FilterFn | null | undefined,
 ...
 * @returns `Token` (or `Token | Comment` if `includeComments` is `true`), or `null` if none found.
 */
declare function getTokenAfter<Options extends SkipOptions | number | FilterFn | null | undefined>(
  nodeOrToken: NodeOrToken,
  skipOptions?: Options,
): TokenResult<Options> | null;
/**
 ...
 * @returns `TokenOrComment | null`.
 */
declare function getTokenOrCommentAfter(
  nodeOrToken: NodeOrToken,
  skip?: number,
): TokenOrComment | null;
/**
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getTokensAfter<
  Options extends CountOptions | number | FilterFn | null | undefined,
>(nodeOrToken: NodeOrToken, countOptions?: Options): TokenResult<Options>[];
/**
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getTokensBetween<
  Options extends CountOptions | number | FilterFn | null | undefined,
 ...
 * @returns `Token` (or `Token | Comment` if `includeComments` is `true`), or `null` if none found.
 */
declare function getFirstTokenBetween<
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getFirstTokensBetween<
  Options extends CountOptions | number | FilterFn | null | undefined,
>(left: NodeOrToken, right: NodeOrToken, countOptions?: Options): TokenResult<Options>[];
/**
 ...
 * @returns `Token` (or `Token | Comment` if `includeComments` is `true`), or `null` if none found.
 */
declare function getLastTokenBetween<
  Options extends SkipOptions | number | FilterFn | null | undefined,
>(left: NodeOrToken, right: NodeOrToken, skipOptions?: Options): TokenResult<Options> | null;
/**
 ...
 * @returns Array of `Token`s, or array of `Token | Comment`s if `includeComments` is `true`.
 */
declare function getLastTokensBetween<
  Options extends CountOptions | number | FilterFn | null | undefined,
>(left: NodeOrToken, right: NodeOrToken, countOptions?: Options): TokenResult<Options>[];
/**
