...
var require_stringify = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function getTagObject(tags, item) {
    ...
    if (!tagObj)
      throw new Error(
        `Tag not resolved for ${obj?.constructor?.name ?? (obj === null ? "null" : typeof obj)} value`,
      );
    return tagObj;
  }
...
var require_Pair = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Pair = class Pair {
    ...
    toJSON(_, ctx) {
      return addPairToJSMap.addPairToJSMap(
        ctx,
  ...
  function stringifyDocument(doc, options) {
    ...
    if (doc.contents) {
      ...
      let body = stringify.stringify(
        ...
        ctx,
        () => (contentComment = null),
        contentComment ? void 0 : () => (chompKeep = true),
      );
      if (contentComment)
...
var require_Document = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Document = class Document {
    ...
    createNode(value, replacer, options) {
      ...
      const node = createNode.createNode(value, tag, {
