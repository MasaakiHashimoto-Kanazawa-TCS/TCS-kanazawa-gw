...
import {
  ConnectedPayload,
  CustomPayload,
  CustomPayload as hmrPayload_CustomPayload,
  ErrorPayload,
  FullReloadPayload,
  HMRPayload,
  HotPayload,
  HotPayload as hmrPayload_HotPayload,
  PrunePayload,
  Update,
  UpdatePayload,
...
import {
  ...
  InferCustomEventPayload as hmrPayload_InferCustomEventPayload,
  InvalidatePayload,
...
import {
  ...
  WatcherOptions,
} from "@voidzero-dev/vite-plus-core/rolldown";
import {
  parseAst as parseAst$1,
  parseAstAsync as parseAstAsync$1,
} from "@voidzero-dev/vite-plus-core/rolldown/parseAst";
...
import {
  ...
  ParseResult,
  ParserOptions,
  TransformOptions as rolldown_utils_TransformOptions,
  TransformResult as rolldown_utils_TransformResult,
  Visitor,
  VisitorObject,
  minify,
  minifySync,
  parse,
  parseSync,
} from "@voidzero-dev/vite-plus-core/rolldown/utils";
...
import {
  ...
  FetchResult,
  FetchResult as moduleRunner_FetchResult,
  ModuleEvaluator,
  ModuleRunner,
  ModuleRunnerHmr,
  ModuleRunnerOptions,
...
import {
  ...
  EsbuildTransformOptions as esbuildOptions_EsbuildTransformOptions,
...
import {
  LightningCSSOptions,
  LightningCSSOptions as lightningcssOptions_LightningCSSOptions,
...
//#endregion
//#region ../../../node_modules/.pnpm/http-proxy-3@1.23.2/node_modules/http-proxy-3/dist/lib/http-proxy/index.d.ts
...
declare class ProxyServer<
  ...
  TServerResponse extends typeof http.ServerResponse = typeof http.ServerResponse,
  TError = Error,
> extends EventEmitter<ProxyServerEventMap<TIncomingMessage, TServerResponse, TError>> {
  /**
  ...
  static createProxyServer<
    ...
    TError = Error,
  >(options?: ServerOptions$3): ProxyServer<TIncomingMessage, TServerResponse, TError>;
  /**
   * Creates the proxy server with specified options.
   * @param options Config object passed to the proxy
   * @returns Proxy object with handlers for `ws` and `web` requests
...
//#endregion
//#region ../../../node_modules/.pnpm/http-proxy-3@1.23.2/node_modules/http-proxy-3/dist/lib/http-proxy/passes/ws-incoming.d.ts
...
interface CorsOptions {
  ...
  origin?:
    | CorsOrigin
    | ((origin: string | undefined, cb: (err: Error, origins: CorsOrigin) => void) => void);
...
interface NormalizedHotChannel<Api = any> {
  ...
  on<T extends string>(
    event: T,
    listener: (data: InferCustomEventPayload<T>, client: NormalizedHotChannelClient) => void,
  ): void;
  /**
...
declare class WebSocket extends EventEmitter {
  ...
  on(
    event: "message",
    listener: (this: WebSocket, data: WebSocket.RawData, isBinary: boolean) => void,
  ): this;
  on(event: "open", listener: (this: WebSocket) => void): this;
  on(event: "ping" | "pong", listener: (this: WebSocket, data: Buffer) => void): this;
  on(
    event: "unexpected-response",
    listener: (this: WebSocket, request: ClientRequest, response: http.IncomingMessage) => void,
  ): this;
  ...
  addListener(
    event: "unexpected-response",
    listener: (request: ClientRequest, response: http.IncomingMessage) => void,
  ): this;
...
declare namespace WebSocket {
  ...
  class Server<T extends WebSocket = WebSocket> extends EventEmitter {
    ...
    on(
      event: "headers",
      cb: (this: Server<T>, headers: string[], request: http.IncomingMessage) => void,
    ): this;
 ...
 * @experimental
 */
declare function perEnvironmentState<State>(
...
declare class MinimalPluginContext$1<T extends Environment = Environment>
  extends BasicMinimalPluginContext
  implements MinimalPluginContext
{
  environment: T;
...
interface ResolvedServerOptions extends Omit<
  RequiredExceptFor<
    ServerOptions$1,
    "host" | "https" | "proxy" | "hmr" | "ws" | "watch" | "origin" | "hotUpdateEnvironments"
  >,
...
interface Plugin<A = any> extends Rolldown.Plugin<A> {
  ...
  configResolved?: ObjectHook<
    (this: MinimalPluginContextWithoutEnvironment, config: ResolvedConfig) => void | Promise<void>
  >;
  /**
 ...
 * @experimental
 */
declare function perEnvironmentPlugin(
  name: string,
  applyToEnvironment: (
    environment: PartialEnvironment,
  ) => boolean | Promise<boolean> | PluginOption,
 ...
 * @experimental
 */
declare function preprocessCSS(
  code: string,
  filename: string,
  config: ResolvedConfig,
): Promise<PreprocessCSSResult>;
declare function formatPostcssSourceMap(
...
declare function transformWithEsbuild(
  code: string,
  filename: string,
  options?: esbuildOptions_EsbuildTransformOptions,
  inMap?: object,
  config?: ResolvedConfig,
  watcher?: FSWatcher,
  ignoreEsbuildWarning?: boolean,
...
interface OxcOptions extends Omit<
  rolldown_utils_TransformOptions,
...
declare function transformWithOxc(
  code: string,
  filename: string,
  options?: rolldown_utils_TransformOptions,
  inMap?: object,
  config?: ResolvedConfig,
  watcher?: FSWatcher,
): Promise<Omit<rolldown_utils_TransformResult, "errors">>;
//#endregion
//#region src/node/config.d.ts
interface ConfigEnv {
  /**
...
declare function sortUserPlugins(
  plugins: (Plugin | Plugin[])[] | undefined,
): [Plugin[], Plugin[], Plugin[]];
declare function loadConfigFromFile(
  configEnv: ConfigEnv,
  configFile?: string,
  configRoot?: string,
  logLevel?: LogLevel,
...
declare function isRunnableDevEnvironment(
  environment: Environment,
...
declare function createFetchableDevEnvironment(
  name: string,
  config: ResolvedConfig,
  context: FetchableDevEnvironmentContext,
): FetchableDevEnvironment;
declare function isFetchableDevEnvironment(
  environment: Environment,
 ...
 * @experimental
 */
declare function runnerImport<T>(
  moduleId: string,
  inlineConfig?: InlineConfig,
...
declare function mergeConfig<D extends Record<string, any>, O extends Record<string, any>>(
...
export {
  ...
  type index_d_exports as HttpProxy,
  type HttpServer,
  ...
  type ManifestChunk,
  type MapToFunction,
  type AnymatchMatcher as Matcher,
  type MinifyOptions,
  type MinifyResult,
  ...
  type ServerOptions$1 as ServerOptions,
  type SkipInformation,
