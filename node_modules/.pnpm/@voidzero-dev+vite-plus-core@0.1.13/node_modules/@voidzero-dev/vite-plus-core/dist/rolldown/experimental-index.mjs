...
} from "./shared/normalize-string-or-regex-D7wlw16t.mjs";
import { o as transformToRollupOutput } from "./shared/bindingify-input-options-nddSVL89.mjs";
import {
  c as validateOption,
  n as createBundlerOptions,
  t as RolldownBuild,
  u as PluginDriver,
} from "./shared/rolldown-build-C7TjtSci.mjs";
...
} from "./shared/constructors-DqC7XSXy.mjs";
import {
  a as minify$1,
  i as transformSync$1,
  n as resolveTsconfig,
  o as minifySync$1,
  r as transform$1,
  t as TsconfigCache$1,
} from "./shared/resolve-tsconfig-C3OzszY-.mjs";
...
var DevEngine = class DevEngine {
  ...
  static async create(inputOptions, outputOptions = {}, devOptions = {}) {
    ...
    const bindingOnHmrUpdates = userOnHmrUpdates
      ? function (rawResult) {
    ...
    const bindingDevOptions = {
      ...
      rebuildStrategy: devOptions.rebuildStrategy
        ? devOptions.rebuildStrategy === "always"
          ? import_binding.BindingRebuildStrategy.Always
          : devOptions.rebuildStrategy === "auto"
            ? import_binding.BindingRebuildStrategy.Auto
            : import_binding.BindingRebuildStrategy.Never
        : void 0,
    ...
    return new DevEngine(
      new import_binding.BindingDevEngine(options.bundlerOptions, bindingDevOptions),
    );
  }
  constructor(inner) {
    this.#inner = inner;
...
const scan = async (rawInputOptions, rawOutputOptions = {}) => {
  ...
  const ret = await createBundlerOptions(
    await PluginDriver.callOptionsHook(rawInputOptions),
    rawOutputOptions,
    false,
  );
