...
var require_binding = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function requireNative() {
    if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH)
      ...
      if (process.arch === "arm64") {
        ...
        try {
          const binding = __require("vite-plus/binding");
          const bindingPackageVersion = __require("vite-plus/binding/package.json").version;
          if (
  ...
  if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
    ...
    if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI)
      try {
        wasiBinding = __require("vite-plus/binding");
        nativeBinding = wasiBinding;
      } catch (err) {
