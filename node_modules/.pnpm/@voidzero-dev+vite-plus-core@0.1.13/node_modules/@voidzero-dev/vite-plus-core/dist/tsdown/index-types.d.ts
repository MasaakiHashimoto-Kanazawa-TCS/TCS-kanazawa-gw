...
type NestedHooks<T> = (Partial<StripGeneric<T>> | Partial<OnlyGeneric<T>>) &
  Partial<{ [key in Namespaces<StripGeneric<T>>]: NestedHooks<WithoutNamespace<T, key>> }> &
  Partial<{ [key in BareHooks<StripGeneric<T>>]: T[key] }>; //#endregion
 ...
 * @maxItems 2
 */
type Size2DFor_DimensionPercentageFor_LengthValue = [
 ...
 * @maxItems 4
 */
type RectFor_BorderImageSideWidth = [
 ...
 * @maxItems 4
 */
type RectFor_NumberOrPercentage = [
  NumberOrPercentage,
  NumberOrPercentage,
  NumberOrPercentage,
  NumberOrPercentage,
 ...
 * @maxItems 4
 */
type RectFor_DimensionPercentageFor_LengthValue = [
  DimensionPercentageFor_LengthValue,
  DimensionPercentageFor_LengthValue,
  DimensionPercentageFor_LengthValue,
  DimensionPercentageFor_LengthValue,
 ...
 */
type WebKitScrollbarPseudoClass =
  | "horizontal"
  | "vertical"
  | "decrement"
  | "increment"
...
type MappedRuleVisitors = {
  [Name in Exclude<Rule["type"], "unknown" | "custom">]?: RuleVisitor<
    RequiredValue<FindByType<Rule, Name>>
  >;
};
...
type RuleVisitors<C extends CustomAtRules> = MappedRuleVisitors & {
  unknown?:
    ...
    | Omit<RuleVisitor<UnknownAtRule>, keyof CallableFunction>;
...
type MappedBody<P extends CustomAtRuleDefinition["body"]> = P extends "style-block"
  ? "rule-list"
  : P;
...
type FindProperty<Union, Name> = Union extends {
  ...
  ? Union
  : never;
type DeclarationVisitor<P = Declaration> = (
  property: P,
) => ReturnedDeclaration | ReturnedDeclaration[] | void;
type MappedDeclarationVisitors = {
  [Name in Exclude<Declaration["property"], "unparsed" | "custom">]?: DeclarationVisitor<
...
declare namespace TsConfigJson {
  namespace CompilerOptions {
    ...
    type Lib =
      ...
      | "WebWorker.Iterable" // Lowercase alternatives
      | "es5"
      | "es6"
      | "es7"
      | "es2015"
    ...
    type ModuleResolution =
      ...
      | "node16"
      | "nodenext"
      | "bundler" // Pascal-cased alternatives
      | "Classic"
      | "Node"
      | "Node10"
      | "Node16"
...
type ResolvedConfig = Overwrite<
  ...
  >,
  {
    /** Resolved entry map (after glob expansion) */ entry: Record<
      string,
      string
 ...
 * @private
 */
declare function resolveUserConfig(
 ...
 * @private
 */
declare function buildWithConfigs(
  configs: ResolvedConfig[],
  configFiles: string[],
  _restart: () => void,
): Promise<TsdownBundle[]>; //#endregion
