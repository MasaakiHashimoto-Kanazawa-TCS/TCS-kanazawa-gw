...
var Qi = x((KC, Ji) => {
  ...
  function rD(e, r) {
    ...
    (c.push(["footnoteDefinition"]),
      t.inlineNotes && (Lt(o, "reference", "inlineNote"), (u.inlineNote = F)),
      Lt(a, "definition", "footnoteDefinition"),
      Lt(o, "reference", "footnoteCall"),
      (i.definition = E),
      (i.footnoteDefinition = p),
      (u.footnoteCall = h),
      (u.reference = g),
    ...
    function p(b, d, y) {
      for (
        var w = this,
          C = w.interruptFootnoteDefinition,
          k = w.offset,
          T = d.length + 1,
          B = 0,
          _ = [],
          ...
          Ae,
          G;
        B < T && ((O = d.charCodeAt(B)), !(O !== pr && O !== Ve));
      )
        B++;
      if (d.charCodeAt(B++) === je && d.charCodeAt(B++) === hr) {
        ...
        if (!(N === void 0 || P === N || d.charCodeAt(B++) !== Kf)) {
          ...
          for (S = d.slice(P, N), I = b.now(), ie = 0, Z = 0, ve = B, Ae = []; B < T; ) {
            if (((O = d.charCodeAt(B)), O !== O || O === Wr))
              ((G = {
                ...
                Ae.push(G),
                O === Wr && ((ie = B + 1), (Z = 0), (ve = void 0), (G.end = ie)));
            else if (Z !== void 0)
              if (O === Ve || O === pr)
                ((Z += O === Ve ? 1 : jr - (Z % jr)), Z > jr && ((Z = void 0), (ve = B)));
              else {
                if (
                  Z < jr &&
                  G &&
                  (G.contentStart === G.contentEnd || nD(C, i, w, [b, d.slice(B, Jf), !0]))
                )
                  break;
                ((Z = void 0), (ve = B));
              }
          ...
          for (B = -1, T = Ae.length; T > 0 && ((G = Ae[T - 1]), G.contentStart === G.contentEnd); )
            T--;
          for (le = b(d.slice(0, G.contentEnd)); ++B < T; )
            ((G = Ae[B]),
              (k[I.line + B] = (k[I.line + B] || 0) + (G.contentStart - G.start)),
              _.push(d.slice(G.contentStart, G.end)));
          return (
            (K = w.enterBlock()),
            (L = w.tokenizeBlock(_.join(""), I)),
            K(),
            le({
    ...
    function g(b, d, y) {
      var w = 0;
      if ((d.charCodeAt(w) === Hf && w++, d.charCodeAt(w) === je && d.charCodeAt(w + 1) !== hr))
        return l.call(this, b, d, y);
    }
    function E(b, d, y) {
...
var uu = x((JC, iu) => {
  ...
  function fD(e) {
    ...
    function t(n) {
      let i = "$";
      return (
        ((n.data && n.data.hProperties && n.data.hProperties.className) || []).includes(nu) &&
          (i = "$$"),
        i + n.value + i
      );
    }
      ...
      if (((g = f - F), !(g < pD))) {
        ...
        if (s.charCodeAt(f) === ou) {
          ...
          for (
            ...
            for (
              g <= A && s.indexOf(DD, b) === h && ((v = !0), (d = h));
              b <= d && b - f < F && s.charCodeAt(b) === dr;
            )
              b++;
...
var Fu = x((tv, mu) => {
  ...
  function xD(e) {
    ...
    for (t in r)
      ((n = r[t]), n && typeof n == "object" && (r[t] = "concat" in n ? n.concat() : bD(n)));
    return u;
    function i(a) {
...
var bu = x((uv, Au) => {
  ...
  function kD(e, r) {
    return t;
    function t(n) {
      for (var i = 0, u = n.indexOf(Gt), a = e[r], o = [], s; u !== -1; )
        (o.push(n.slice(i, u)),
          (i = u + 1),
          (s = n.charAt(i)),
          (!s || a.indexOf(s) === -1) && o.push(Gt),
          (u = n.indexOf(Gt, i + 1)));
...
var mr = x((hv, Hu) => {
  ...
  function rp(e, r) {
    var t = r.additional,
      ...
      L;
    for (
      typeof t == "string" && (t = t.charCodeAt(0)), I = ie(), k = a ? Z : zD, m--, D++;
      ++m < D;
    )
      if ((y === Mu && (h = f[p] || 1), (y = e.charCodeAt(m)), y === Uu)) {
        if (
          ((C = e.charCodeAt(m + 1)),
          C === WD ||
            C === Mu ||
        ...
        for (
          P = m + 1,
            ...
            O = Hr[N],
            L--;
          ++L < D && ((C = e.charCodeAt(L)), !!O(C));
        )
          ((d += He(C)), N === Ke && GD.call(Su, d) && ((v = d), (_ = Su[d])));
        ((b = e.charCodeAt(L) === $D),
          b && (L++, (A = N === Ke ? YD(d) : !1), A && ((v = d), (_ = A))),
          (K = 1 + L - P),
          (!b && !n) ||
            (d
              ? N === Ke
                ? (b && !_
                    ? k(ju, 1)
                    : (v !== d && ((L = S + v.length), (K = 1 + L - S), (b = !1)),
                      b ||
                        ((T = v ? Gu : Wu),
                        r.attribute
                          ? ((C = e.charCodeAt(L)),
                            C === KD ? (k(T, K), (_ = null)) : Yu(C) ? (_ = null) : k(T, K))
                          : k(T, K))),
                  (w = _))
                : (b || k(zu, K),
                  (w = parseInt(d, jt[N])),
                  tp(w)
                    ...
                    : w in Lu
                      ...
                      : ((B = ""),
                        np(w) && k(zt, K),
                        w > 65535 &&
                          ((w -= 65536), (B += He((w >>> 10) | 55296)), (w = 56320 | (w & 1023))),
                        (w = B + He(w))))
              : N !== Ke && k(Vu, K)),
          w
            ? (ve(),
              ...
              (I = le))
            : ((d = e.slice(P - 1, L)), (g += d), (h += d.length), (m = L - 1)));
    ...
    function r(t, n) {
      ...
      for (w.now = v, w.file = i.file, g(""); t; ) {
        for (
          ...
          !(
            m &&
            (!m.onlyAtStart || i.atStart) &&
            (!m.notInList || !i.inList) &&
            (!m.notInBlock || !i.inBlock) &&
            (!m.notInLink || !i.inLink) &&
            ((F = t.length), m.apply(i, [w, t]), (h = F !== t.length), h)
          ));
        );
...
`,
        ...
        (k === -1 ? (c += C.length) : (c = C.length - k),
          l in u && (k !== -1 ? (c += u[l]) : c <= u[l] && (c = u[l] + 1)));
      }
      function E() {
        var C = [],
          k = l + 1;
      ...
      function y(C, k) {
        var T = k ? k.children : a,
          B = T[T.length - 1],
          _;
        return (
          B &&
            C.type === B.type &&
            (C.type === "text" || C.type === "blockquote") &&
            Qu(B) &&
            Qu(C) &&
            ((_ = C.type === "text" ? op : sp), (C = _.call(i, B, C))),
          C !== B && T.push(C),
          i.atStart && a.length !== 0 && i.exitStart(),
          C
        );
      }
      function w(C) {
  ...
  function Dp(e) {
    ...
    for (n in fp) {
      if (
        ((i = e[n]),
        (i ??= t[n]),
        (n !== "blocks" && typeof i != "boolean") || (n === "blocks" && typeof i != "object"))
      )
        throw new Error("Invalid value `" + i + "` for setting `options." + n + "`");
      e[n] = i;
    }
    ...
    function a(o, s, l) {
      ...
      return (
        typeof c.type == "string" &&
          ...
          (D.displayName = "node (" + Ep(c.type + (f ? "<" + f + ">" : "")) + ")")),
        D
      );
      function D() {
        var m = l.concat(o),
        ...
        if (o.children && p[0] !== da)
          for (F = (n ? o.children.length : -1) + i; F > -1 && F < o.children.length; ) {
...
var wa = x((kv, ya) => {
  ...
  ya.exports = Np;
  function Np(e, r, t) {
    for (var n, i = "", u = 0, a = r.length; u < a && ((n = qp.exec(r.slice(u))), n != null); )
      ((u += n[0].length), (i += n[0]));
    if (i !== "") {
      if (t) return !0;
      e(i);
...
`,
    ...
    Mp = Sp(en, 4);
  function Up(e, r, t) {
    for (var n = -1, i = r.length, u = "", a = "", o = "", s = "", l, c, f; ++n < i; )
      if (((l = r.charAt(n)), f))
        if (((f = !1), (u += o), (a += s), (o = ""), (s = ""), l === Zt)) ((o = l), (s = l));
        else
          for (u += l, a += l; ++n < i; ) {
      ...
      else if (l === en && r.charAt(n + 1) === l && r.charAt(n + 2) === l && r.charAt(n + 3) === l)
        ((o += Mp), (n += 3), (f = !0));
  ...
  function Wp(e, r, t) {
    ...
    if (i) {
      ...
      if (((v = a), (c = r.charAt(a)), !(c !== Yp && c !== qa))) {
        for (a++, l = c, s = 1, o += c; a < u && ((c = r.charAt(a)), c === l); )
          ((o += c), s++, a++);
        if (!(s < Gp)) {
          for (; a < u && ((c = r.charAt(a)), !(c !== Xe && c !== Fr)); ) ((o += c), a++);
          for (f = "", p = ""; a < u && ((c = r.charAt(a)), !(c === et || (l === qa && c === l))); )
            (c === Xe || c === Fr ? (p += c) : ((f += p + c), (p = "")), a++);
          if (((c = r.charAt(a)), !(c && c !== et))) {
            ...
            for (var b = !0; a < u; ) {
              ...
              for (
                b ? ((o += c), (b = !1)) : ((g += c), (E += c)), p = "", a++;
                a < u && ((c = r.charAt(a)), c === Xe);
              )
                ((p += c), a++);
              if (((g += p), (E += p.slice(v)), !(p.length >= zp))) {
                for (p = ""; a < u && ((c = r.charAt(a)), c === l); ) ((p += c), a++);
                if (((g += p), (E += p), !(p.length < s))) {
                  for (p = ""; a < u && ((c = r.charAt(a)), !(c !== Xe && c !== Fr)); )
                    ((g += c), (E += c), a++);
                  if (!c || c === et) break;
                }
              }
            }
            for (o += h + g, a = -1, u = f.length; ++a < u; )
              if (((c = f.charAt(a)), c === Xe || c === Fr)) D || (D = f.slice(0, a));
              else if (D) {
                m = f.slice(a);
                break;
              }
...
var rt = x((qv, Sa) => {
  ...
  Sa.exports = jp;
  function jp(e, r, t, n) {
    for (var i = e.length, u = -1, a, o; ++u < i; )
      if (
        ((a = e[u]),
        (o = a[1] || {}),
...
`,
  ...
  function Kp(e, r, t) {
    ...
    if (r.charAt(p) === Ra) {
      ...
      for (p = 0; p < l; ) {
        for (
          g = r.indexOf(rn, p), A = p, b = !1, g === -1 && (g = l);
          p < l && ((h = r.charAt(p)), !(h !== tn && h !== La));
        )
          p++;
        if (
          (r.charAt(p) === Ra ? (p++, (b = !0), r.charAt(p) === tn && p++) : (p = A),
          (E = r.slice(p, g)),
          !b && !$p(E))
        ) {
          p = A;
...
`,
  ...
  function ih(e, r, t) {
    for (
      var n = -1, i = r.length + 1, u = "", a, o, s, l;
      ++n < i && ((a = r.charAt(n)), !(a !== Qp && a !== Wa));
    )
      u += a;
    if (!(a !== eh && a !== rh && a !== th))
      for (o = a, u += a, s = 1, l = ""; ++n < i; )
        if (((a = r.charAt(n)), a === o)) (s++, (u += l + o), (l = ""));
        else if (a === Wa) l += a;
        else
          return s >= nh && (!a || a === Zp)
...
var nn = x((Sv, Ha) => {
  ...
  function sh(e) {
    for (var r = 0, t = 0, n = e.charAt(r), i = {}, u, a = 0; n === $a || n === uh; ) {
      for (u = n === $a ? oh : ah, t += u, u > 1 && (t = Math.floor(t / u) * u); a < t; )
        i[++a] = r;
      n = e.charAt(++r);
    }
    return {
...
`,
  ...
  function hh(e, r) {
    var t = e.split(Ka),
      ...
      o,
      s;
    for (t.unshift(lh(Dh, r) + ph); n--; )
      if (((o = fh(t[n])), (u[n] = o.stops), ch(t[n]).length !== 0))
        if (o.indent) o.indent > 0 && o.indent < i && (i = o.indent);
        else {
          i = Infinity;
          break;
        }
...
`,
      ...
      for (s = 0, w = [], C = [], k = []; s < l; ) {
        ...
        if ((T && f >= T.indent && (I = !0), (p = r.charAt(s)), (v = null), !I)) {
          if (p === un || p === Za || p === an) ((v = p), s++, f++);
            ...
            ((p = r.charAt(s)),
              s++,
              D && (p === eo || (i && p === ro)) && ((v = p), (f += D.length + 1)));
          }
          if (v)
            if (((p = r.charAt(s)), p === tt)) ((f += ke - (f % ke)), s++);
            else if (p === Ee) {
        ...
        if (v) {
          ...
          (!i && !I && r.charAt(g) === Ee ? (I = !0) : i && T && (I = f >= T.indent || f > ke),
            (E = !1),
            (s = g));
        if (
          ((b = r.slice(g, F)),
          (A = g === s ? b : r.slice(s, F)),
          (v === un || v === Ch || v === an) && a.thematicBreak.call(n, e, b, !0))
        )
          break;
        if (((d = y), (y = !E && !dh(A).length), I && T))
          ((T.value = T.value.concat(k, b)), (C = C.concat(k, b)), (k = []));
        else if (E)
          (k.length !== 0 && ((S = !0), T.value.push(""), (T.trail = k.concat())),
            (T = {
              value: [b],
              indent: f,
              trail: [],
  ...
  function Th(e, r, t) {
    ...
    return (
      ...
      e.options.gfm &&
        ((a = r.match(bh)),
        a &&
          ((o = a[0].length), (u = a[1].toLowerCase() === vh), (n[t.line] += o), (r = r.slice(o)))),
      {
        type: "listItem",
        spread: Ah.test(r),
        checked: u,
  ...
  function _h(e, r, t) {
    ...
    for (
      ...
      ((n[i] = (n[i] || 0) + s[c].length - l[c].length), i++);
    return l.join(oe);
    function D(m, p, h, F, g) {
      return (
        (a = p + h + F),
        (o = g),
        Number(h) < 10 && a.length % 2 === 1 && (h = Ee + h),
        (u = p + mh(Ee, h.length) + F),
        u + o
      );
    }
  }
...
`,
    Xh = "<",
    Jh = /^<(script|pre|style)(?=(\s|>|$))/i,
    Qh = /<\/(script|pre|style)>/i,
    Zh = /^<!--/,
    ed = /-->/,
    rd = /^<\?/,
    td = /\?>/,
    ...
    ad = /]]>/,
    fo = /^$/,
    od = new RegExp($h.source + "\\s*$");
  function sd(e, r, t) {
    for (
      var i = this.options.blocks.join("|"),
        u = new RegExp("^</?(" + i + ")(?=(\\s|/?>|$))", "i"),
        a = r.length,
        o = 0,
        s,
      ...
      o < a && ((f = r.charAt(o)), !(f !== Hh && f !== Kh));
    )
      o++;
    if (r.charAt(o) === Xh) {
      for (
        s = r.indexOf(lo, o + 1), s = s === -1 ? a : s, l = r.slice(o, s), c = -1, D = h.length;
        ++c < D;
      )
        if (h[c][0].test(l)) {
          m = h[c];
...
`,
  ...
  function Ed(e, r, t) {
    for (
      var n = this, i = n.options.commonmark, u = 0, a = r.length, o = "", s, l, c, f, D, m, p, h;
      u < a && ((f = r.charAt(u)), !(f !== it && f !== nt));
    )
      ((o += f), u++);
    if (((f = r.charAt(u)), f === Dn)) {
      for (u++, o += f, c = ""; u < a && ((f = r.charAt(u)), f !== vr); )
        (f === md && ((c += f), u++, (f = r.charAt(u))), (c += f), u++);
      if (!(!c || r.charAt(u) !== vr || r.charAt(u + 1) !== Eo)) {
        for (
          m = c, o += c + vr + Eo, u = o.length, c = "";
          u < a && ((f = r.charAt(u)), !(f !== nt && f !== it && f !== Qe));
        )
          ((o += f), u++);
        ...
        if (c) {
          for (p = c, c = ""; u < a && ((f = r.charAt(u)), !(f !== nt && f !== it && f !== Qe)); )
            ((c += f), u++);
          if (
            ((f = r.charAt(u)),
            (D = null),
            f === Fo ? (D = Fo) : f === go ? (D = go) : f === Fd && (D = gd),
            !D)
          )
            ((c = ""), (u = o.length));
          else if (c) {
...
`,
  ...
  function Od(e, r, t) {
    ...
    if (n.options.gfm) {
      ...
      for (
        o = c.join(ut), u = c.splice(1, 1)[0] || [], i = 0, l = u.length, v--, a = !1, p = [];
        i < l;
      ) {
...
`,
  ...
  function No(e, r, t) {
    var n = this,
      i,
      u;
    if (r.charAt(0) === qo && ((i = r.charAt(1)), n.escape.indexOf(i) !== -1))
      return t
        ? !0
        : (i === Ud
            ? (u = { type: "break" })
  ...
  function gn(e, r, t) {
    ...
    if (r.charAt(0) === Ro) {
      for (
        ...
        a < u &&
        ((c = r.charAt(a)),
        !(Lo(c) || c === dn || c === Mo || (c === ":" && r.charAt(a + 1) === mn)));
      )
        ((o += c), a++);
      if (o) {
        ...
        if (((c = r.charAt(a)), !(!o || c !== dn)))
          return t
            ...
            : ((l += o),
              ...
              f.offset++,
              s &&
                (l.slice(0, at).toLowerCase() === Fn
                  ? ((D = D.slice(at)), (f.column += at), (f.offset += at))
                  : (l = Fn + l)),
              (m = n.inlineTokenizers),
              (n.inlineTokenizers = { text: m.text }),
              (p = n.enterLink()),
              (D = n.tokenizeInline(D, f)),
              (n.inlineTokenizers = m),
              p(),
              e(i)({
                type: "link",
                title: null,
  ...
  function vn(e, r, t) {
    ...
    if (i) {
      ...
      if (
        (h === Cn && (l.pop(), D--),
        l[0] !== void 0 &&
          ((c = l.length < 2 ? f : l[l.length - 2] + 1), r.slice(c, D).indexOf("_") === -1))
      ) {
        if (t) return !0;
        for (F = D, m = D; D < a && ((h = r.charCodeAt(D)), !(Hd(h) || h === u0)); )
          (D++,
            h === Xd ||
              h === Zd ||
              h === e0 ||
              ...
              h === a0 ||
              (F = D));
        if (((D = F), r.charCodeAt(D - 1) === Qd))
          for (p = r.slice(m, D), g = $o(p, o0), E = $o(p, Ko); E > g; )
            ((D = m + p.lastIndexOf(Ko)), (p = r.slice(m, D)), E--);
        ...
        return (
          (v = r.slice(0, D)),
          (b = jd(v, { nonTerminated: !1 })),
          s && (b = "http://" + b),
          (d = n.enterLink()),
          (n.inlineTokenizers = { text: u.text }),
          (A = n.tokenizeInline(v, e.now())),
...
var us = x((r2, is) => {
  ...
  function xn(e, r, t) {
    var n = this,
      ...
      D;
    if (i) {
      for (l = r.charCodeAt(a); ts(l) || ns(l) || l === m0 || l === An || l === ot || l === bn; )
        l = r.charCodeAt(++a);
      if (a !== 0 && l === F0) {
        for (a++; a < o; ) {
...
var ss = x((t2, os) => {
  ...
  function as(e, r, t) {
    ...
    if (
      !(r.charAt(0) !== v0 || i < 3) &&
      ((u = r.charAt(1)), !(!g0(u) && u !== A0 && u !== b0 && u !== x0) && ((a = r.match(C0)), !!a))
    )
      return t
        ? !0
        : ((a = a[0]),
          !n.inLink && y0.test(a) ? (n.inLink = !0) : n.inLink && w0.test(a) && (n.inLink = !1),
          e(a)({
            type: "html",
            value: a,
          }));
...
`,
  ...
  function hs(e, r, t) {
    ...
    if ((a === _0 && ((g = !0), (i = a), (a = r.charAt(++u))), a === Ds && !(!g && n.inLink))) {
      for (
        i += a, y = "", u++, A = r.length, C = e.now(), d = 0, C.column += u, C.offset += u;
        u < A;
      ) {
      ...
      if (c) {
        ...
        if (((a = r.charAt(u)), (y = ""), (m = i), a === wn)) {
          ...
          for (
            a = null, h = "";
            u < A && ((a = r.charAt(u)), !(h && (a === ls || a === fs || (s && a === Ze))));
          ) {
            if (br(a)) {
              if (!o) break;
              h += a;
        ...
        if (((a = r.charAt(u)), (i += y), y && (a === ls || a === fs || (s && a === Ze))))
          if ((u++, (i += a), (y = ""), (v = a === Ze ? xr : a), (p = i), s)) {
            for (; u < A && ((a = r.charAt(u)), a !== v); )
              (a === yr && ((y += yr), (a = r.charAt(++u))), u++, (y += a));
        ...
        if (r.charAt(u) === xr)
          return t
            ? !0
            : ((i += xr),
              (w = n.decode.raw(n.unescape(w), e(m).test().end, { nonTerminated: !1 })),
              b && ((p = e(p).test().end), (b = n.decode.raw(n.unescape(b), p))),
              (T = {
                type: g ? "image" : "link",
                title: b || null,
                url: w,
              ...
              g
                ? (T.alt = n.decode.raw(n.unescape(E), C) || null)
                : ((k = n.enterLink()), (T.children = n.tokenizeInline(E, C)), k()),
              e(i)(T));
      }
    }
  }
  ...
  function Fs(e, r, t) {
    ...
    if ((u === R0 && ((c = I0), (l = u), (u = r.charAt(++a))), u === st)) {
      ...
      if (((s = g), (D = g), (u = r.charAt(a)), u === lt)) {
        if ((a++, (s += u), (g = ""), !i))
          for (; a < o && ((u = r.charAt(a)), !!q0(u)); ) ((g += u), a++);
        if (((u = r.charAt(a)), u === st)) {
          for (m = "", g += u, a++; a < o && ((u = r.charAt(a)), !(u === st || u === lt)); )
            (u === ct && ((m += ct), (u = r.charAt(++a))), (m += u), a++);
          ((u = r.charAt(a)),
            u === lt ? ((f = m ? Bn : L0), (g += m + u), a++) : (m = ""),
            (s += g),
            (g = ""));
        } else {
          if (!D) return;
            ...
            c === Tn && n.inLink
              ...
              : t
                ...
                : ((p = e.now()),
                  ...
                  c === Tn
                    ? ((F = n.enterLink()), (h.children = n.tokenizeInline(D, p)), F())
                    : (h.alt = n.decode.raw(n.unescape(D), p) || null),
                  e(s)(h))
          );
      }
    }
    ...
    if (
      ...
      for (; i < f; ) {
        if (
          ((D = u),
          (u = r.charAt(i)),
          u === s && r.charAt(i + 1) === s && (!o || !As(D)) && ((u = r.charAt(i + 2)), u !== s))
        )
          return U0(l)
            ? t
              ? !0
...
var Ys = x((D2, Us) => {
  ...
  function Ms(e, r, t) {
    var n = this,
      ...
      l,
      c;
    if (!(!n.options.gfm || r.charAt(0) !== ft || r.charAt(1) !== ft || Ls(r.charAt(2))))
      for (s = 1, l = r.length, c = e.now(), c.column += 2, c.offset += 2; ++s < l; ) {
        if (((i = r.charAt(s)), i === ft && u === ft && (!a || !Ls(a))))
          return t
            ? !0
            : e(Rs + o + Rs)({
                type: "delete",
...
`,
  ...
  function Ks(e, r, t) {
    for (var n = r.length, i = -1, u = "", a; ++i < n; ) {
      if (((a = r.charAt(i)), a === om))
        return i < sm ? void 0 : t ? !0 : ((u += a), e(u)({ type: "break" }));
      if (a !== am) return;
      u += a;
    }
  }
...
var Zs = x((F2, Qs) => {
  ...
  function cm(e, r, t) {
    var n = this,
      ...
      m;
    if (t) return !0;
    for (i = n.inlineMethods, o = i.length, u = n.inlineTokenizers, a = -1, D = r.length; ++a < o; )
      ((f = i[a]),
        !(f === "text" || !u[f]) &&
          ((c = u[f].locator),
...
var nc = x((g2, tc) => {
  ...
  function ec(e, r) {
    ((this.file = r),
      (this.offset = {}),
      (this.options = lm(this.options)),
      this.setOptions({}),
      (this.inList = !1),
      (this.inBlock = !1),
      (this.inLink = !1),
      (this.atStart = !0),
      (this.toOffset = fm(r).toOffset),
      (this.unescape = Dm(this, "escape")),
      (this.decode = pm(this)));
  }
  var Y = ec.prototype;
  Y.setOptions = sa();
  ...
  var pt = Object.prototype.hasOwnProperty,
    ...
    pc = function (r) {
      return typeof Array.isArray == "function"
        ? Array.isArray(r)
        : Fc.call(r) === "[object Array]";
    },
    hc = function (r) {
      if (!r || Fc.call(r) !== "[object Object]") return !1;
      var t = pt.call(r, "constructor"),
        n =
          r.constructor &&
          r.constructor.prototype &&
          pt.call(r.constructor.prototype, "isPrototypeOf");
...
var Sc = x((rr) => {
  ...
  function Am(e, r) {
    ...
    for (u = -1, o = r.length - 1; i--; )
      if (e.charCodeAt(i) === 47) {
        ...
        (u < 0 && ((a = !0), (u = i + 1)),
          o > -1 &&
            (e.charCodeAt(i) === r.charCodeAt(o--) ? o < 0 && (n = i) : ((o = -1), (n = u))));
  ...
  function xm(e) {
    ...
    for (wr(e), o = e.length; o--; ) {
      ...
      (n < 0 && ((u = !0), (n = o + 1)),
        a === 46 ? (r < 0 ? (r = o) : i !== 1 && (i = 1)) : r > -1 && (i = -1));
    }
    return r < 0 || n < 0 || i === 0 || (i === 1 && r === n - 1 && r === t + 1)
      ? ""
      : e.slice(r, n);
  }
  function ym() {
      ...
      if (o === 47) {
        if (!(i === a - 1 || u === 1))
          if (i !== a - 1 && u === 2) {
            ...
            (t.length ? (t += "/" + e.slice(i + 1, a)) : (t = e.slice(i + 1, a)), (n = a - i - 1));
        ((i = a), (u = 0));
      } else o === 46 && u > -1 ? u++ : (u = -1);
    }
    return t;
...
var Yc = x((_2, Uc) => {
  ...
  var ce = Sc(),
    ...
    _m = Pn();
  Uc.exports = Ce;
  var Om = {}.hasOwnProperty,
    Ln = ["history", "path", "basename", "stem", "extname", "dirname"];
  ...
  function Ym(e) {
    (Mn(e, "stem"),
      Rn(e, "stem"),
      (this.path = ce.join(this.dirname || "", e + (this.extname || ""))));
  }
  function Gm(e) {
    return (this.contents || "").toString(e);
  }
  function Rn(e, r) {
    if (e && e.indexOf(ce.sep) > -1)
      throw new Error("`" + r + "` cannot be a path: did not expect `" + ce.sep + "`");
  }
  function Mn(e, r) {
  ...
  function Qc() {
    ...
    function s(F) {
      ...
      function A(d) {
        var y = -1;
        if (d != null)
          if (typeof d == "object" && "length" in d) for (; ++y < d.length; ) v(d[y]);
    ...
    function c(F) {
      ...
      return (
        ...
        (E = u.Parser),
        Un("parse", E),
        Hc(E, "parse") ? new E(String(g), g).parse() : E(String(g), g)
      );
    }
    function f(F, g, E) {
      if ((Kc(F), a(), !E && typeof g == "function" && ((E = g), (g = null)), !E))
    ...
    function m(F, g) {
      ...
      return (
        ...
        Yn("stringify", v),
        Kc(F),
        Hc(v, "compile") ? new v(F, E).compile() : v(F, E)
      );
    }
    function p(F, g) {
    ...
    function h(F) {
      ...
      return (
        a(),
        Un("processSync", u.Parser),
        Yn("processSync", u.Compiler),
        (g = kr(F)),
        p(g, v),
        Xc("processSync", "process", E),
        g
      );
      function v(A) {
        ((E = !0), jc(A));
...
var Me =
  (e, r) =>
  (t, n, ...i) =>
    t | 1 && n == null ? void 0 : (r.call(n) ?? n[e]).apply(n, i);
function yl(e) {
...
var V = "string",
  ...
  pe = "indent-if-break",
  he = "line-suffix",
  de = "line-suffix-boundary",
  $ = "line",
  me = "label",
  te = "break-parent",
  Br = new Set([be, ee, re, De, X, J, Q, pe, he, de, $, me, te]);
function Ol(e) {
...
function ni(e, r, t) {
  let n = r.type === 1 ? e.queue.slice(0, -1) : [...e.queue, r],
    i = "",
    u = 0,
    a = 0,
    o = 0;
  ...
  for (; t >= 0; ) {
    ...
    switch (D) {
      ...
      case X: {
        ...
        let m = f.break ? H : c,
          p = f.expandedStates && m === H ? U(0, f.expandedStates, -1) : f.contents;
        s.push({
          mode: m,
          doc: p,
        });
...
`,
          ...
          case H: {
            ...
            if (!A.break && Pr(b, a, d, y, t)) a.push(b);
              ...
              if (A.break) {
                ...
                for (let C = 1; C < A.expandedStates.length + 1; C++)
                  if (C >= A.expandedStates.length) {
                    a.push({
                      indent: E,
                      mode: H,
                      doc: w,
        ...
        switch (v) {
          ...
          case H:
            ...
            A.literal
              ? ((o += i),
                (u = 0),
                E.root && (E.root.value && (o += E.root.value), (u = E.root.length)))
              : (g(), (o += i + E.value), (u = E.length));
            break;
        }
        break;
      case me:
  ...
  function g() {
    ...
    (E && (f.push(E), (m += E.length)),
      (o = ""),
      (u -= v),
      c.length > 0 && (D.push(...c.map((A) => Math.min(A, m))), (c.length = 0)));
  }
}
function Kl(e, r) {
...
function Zl(e, r) {
  let { preferred: t, alternate: n } = r === !0 || r === "'" ? Jl : Ql,
    { length: i } = e,
    u = 0,
    a = 0;
  for (let o = 0; o < i; o++) {
...
var hi = (e) => String(e).split(/[/\\]/u).pop(),
  di = (e) => String(e).startsWith("file:");
function mi(e, r) {
  if (!r) return;
  let t = hi(r).toLowerCase();
  return (
    e.find(({ filenames: n }) => n?.some((i) => i.toLowerCase() === t)) ??
    e.find(({ extensions: n }) => n?.some((i) => t.endsWith(i)))
  );
}
function of(e, r) {
  if (r)
    return (
      ...
      e.find(({ aliases: t }) => t?.includes(r)) ??
      e.find(({ extensions: t }) => t?.includes(`.${r}`))
    );
}
var sf = void 0;
function Fi(e, r) {
...
var gi = "format";
var Ei =
    /<!--\s*@(?:noformat|noprettier)\s*-->|\{\s*\/\*\s*@(?:noformat|noprettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:noformat|noprettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/mu,
  Ci =
    /<!--\s*@(?:format|prettier)\s*-->|\{\s*\/\*\s*@(?:format|prettier)\s*\*\/\s*\}|<!--.*\r?\n[\s\S]*(^|\n)[^\S\n]*@(?:format|prettier)[^\S\n]*($|\n)[\s\S]*\n.*-->/mu;
var Lr = (e) => _e(e).content.trimStart().match(Ci)?.index === 0,
  vi = (e) => _e(e).content.trimStart().match(Ei)?.index === 0,
  Ai = (e) => {
    let { frontMatter: r } = _e(e),
      t = `<!-- @${gi} -->`;
    return r
      ? `${r.raw}
...
`,
    ...
    (e.type === "definition" || e.type === "linkReference" || e.type === "imageReference") &&
      (r.label = (0, bi.default)(e.label)),
    (e.type === "link" || e.type === "image") && e.url && e.url.includes("("))
  )
    for (let n of "<>") r.url = R(0, e.url, n, encodeURIComponent(n));
  if (
    ((e.type === "definition" || e.type === "link" || e.type === "image") &&
      e.title &&
      (r.title = R(0, e.title, /\\(?=["')])/gu, "")),
    t?.type === "root" &&
      t.children.length > 0 &&
      (t.children[0] === e || (kt(t.children[0]) && t.children[1] === e)) &&
      e.type === "html" &&
      Lr(e.value))
  )
    return null;
...
var qe = (e) => e.position.start.offset,
  Ne = (e) => e.position.end.offset;
var Tt = new Set([
    "liquidNode",
    "inlineCode",
    "emphasis",
  ...
  Rr = new Set([...Tt, "tableCell", "paragraph", "heading"]),
  We = "non-cjk",
  ae = "cj-letter",
  Pe = "k-letter",
  cr = "cjk-punctuation",
...
`
  ...
  function n(i) {
    ...
    (u?.type === "word" &&
      !a(We, cr) &&
      ![u.value, i.value].some((o) => /\u3000/u.test(o)) &&
      r.push({
        type: "whitespace",
        value: "",
      }),
...
function ze(e, r) {
  let { numberText: n, leadingSpaces: i } = r.originalText
    .slice(e.position.start.offset, e.position.end.offset)
    .match(/^\s*(?<numberText>\d+)(\.|\))(?<leadingSpaces>\s*)/u).groups;
  return {
    number: Number(n),
    leadingSpaces: i,
  };
...
function ki(e, r) {
  return !e.ordered || e.children.length < 2 || ze(e.children[1], r).number !== 1
    ? !1
    : ze(e.children[0], r).number !== 0
      ? !0
      : e.children.length > 2 && ze(e.children[2], r).number === 1;
}
function Ur(e, r) {
  let { value: t } = e;
      ...
      return (
        ...
        i
          ? async (u) => {
              ...
              n === "ts" || n === "typescript"
                ? (a.filepath = "dummy.ts")
                : n === "tsx" && (a.filepath = "dummy.tsx");
              let o = await u(Ur(t, r.originalText), a),
                s = r.__inJsTemplate ? "~" : "`",
                l = s.repeat(Math.max(3, Ir(t.value, s) + 1));
...
function mf(e, r) {
  ...
  if (
    ...
    throw new Error(`Unexpected '${r}' in MDX.`);
}
var Ti = df;
var fr = null;
function Dr(e) {
...
function z(e, r, t, n = {}) {
  ...
  return (
    e.each(() => {
      let a = i(e);
      a !== !1 &&
        (u.length > 0 && Cf(e) && (u.push(M), (Af(e, r) || qi(e)) && u.push(M), qi(e) && u.push(M)),
        u.push(a));
    }, "children"),
    u
  );
...
function Af({ node: e, previous: r, parent: t }, n) {
  ...
  let u = r.type === e.type && vf.has(e.type),
    a = t.type === "listItem" && (e.type === "list" || !Ni(t, n)),
    o = lr(r) === "next",
    s = e.type === "html" && r.type === "html" && r.position.end.line + 1 === e.position.start.line,
    l =
      e.type === "html" &&
      t.type === "listItem" &&
      r.type === "paragraph" &&
...
function Ii(e, r, t) {
  ...
  return z(e, r, t, {
    processor() {
      ...
      if (
        o.children.length === 2 &&
        o.children[1].type === "html" &&
        o.children[0].position.start.column !== o.children[1].position.start.column
      )
        return [a, Pi(e, r, t, a)];
      return [a, Fe(" ".repeat(a.length), Pi(e, r, t, a))];
      function s() {
        let l = n.ordered
          ? (e.isFirst ? n.start : u ? 1 : n.start + e.index) + (i % 2 === 0 ? ". " : ") ")
          : i % 2 === 0
            ? "- "
            : "* ";
...
function Pi(e, r, t, n) {
  let { node: i } = e,
    u = i.checked === null ? "" : i.checked ? "[x] " : "[ ] ";
  return [
    u,
    z(e, r, t, {
      processor({ node: a, isFirst: o }) {
...
function Si(e, r, t) {
  let { node: n } = e,
    ...
    u = e.map(
      () =>
        e.map(({ index: f }) => {
          let D = ai(t(), r).formatted,
            m = or(D);
          return (
            (i[f] = Math.max(i[f] ?? 3, m)),
            {
              text: D,
              width: m,
            }
  ...
  function s(f) {
    return _r(
      ar,
      [c(u[0], f), l(f), ...u.slice(1).map((D) => c(D, f))].map((D) => `| ${D.join(" | ")} |`),
    );
  }
  function l(f) {
    return i.map((D, m) => {
...
function Li(e) {
  let { node: r } = e,
    t = R(
      0,
      R(0, r.value, "*", "\\*"),
      new RegExp([`(^|${Oe.source})(_+)`, `(_+)(${Oe.source}|$)`].join("|"), "gu"),
      (u, a, o, s, l) => R(0, o ? `${a}${o}` : `${s}${l}`, "_", "\\_"),
    ),
    n = (u, a, o) => u.type === "sentence" && o === 0,
    i = (u, a, o) => Yr(u.children[o - 1]);
  return (
    t !== r.value &&
      (e.match(void 0, n, i) ||
        e.match(void 0, n, (u, a, o) => u.type === "emphasis" && o === 0, i)) &&
      (t = t.replace(/^(\\?[*_])+/u, (u) => R(0, u, "\\", ""))),
    t
  );
}
function Ri(e, r, t) {
...
var _t = class {
  ...
  split(r, t = !1) {
    let n = `[${fe([...this.#e].join(""))}]+`,
      i = new RegExp(t ? `(${n})` : n, "u");
    return r.split(i);
  }
...
function qf(e, r, t) {
  return ye(e, (n) => {
    ...
    for (let o of n.children)
      (u && r(u, o) ? ((o = t(u, o)), i.splice(-1, 1, o), a || (a = !0)) : i.push(o), (u = o));
    return a
      ? {
          ...n,
          children: i,
...
function Pf(e) {
  return ye(e, (r, t, [n]) => {
    ...
    return (
      n.type === "paragraph" &&
        (t === 0 && (i = Ot.trimStart(i)), t === n.children.length - 1 && (i = Ot.trimEnd(i))),
      {
        type: "sentence",
        position: r.position,
        children: Mr(i),
...
var Lf = new Set(["heading", "tableCell", "link", "wikiLink"]),
...
function Mf(e, r) {
  ...
  let i = t.kind,
    u = n.kind;
  return (zi(i) && zi(u)) || (i === Pe && u === ae) || (u === Pe && i === ae)
    ? !0
    : i === cr || u === cr || (i === ae && u === ae)
      ? !1
      : Gi.has(n.value[0]) || Gi.has(U(0, t.value, -1))
        ? !0
...
function Uf(e, r, t, n) {
  ...
  return !i || !u
    ...
    : r === ""
      ? !1
      : (i.kind === Pe && u.kind === ae) || (u.kind === Pe && i.kind === ae)
        ? !0
        : !(i.isCJ || u.isCJ);
}
function qt(e, r, t, n) {
...
function Wi(e) {
  ...
  return (
    (r?.type === "sentence" &&
      U(0, r.children, -1)?.type === "word" &&
      !U(0, r.children, -1).hasTrailingPunctuation) ||
    (t?.type === "sentence" &&
      t.children[0]?.type === "word" &&
...
function Yf(e, r, t) {
  ...
  if (zf(e)) {
    let i = [""],
      u = Mr(r.originalText.slice(n.position.start.offset, n.position.end.offset));
    for (let a of u) {
      if (a.type === "word") {
  ...
  switch (n.type) {
    ...
    case "emphasis": {
      ...
      if (Yr(n.children[0])) i = r.originalText[n.position.start.offset];
        ...
        let u = Wi(e),
          a = e.callParent(({ node: o }) => o.type === "strong" && Wi(e));
...
`,
    ...
    case "wikiLink": {
      let i = "";
      return (
        r.proseWrap === "preserve" ? (i = n.value) : (i = R(0, n.value, /[\t\n]+/gu, " ")),
        ["[[", i, "]]"]
      );
    }
    case "link":
      switch (r.originalText[n.position.start.offset]) {
        case "<": {
          ...
          return [
            "<",
            n.url.startsWith(i) &&
            r.originalText.slice(n.position.start.offset + 1, n.position.start.offset + 1 + 7) !== i
              ? n.url.slice(7)
              : n.url,
            ">",
          ];
      ...
      return [
        ...
        i
          ...
          : Ge([
              Fe(
                " ".repeat(4),
                z(e, r, t, { processor: ({ isFirst: u }) => (u ? Ge([Nr, t()]) : t()) }),
              ),
            ]),
      ];
    }
...
function zr(e, r, t = !0) {
  ...
  if (((e = R(0, e, /\\(?=["')])/gu, "")), e.includes('"') && e.includes("'") && !e.includes(")")))
    return `(${e})`;
...
var al = function () {
  let { Parser: e } = this,
    { blockTokenizers: r, blockMethods: t, inlineTokenizers: n, inlineMethods: i } = e.prototype;
  ((r.esSyntax = zn),
    (n.esComment = ul),
    t.splice(t.indexOf("paragraph"), 0, "esSyntax"),
    i.splice(i.indexOf("text"), 0, "esComment"));
};
var uF = function () {
...
function aF() {
  return (e) =>
    ye(e, (r, t, [n]) =>
      r.type !== "html" || tl.test(r.value) || Rr.has(n.type)
        ? r
        : {
            ...r,
            type: "jsx",
