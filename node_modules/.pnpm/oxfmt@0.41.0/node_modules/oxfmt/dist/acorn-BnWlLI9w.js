...
var $e = ot((yr, Ye) => {
  ...
  function Es(e, t) {
    let i = t.acorn || void 0,
      ...
      h = s.tokContexts.tc_cTag,
      l = s.tokContexts.tc_expr,
      m = i.isNewLine,
      S = i.isIdentifierStart,
      E = i.isIdentifierChar;
          ...
          switch (y) {
            ...
            case 123:
              return this.pos === this.start
                ? y === 60 && this.exprAllowed
                  ? (++this.pos, this.finishToken(o.jsxTagStart))
                  : this.getTokenFromCode(y)
                : ((c += this.input.slice(x, this.pos)), this.finishToken(o.jsxText, c));
            case 38:
            ...
            default:
              m(y)
                ? ((c += this.input.slice(x, this.pos)),
                  (c += this.jsx_readNewLine(!0)),
                  (x = this.pos))
                : ++this.pos;
          }
        }
...
`))
      ...
      jsx_readString(c) {
        ...
        for (;;) {
          ...
          if (v === c) break;
          v === 38
            ? ((x += this.input.slice(y, this.pos)), (x += this.jsx_readEntity()), (y = this.pos))
            : m(v)
              ? ((x += this.input.slice(y, this.pos)),
      ...
      jsx_readEntity() {
        ...
        for (; this.pos < this.input.length && x++ < 10; ) {
          if (((v = this.input[this.pos++]), v === ";")) {
            c[0] === "#"
              ? c[1] === "x"
                ? ((c = c.substr(2)), Cs.test(c) && (y = String.fromCharCode(parseInt(c, 16))))
                : ((c = c.substr(1)), Ts.test(c) && (y = String.fromCharCode(parseInt(c, 10))))
              : (y = _s[c]);
            break;
          }
          c += v;
      ...
      jsx_readWord() {
        let c,
          x = this.pos;
        do c = this.input.charCodeAt(++this.pos);
        while (E(c) || c === 45);
      ...
      jsx_parseIdentifier() {
        ...
        return (
          this.type === o.jsxName
            ? (c.name = this.value)
            : this.type.keyword
              ? (c.name = this.type.keyword)
              : this.unexpected(),
          this.next(),
          this.finishNode(c, "JSXIdentifier")
        );
      }
      jsx_parseNamespacedName() {
        let c = this.start,
          x = this.startLoc,
          y = this.jsx_parseIdentifier();
      ...
      jsx_parseElementName() {
        ...
        let c = this.start,
          x = this.startLoc,
          y = this.jsx_parseNamespacedName();
        for (
          this.type === r.dot &&
          y.type === "JSXNamespacedName" &&
          ...
          ((v.object = y),
            ...
            (y = this.finishNode(v, "JSXMemberExpression")));
        }
        return y;
      }
          ...
          case r.braceL:
            ...
            return (
              c.expression.type === "JSXEmptyExpression" &&
                this.raise(c.start, "JSX attributes must only be assigned a non-empty expression"),
              c
            );
          case o.jsxTagStart:
          case r.string:
      ...
      jsx_parseExpressionContainer() {
        ...
        return (
          ...
          this.finishNode(c, "JSXExpressionContainer")
        );
      }
      jsx_parseAttribute() {
        let c = this.startNode();
        return this.eat(r.braceL)
          ? (this.expect(r.ellipsis),
            ...
            this.expect(r.braceR),
            this.finishNode(c, "JSXSpreadAttribute"))
          : ((c.name = this.jsx_parseNamespacedName()),
            (c.value = this.eat(r.eq) ? this.jsx_parseAttributeValue() : null),
            this.finishNode(c, "JSXAttribute"));
      }
      jsx_parseOpeningElementAt(c, x) {
        let y = this.startNodeAt(c, x);
        y.attributes = [];
        let v = this.jsx_parseElementName();
        for (v && (y.name = v); this.type !== r.slash && this.type !== o.jsxTagEnd; )
          y.attributes.push(this.jsx_parseAttribute());
        return (
          (y.selfClosing = this.eat(r.slash)),
          this.expect(o.jsxTagEnd),
          this.finishNode(y, v ? "JSXOpeningElement" : "JSXOpeningFragment")
        );
      }
      jsx_parseClosingElementAt(c, x) {
        ...
        return (
          v && (y.name = v),
          this.expect(o.jsxTagEnd),
          this.finishNode(y, v ? "JSXClosingElement" : "JSXClosingFragment")
        );
      }
      jsx_parseElementAt(c, x) {
        let y = this.startNodeAt(c, x),
          v = [],
          I = this.jsx_parseOpeningElementAt(c, x),
          de = null;
        if (!I.selfClosing) {
          e: for (;;)
            switch (this.type) {
          ...
          pe(de.name) !== pe(I.name) &&
            this.raise(de.start, "Expected corresponding JSX closing tag for <" + pe(I.name) + ">");
        }
      ...
      parseExprAtom(c) {
        return this.type === o.jsxText
          ? this.jsx_parseText()
          : this.type === o.jsxTagStart
      ...
      readToken(c) {
        ...
        return c === 60 && this.exprAllowed && this.input.charCodeAt(this.pos + 1) !== 33
          ? (++this.pos, this.finishToken(o.jsxTagStart))
          : super.readToken(c);
      }
      updateContext(c) {
        if (this.type == r.braceL) {
          ...
          (x == p
            ? this.context.push(u.b_expr)
            : x == l
              ? this.context.push(u.b_tmpl)
              : super.updateContext(c),
            (this.exprAllowed = !0));
        } else if (this.type === r.slash && c === o.jsxTagStart)
        ...
        : e < 91
          ...
          : e < 97
            ...
            : e < 123
              ? !0
              : e <= 65535
                ? e >= 170 && Gi.test(String.fromCharCode(e))
                : t === !1
                  ? !1
                  : je(e, dt) || je(e, Di);
}
...
var xe = 0,
  ...
  A = function (t, i, s) {
    ((this.options = t = Xi(t)),
      ...
      (this.keywords = H(Fi[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5])));
    var r = "";
    (t.allowReserved !== !0 &&
      ((r = De[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3]),
      t.sourceType === "module" && (r += " await")),
      (this.reservedWords = H(r)));
    var o = (r ? r + " " : "") + De.strict;
    ((this.reservedWordsStrict = H(o)),
      (this.reservedWordsStrictBind = H(o + " " + De.strictBind)),
      (this.input = String(i)),
      (this.containsEsc = !1),
      s
        ? ((this.pos = s),
...
d.isAsyncFunction = function () {
  ...
  return (
    ...
    (t + 8 === this.input.length ||
      !(X((i = this.input.charCodeAt(t + 8))) || (i > 55295 && i < 56320)))
  );
};
d.isUsingKeyword = function (e, t) {
  ...
  if (t) {
    ...
    if (
      ...
      (p === this.input.length || (!X((h = this.input.charCodeAt(p))) && !(h > 55295 && h < 56320)))
    )
      return !1;
  }
...
d.parseStatement = function (e, t, i) {
  ...
  switch ((this.isLet(e) && ((s = a._var), (o = "let")), s)) {
    ...
    case a._var:
      return (
        (o = o || this.value), e && o !== "var" && this.unexpected(), this.parseVarStatement(r, o)
      );
    case a._while:
    ...
    case a._import:
      if (this.options.ecmaVersion > 10 && s === a._import) {
        k.lastIndex = this.pos;
        var u = k.exec(this.input),
          p = this.pos + u[0].length,
          h = this.input.charCodeAt(p);
    ...
    default:
      ...
      return s === a.name && S.type === "Identifier" && this.eat(a.colon)
        ? this.parseLabeledStatement(r, m, S, e)
        : this.parseExpressionStatement(r, S);
  }
};
...
d.parseForStatement = function (e) {
  ...
  var t =
    this.options.ecmaVersion >= 9 && this.canAwait && this.eatContextual("await")
      ? this.lastTokStart
      : -1;
  if ((this.labels.push(ze), this.enterScope(0), this.expect(a.parenL), this.type === a.semi))
  ...
  if (p) {
    ...
    return (
      ...
      this.parseForAfterInit(e, h, t)
    );
  }
  var l = this.containsEsc,
    m = new Ce(),
    S = this.start,
    E = t > -1 ? this.parseExprSubscripts(m, "await") : this.parseExpression(!0, m);
  return this.type === a._in || (u = this.options.ecmaVersion >= 6 && this.isContextual("of"))
    ? (t > -1
        ? (this.type === a._in && this.unexpected(t), (e.await = !0))
        : u &&
          this.options.ecmaVersion >= 8 &&
          (E.start === S && !l && E.type === "Identifier" && E.name === "async"
            ? this.unexpected()
            : this.options.ecmaVersion >= 9 && (e.await = !1)),
      o &&
        u &&
        this.raise(E.start, "The left-hand side of a for-of loop may not start with 'let'."),
      this.toAssignable(E, !1, m),
      this.checkLValPattern(E),
      this.parseForIn(e, E))
    : (this.checkExpressionErrors(m, !0), t > -1 && this.unexpected(t), this.parseFor(e, E));
};
...
d.parseCatchClauseParam = function () {
  var e = this.parseBindingAtom(),
    t = e.type === "Identifier";
  return (
    this.enterScope(t ? St : 0), this.checkLValPattern(e, t ? Tt : K), this.expect(a.parenR), e
  );
};
...
d.parseLabeledStatement = function (e, t, i, s) {
  for (var r = 0, o = this.labels; r < o.length; r += 1)
    o[r].name === t && this.raise(i.start, "Label '" + t + "' is already declared");
  for (
...
d.parseVarId = function (e, t) {
  ((e.id = t === "using" || t === "await using" ? this.parseIdent() : this.parseBindingAtom()),
    this.checkLValPattern(e.id, t === "var" ? We : K, !1));
};
var ae = 1,
  Ge = 2,
  At = 4;
d.parseFunction = function (e, t, i, s, r) {
  (this.initFunction(e),
    (this.options.ecmaVersion >= 9 || (this.options.ecmaVersion >= 6 && !s)) &&
      (this.type === a.star && t & Ge && this.unexpected(), (e.generator = this.eat(a.star))),
    this.options.ecmaVersion >= 8 && (e.async = !!s),
    t & ae &&
      ((e.id = t & At && this.type !== a.name ? null : this.parseIdent()),
      e.id &&
        !(t & Ge) &&
        this.checkLValSimple(
          e.id,
          this.strict || e.generator || e.async ? (this.treatFunctionsAsVar ? We : K) : Ct,
        )));
  var o = this.yieldPos,
    u = this.awaitPos,
  ...
  return (
    ...
    this.enterScope(Xe(e.async, e.generator)),
    t & ae || (e.id = this.type === a.name ? this.parseIdent() : null),
    this.parseFunctionParams(e),
    this.parseFunctionBody(e, i, !1, r),
    (this.yieldPos = o),
    (this.awaitPos = u),
    (this.awaitIdentPos = p),
    this.finishNode(e, t & ae ? "FunctionDeclaration" : "FunctionExpression")
  );
};
  ...
  if (
    ...
    !s &&
      ...
      ((this.isClassElementNameStart() || this.type === a.star) && !this.canInsertSemicolon()
        ? (o = !0)
        : (s = "async")),
    !s && (t >= 9 || !o) && this.eat(a.star) && (r = !0),
    !s && !o && !r)
  ) {
    var h = this.value;
    (this.eatContextual("get") || this.eatContextual("set")) &&
      (this.isClassElementNameStart() ? (u = h) : (s = h));
  }
  if (
    (s
      ? ((i.computed = !1),
    ...
    t < 13 || this.type === a.parenL || u !== "method" || r || o)
  ) {
    var l = !i.static && ye(i, "constructor"),
      m = l && e;
    (l && u !== "method" && this.raise(i.key.start, "Constructor can't have get/set modifier"),
      (i.kind = l ? "constructor" : u),
      this.parseClassMethod(i, r, o, m));
...
d.parseClassField = function (e) {
  return (
    ...
    this.eat(a.eq)
      ? (this.enterScope(ue | Se), (e.value = this.parseMaybeAssign()), this.exitScope())
      : (e.value = null),
    this.semicolon(),
...
d.parseClassId = function (e, t) {
  this.type === a.name
    ? ((e.id = this.parseIdent()), t && this.checkLValSimple(e.id, K, !1))
...
d.parseImport = function (e) {
  return (
    this.next(),
    this.type === a.string
      ? ((e.specifiers = Yi), (e.source = this.parseExprAtom()))
...
d.parseImportSpecifier = function () {
  ...
  return (
    ...
    this.checkLValSimple(e.local, K),
...
d.parseModuleExportName = function () {
  if (this.options.ecmaVersion >= 13 && this.type === a.string) {
    ...
    return (
      Hi.test(e.value) && this.raise(e.start, "An export name cannot include a lone surrogate."), e
    );
  }
...
D.parseBindingList = function (e, t, i, s) {
  for (var r = [], o = !0; !this.eat(e); )
    if ((o ? (o = !1) : this.expect(a.comma), t && this.type === a.comma)) r.push(null);
    else {
      ...
      (this.strict &&
        ...
        s &&
          ...
          i &&
            ...
            (i[e.name] = !0)),
          t !== Et && this.declareName(e.name, t, e.start)));
      break;
    case "ChainExpression":
      this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
      break;
...
ee.braceIsBlock = function (e) {
  ...
  return t === T.f_expr || t === T.f_stat
    ? !0
    : e === a.colon && (t === T.b_stat || t === T.b_expr)
      ? !t.isExpr
...
a.parenR.updateContext = a.braceR.updateContext = function () {
  ...
  (e === T.b_stat && this.curContext().token === "function" && (e = this.context.pop()),
...
a._function.updateContext = a._class.updateContext = function (e) {
  (e.beforeExpr &&
  e !== a._else &&
  !(e === a.semi && this.curContext() !== T.p_stat) &&
  !(e === a._return && L.test(this.input.slice(this.lastTokEnd, this.start))) &&
  !((e === a.colon || e === a.braceL) && this.curContext() === T.b_stat)
    ? this.context.push(T.f_expr)
    : this.context.push(T.f_stat),
    (this.exprAllowed = !1));
};
...
a.backQuote.updateContext = function () {
  (this.curContext() === T.q_tmpl ? this.context.pop() : this.context.push(T.q_tmpl),
    (this.exprAllowed = !1));
};
...
g.checkPropClash = function (e, t, i) {
  if (
    ...
    if (u) {
      var p;
      (o === "init" ? (p = (this.strict && u.init) || u.get || u.set) : (p = u.init || u[o]),
...
g.parseMaybeAssign = function (e, t, i) {
  ...
  if ((i && (l = i.call(this, l, p, h)), this.type.isAssign)) {
    ...
    return (
      ...
      this.type === a.eq && (l = this.toAssignable(l, !1, t)),
      s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1),
      t.shorthandAssign >= l.start && (t.shorthandAssign = -1),
      this.type === a.eq ? this.checkLValPattern(l) : this.checkLValSimple(l),
      (m.left = l),
      this.next(),
...
g.parseExprOp = function (e, t, i, s, r) {
  ...
  if (o != null && (!r || this.type !== a._in) && o > s) {
    ...
    var l = this.start,
      m = this.startLoc,
      S = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, r), l, m, o, r),
      E = this.buildBinary(t, i, e, S, h, u || p);
    return (
...
g.parseMaybeUnary = function (e, t, i, s) {
  ...
  if (this.isContextual("await") && this.canAwait) ((u = this.parseAwait(s)), (t = !0));
    ...
    var p = this.startNode(),
      h = this.type === a.incDec;
    ((p.operator = this.value),
      (p.prefix = !0),
      this.next(),
      (p.argument = this.parseMaybeUnary(null, !0, h, s)),
      ...
      h
        ...
        : this.strict && p.operator === "delete" && kt(p.argument)
          ...
          : p.operator === "delete" && qe(p.argument)
            ? this.raiseRecoverable(p.start, "Private fields can not be deleted")
            : (t = !0),
      (u = this.finishNode(p, h ? "UpdateExpression" : "UnaryExpression")));
    ...
    for (; this.type.postfix && !this.canInsertSemicolon(); ) {
      ...
      ((l.operator = this.value),
        ...
        this.next(),
        (u = this.finishNode(l, "UpdateExpression")));
    }
  }
...
function qe(e) {
  return (
    ...
    (e.type === "ChainExpression" && qe(e.expression)) ||
    (e.type === "ParenthesizedExpression" && qe(e.expression))
  );
}
...
g.parseSubscript = function (e, t, i, s, r, o, u) {
  ...
  if (l || (h && this.type !== a.parenL && this.type !== a.backQuote) || this.eat(a.dot)) {
    ...
    ((m.object = e),
      l
        ? ((m.property = this.parseExpression()), this.expect(a.bracketR))
        : this.type === a.privateId && e.type !== "Super"
          ? (m.property = this.parsePrivateIdent())
          : (m.property = this.parseIdent(this.options.allowReserved !== "never")),
      (m.computed = !!l),
      p && (m.optional = h),
    ...
    if (r && !h && this.shouldParseAsyncArrow())
      return (
        ...
        this.parseSubscriptAsyncArrow(t, i, y, u)
      );
    (this.checkExpressionErrors(S, !0),
      (this.yieldPos = E || this.yieldPos),
  ...
  switch (this.type) {
    ...
    case a.name:
      ...
      if (
        ...
        return (
          this.overrideContext(T.f_expr), this.parseFunction(this.startNodeAt(o, u), 0, !1, !0, t)
        );
      if (r && !this.canInsertSemicolon()) {
        ...
        if (
          ...
          return (
            ...
            this.parseArrowExpression(this.startNodeAt(o, u), [h], !0, t)
          );
      }
      return h;
    case a.regexp:
    ...
    case a.parenL:
      var m = this.start,
        S = this.parseParenAndDistinguishExpression(r, t);
      return (
        e &&
...
g.parseParenAndDistinguishExpression = function (e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    ...
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR; )
      if ((l ? (l = !1) : this.expect(a.comma), o && this.afterTrailingComma(a.parenR, !0))) {
        m = !0;
        break;
    ...
    if ((this.expect(a.parenR), e && this.shouldParseArrow(h) && this.eat(a.arrow)))
      return (
        ...
        (this.yieldPos = E),
        (this.awaitPos = c),
        this.parseParenArrowList(i, s, h, t)
      );
  ...
  return (
    ...
    !e && !p && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(i)
      ? ((r = !0),
        ...
        this.parsePropertyName(i))
      : (r = !1),
    this.parsePropertyValue(i, e, s, r, o, u, t, p),
...
g.parseMethod = function (e, t, i) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(Xe(t, s.generator) | Se | (i ? _t : 0)),
    this.expect(a.parenL),
...
g.parseFunctionBody = function (e, t, i, s) {
  ...
  if (r) ((e.body = this.parseMaybeAssign(s)), (e.expression = !0), this.checkParams(e, !1));
    ...
    ((this.labels = []),
      ...
      this.strict && e.id && this.checkLValSimple(e.id, Et),
...
g.checkUnreserved = function (e) {
  ...
  if (
    ...
    !(this.currentThisScope().flags & _e) &&
      s === "arguments" &&
    ...
    (this.strict ? this.reservedWordsStrict : this.reservedWords).test(s) &&
      (!this.inAsync &&
        s === "await" &&
...
W.declareName = function (e, t, i) {
  ...
  if (t === K) {
    ...
    ((s = r.lexical.indexOf(e) > -1 || r.functions.indexOf(e) > -1 || r.var.indexOf(e) > -1),
      r.lexical.push(e),
      this.inModule && r.flags & oe && delete this.undefinedExports[e]);
    ...
    for (var p = this.scopeStack.length - 1; p >= 0; --p) {
      ...
      if (
        (h.lexical.indexOf(e) > -1 && !(h.flags & St && h.lexical[0] === e)) ||
      ...
      if (
        (h.var.push(e),
        this.inModule && h.flags & oe && delete this.undefinedExports[e],
        h.flags & _e)
      )
        break;
    }
...
var Te = function (t, i, s) {
    ((this.type = ""),
      (this.start = i),
      (this.end = 0),
      t.options.locations && (this.loc = new be(t, s)),
...
var ts =
  ...
  It = Pt + " Extended_Pictographic",
  Nt = It,
  Lt = Nt + " EBase EComp EMod EPres ExtPict",
  Rt = Lt,
  is = Rt,
  ss = {
    9: Pt,
  ...
  Bt = Ot + " Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho",
  Dt = Bt + " Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi",
  Mt = Dt + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
  ns = Mt + " " + ts,
  os = {
    9: Vt,
    10: Ot,
...
f.regexp_disjunction = function (e) {
  ...
  for (t && (e.branchID = new ve(e.branchID, null)), this.regexp_alternative(e); e.eat(124); )
        ...
        if (i || s) {
          ...
          if (s) {
            ...
            for (var p = 0; p < u.length; p++) {
              var h = u.charAt(p);
              (u.indexOf(h, p + 1) > -1 || i.indexOf(h) > -1) &&
...
f.regexp_eatRegExpIdentifierName = function (e) {
  if (((e.lastStringValue = ""), this.regexp_eatRegExpIdentifierStart(e))) {
    for (e.lastStringValue += q(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e); )
      e.lastStringValue += q(e.lastIntValue);
    return !0;
  }
  return !1;
};
f.regexp_eatRegExpIdentifierStart = function (e) {
  ...
  return (
    ...
    cs(s) ? ((e.lastIntValue = s), !0) : ((e.pos = t), !1)
  );
};
function cs(e) {
...
f.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    e.advance(i),
    s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue),
    ls(s) ? ((e.lastIntValue = s), !0) : ((e.pos = t), !1)
  );
};
function ls(e) {
...
f.regexp_eatRegExpUnicodeEscapeSequence = function (e, t) {
  ...
  if (e.eat(117)) {
    ...
    if (s && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && fs(e.lastIntValue))
      return !0;
...
f.regexp_classContents = function (e) {
  return e.current() === 93
    ...
    : e.switchV
      ...
      : (this.regexp_nonEmptyClassRanges(e), J);
};
  ...
  if (e.eat(92))
    return this.regexp_eatCharacterEscape(e) || this.regexp_eatClassSetReservedPunctuator(e)
      ...
      : e.eat(98)
        ...
        : ((e.pos = t), !1);
  var i = e.current();
  return i < 0 || (i === e.lookahead() && xs(i)) || ys(i)
    ? !1
...
f.regexp_eatDecimalDigits = function (e) {
  var t = e.pos,
    i = 0;
  for (e.lastIntValue = 0; Ee((i = e.current())); )
...
var Qe = function (t) {
    ((this.type = t.type),
      ...
      (this.start = t.start),
      (this.end = t.end),
      t.options.locations && (this.loc = new be(t, t.startLoc, t.endLoc)),
...
b.readToken = function (e) {
  return j(e, this.options.ecmaVersion >= 6) || e === 92
    ? this.readWord()
...
b.skipBlockComment = function () {
  ...
  if (
    ...
    for (var s = void 0, r = t; (s = xt(this.input, r, this.pos)) > -1; )
...
b.readToken_numberSign = function () {
  var e = this.options.ecmaVersion,
    t = 35;
  if (e >= 13 && (++this.pos, (t = this.fullCharCodeAtPos()), j(t, !0) || t === 92))
...
b.readRadixNumber = function (e) {
  ...
  return (
    i ?? this.raise(this.start + 2, "Expected number in radix " + e),
    this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110
      ? ((i = Xt(this.input.slice(t, this.pos))), ++this.pos)
      : j(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"),
...
b.readWord1 = function () {
  ...
  for (
    ...
    if (X(r, s)) this.pos += r <= 65535 ? 1 : 2;
      ...
      ((t ? j : X)(u, s) || this.invalidStringToken(o, "Invalid Unicode escape"),
        (e += q(u)),
        (i = this.pos));
    } else break;
    t = !1;
...
var Si = ut($e(), 1);
function As(e, t) {
  let i = /* @__PURE__ */ new SyntaxError(
...
var te =
  (e, t) =>
  (i, s, ...r) =>
    i | 1 && s == null ? void 0 : (t.call(s) ?? s[e]).apply(s, r);
var ks =
...
function M(e) {
  let t = e.range?.[0] ?? e.start,
    i = (e.declaration?.decorators ?? e.decorators)?.[0];
...
var se = Ns;
var re = se(["Block", "CommentBlock", "MultiLine"]);
var ei = se([
  "Line",
  "CommentLine",
  "SingleLine",
...
function Vs(e) {
  return (
    Ze.has(e) || Ze.set(e, re(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/u.test(e.value)),
    Ze.get(e)
  );
}
var ti = Vs;
  ...
  for (let i = e.length - 1; i >= 0; i--) {
    ...
    if (
      (t &&
        ...
        tt(s) &&
        tt(t) &&
        (e.splice(i + 1, 1), (s.value += "*//*" + t.value), (s.range = [M(s), R(t)])),
      !ei(s) && !re(s))
    )
...
function js(e, t = "type") {
  ...
  function i(s) {
    let r = s[t],
      o = e[r];
    if (!Array.isArray(o))
      throw Object.assign(/* @__PURE__ */ new Error(`Missing visitor keys for '${r}'.`), {
        node: s,
      });
    return o;
  }
...
function Gs(e, t) {
  let { parser: i, text: s } = t,
    { comments: r } = e,
    o = i === "oxc" && t.oxcAstType === "ts";
  ii(r);
  let u = e.type === "File" ? e.program : e;
  (u.interpreter && (r.unshift(u.interpreter), delete u.interpreter),
    o && e.hashbang && (r.unshift(e.hashbang), delete e.hashbang),
...
`,
  ...
  let s = Object.create(null),
    r = fe(0, e, pi, "").replace(hi, "").trimEnd(),
    o;
  for (; (o = pi.exec(e)); ) {
    let u = fe(0, o[2], Ws, "");
...
rt.prototype = {
  ...
  translate(e, t) {
    ...
    if (i === s.name)
      ((e.type = P.Identifier),
        e.value === "static" && (e.type = P.Keyword),
        t.ecmaVersion > 5 && (e.value === "yield" || e.value === "let") && (e.type = P.Keyword));
      ...
      ((e.type = P.Punctuator), (e.value = this._code.slice(e.start, e.end)));
      ...
      (t.jsxAttrValueToken
        ? ((t.jsxAttrValueToken = !1), (e.type = P.JSXText))
        : (e.type = P.String),
...
function Ei(e) {
  ...
  let o = t === 3 ? e.allowReserved || "never" : !1,
    u = e.ecmaFeatures || {},
    p = e.sourceType === "commonjs" || !!u.globalReturn;
  if (i === "module" && t < 6)
    throw new Error(
...
var Q = Symbol("espree's internal state"),
  at = Symbol("espree's esprimaFinishNode");
function hr(e, t, i, s, r, o, u) {
  ...
  return (
    typeof i == "number" && ((h.start = i), (h.end = s), (h.range = [i, s])),
    typeof r == "object" &&
      (h.loc = {
        start: r,
        end: o,
    ...
    class extends e {
      ...
      parse() {
        ...
        return (
          ...
          this[Q].templateElements.forEach((o) => {
            let p = o.tail ? 1 : 2;
            ((o.start += -1),
              (o.end += p),
              o.range && ((o.range[0] += -1), (o.range[1] += p)),
              o.loc && ((o.loc.start.column += -1), (o.loc.end.column += p)));
          }),
          r
        );
      }
      ...
      raise(s, r) {
        let o = e.acorn.getLineInfo(this.input, s),
          u = new SyntaxError(r);
