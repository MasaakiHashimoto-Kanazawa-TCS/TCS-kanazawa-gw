    ...
    switch (docType) {
      ...
      case DOC_TYPE_GROUP$1:
        if (shouldTraverseConditionalGroups && doc2.expandedStates)
          for (let i = doc2.expandedStates.length - 1; i >= 0; --i)
...
function stripTrailingHardlineFromParts(parts) {
  ...
  while (
    parts.length >= 2 &&
    method_at_default$1(0, parts, -2).type === DOC_TYPE_LINE$1 &&
    method_at_default$1(0, parts, -1).type === DOC_TYPE_BREAK_PARENT$1
  )
    parts.length -= 2;
  if (parts.length > 0) {
...
function cleanDocFn(doc) {
  switch (get_doc_type_default(doc)) {
    ...
    case DOC_TYPE_GROUP$1:
      ...
      if (
        doc.contents.type === DOC_TYPE_GROUP$1 &&
    ...
    case DOC_TYPE_ARRAY: {
      ...
      for (const part of doc) {
        ...
        if (
          ...
          typeof method_at_default$1(0, parts, -1) === "string"
        )
...
function convertEndOfLineOptionToCharacter$1(endOfLineOption) {
  return endOfLineOption === OPTION_CR$1
    ? CHARACTER_CR$1
    : endOfLineOption === OPTION_CRLF$1
      ? CHARACTER_CRLF$1
      : DEFAULT_EOL$1;
}
...
var narrow_emojis_evaluate_default$1 =
  "©®‼⁉™ℹ↔↕↖↗↘↙↩↪⌨⏏⏱⏲⏸⏹⏺▪▫▶◀◻◼☀☁☂☃☄☎☑☘☝☠☢☣☦☪☮☯☸☹☺♀♂♟♠♣♥♦♨♻♾⚒⚔⚕⚖⚗⚙⚛⚜⚠⚧⚰⚱⛈⛏⛑⛓⛩⛱⛷⛸⛹✂✈✉✌✍✏✒✔✖✝✡✳✴❄❇❣❤➡⤴⤵⬅⬆⬇";
...
function getStringWidth$1(text) {
  ...
  text = text.replace(emoji_regex_default$1(), (match) =>
    narrowEmojisSet$1.has(match) ? " " : "  ",
  );
  let width = 0;
...
function generateIndent(indent2, command, options) {
  const queue =
    command.type === INDENT_COMMAND_TYPE_DEDENT
      ? indent2.queue.slice(0, -1)
      : [...indent2.queue, command];
  let value = "";
  let length = 0;
  let lastTabs = 0;
  let lastSpaces = 0;
...
function fits(next, restCommands, remainingWidth, hasLineSuffix, groupModeMap, mustBeFlat) {
  ...
  while (remainingWidth >= 0) {
    ...
    switch (docType) {
      ...
      case DOC_TYPE_GROUP$1: {
        ...
        const contents =
          doc.expandedStates && groupMode === MODE_BREAK
            ? method_at_default$1(0, doc.expandedStates, -1)
            : doc.contents;
        commands.push({
          mode: groupMode,
          doc: contents,
      ...
      case DOC_TYPE_IF_BREAK$1: {
        const contents =
          (doc.groupId ? groupModeMap[doc.groupId] || MODE_FLAT : mode) === MODE_BREAK
            ? doc.breakContents
            : doc.flatContents;
        if (contents)
          commands.push({
...
function printDocToString$1(doc, options) {
    ...
    switch (get_doc_type_default(doc2)) {
      ...
      case DOC_TYPE_INDENT_IF_BREAK$1: {
        ...
        if (groupMode === MODE_BREAK) {
          const breakContents =
            doc2.type === DOC_TYPE_IF_BREAK$1
              ? doc2.breakContents
              : doc2.negate
                ? doc2.contents
                : indent$1(doc2.contents);
          if (breakContents)
            commands.push({
              indent: indent2,
              mode,
  ...
  return {
    ...
    cursorNodeText: formatted.slice(
      cursorNodeStart,
      method_at_default$1(0, finalCursorPositions, -1),
    ),
  };
  function trim2() {
    ...
    if (cursorPositions.length > 0) {
      settledCursorPositions.push(
        ...cursorPositions.map((position2) => Math.min(position2, settledTextLength)),
      );
...
var require_picomatch = __commonJS({
  "node_modules/micromatch/node_modules/picomatch/lib/picomatch.js"(exports, module) {
    ...
    picomatch.matchBase = (input, glob, options8, posix = utils.isWindows(options8)) => {
      return (glob instanceof RegExp ? glob : picomatch.makeRe(glob, options8)).test(
        path15.basename(input),
      );
    };
...
var require_micromatch = __commonJS({
  "node_modules/micromatch/index.js"(exports, module) {
    ...
    var micromatch2 = (list, patterns, options8) => {
      ...
      let matches = (negatives === patterns.length ? [...items] : [...keep]).filter(
        (item) => !omit2.has(item),
      );
    ...
    micromatch2.parse = (patterns, options8) => {
      let res = [];
      for (let pattern of [].concat(patterns || []))
        for (let str of braces(String(pattern), options8)) res.push(picomatch.parse(str, options8));
      return res;
    };
  ...
  "node_modules/@nodelib/fs.scandir/out/providers/async.js"(exports) {
    ...
    function readdirWithFileTypes(directory, settings, callback) {
      settings.fs.readdir(directory, { withFileTypes: true }, (readdirError, dirents) => {
        ...
        rpl(
          entries.map((entry) => makeRplTaskEntry(entry, settings)),
          (rplError, rplEntries) => {
            if (rplError !== null) {
  ...
  "node_modules/fast-glob/out/providers/filters/entry.js"(exports) {
    ...
    var EntryFilter = class {
      ...
      _isMatchToPatternsSet(filepath, patterns, isDirectory2) {
        ...
        if (this._isMatchToPatterns(filepath, patterns.negative.relative, isDirectory2))
          return false;
        if (this._isMatchToAbsoluteNegative(filepath, patterns.negative.absolute, isDirectory2))
          return false;
        return true;
      }
  ...
  "node_modules/fast-glob/out/index.js"(exports, module) {
    ...
    function assertPatternsInput(input) {
      if (
        ![]
          .concat(input)
          .every((item) => utils.string.isString(item) && !utils.string.isEmpty(item))
      )
  ...
  "node_modules/editorconfig/src/index.js"(exports) {
    ...
    function parseSync(_filepath, _options) {
      ...
      return parseFromConfigs(
        getConfigsForFiles(
          readConfigFilesSync(getConfigFileNames(resolvedFilePath, processedOptions)),
        ),
        resolvedFilePath,
        processedOptions,
      );
  ...
  "node_modules/ignore/index.js"(exports, module) {
    ...
    var Ignore = class {
      ...
      _t(path15, cache3, checkUnignored, slices) {
        ...
        return (cache3[path15] = parent.ignored
          ? parent
          : this._rules.test(path15, checkUnignored, MODE_IGNORE));
      }
      ignores(path15) {
    ...
    var isPathValid = (path15) =>
      checkPath(path15 && checkPath.convert(path15), path15, RETURN_FALSE);
    var setupWindows = () => {
      const makePosix = (str) =>
      ...
      checkPath.isNotRelative = (path15) =>
        REGEX_TEST_WINDOWS_PATH_ABSOLUTE.test(path15) || isNotRelative(path15);
    };
...
var Diff = class {
  ...
  equals(left, right, options8) {
    if (options8.comparator) return options8.comparator(left, right);
      ...
      return (
        left === right || (!!options8.ignoreCase && left.toLowerCase() === right.toLowerCase())
      );
  }
  removeEmpty(array2) {
    const ret = [];
      ...
      if (current.added || current.removed) {
        ...
        if (oldRangeStart)
          if (lines.length <= context * 2 && i < diff.length - 2)
            for (const line3 of contextLines(lines)) curRange.push(line3);
          else {
...
function leven(first, second, options8) {
  ...
  while (index2 < secondLength) {
    ...
    if (maxDistance !== void 0) {
      ...
      for (index = 0; index < firstLength; index++)
        if (array[index] < rowMinimum) rowMinimum = array[index];
...
function closestMatch(target, candidates, options8) {
  ...
  for (const candidate of candidates) {
    ...
    const cap = Number.isFinite(bestDist)
      ...
      : userMax;
    const distance =
      cap === void 0 ? leven(target, candidate) : leven(target, candidate, { maxDistance: cap });
...
var levenUnknownHandler = (key2, value, { descriptor, logger, schemas }) => {
  const messages2 = [
    `Ignored unknown option ${import_picocolors3.default.yellow(
      descriptor.pair({
        key: key2,
        value,
      }),
...
function partition(array2, predicate) {
  ...
  const falseArray = [];
  for (const value of array2)
    if (predicate(value)) trueArray.push(value);
...
var Normalizer = class {
  ...
  _applyNormalization(options8, newOptions) {
    ...
    for (const key2 of knownKeys) {
      ...
      normalizeForwardResult(schema.forward(value, this._utils), value).forEach(
  ...
  _applyPostprocess(options8) {
    ...
    if (postprocessed.delete)
      for (const deleteKey of postprocessed.delete) delete options8[deleteKey];
...
var toAbsolutePath = (urlOrPath) =>
  urlOrPath ? path.resolve(isUrl(urlOrPath) ? url.fileURLToPath(urlOrPath) : urlOrPath) : urlOrPath;
...
var Searcher = class {
  ...
  constructor(nameOrNames, { allowSymlinks, filter: filter2, stopDirectory, cache: cache3 } = {}) {
    ...
    this.#searchWithoutCache = (directory) =>
      this.findInDirectory(nameOrNames, {
        cwd: directory,
        filter: filter2,
        allowSymlinks,
      });
...
function editorConfigToPrettier(editorConfig) {
  ...
  const result = {};
  const { indent_style, indent_size, tab_width, max_line_length, quote_type, end_of_line } =
    editorConfig;
...
async function loadEditorconfigInternal(file, { shouldCache }) {
  ...
  return editorconfig_to_prettier_default(
    await import_editorconfig.default.parse(file, { root: root2 }),
  );
}
...
function isColorSupported() {
  return typeof process === "object" &&
    ...
    ? false
    : import_picocolors4.default.isColorSupported;
}
...
var tokenize2;
{
  const getTokenType = function (token2) {
    if (token2.type === "IdentifierName") {
      if (
        isKeyword(token2.value) ||
        isStrictReservedWord(token2.value, true) ||
  ...
  tokenize2 = function* (text) {
    for (const token2 of (0, import_js_tokens.default)(text, { jsx: true }))
      switch (token2.type) {
        case "TemplateHead":
          yield {
            type: "string",
  ...
  if (lineDiff2)
    for (let i = 0; i <= lineDiff2; i++) {
      ...
      if (!startColumn) markerLines[lineNumber] = true;
        ...
        markerLines[lineNumber] = [startColumn, source2[lineNumber - 1].length - startColumn + 1];
      else if (i === lineDiff2) markerLines[lineNumber] = [0, endColumn];
      else markerLines[lineNumber] = [0, source2[lineNumber - i].length];
    }
  else if (startColumn === endColumn)
    if (startColumn) markerLines[startLine] = [startColumn, 0];
...
function codeFrameColumns(rawLines, loc, opts = {}) {
  ...
  let frame = (shouldHighlight ? highlight(rawLines) : rawLines)
    .split(NEWLINE, end)
    .slice(start, end)
    .map((line3, index) => {
...
var getOffsets = ({ oneBased, oneBasedLine = oneBased, oneBasedColumn = oneBased } = {}) => [
  oneBasedLine ? 1 : 0,
  oneBasedColumn ? 1 : 0,
];
...
var JSONError = class _JSONError extends Error {
  ...
  get message() {
    ...
    return `${this.#message}${this.fileName ? ` in ${this.fileName}` : ""}${
      codeFrame
        ? `
...
function emitLegacyIndexDeprecation(url3, packageJsonUrl, base, main) {
  ...
  if (!main)
    process2.emitWarning(
      `No "main" or "exports" field defined in the package.json for ${packagePath} resolving the main entry point "${urlPath.slice(packagePath.length)}", imported from ${basePath}.
Default "index" lookups for the main are deprecated for ES modules.`,
      "DeprecationWarning",
      "DEP0151",
    );
  else if (path10.resolve(packagePath, main) !== urlPath)
    process2.emitWarning(
      `Package ${packagePath} has a "main" field set to "${main}", excluding the full filename and extension to the resolved file at "${urlPath.slice(packagePath.length)}", imported from ${basePath}.
...
function throwInvalidSubpath(request, match, packageJsonUrl, internal, base) {
  throw new ERR_INVALID_MODULE_SPECIFIER(
    request,
    `request is not a valid match in pattern "${match}" for the "${internal ? "imports" : "exports"}" resolution of ${fileURLToPath(packageJsonUrl)}`,
    base && fileURLToPath(base),
  );
}
...
function searchPrettierConfig(startDirectory, options8 = {}) {
  ...
  return getSearchFunction(mockable_default.getPrettierConfigSearchStopDirectory())(
    startDirectory,
...
async function loadPrettierConfig2(file, options8) {
  ...
  if (!configFile)
    configFile = await searchPrettierConfig(file ? path10.dirname(path10.resolve(file)) : void 0, {
      shouldCache,
    });
...
async function resolveConfigFile(fileUrlOrPath) {
  return (
    (await searchPrettierConfig(
      fileUrlOrPath ? path10.dirname(path10.resolve(toPath(fileUrlOrPath))) : void 0,
      { shouldCache: false },
    )) ?? null
  );
}
...
function flattenDoc(doc2) {
  ...
  if (Array.isArray(doc2)) {
    ...
    for (const part of doc2)
      if (Array.isArray(part)) res.push(...flattenDoc(part));
      else {
...
function printDocToDebug(doc2) {
  ...
  function printDoc(doc3, index, parentParts) {
    ...
    if (doc3.type === DOC_TYPE_BREAK_PARENT)
      return parentParts?.[index - 1]?.type === DOC_TYPE_LINE && parentParts[index - 1].hard
        ? void 0
        : "breakParent";
...
function getAlignmentSize(text, tabWidth, startIndex = 0) {
  ...
  for (let i = startIndex; i < text.length; ++i)
    if (text[i] === "	") size = size + tabWidth - (size % tabWidth);
    else size++;
  return size;
}
...
var AstPath = class {
  ...
  #getNodeStackIndex(count) {
    ...
    for (let i = stack2.length - 1; i >= 0; i -= 2)
      if (!Array.isArray(stack2[i]) && --count < 0) return i;
    return -1;
  }
  call(callback, ...names) {
    const { stack: stack2 } = this;
...
var isNewlineCharacter = (character) =>
...
function getSortedChildNodes(node, ancestors, options8) {
  ...
  let childAncestors;
  const childNodes = (
    options8.getChildren?.(node, options8) ?? [
      ...getChildren(node, { getVisitorKeys: options8.getVisitorKeys }),
    ]
  ).flatMap((child) => {
    childAncestors ?? (childAncestors = [node, ...ancestors]);
    return filter2(child, childAncestors)
      ? [child]
      : getSortedChildNodes(child, childAncestors, options8);
  });
...
function decorateComment(node, comment, options8, enclosingNode, ancestors = []) {
  ...
  while (left < right) {
    ...
    if (start <= commentStart && commentEnd <= end)
      return decorateComment(child, comment, options8, child, [child, ...ancestors]);
    if (end <= commentStart) {
      precedingNode = child;
      left = middle + 1;
      continue;
  ...
  for (const [index, context] of decoratedComments.entries()) {
    ...
    if (isOwnLineComment(text2, options9, decoratedComments, index)) {
      ...
      if (handleRemainingComment(...args)) {
        ...
        if (tieCount > 0) {
          if (tiesToBreak[tieCount - 1].followingNode !== followingNode)
...
function breakTies(tiesToBreak, options8) {
  ...
  for (const [i, { comment }] of tiesToBreak.entries())
    if (i < indexOfFirstLeadingComment) addTrailingComment(precedingNode, comment);
...
function getSupportInfo({ plugins = [], showDeprecated = false } = {}) {
  ...
  for (const option of normalizeOptionSettings(
    ...
    option.pluginDefaults = Object.fromEntries(
      plugins
        .filter((plugin) => plugin.defaultOptions?.[option.name] !== void 0)
...
function normalizeOptionSettings(settings) {
  ...
  for (const [name, originalOption] of Object.entries(settings)) {
    ...
    if (Array.isArray(option.default))
      option.default = method_at_default(0, option.default, -1).value;
    options8.push(option);
  }
  return options8;
}
...
function getLanguageByLanguageName(languages2, languageName) {
  ...
  return (
    ...
    languages2.find(({ aliases }) => aliases?.includes(languageName)) ??
    languages2.find(({ extensions }) => extensions?.includes(`.${languageName}`))
  );
}
...
function inferParser(options8, fileInfo) {
  const languages2 = method_to_reversed_default(0, options8.plugins).flatMap(
    (plugin) => plugin.languages ?? [],
  );
  return (
...
function optionInfoToSchema(optionInfo, { isCLI, optionInfos, FlagSchema }) {
  ...
  if (isCLI && !optionInfo.array) {
    ...
    parameters.preprocess = (value, schema, utils) =>
      schema.preprocess(
        originalPreprocess(Array.isArray(value) ? method_at_default(0, value, -1) : value),
        utils,
      );
  }
...
function createGetVisitorKeysFunction(printerGetVisitorKeys, supportFrontMatter) {
  ...
  return new Proxy(getVisitorKeys, {
    apply: (target, thisArgument, argumentsList) =>
      is_front_matter_default(argumentsList[0])
        ...
        if (property === "getVisitorKeys") {
          embedGetVisitorKeys ??
            (embedGetVisitorKeys = originalEmbed.getVisitorKeys
              ? create_get_visitor_keys_function_default(
...
var PRINTER_FRONT_MATTER_SUPPORT_OFF = Object.fromEntries(
  ["clean", "embed", "print"].map((feature) => [feature, false]),
);
...
async function normalizeFormatOptions(options8, opts = {}) {
  ...
  for (const [k, value] of Object.entries(mixedDefaults))
    if (rawOptions[k] === null || rawOptions[k] === void 0) rawOptions[k] = value;
...
async function printEmbeddedLanguages(path15, genericPrint, options8, printAstToDoc2, embeds) {
  ...
  function recurse() {
    ...
    for (const key2 of getVisitorKeys(node))
      if (Array.isArray(node[key2])) path15.each(recurse, key2);
...
function printIgnored(path15, options8, printPath, args) {
  ...
  for (const comment of comments)
    if (locStart(comment) >= start && locEnd(comment) <= end) printedComments.add(comment);
  const { printPrettierIgnored } = options8.printer;
  return printPrettierIgnored
    ? printPrettierIgnored(path15, options8, printPath, args)
...
function findSiblingAncestors(startNodeAndAncestors, endNodeAndAncestors, { locStart, locEnd }) {
  ...
  for (const endAncestor of dropRootParents(endNodeAncestors))
    if (locStart(endAncestor) >= startNodeStart) resultEndNode = endAncestor;
    else break;
...
function calculateRange(text, opts, ast) {
  ...
  const endNodeAndAncestors = isAllWhitespace
...
var builtin_plugins_proxy_default = [
  estreePlugin,
  {
    options: options7,
    languages,
...
var slash =
  path10.sep === "\\"
    ? (filePath) => method_replace_all_default(0, filePath, "\\", "/")
    : (filePath) => filePath;
...
function getMaxContinuousCount(text, searchString) {
  ...
  return (
    results.reduce((maxCount, [result]) => Math.max(maxCount, result.length), 0) /
    searchString.length
  );
}
...
function hasSpaces(text, startIndex, options8 = {}) {
  return (
    skipSpaces(text, options8.backwards ? startIndex - 1 : startIndex, options8) !== startIndex
  );
}
...
function makeString(rawText, enclosingQuote, unescapeUnnecessaryEscapes) {
  ...
  return (
    enclosingQuote +
    method_replace_all_default(0, rawText, /\\(.)|(["'])/gsu, (match, escaped, quote) => {
...
var sharedWithCli = {
  ...
  inferParser: (file, options8) =>
    Promise.resolve(options8?.parser ?? inferParser2(file, options8)),
  vnopts: {
    ChoiceSchema,
    apiDescriptor,
  },
