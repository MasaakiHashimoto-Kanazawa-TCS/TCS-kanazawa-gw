//#region ../../node_modules/.pnpm/prettier@3.8.1/node_modules/prettier/plugins/estree.mjs
...
var Wt =
  (e, t) =>
  (r, n, ...s) =>
    r | 1 && n == null ? void 0 : (t.call(n) ?? n[e]).apply(n, s);
var ba =
...
function Ha(e, t) {
  let { preferred: r, alternate: n } = t === !0 || t === "'" ? Ua : Ya,
    { length: s } = e,
    i = 0,
    o = 0;
  for (let u = 0; u < s; u++) {
...
function za(e, t = "type") {
  ...
  function r(n) {
    let s = n[t],
      i = e[s];
    if (!Array.isArray(i))
      throw Object.assign(/* @__PURE__ */ new Error(`Missing visitor keys for '${s}'.`), {
        node: n,
      });
    return i;
  }
...
var pe = tp;
var ce = k(["Block", "CommentBlock", "MultiLine"]);
var Nr = k([
  "AnyTypeAnnotation",
  "ThisTypeAnnotation",
...
function Hn(e) {
  return (
    e.type === "UnaryExpression" && (e.operator === "+" || e.operator === "-") && Ce(e.argument)
  );
}
function V(e) {
  return !!(
...
var Jr = k([
  ...
  pp = k(["Identifier", "ThisExpression", "Super", "PrivateName", "PrivateIdentifier"]),
  Je = k(["ObjectTypeAnnotation", "TSTypeLiteral", "TSMappedType"]),
...
function Vt(e) {
  return (
    ...
    Nr(e) ||
    lp(e) ||
    (e.type === "GenericTypeAnnotation" && !e.typeParameters) ||
    (e.type === "TSTypeReference" && !e.typeArguments)
  );
}
function mp(e) {
  return (
...
function It(e, t) {
  ...
  if (r.length === 1) {
    ...
    (r[0].type === "TemplateLiteral" || V(r[0])) &&
    fp(e.callee)
  )
    return r[2] && !Ce(r[2])
      ? !1
      : (r.length === 2 ? Ht(r[1]) : cp(r[1]) && K(r[1]).length <= 1) || Wn(r[1]);
  return !1;
}
var Fi = (e) => (t) => (t?.type === "ChainExpression" && (t = t.expression), e(t)),
  M = Fi(k(["CallExpression", "OptionalCallExpression"])),
  J = Fi(k(["MemberExpression", "OptionalMemberExpression"]));
function Vn(e, t = 5) {
  return di(e, t) <= t;
}
function di(e, t) {
...
function Wr(e, t) {
  return (
    ((e.type === "TemplateLiteral" && ci(e)) ||
      (e.type === "TaggedTemplateExpression" && ci(e.quasi))) &&
    !Z(t, w(e), { backwards: !0 })
  );
}
function qr(e) {
...
`),
  ...
  return J(e)
    ? Re(e.object, t) && Re(e.property, t)
    : (e.type === "UnaryExpression" && Ep.has(e.operator)) || e.type === "UpdateExpression"
      ? Re(e.argument, t)
      : !1;
}
function ie(e, t = "es5") {
...
function le(e) {
  ...
  return (
    e.type === "ImportExpression" || e.type === "TSImportType"
      ...
      : e.type === "TSExternalModuleReference"
        ? (t = [e.expression])
        : (t = e.arguments),
    Un.set(e, t),
    t
...
function $t(e, t) {
  ...
  r.type === "ImportExpression" || r.type === "TSImportType"
    ? (e.call(() => t(e, 0), "source"), r.options && e.call(() => t(e, 1), "options"))
...
var Ae = k([
  ...
  Se = k(["TSUnionType", "UnionTypeAnnotation"]),
  xt = k(["TSIntersectionType", "IntersectionTypeAnnotation"]),
  Ue = k(["TSConditionalType", "ConditionalTypeAnnotation"]),
  hi = (e) =>
  ...
  Cr = k(["TSTypeAliasDeclaration", "TypeAlias"]);
...
var Cp = k(["File", "TemplateElement", "TSEmptyBodyFunctionExpression", "ChainExpression"]),
  Ap = (e, [t]) =>
    (t?.type === "ComponentParameter" && t.shorthand && t.name === e && t.local !== t.name) ||
    (t?.type === "MatchObjectPatternProperty" && t.shorthand && t.key === e && t.value !== t.key) ||
    (t?.type === "ObjectProperty" && t.shorthand && t.key === e && t.value !== t.key) ||
    (t?.type === "Property" && t.shorthand && t.key === e && !mt(t) && t.value !== t.key),
  Tp = (e, [t]) =>
    !!(
      e.type === "FunctionExpression" &&
  ...
  bi = (e, [t]) => t?.typeAnnotation === e && hi(t),
  xp = (e, [t, ...r]) => bi(e, [t]) || (t?.typeName === e && bi(t, r));
function gp(e, t) {
  return Cp(e) || Ap(e, t) || Tp(e, t)
    ? !1
    : e.type === "EmptyStatement"
      ? kt({
          node: e,
...
function Pp(e) {
  return (
    Qn.has(e) || Qn.set(e, ce(e) && e.value[0] === "*" && /@(?:type|satisfies)\b/u.test(e.value)),
    Qn.get(e)
  );
}
var Hr = Pp;
...
function Ip(e) {
  return [Op, _i, Ii, Ni, es, ts, ki, Li, Mi, Gp, Up, ns, $p, rs, Qp, zp, ec, vi, rc, tc, ss].some(
    (t) => t(e),
  );
}
function Lp(e) {
...
function ts({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
  return r?.type !== "WhileStatement" || !n
    ? !1
    : _e(s, I(e)) === ")"
      ? ($(t, e), !0)
...
function ki({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
  return (r?.type !== "TryStatement" && r?.type !== "CatchClause") || !n
    ? !1
...
function _p({ comment: e, enclosingNode: t, followingNode: r, options: n }) {
  return !n.experimentalTernaries || !(t?.type === "ConditionalExpression" || Ue(t))
    ? !1
    : r?.type === "ConditionalExpression" || Ue(r)
      ? (we(t, e), !0)
      : !1;
}
function Ii({
  ...
  return (!t || !o) && (r?.type === "ConditionalExpression" || Ue(r)) && n
    ? i.experimentalTernaries && r.alternate === n && !(ce(e) && !ue(i.originalText, w(e), I(e)))
      ? (we(r, e), !0)
      : (te(n, e), !0)
    : !1;
}
...
function Oi({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
  return r &&
    ...
    _e(n, I(t)) !== ":"
    ? ($(t, e), !0)
    : t?.type === "Decorator" && Np(r) && (At(e) || e.placement === "ownLine")
      ? ($(t, e), !0)
      : !1;
}
var wi = k([
...
function Rp({ comment: e, enclosingNode: t, text: r }) {
  return _e(r, I(e)) !== ")"
    ? !1
    : t && ((Ri(t) && K(t).length === 0) || (Dt(t) && le(t).length === 0))
      ? (we(t, e), !0)
      : (t?.type === "MethodDefinition" || t?.type === "TSAbstractMethodDefinition") &&
          K(t.value).length === 0
        ? (we(t.value, e), !0)
        : !1;
}
function Jp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
  return t?.type === "ComponentTypeParameter" &&
    (r?.type === "DeclareComponent" || r?.type === "ComponentTypeAnnotation") &&
    n?.type !== "ComponentTypeParameter"
    ? ($(t, e), !0)
    : (t?.type === "ComponentParameter" || t?.type === "RestElement") &&
        r?.type === "ComponentDeclaration" &&
        _e(s, I(e)) === ")"
      ? ($(t, e), !0)
      : !1;
}
  ...
  return t?.type === "FunctionTypeParam" &&
    ...
    : (t?.type === "Identifier" ||
      ...
      : !ce(e) &&
          n?.type === "BlockStatement" &&
          wi(r) &&
          (r.type === "MethodDefinition" ? r.value.body : r.body) === n &&
          at(s, I(e)) === w(n)
        ? (wt(n, e), !0)
        : !1;
}
...
function rs({ comment: e, enclosingNode: t }) {
  return (t?.type === "ContinueStatement" || t?.type === "BreakStatement") && !t.label
    ? ($(t, e), !0)
    : !1;
}
...
function Wp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
  return Se(r)
    ? (Lt(e) && ((n.prettierIgnore = !0), (e.unignore = !0)), t ? ($(t, e), !0) : !1)
    : (Se(n) && Lt(e) && ((n.types[0].prettierIgnore = !0), (e.unignore = !0)), !1);
}
function qp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
  return r && r.type === "MatchOrPattern"
    ? (Lt(e) && ((n.prettierIgnore = !0), (e.unignore = !0)), t ? ($(t, e), !0) : !1)
    : (n &&
        n.type === "MatchOrPattern" &&
        Lt(e) &&
...
function ns({ comment: e, enclosingNode: t, ast: r, isLastComment: n }) {
  return r?.body?.length === 0
    ? (n ? we(r, e) : te(r, e), !0)
    : t?.type === "Program" && t.body.length === 0 && !R(t.directives)
      ? (n ? we(t, e) : te(t, e), !0)
      : !1;
}
function Yp({ comment: e, enclosingNode: t, followingNode: r }) {
  return (t?.type === "ForInStatement" || t?.type === "ForOfStatement") && r !== t.body
    ? (te(t, e), !0)
    : !1;
}
function Ni({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
  ...
  let s = t?.type === "ImportSpecifier" && r?.type === "ImportDeclaration",
    i = t?.type === "ExportSpecifier" && r?.type === "ExportNamedDeclaration";
...
function ji({ comment: e, enclosingNode: t, followingNode: r }) {
  if (Lt(e) && t?.type === "TSMappedType" && r === t.key)
...
function Qp({ comment: e, enclosingNode: t, followingNode: r }) {
  return !t || t.type !== "SwitchCase" || t.test || !r || r !== t.consequent[0]
    ? !1
    : (r.type === "BlockStatement" && At(e) ? wt(r, e) : we(t, e), !0);
}
function zp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
  return Se(t) && (((r.type === "TSArrayType" || r.type === "ArrayTypeAnnotation") && !n) || xt(r))
    ? ($(N(0, t.types, -1), e), !0)
    : !1;
}
...
function tc({ enclosingNode: e, followingNode: t, comment: r }) {
  if (
    e &&
    (e.type === "TSPropertySignature" || e.type === "ObjectTypeProperty") &&
    (Se(t) || xt(t))
  )
    return (te(t, r), !0);
}
...
function rc({ comment: e, enclosingNode: t, followingNode: r, precedingNode: n }) {
  return t &&
    ...
    t.returnType === n &&
    (n.type === "TSTypeAnnotation" || n.type === "TypeAnnotation")
    ? (te(r, e), !0)
    : !1;
}
var Ri = k([
...
function oc(e) {
  ...
  if (
    (t === "types" && Se(r)) ||
    (t === "argument" && r.type === "JSXSpreadAttribute") ||
    (t === "expression" && r.type === "JSXSpreadChild") ||
    (t === "superClass" && (r.type === "ClassDeclaration" || r.type === "ClassExpression")) ||
    ((t === "id" || t === "typeParameters") && ic(r)) ||
    (t === "patterns" && r.type === "MatchOrPattern")
  )
    return !0;
  let { node: n } = e;
...
var Ye = "string",
  ...
  Pe = "label",
  Ne = "break-parent",
  Xr = new Set([tt, He, Xe, rt, Fe, Me, be, Ve, $e, Ge, me, Pe, Ne]);
function uc(e) {
      ...
      switch (o) {
        ...
        case Fe:
          if (n && i.expandedStates)
            for (let u = i.expandedStates.length, p = u - 1; p >= 0; --p)
  ...
  switch (We(e)) {
    ...
    case Be: {
      ...
      for (let r of e) {
        ...
        (typeof n == "string" && typeof N(0, t, -1) == "string"
          ? (t[t.length - 1] += n)
          : t.push(n),
          t.push(...s));
      }
...
function eo(e, t, r) {
  let n = t.type === 1 ? e.queue.slice(0, -1) : [...e.queue, t],
    s = "",
    i = 0,
    o = 0,
    u = 0;
...
function Zr(e, t, r, n, s, i) {
  ...
  for (; r >= 0; ) {
    ...
    switch (F) {
      ...
      case Be:
      case Me: {
        let C = F === Be ? D : D.parts,
          d = D[cs] ?? 0;
        for (let b = C.length - 1; b >= d; b--)
          p.push({
            mode: y,
            doc: C[b],
          });
      ...
      case Fe: {
        ...
        let C = D.break ? ve : y,
          d = D.expandedStates && C === ve ? N(0, D.expandedStates, -1) : D.contents;
        p.push({
          mode: C,
          doc: d,
        });
...
`,
          ...
          case ve: {
            ...
            if (!S.break && Zr(j, o, U, fe, r)) o.push(j);
              ...
              if (S.break) {
                ...
                for (let z = 1; z < S.expandedStates.length + 1; z++)
                  if (z >= S.expandedStates.length) {
                    o.push({
                      indent: h,
                      mode: ve,
                      doc: Y,
        ...
        switch (g) {
          ...
          case ve:
            ...
            S.literal
              ? ((u += s),
                (i = 0),
                h.root && (h.root.value && (u += h.root.value), (i = h.root.length)))
              : (O(), (u += s + h.value), (i = h.length));
            break;
        }
        break;
      case Pe:
  ...
  function O() {
    ...
    (h && (D.push(h), (C += h.length)),
      (u = ""),
      (i -= g),
      y.length > 0 && (F.push(...y.map((S) => Math.min(S, C))), (y.length = 0)));
  }
}
function Sc(e, t, r = 0) {
  let n = 0;
...
`)
      ...
      let d = u[c],
        b = n[i][c],
        B = ue(t.originalText, I(y), w(n.quasis[c + 1]));
      if (!B) {
        let h = ls(d, {
          ...t,
...
function io(e, t, r) {
  let n = r("quasi"),
    { node: s } = e,
    i = "",
    o = et(s.quasi, x.Leading)[0];
  return (
    o && (ue(t.originalText, I(s.typeArguments ?? s.tag), w(o)) ? (i = f) : (i = " ")),
    pt(
      n.label && {
        tagged: !0,
        ...n.label,
      },
      [r("tag"), r("typeArguments"), i, je, n],
    )
  );
}
function bc(e, t, r) {
...
`) &&
    ...
    let p = Math.max(s.length, ...u.map((D) => D.cells.length)),
      c = Array.from({ length: p }).fill(0),
      y = [{ cells: s }, ...u.filter((D) => D.cells.length > 0)];
    for (let { cells: D } of y.filter((F) => !F.hasLineBreak))
      for (let [F, C] of D.entries()) c[F] = Math.max(c[F], ot(C));
    return [
      je,
      "`",
      m([
        ...
        L(
          ...
          y.map((D) =>
            L(
              " | ",
              D.cells.map((F, C) => (D.hasLineBreak ? F : F + " ".repeat(c[C] - ot(F)))),
            ),
          ),
        ),
      ]),
  ...
  return (
    e.match(
      ...
      (t, r) =>
        r === "quasi" &&
        t.type === "TaggedTemplateExpression" &&
        Pt(t.tag, ["css", "css.global", "css.resolve"]),
    ) ||
    e.match(
      void 0,
      (t, r) => r === "expression" && t.type === "JSXExpressionContainer",
      (t, r) =>
        r === "children" &&
        t.type === "JSXElement" &&
        t.openingElement.name.type === "JSXIdentifier" &&
        t.openingElement.name.name === "style" &&
        t.openingElement.attributes.some(
          (n) =>
            n.type === "JSXAttribute" && n.name.type === "JSXIdentifier" && n.name.name === "jsx",
        ),
    )
  );
}
      ...
      return (
        ...
        (t.callee.type === "MemberExpression" &&
          ((t.callee.object.type === "MemberExpression" &&
            (nn(t.callee.object.object) || uo(t.callee.object))) ||
            (t.callee.object.type === "CallExpression" && nn(t.callee.object.callee))))
      );
    case "Identifier":
      return t.name === "css";
    default:
...
`),
      C = F.length,
      d = i[u],
      b = C > 2 && F[0].trim() === "" && F[1].trim() === "",
      B = C > 2 && F[C - 1].trim() === "" && F[C - 2].trim() === "",
      O = F.every((g) => /^\s*(?:#[^\n\r]*)?$/u.test(g));
    if (!y && /#[^\n\r]*$/u.test(F[C - 1])) return null;
    let h = null;
    (O ? (h = Mc(F)) : (h = await e(D, { parser: "graphql" })),
      h
        ? ((h = tn(h, !1)), !c && b && o.push(""), o.push(h), !y && B && o.push(""))
        : !c && !y && b && o.push(""),
      d && o.push(d));
  }
  return ["`", m([E, L(E, o)]), E, "`"];
...
function Mc(e) {
  ...
  for (let [s, i] of n.entries())
    i !== "" && (n[s - 1] === "" && r ? t.push([E, i]) : t.push(i), (r = !0));
...
async function mo(e, t, r, n, s) {
  let { node: i } = n,
    o = Es;
  Es = (Es + 1) >>> 0;
  let u = (O) => `PRETTIER_HTML_PLACEHOLDER_${O}_${o}_IN_JS`,
    p = i.quasis
      .map((O, h, g) => (h === g.length - 1 ? O.value.cooked : O.value.cooked + u(h)))
      .join(""),
    c = zt(n, r),
    y = new RegExp(u("(\\d+)"), "gu"),
    D = 0,
      ...
      (O) => {
        ...
        for (let S = 0; S < g.length; S++) {
          ...
          if (S % 2 === 0) {
            j &&
              ((j = ms(j)),
              s.__embeddedInHtml && (j = W(0, j, /<\/(?=script\b)/giu, "<\\/")),
              h.push(j));
            continue;
          }
          let U = Number(j);
    ...
    d = /^\s/u.test(p) ? " " : "",
    b = /\s$/u.test(p) ? " " : "",
    B = s.htmlWhitespaceSensitivity === "ignore" ? E : d && b ? A : null;
  return B
    ? l(["`", m([B, l(C)]), B, "`"])
    : pt({ hug: !1 }, l(["`", d, D > 1 ? m(l(C)) : l(C), b, "`"]));
}
function Do(e) {
  return (
    rn(e, "HTML") ||
...
var fo = mo.bind(void 0, "html"),
  yo = mo.bind(void 0, "angular");
async function Eo(e, t, r) {
  let { node: n } = r,
    s = W(0, n.quasis[0].value.raw, /((?:\\\\)*)\\`/gu, (p, c) => "\\".repeat(c.length / 2) + "`"),
    i = Nc(s),
    o = i !== "";
...
function Lo(e) {
  let { shebang: t, text: r, pragmas: n, comments: s } = Xc(e),
    i = Bo(r),
    o = Po({
      pragmas: {
        [ko]: "",
...
function ds(e, t) {
  ...
  if (r.type === "Identifier") {
    if (
      (r.extra?.parenthesized && /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/u.test(r.name)) ||
      (n === "left" &&
    ...
    if (
      ...
      let i = e.findAncestor(
          (u) =>
            u.type === "ExpressionStatement" ||
            u.type === "ForStatement" ||
            u.type === "ForInStatement",
        ),
        o = i
    ...
    case "ClassExpression":
      if (
        ...
        (r.type === "ArrowFunctionExpression" ||
          ...
          (r.type === "ClassExpression" && R(r.decorators)))
      )
        return !0;
      break;
    ...
    case "TypeAnnotation":
      if (
        e.match(
          void 0,
          void 0,
          (i, o) => o === "returnType" && i.type === "ArrowFunctionExpression",
        ) &&
        Zc(r)
      )
        return !0;
    ...
    case "VariableDeclarator":
      if (
        ...
        e.match(
          void 0,
          void 0,
          (i, o) => o === "declarations" && i.type === "VariableDeclaration",
          (i, o) => o === "left" && i.type === "ForInStatement",
        )
      )
        return !0;
      break;
  ...
  switch (r.type) {
    ...
    case "TSFunctionType":
      if (
        e.match(
          (i) => i.type === "TSFunctionType",
          (i, o) => o === "typeAnnotation" && i.type === "TSTypeAnnotation",
          (i, o) => o === "returnType" && i.type === "ArrowFunctionExpression",
        )
      )
        return !0;
    ...
    case "ConditionalTypeAnnotation":
      if ((n === "extendsType" && Ue(r) && s.type === r.type) || (n === "checkType" && Ue(s)))
        return !0;
      if (n === "extendsType" && s.type === "TSConditionalType") {
        let { typeAnnotation: i } = r.returnType || r.typeAnnotation;
        if (
          (i.type === "TSTypePredicate" &&
            i.typeAnnotation &&
            (i = i.typeAnnotation.typeAnnotation),
          i.type === "TSInferType" && i.typeParameter.constraint)
        )
          return !0;
      }
    case "TSUnionType":
    ...
    case "FunctionTypeAnnotation": {
      ...
      if (
        e.match(
          void 0,
          (o, u) => u === "typeAnnotation" && o.type === "TypeAnnotation",
          (o, u) => u === "returnType" && o.type === "ArrowFunctionExpression",
        ) ||
        e.match(
          void 0,
          (o, u) => u === "typeAnnotation" && o.type === "TypePredicate",
          (o, u) => u === "typeAnnotation" && o.type === "TypeAnnotation",
          (o, u) => u === "returnType" && o.type === "ArrowFunctionExpression",
        )
      )
      ...
      return (
        ...
        i.type === "ArrayTypeAnnotation" ||
        (n === "objectType" &&
          (i.type === "IndexedAccessType" || i.type === "OptionalIndexedAccessType")) ||
        ...
        i.type === "NullableTypeAnnotation" ||
        (s.type === "FunctionTypeParam" &&
          s.name === null &&
          K(r).some((o) => o.typeAnnotation?.type === "NullableTypeAnnotation"))
      );
    }
      ...
      return !(
        ...
        (n === "expressions" &&
          ...
          e.match(
            void 0,
            void 0,
            (i, o) => (o === "init" || o === "update") && i.type === "ForStatement",
          )) ||
        (n === "value" &&
          s.type === "Property" &&
          e.match(void 0, void 0, (i, o) => o === "properties" && i.type === "ObjectPattern")) ||
    ...
    case "NGPipeExpression":
      return !(
        ...
        (s.type === "ObjectProperty" && !r.extra?.parenthesized) ||
        q(s) ||
        (n === "arguments" && M(s)) ||
...
function Zc(e) {
  return Er(
    e,
    (t) => t.type === "ObjectTypeAnnotation" && Er(t, (r) => r.type === "FunctionTypeAnnotation"),
  );
}
function el(e) {
  return se(e);
...
function _o(e, t) {
  ...
  return r.type === "FunctionExpression" || r.type === "ClassExpression"
    ? n.type === "ExportDefaultDeclaration" || !ds(e, t)
    : !Xt(r) || (n.type !== "ExportDefaultDeclaration" && ds(e, t))
      ? !1
      : e.call(() => _o(e, t), ...Rr(r));
}
function tl(e) {
...
function rl(e) {
  return (
    ...
    Cs(e) || (M(e) && !e.optional && Cs(e.callee))
  );
}
var ge = ds;
function nl(e, t) {
  let r = t - 1;
  ((r = ze(e, r, { backwards: !0 })),
    (r = Ze(e, r, { backwards: !0 })),
    (r = ze(e, r, { backwards: !0 })));
...
function il(e, t) {
  let r = e.node,
    n = [As(e, t)],
    { printer: s, originalText: i, locStart: o, locEnd: u } = t;
...
function ol(e, t, r) {
  let n = e.node,
    s = As(e, t),
    { printer: i, originalText: o, locStart: u } = t,
    p = i.isBlockComment?.(n);
  if ((r?.hasLineSuffix && !r?.isBlock) || Z(o, u(n), { backwards: !0 }))
    return {
      doc: us([E, Mo(o, u(n)) ? E : "", s]),
      isBlock: p,
      hasLineSuffix: !0,
    };
...
function v(e, t, r = {}) {
  ...
  let { indent: s = !1, marker: i, filter: o = sl } = r,
    u = [];
  if (
    (e.each(({ node: c }) => {
...
function Mt(e, t) {
  ...
  if ((r.comments || []).filter((p) => !n.has(p)).length === 0)
    return {
      leading: "",
      trailing: "",
    };
...
function Ke(e, t, r, n, s) {
  let i = e.node,
    o = K(i),
    u = s && i.typeParameters ? r("typeParameters") : "";
  if (o.length === 0)
    return [u, "(", v(e, t, { filter: (d) => _e(t.originalText, I(d)) === ")" }), ")"];
  let { parent: p } = e,
    c = It(p),
    y = No(i),
    D = [];
  if (
    (xi(e, (d, b) => {
      ...
      (B && i.rest && D.push("..."),
        D.push(r()),
        !B && (D.push(","), c || y ? D.push(" ") : oe(o[b], t) ? D.push(E, E) : D.push(A)));
    }),
    n && !al(e))
  ) {
  ...
  return y && F
    ...
    : c
      ...
      : (Gr(p) ||
            ...
            (p.type === "FunctionTypeAnnotation" && p.returnType === i)) &&
          o.length === 1 &&
          o[0].name === null &&
          i.this !== o[0] &&
          o[0].typeAnnotation &&
          i.typeParameters === null &&
          Vt(o[0].typeAnnotation) &&
          !i.rest
        ? t.arrowParens === "always" || i.type === "HookTypeAnnotation"
          ? ["(", ...D, ")"]
          : D
        : [u, "(", m([f, ...D]), P(!Ti(i) && ie(t, "all") ? "," : ""), f, ")"];
}
function No(e) {
  if (!e) return !1;
  let t = K(e);
  ...
  return (
    ...
    (r.type === "ObjectPattern" ||
      ...
      (r.type === "Identifier" &&
        ...
        Je(r.typeAnnotation.typeAnnotation)) ||
      (r.type === "FunctionTypeParam" && Je(r.typeAnnotation) && r !== e.rest) ||
      (r.type === "AssignmentPattern" &&
        ...
        (r.right.type === "Identifier" ||
          ...
          (q(r.right) && r.right.elements.length === 0))))
  );
}
function ul(e) {
  let t;
...
function X(e) {
  ...
  return !t.optional || (t.type === "Identifier" && t === e.parent.key)
    ? ""
    : M(t) || (J(t) && t.computed) || t.type === "OptionalIndexedAccessType"
      ? "?."
      : "?";
}
function sn(e) {
...
var fl = 0;
function on(e, t, r) {
  let { node: n, parent: s, grandparent: i, key: o } = e,
    u =
      o !== "body" &&
      (s.type === "IfStatement" ||
    ...
    p = n.operator === "|>" && e.root.extra?.__isUsingHackPipeline,
    c = Ts(e, t, r, !1, u);
  if (u) return c;
  if (p) return l(c);
  if (
    (o === "callee" && (M(s) || s.type === "NewExpression")) ||
  ...
  let y =
    ...
    D =
      ...
      Oe(s),
    F = Te(n.left) && dr(n.operator, n.left.operator);
  if (y || (er(n) && !F) || (!er(n) && D)) return l(c);
  if (c.length === 0) return "";
  let C = H(n.right),
    d = c.findIndex((S) => typeof S != "string" && !Array.isArray(S) && S.type === Fe),
    b = c.slice(0, d === -1 ? 1 : d + 1),
    B = c.slice(b.length, C ? -1 : void 0),
    O = Symbol("logicalChain-" + ++fl),
    h = l([...b, m(B)], { id: O });
  if (!C) return h;
...
function Ts(e, t, r, n, s) {
  ...
  if (!Te(i)) return [l(r())];
  let o = [];
  dr(i.operator, i.left.operator)
    ? (o = e.call(() => Ts(e, t, r, !0, s), "left"))
    : o.push(l(r("left")));
  let u = er(i),
    p = i.right.type === "ChainExpression" ? i.right.expression : i.right,
    c =
      (i.operator === "|>" || i.type === "NGPipeExpression" || yl(e, t)) && !Ee(t.originalText, p),
    D = !T(p, x.Leading, Hr) && Ee(t.originalText, p),
    F = i.type === "NGPipeExpression" ? "|" : i.operator,
    C =
      i.type === "NGPipeExpression" && i.arguments.length > 0
        ? l(
            m([
              f,
              ": ",
  ...
  if (u) d = [F, Ee(t.originalText, p) ? m([A, r("right"), C]) : [" ", r("right"), C]];
    ...
    let g =
      F === "|>" && e.root.extra?.__isUsingHackPipeline
        ? e.call(() => Ts(e, t, r, !0, s), "right")
        : r("right");
  ...
  let { parent: b } = e,
    B = T(i.left, x.Trailing | x.Line);
  if (
    ((B ||
      (!(s && i.type === "LogicalExpression") &&
        b.type !== i.type &&
        i.left.type !== i.type &&
        i.right.type !== i.type)) &&
      (d = l(d, { shouldBreak: B })),
...
function er(e) {
  return e.type !== "LogicalExpression"
    ...
    : !!(
        ...
        (q(e.right) && e.right.elements.length > 0) ||
        H(e.right)
      );
}
...
function yl(e, t) {
  return (
    ...
    Ro(e.node) &&
    !e.hasAncestor((r) => !Ro(r) && r.type !== "JsExpressionRoot")
  );
}
function El(e) {
...
function un(e, t, r) {
  let { node: n } = e,
    ...
    i =
      ...
      !((Cr(s) || s.type === "VariableDeclarator") && Ee(t.originalText, n)) &&
      !(Cr(s) && T(s.id, x.Trailing | x.Line)),
    o = xs(n),
    u = e.map(() => {
      let C = r();
  ...
  let F = [p, l(D)];
  return (s.type === "TupleTypeAnnotation" || s.type === "TSTupleType") &&
...
var Fl = k(["VoidTypeAnnotation", "TSVoidKeyword", "NullLiteralTypeAnnotation", "TSNullKeyword"]),
  dl = k(["ObjectTypeAnnotation", "TSTypeLiteral", "GenericTypeAnnotation", "TSTypeReference"]);
function xs(e) {
  let { types: t } = e;
...
function tr(e, t, r) {
  ...
  if (p.length === 0) s.push(Al(e, t, i, o));
    ...
    let c = N(0, p, -1),
      y = c?.type !== "RestElement" && !n.inexact,
      D = c === null,
      F = Symbol("array"),
      C =
        !t.__inJestEach &&
      ...
      d = gs(n, t),
      b = y ? (D ? "," : ie(t) ? (d ? P(",", "", { groupId: F }) : P(",")) : "") : "";
    s.push(
      l([i, m([f, d ? xl(e, t, r, b) : [Tl(e, t, r, u, n.inexact), b], v(e, t)]), f, o], {
        shouldBreak: C,
        id: F,
      }),
    );
...
function gs(e, t) {
  return (
    ...
    e.elements.every(
      (r) =>
        r &&
        (Ce(r) || (Hn(r) && !T(r.argument))) &&
        !T(r, x.Trailing | x.Line, (n) => !Z(t.originalText, w(n), { backwards: !0 })),
    )
  );
}
...
function xl(e, t, r, n) {
  let s = [];
  return (
    e.each(({ isLast: i, next: o }) => {
      (s.push([r(), i ? n : ","]),
        i || s.push(Wo(e, t) ? [E, E] : T(o, x.Leading | x.Line) ? E : A));
    }, "elements"),
    zr(s)
  );
}
function gl(e, t, r) {
  ...
  if (Sl(s)) {
    ...
    return ne(F)
      ? [ke, nt([["(", l(F, { shouldBreak: !0 }), ", ", ...D, ")"], c()])]
      : nt([["(", F, ", ", ...D, ")"], ["(", l(F, { shouldBreak: !0 }), ", ", ...D, ")"], c()]);
  }
  if (hl(s, u, t)) {
    let D = u.slice(0, -1);
    if (D.some(ne)) return c();
    ...
    return ne(F)
      ? [ke, nt([["(", ...D, l(F, { shouldBreak: !0 }), ")"], c()])]
      : nt([["(", ...D, F, ")"], ["(", ...D, l(F, { shouldBreak: !0 }), ")"], c()]);
  }
  let y = ["(", m([f, ...u]), P(p), f, ")"];
...
function gr(e, t = !1) {
  return (
    ...
    (q(e) && (e.elements.length > 0 || T(e))) ||
    (e.type === "TSTypeAssertion" && gr(e.expression)) ||
    (Ae(e) && gr(e.expression)) ||
    e.type === "FunctionExpression" ||
    (e.type === "ArrowFunctionExpression" &&
      ...
      (e.body.type === "BlockStatement" ||
        (e.body.type === "ArrowFunctionExpression" && gr(e.body, !0)) ||
        se(e.body) ||
        q(e.body) ||
        (!t && (M(e.body) || e.body.type === "ConditionalExpression")) ||
        H(e.body))) ||
    e.type === "DoExpression" ||
...
function hl(e, t, r) {
  ...
  return (
    ...
    gr(n) &&
    (!s || s.type !== n.type) &&
    (e.length !== 2 || s.type !== "ArrowFunctionExpression" || !q(n)) &&
    !(e.length > 1 && gs(n, r))
  );
}
function Sl(e) {
  ...
  let [t, r] = e;
  return t.type === "ModuleExpression" && Pl(r)
    ? !0
    : !T(t) &&
...
function bl(e) {
  return (
    ...
    (e.body.some((t) => t.type !== "EmptyStatement") || T(e, x.Dangling))
  );
}
function Pl(e) {
...
function Il(e) {
  ...
  for (let n of r) {
    if (!((J(n) && n.object === t) || (n.type === "TSNonNullExpression" && n.expression === t)))
...
function Ho(e, t, r) {
  let n = r("object"),
    s = Ss(e, t, r),
    { node: i } = e,
    o = e.findAncestor((c) => !(J(c) || c.type === "TSNonNullExpression")),
    u = e.findAncestor((c) => !(c.type === "ChainExpression" || c.type === "TSNonNullExpression")),
    p =
      o.type === "BindExpression" ||
      (o.type === "AssignmentExpression" && o.left.type !== "Identifier") ||
      Il(e) ||
      i.computed ||
      (i.object.type === "Identifier" && i.property.type === "Identifier" && !J(u)) ||
      ((u.type === "AssignmentExpression" || u.type === "VariableDeclarator") &&
        (kl(i.object) || n.label?.memberChain));
...
function Xo(e, t, r) {
  ...
  function o() {
    ...
    if (M(_) && (Tt(_.callee) || M(_.callee))) {
      ...
      (s.unshift({
        ...
        printed: [De(e, [X(e), r("typeArguments"), hr(e, t, r)], t), re ? E : ""],
      }),
        e.call(o, "callee"));
    } else
      Tt(_)
  ...
  (s.unshift({
    node: u,
    printed: [X(e), r("typeArguments"), hr(e, t, r)],
  }),
  ...
  for (
    ;
    y < s.length &&
    (s[y].node.type === "TSNonNullExpression" ||
      M(s[y].node) ||
      (J(s[y].node) && s[y].node.computed && Ce(s[y].node.property)));
    ++y
  )
    c.push(s[y]);
  if (!M(s[0].node))
    for (; y + 1 < s.length && Tt(s[y].node) && Tt(s[y + 1].node); ++y) c.push(s[y]);
  (p.push(c), (c = []));
  let D = !1;
  for (; y < s.length; ++y) {
    if (D && Tt(s[y].node)) {
    ...
    ((M(s[y].node) || s[y].node.type === "ImportExpression") && (D = !0),
      c.push(s[y]),
      T(s[y].node, x.Trailing) && (p.push(c), (c = []), (D = !1)));
  }
  c.length > 0 && p.push(c);
  function F(_) {
  ...
  function d(_) {
    ...
    if (_[0].length === 1) {
      let it = _[0][0].node;
      return (
        it.type === "ThisExpression" ||
        (it.type === "Identifier" && (F(it.name) || (n && C(it.name)) || re))
      );
    }
  ...
  let h = p.map(B),
    ...
    j = p.flat(),
    U =
      j.slice(1, -1).some((_) => T(_.node, x.Leading)) ||
      j.slice(0, -1).some((_) => T(_.node, x.Trailing)) ||
      (p[S] && T(p[S][0].node, x.Leading));
  if (p.length <= S && !U && !p.some((_) => N(0, _, -1).hasTrailingEmptyLine))
    return Ur(e) ? g : l(g);
  let fe = N(0, p[b ? 1 : 0], -1).node,
    Y = !M(fe) && i(fe),
    z = [B(p[0]), b ? p.slice(1, 2).map(B) : "", Y ? E : "", O(p.slice(b ? 2 : 1))],
    ee = s.map(({ node: _ }) => _).filter(M);
  function Ie() {
    let _ = N(0, N(0, p, -1), -1).node,
      re = N(0, h, -1);
  ...
  return (
    U ||
    (ee.length > 2 && ee.some((_) => !_.arguments.every((re) => Re(re)))) ||
    h.slice(0, -1).some(ne) ||
    Ie()
      ? (st = l(z))
      : (st = [ne(g) || Y ? ke : "", nt([g, z])]),
...
function vt(e, t, r) {
  let { node: n } = e,
    ...
    i = X(e),
    o = le(n),
    u = n.type !== "TSImportType" && n.typeArguments ? r("typeArguments") : "",
    p = o.length === 1 && Wr(o[0], t.originalText);
...
function Ol(e) {
  ...
  if (
    !(
      ...
      t.type === "TSImportType" ||
      t.type === "TSExternalModuleReference" ||
      (t.type === "CallExpression" && !t.optional && Pt(t.callee, Ll))
    )
  )
    return !1;
  let r = le(t);
...
function _l(e, t, r, n, s) {
  ...
  if (
    e.match(
      pn,
      eu,
      (F) => !u || (F.type !== "ExpressionStatement" && F.type !== "VariableDeclaration"),
    )
  )
    return u
  ...
  if (
    i.type === "ImportAttribute" ||
    (o.type === "CallExpression" && o.callee.name === "require") ||
    t.parser === "json5" ||
    t.parser === "jsonc" ||
    t.parser === "json"
  )
...
function Ml(e, t, r, n) {
  ...
  for (;;)
    if (
      ...
      i.type === "AwaitExpression" ||
      (i.type === "YieldExpression" && i.argument !== null)
    )
...
function Nl(e) {
  if (eu(e)) {
    ...
    return (
      ...
      t.properties.some((r) => Oe(r) && (!r.shorthand || r.value?.type === "AssignmentPattern"))
    );
  }
  return !1;
}
...
function tu(e, t, r, n = !1) {
  ...
  if (M(s)) {
    ...
    let u = le(s);
    return !(u.length === 0 || (u.length === 1 && Fr(u[0], t))) || Gl(s, r)
      ? !1
      : e.call(i, "callee");
  }
...
function Gl(e, t) {
  ...
  if (R(r)) {
    ...
    if (r.length === 1) {
      let s = r[0];
      if (Se(s) || xt(s) || s.type === "TSTypeLiteral" || s.type === "ObjectTypeAnnotation")
        return !0;
    }
...
function ru(e, t) {
  return t.parser === "json" ||
    t.parser === "jsonc" ||
    !V(e.key) ||
    ut(pe(e.key), t).slice(1, -1) !== e.key.value
    ? !1
    : !!(
        (vo(e.key.value) &&
          !(
...
function Ul(e, t) {
  ...
  return (
    (r.type === "Identifier" ||
      (Ce(r) &&
        nu(dt(pe(r))) &&
        String(r.value) === dt(pe(r)) &&
        !(t.parser === "typescript" || t.parser === "babel-ts" || t.parser === "oxc-ts"))) &&
    (t.parser === "json" ||
      t.parser === "jsonc" ||
      (t.quoteProps === "consistent" && cn.get(e.parent)))
  );
}
function Ct(e, t, r) {
  let { node: n } = e;
  ...
  return ru(n, t) && (t.quoteProps === "as-needed" || (t.quoteProps === "consistent" && !cn.get(s)))
    ? e.call(() => De(e, /^\d/u.test(i.value) ? dt(i.value) : i.value, t), "key")
    : r("key");
}
function ln(e, t, r) {
  let { node: n } = e;
...
function mn(e, t, r, n) {
  ...
  if ((s.type === "FunctionDeclaration" || s.type === "FunctionExpression") && n?.expandLastArg) {
    let { parent: y } = e;
    M(y) &&
      (le(y).length > 1 || K(s).every((D) => D.type === "Identifier" && !D.typeAnnotation)) &&
      (i = !0);
  }
  let o = [
      Q(e),
    ...
    c = lt(s, p);
  return (
    o.push(r("typeParameters"), l([c ? l(u) : u, p]), s.body ? " " : "", r("body")),
    t.semi && (s.declare || !s.body) && o.push(";"),
    o
  );
}
function Sr(e, t, r) {
  ...
  return (
    !s || s === "init" || s === "method" || s === "constructor"
      ...
      : (Le(s === "get" || s === "set"), o.push(s, " ")),
    i.generator && o.push("*"),
    o.push(Ct(e, t, r), n.optional ? "?" : "", n === i ? Dn(e, t, r) : r("value")),
    o
  );
}
function Dn(e, t, r) {
  let { node: n } = e,
    ...
    o = jo(n),
    u = lt(n, i),
    p = [r("typeParameters"), l([o ? l(s, { shouldBreak: !0 }) : u ? l(s) : s, i])];
...
function su(e, t, r) {
  ...
  let i = T(n, x.Dangling),
    o = t.semi && i && T(n, x.Last | x.Line);
...
function Xl(e, t) {
  if (Ee(e.originalText, t) || (T(t, x.Leading, (r) => ue(e.originalText, w(r), I(r))) && !H(t)))
    return !0;
  if (Xt(t)) {
    let r = t,
      n;
...
var bs = ({ node: e, parent: t }) =>
  e.type === "ExpressionStatement" &&
  t.type === "Program" &&
  t.body.length === 1 &&
  ((Array.isArray(t.directives) && t.directives.length === 0) || !t.directives);
function Ps(e, t) {
  return (
    (t.parentParser === "markdown" || t.parentParser === "mdx") && bs(e) && H(e.node.expression)
  );
}
function ks(e, t) {
...
function Vl(e, t, r) {
  ...
  let s = n.type === "JSXElement" ? r("openingElement") : r("openingFragment"),
    i = n.type === "JSXElement" ? r("closingElement") : r("closingFragment");
  if (
    n.children.length === 1 &&
  ...
  let o = n.children.some(H),
    u = n.children.filter((g) => g.type === "JSXExpressionContainer").length > 1,
    p = n.type === "JSXElement" && n.openingElement.attributes.length > 1,
    c = ne(s) || o || p || u,
    y = e.parent.rootMarker === "mdx",
    D = t.singleQuote ? "{' '}" : '{" "}',
    F = y ? A : P([D, f], " "),
    d = $l(e, t, r, F, n.openingElement?.name?.name === "fbt"),
    b = n.children.some((g) => Br(g));
  for (let g = d.length - 2; g >= 0; g--) {
    let S = d[g] === "" && d[g + 1] === "",
      j = d[g] === E && d[g + 1] === "" && d[g + 2] === E,
      U = (d[g] === f || d[g] === E) && d[g + 1] === "" && d[g + 2] === F,
      fe = d[g] === F && d[g + 1] === "" && (d[g + 2] === f || d[g + 2] === E),
      Y = d[g] === F && d[g + 1] === "" && d[g + 2] === F,
      z =
        (d[g] === f && d[g + 1] === "" && d[g + 2] === E) ||
        (d[g] === E && d[g + 1] === "" && d[g + 2] === f);
  ...
  if (
    (t.cursorNode?.type === "JSXText" && n.children.includes(t.cursorNode)
      ? (O = [Tr, O, Tr])
      : t.nodeBeforeCursor?.type === "JSXText" && n.children.includes(t.nodeBeforeCursor)
        ? (O = [Tr, O])
...
function zl(e) {
  return (
    e.match(
      void 0,
      (t, r) => r === "body" && t.type === "ArrowFunctionExpression",
      (t, r) => r === "arguments" && M(t),
    ) &&
    (e.match(
      void 0,
...
function Zl(e, t, r) {
  ...
  if (n.value) {
    let i;
    if (V(n.value)) {
      let u = W(0, W(0, pe(n.value).slice(1, -1), "&apos;", "'"), "&quot;", '"'),
        p = wr(u, t.jsxSingleQuote);
      ((u = p === '"' ? W(0, u, '"', "&quot;") : W(0, u, "'", "&apos;")),
        (i = e.call(() => De(e, qe(p + u + p), t), "value")));
    } else i = r("value");
    s.push("=", i);
  }
  return s;
...
function em(e, t, r) {
  let { node: n } = e,
    s = (i, o) =>
      i.type === "JSXEmptyExpression" ||
      (!T(i) &&
        (q(i) ||
          se(i) ||
          i.type === "ArrowFunctionExpression" ||
          (i.type === "AwaitExpression" &&
            (s(i.argument, i) || i.argument.type === "JSXElement")) ||
          M(i) ||
          (i.type === "ChainExpression" && M(i.expression)) ||
          i.type === "FunctionExpression" ||
          i.type === "TemplateLiteral" ||
          i.type === "TaggedTemplateExpression" ||
          i.type === "DoExpression" ||
          (H(o) && (i.type === "ConditionalExpression" || Te(i)))));
  return s(n.expression, e.parent)
    ? l(["{", r("expression"), je, "}"])
    : l(["{", m([f, r("expression")]), f, je, "}"]);
}
function tm(e, t, r) {
  let { node: n } = e,
    s = T(n.name) || T(n.typeArguments);
  if (n.selfClosing && n.attributes.length === 0 && !s)
    return ["<", r("name"), r("typeArguments"), " />"];
  if (
    n.attributes?.length === 1 &&
    V(n.attributes[0].value) &&
...
`) &&
  ...
  let i = n.attributes?.some(
      (u) =>
        V(u.value) &&
        u.value.value.includes(`
`),
    ),
    o = t.singleAttributePerLine && n.attributes.length > 1 ? E : A;
  return l(
    ["<", r("name"), r("typeArguments"), m(e.map(() => [o, r()], "attributes")), ...rm(n, t, s)],
    { shouldBreak: i },
  );
}
function rm(e, t, r) {
...
function sm(e, t, r) {
  let { node: n } = e,
    ...
    i = r("name");
  return (
    T(n.name, x.Leading | x.Line)
      ? s.push(m([E, i]), E)
      : T(n.name, x.Leading | x.Block)
        ? s.push(" ", i)
        : s.push(i),
    s.push(">"),
    s
        ...
        let { index: s, parent: i } = e,
          o =
            ...
            (((s === 1 &&
              ...
              (s === 2 &&
                ((n.key.name === "else" &&
                  i.body[s - 1].type === "NGMicrosyntaxKeyedExpression" &&
                  i.body[s - 1].key.name === "then") ||
                  n.key.name === "track"))) &&
              i.body[0].type === "NGMicrosyntaxExpression");
...
function Au(e) {
  return (
    Ns.has(e) ||
      Ns.set(e, e.type === "ConditionalExpression" && !ye(e, (t) => t.type === "ObjectExpression")),
    Ns.get(e)
  );
}
...
function Tu(e, t, r, n = {}) {
  let s = [],
    ...
    o = [],
    u = !1,
    p = !n.expandLastArg && e.node.body.type === "ArrowFunctionExpression",
    c;
  (function O() {
    let { node: h } = e,
      g = Em(e, t, r, n);
    ...
    (p &&
      (u ||
        (u =
          (h.returnType && K(h).length > 0) ||
          h.typeParameters ||
          K(h).some((S) => S.type !== "Identifier"))),
      !p || h.body.type !== "ArrowFunctionExpression"
        ? ((i = r("body", n)), (c = h.body))
        : e.call(O, "body"));
  })();
  let y = !Ee(t.originalText, c) && (ym(c) || Fm(c, i, t) || (!u && Au(c))),
    D = e.key === "callee" && Dt(e.parent),
  ...
  return (
    p &&
      ...
      ((b = !0),
      (B = !T(e.node, x.Leading & x.Line)),
      (d = n.assignmentLayout === "chain-tail-arrow-chain" || (D && !y))),
    (i = Cm(e, t, n, {
      bodyDoc: i,
      bodyComments: o,
      functionBody: c,
...
function Em(e, t, r, n) {
  ...
  if ((s.async && i.push("async "), fn(e, t))) i.push(r(["params", 0]));
    ...
    let u = n.expandLastArg || n.expandFirstArg,
      p = rr(e, r);
    if (u) {
...
function Fm(e, t, r) {
  return (
    ...
    e.type === "BlockStatement" ||
    H(e) ||
    (t.label?.hug !== !1 && (t.label?.embed || Wr(e, r.originalText)))
  );
}
function dm(e, t, { signatureDocs: r, shouldBreak: n }) {
  if (r.length === 1) return r[0];
  let { parent: s, key: i } = e;
  return (i !== "callee" && Dt(s)) || Te(s)
    ? l([r[0], " =>", m([A, L([" =>", A], r.slice(1))])], { shouldBreak: n })
    : (i === "callee" && Dt(s)) || t.assignmentLayout
      ? l(L([" =>", A], r), { shouldBreak: n })
      : l(m(L([" =>", A], r)), { shouldBreak: n });
}
function Cm(e, t, r, { bodyDoc: n, bodyComments: s, functionBody: i, shouldPutBodyOnSameLine: o }) {
  let { node: u, parent: p } = e,
    c = r.expandLastArg && ie(t, "all") ? P(",") : "",
    y = (r.expandLastArg || p.type === "JSXExpressionContainer") && !T(u) ? f : "";
  return o && Au(i)
    ? [" ", l([P("", "("), m([f, n]), P("", ")"), c, y]), s]
    : o
      ? [" ", n, s]
...
function br(e, t, r, n) {
  let { node: s } = e,
    i = [],
    o = xu(0, s[n], (u) => u.type !== "EmptyStatement");
  return (
    e.each(({ node: u }) => {
...
function En(e, t, r) {
  ...
  if ((s.type === "StaticBlock" && o.push("static "), o.push("{"), n)) o.push(m([E, n]), E);
    ...
    i.type === "ArrowFunctionExpression" ||
      ...
      i.type === "DoExpression" ||
      i.type === "ModuleExpression" ||
      (i.type === "CatchClause" && !u.finalizer) ||
      i.type === "TSModuleDeclaration" ||
      i.type === "MatchStatementCase" ||
      s.type === "StaticBlock" ||
      o.push(E);
  }
  return (o.push("}"), o);
...
function xm(e, t, r) {
  let { node: n } = e,
    s = R(n.directives),
    i = n.body.some((p) => p.type !== "EmptyStatement"),
    o = T(n, x.Dangling);
  if (!s && !i && !o) return "";
  let u = [];
  return (
    s &&
      (u.push(br(e, t, r, "directives")),
      (i || o) && (u.push(E), oe(N(0, n.directives, -1), t) && u.push(E))),
    i && u.push(br(e, t, r, "body")),
    o && u.push(v(e, t)),
    u
  );
}
  ...
  if (
    (hm(e, ({ node: F, next: C, isLast: d }) => {
      ...
      (!o &&
        ...
        s.push(";"),
        d || (s.push(u), oe(F, t) && s.push(E)));
    }),
    p && s.push(v(e, t)),
    n.type === "ObjectTypeAnnotation" && n.inexact)
  ) {
    let F;
    (T(n, x.Dangling)
      ? (F = [T(n, x.Line) || Z(t.originalText, I(N(0, et(n), -1))) ? E : A, "..."])
      : (F = [D ? A : "", "..."]),
      s.push(F));
  }
  if (o) {
    let F = p || (t.objectWrap === "preserve" && D && ue(t.originalText, w(n), w(D))),
      C;
    if (s.length === 0) C = c + y;
    else {
    ...
    return e.match(
      void 0,
      (d, b) => b === "typeAnnotation",
      (d, b) => b === "typeAnnotation",
      Nt,
    ) || e.match(void 0, (d, b) => d.type === "FunctionTypeParam" && b === "typeAnnotation", Nt)
      ? C
      : l(C, { shouldBreak: F });
  }
...
function hm(e, t) {
  ...
  if (r.type === "ObjectTypeAnnotation") {
    let n = ["properties", "indexers", "callProperties", "internalSlots"]
      .flatMap((s) =>
        e.map(
          ({ node: i, index: o }) => ({
            node: i,
...
function he(e, t) {
  let { parent: r } = e;
  return e.callParent(Su)
    ? t.semi || r.type === "ObjectTypeAnnotation"
      ? ";"
      : ""
    : r.type === "TSTypeLiteral"
      ? e.isLast
        ? t.semi
          ? P(";")
          : ""
...
function sr(e, t, r) {
  let { node: n } = e,
    s = Pm(n),
    i = [Q(e), Zt(e), s ? "interface" : "class"],
    o = ku(e),
    u = [],
    p = [];
  if (n.type !== "InterfaceTypeAnnotation") {
    n.id && u.push(" ");
    for (let y of ["id", "typeParameters"])
      if (n[y]) {
  ...
  if (n.superClass) {
    let y = [Lm(e, t, r), r(n.superTypeArguments ? "superTypeArguments" : "superTypeParameters")],
      D = e.call(() => ["extends ", De(e, y, t)], "superClass");
    o ? p.push(A, l(D)) : p.push(" ", D);
  } else p.push(vs(e, t, r, "extends"));
  p.push(vs(e, t, r, "mixins"), vs(e, t, r, "implements"));
  let c;
  return (
    o ? ((c = bm(n)), i.push(l([...u, m(p)], { id: c }))) : i.push(...u, ...p),
    !s && o && km(n.body) ? i.push(P(E, " ", { groupId: c })) : i.push(" "),
    i.push(r("body")),
    i
  );
}
function km(e) {
  return e.type === "ObjectTypeAnnotation"
    ? ["properties", "indexers", "callProperties", "internalSlots"].some((t) => R(e[t]))
    : R(e.body);
}
function Pu(e) {
...
function Im(e) {
  ...
  if (t.superClass)
    return e.parent.type === "AssignmentExpression"
      ? !1
      : !(t.superTypeArguments ?? t.superTypeParameters) && J(t.superClass);
  let r = t.extends?.[0] ?? t.mixins?.[0] ?? t.implements?.[0];
  return r
    ? (r.type === "InterfaceExtends" &&
        r.id.type === "QualifiedTypeIdentifier" &&
        !r.typeParameters) ||
        ((r.type === "TSClassImplements" || r.type === "TSInterfaceHeritage") &&
          J(r.expression) &&
          !r.typeArguments)
    : !1;
}
...
function Fn(e, t, r) {
  let { node: n } = e,
    s = [];
  return (
    R(n.decorators) && s.push(Ms(e, t, r)),
    s.push(jt(n)),
...
function dn(e, t, r) {
  ...
  (R(n.decorators) && s.push(Ms(e, t, r)),
    ...
    (n.type === "ClassAccessorProperty" ||
      ...
      s.push("accessor "),
    s.push(Ct(e, t, r), X(e), sn(e), G(e, r)));
  return [
    ht(
      e,
      t,
...
function ir(e, t, r) {
  let { node: n, parent: s } = e,
    i = jm(n),
    o = n.type === "TSEnumBody" || i,
    u = ju(n),
    p = i && n.hasUnknownMembers,
    c = o ? "members" : u ? "attributes" : "properties",
    y = n[c],
    D =
      o ||
      (n.type === "ObjectPattern" &&
        ...
        s.type !== "CatchClause" &&
        n.properties.some(
          (B) => B.value && (B.value.type === "ObjectPattern" || B.value.type === "ArrayPattern"),
        )) ||
      (n.type !== "ObjectPattern" && t.objectWrap === "preserve" && y.length > 0 && vm(n, y[0], t)),
    F = [],
    C = e.map(({ node: B }) => {
      let O = [...F, l(r())];
  ...
  let d = !(p || N(0, y, -1)?.type === "RestElement"),
    b;
  if (C.length === 0) {
  ...
  return e.match((B) => B.type === "ObjectPattern" && !R(B.decorators), Nt) ||
    (Je(n) &&
      (e.match(
        void 0,
        (B, O) => O === "typeAnnotation",
        (B, O) => O === "typeAnnotation",
        Nt,
      ) ||
        e.match(void 0, (B, O) => B.type === "FunctionTypeParam" && O === "typeAnnotation", Nt))) ||
    (!D &&
      e.match(
        (B) => B.type === "ObjectPattern",
        (B) => B.type === "AssignmentExpression" || B.type === "VariableDeclarator",
      ))
    ? b
    : l(b, { shouldBreak: D });
}
function vm(e, t, r) {
  let n = r.originalText,
    s = w(e),
    i = w(t);
  if (ju(e)) {
    let o = w(e);
...
function An(e, t, r) {
  let { node: n } = e,
    s = [Eu(e, t, r), Q(e), "export", Ru(n) ? " default" : ""],
    { declaration: i, exported: o } = n;
  return (
    T(n, x.Dangling) && (s.push(" ", v(e, t)), qr(n) && s.push(E)),
    i
      ? s.push(" ", r("declaration"))
      : (s.push(Gm(n)),
        n.type === "ExportAllDeclaration" || n.type === "DeclareExportAllDeclaration"
          ? (s.push(" *"), o && s.push(" as ", r("exported")))
          : s.push(Gu(e, t, r)),
        s.push(Ju(e, t, r), qu(e, t, r))),
    s.push(Jm(n, t)),
    s
  );
}
...
function Gu(e, t, r) {
  ...
  if (R(n.specifiers)) {
    ...
    (e.each(() => {
      ...
      o.length > 0 &&
        (i.length > 0 && s.push(", "),
        o.length > 1 || i.length > 0 || n.specifiers.some((p) => T(p))
          ? s.push(
              l([
                "{",
          ...
          : s.push(["{", t.bracketSpacing ? " " : "", ...o, t.bracketSpacing ? " " : "", "}"])));
  } else s.push("{}");
  return s;
}
function Wu(e, t) {
  return e.type !== "ImportDeclaration" || R(e.specifiers) || e.importKind === "type"
    ? !0
    : Jt(t, w(e), w(e.source)).trimEnd().endsWith("from");
}
function Wm(e, t) {
  ...
  return r.startsWith("assert")
    ? "assert"
    : r.startsWith("with") || R(e.attributes)
      ? "with"
      : void 0;
}
var qm = (e) => {
  ...
  if (t.length !== 1) return !1;
  let [r] = t,
    { type: n, key: s, value: i } = r;
  return (
    n === "ImportAttribute" &&
    ((s.type === "Identifier" && s.name === "type") || (V(s) && s.value === "type")) &&
    V(i) &&
    !T(r) &&
    !T(s) &&
    !T(i)
...
function Uu(e, t, r) {
  ...
  return (
    s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier"
      ...
      : p && (y = r(o)),
    c && !Um(n) && (D = r(u)),
    [Js(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1), y, y && D ? " as " : "", D]
  );
}
function Um(e) {
...
function Hm(e, t, r) {
  let { node: n } = e,
    ...
    { parent: o } = e,
    u = s ? r("test") : [r("checkType"), " ", "extends", " ", r("extendsType")];
...
function Vm(e) {
  ...
  for (let s = 0; !r; s++) {
    ...
    if (
      (i.type === "ChainExpression" && i.expression === n) ||
      (M(i) && i.callee === n) ||
      (J(i) && i.object === n) ||
      (i.type === "TSNonNullExpression" && i.expression === n)
    ) {
      n = i;
      continue;
    }
    (i.type === "NewExpression" && i.callee === n) || (Ae(i) && i.expression === n)
      ? ((r = e.getParentNode(s + 1)), (n = i))
      : (r = i);
  }
...
function Yu(e, t, r) {
  let { node: n } = e,
    s = n.type === "ConditionalExpression",
    i = s ? "consequent" : "trueType",
    o = s ? "alternate" : "falseType",
    u = s ? ["test"] : ["checkType", "extendsType"],
    p = n[i],
    c = n[o],
    y = [],
    D = !1,
    { parent: F } = e,
    C = F.type === n.type && u.some((Y) => F[Y] === n),
    d = F.type === n.type && !C,
    b,
    B,
    O = 0;
  do ((B = b || n), (b = e.getParentNode(O)), O++);
  while (b && b.type === n.type && u.every((Y) => b[Y] !== B));
  let h = b || F,
    g = B;
  if (s && (H(n[u[0]]) || H(p) || H(c) || Ym(g))) {
    ((D = !0), (d = !0));
    let Y = (ee) => [P("("), m([f, ee]), f, P(")")],
      z = (ee) =>
        ee.type === "NullLiteral" ||
    ...
    let Y = (ee) => (t.useTabs ? m(r(ee)) : xe(2, r(ee))),
      z = [
        A,
        "? ",
        p.type === n.type ? P("", "(") : "",
    ...
    y.push(
      F.type !== n.type || F[o] === n || C
        ? z
        : t.useTabs
          ? Qr(m(z))
          : xe(Math.max(0, t.tabWidth - 2), z),
    );
  }
  let S = (Y) => (F === h ? l(Y) : Y),
    j = !D && (J(F) || (F.type === "NGPipeExpression" && F.left === n)) && !F.computed,
    U = Vm(e),
    fe = S([Hm(e, t, r), d ? y : m(y), s && j && !U ? f : ""]);
...
function Km(e, t, r, n) {
  return [...e.map((i) => et(i)), et(t), et(r)]
    .flat()
    .some((i) => ce(i) && ue(n.originalText, w(i), I(i)));
}
var Qm = new Map([
  ["AssignmentExpression", "right"],
  ["VariableDeclarator", "init"],
...
function ur(e, t, r, n) {
  ...
  let { node: s } = e,
    i = s.type === "ConditionalExpression",
    o = Ue(s),
    u = i ? "consequent" : "trueType",
    p = i ? "alternate" : "falseType",
    c = i ? ["test"] : ["checkType", "extendsType"],
    y = s[u],
    D = s[p],
    F = c.map((mr) => s[mr]),
    { parent: C } = e,
    d = C.type === s.type,
    b = d && c.some((mr) => C[mr] === s),
    B = d && C[p] === s,
    O = y.type === s.type,
    h = D.type === s.type,
    g = h || B,
    S = t.tabWidth > 2 || t.useTabs,
    j,
    U,
    fe = 0;
  do ((U = j || s), (j = e.getParentNode(fe)), fe++);
  ...
  let Y = j || C,
    z =
      ...
      (C.type === "AssignmentExpression" ||
        ...
        C.type === "Property"),
    ee = (C.type === "ReturnStatement" || C.type === "ThrowStatement") && !(O || h),
    Ie = i && Y.type === "JSXExpressionContainer" && e.grandparent.type !== "JSXAttribute",
    st = zm(e),
    _ = $m(s, C),
    re = o && ge(e, t),
    ae = S ? (t.useTabs ? "	" : " ".repeat(t.tabWidth - 1)) : "",
    it = Km(F, y, D, t) || O || h,
    Bt =
      !g &&
      !d &&
  ...
  (T(s.test, x.Dangling) &&
    ...
    T(s, x.Dangling) && cr.push(v(e, t)));
  let Vs = Symbol("test"),
    xa = Symbol("consequent"),
    kr = Symbol("test-and-consequent"),
    $s = l(
      [
        i
          ? [Ws(r("test")), s.test.type === "ConditionalExpression" ? ke : ""]
          : [
              r("checkType"),
              " ",
              "extends",
              " ",
              Ue(s.extendsType) || s.extendsType.type === "TSMappedType"
                ? r("extendsType")
                : l(Ws(r("extendsType"))),
            ],
        " ?",
    ...
    ha = r(u),
    Ir = m([O || (Ie && (H(y) || d || g)) ? E : A, Pr, ha]),
    Sa = Mn ? l([$s, g ? Ir : P(Ir, l(Ir, { id: xa }), { groupId: Vs })], { id: kr }) : [$s, Ir],
    Nn = r(p),
    Ks = Bt ? P(Nn, Qr(Ws(Nn)), { groupId: kr }) : Nn,
    lr = [
      Sa,
...
function Hu(e, t, r, n) {
  ...
  switch (s.type) {
    ...
    case "ChainExpression":
      return r("expression");
    case "ParenthesizedExpression":
      return !T(s.expression) && (se(s.expression) || q(s.expression))
        ? ["(", r("expression"), ")"]
        : l(["(", m([f, r("expression")]), f, ")"]);
    case "AssignmentExpression":
      return zo(e, t, r);
    case "VariableDeclarator":
      return Zo(e, t, r);
    ...
    case "SequenceExpression": {
      ...
      return ((i.type === "ReturnStatement" || i.type === "ThrowStatement") &&
        e.key === "argument") ||
        (i.type === "ArrowFunctionExpression" && e.key === "body")
        ? l(P([m([f, o]), f], o))
        : l(o);
    }
    case "ThisExpression":
    ...
    case "UnaryExpression": {
      ...
      return (
        ...
        T(s.argument) ? i.push(l(["(", m([f, r("argument")]), f, ")"])) : i.push(r("argument")),
        i
      );
    }
    case "UpdateExpression":
    ...
    case "VariableDeclaration": {
      let i = e.map(r, "declarations"),
        o = e.parent,
        u = o.type === "ForStatement" || o.type === "ForInStatement" || o.type === "ForOfStatement",
        p = s.declarations.some((y) => y.init),
        c;
      return (
        i.length === 1 && !T(s.declarations[0]) ? (c = i[0]) : i.length > 0 && (c = m(i[0])),
        l([
          Q(e),
          s.kind,
          c ? [" ", c] : "",
          m(i.slice(1).map((y) => [",", p && !u ? E : A, y])),
          t.semi && !(u && o.body !== s) ? ";" : "",
        ])
      );
    }
    ...
    case "IfStatement": {
      let i = Ft(s.consequent, r("consequent")),
        u = [l(["if (", l([m([f, r("test")]), f]), ")", i])];
      if (s.alternate) {
        let p = T(s.consequent, x.Trailing | x.Line) || qr(s),
          c = s.consequent.type === "BlockStatement" && !p;
        (u.push(c ? " " : E),
          T(s, x.Dangling) && u.push(v(e, t), p ? E : " "),
          u.push("else", l(Ft(s.alternate, r("alternate"), s.alternate.type === "IfStatement"))));
      }
      return u;
    }
    case "ForStatement": {
      ...
      return !s.init && !s.test && !s.update
        ...
        : [
            ...
            l([
              "for (",
              l([
                m([f, r("init"), ";", A, r("test"), ";", s.update ? [A, r("update")] : P("", A)]),
                f,
              ]),
              ")",
              i,
    ...
    case "CatchClause":
      if (s.param) {
        let i = T(
            ...
            (u) =>
              !ce(u) ||
              (u.leading && Z(t.originalText, I(u))) ||
              (u.trailing && Z(t.originalText, w(u), { backwards: !0 })),
          ),
          o = r("param");
      ...
      return [
        ...
        s.cases.length > 0
          ? m([
              ...
              L(
                E,
                e.map(({ node: i, isLast: o }) => [r(), !o && oe(i, t) ? E : ""], "cases"),
              ),
            ])
          : "",
        E,
...
function xn(e, t, r) {
  let { parent: n, node: s, key: i } = e,
    u = s.type === "AsConstExpression" ? "const" : r("typeAnnotation"),
    p = [r("expression"), " ", Zm(s) ? "satisfies" : "as", " ", u];
...
function Xu(e, t, r) {
  ...
  let i = eD(e, t, r);
  return (
    n.rendersType ? s.push(l([i, " ", r("rendersType")])) : s.push(l([i])),
...
function eD(e, t, r) {
  ...
  if ((n.rest && (s = [...s, n.rest]), s.length === 0))
    return ["(", v(e, t, { filter: (o) => _e(t.originalText, I(o)) === ")" }), ")"];
  let i = [];
  return (
    rD(e, (o, u) => {
      let p = u === s.length - 1;
      (p && n.rest && i.push("..."),
        i.push(r()),
        !p && (i.push(","), oe(s[u], t) ? i.push(E, E) : i.push(A)));
    }),
...
function Ku(e, t, r) {
  let { node: n } = e;
  return [
    n.type === "EnumSymbolBody" || n.explicitType ? `of ${n.type.slice(4, -4).toLowerCase()} ` : "",
    qs(e, t, r),
  ];
}
function gn(e, t) {
...
function Sn(e, t, r) {
  ...
  return (
    n.type === "FunctionTypeAnnotation"
      ? o.push(nD(e) ? " => " : ": ", r("returnType"))
      : o.push(G(e, r, "returnType")),
    lt(n, o) && (i = l(i)),
    s.push(i, o),
    [
      l(s),
      n.type === "TSConstructSignatureDeclaration" || n.type === "TSCallSignatureDeclaration"
        ? he(e, t)
        : "",
    ]
  );
...
function Pn(e, t, r) {
  let n = !1;
  return l(
    e.map(({ isFirst: s, previous: i, node: o, index: u }) => {
      let p = r();
      if (s) return p;
      let c = Je(o),
        y = Je(i);
  ...
  return [
    ...
    n.cases.length > 0
      ? m([
          ...
          L(
            E,
            e.map(({ node: s, isLast: i }) => [r(), !i && oe(s, t) ? E : ""], "cases"),
          ),
        ])
      : "",
    E,
...
function ia(e, t, r) {
  let { node: n } = e,
    s = T(n, x.Dangling) ? [" ", v(e, t)] : [],
    i = n.type === "MatchStatementCase" ? [" ", r("body")] : m([A, r("body"), ","]);
...
function oa(e, t, r) {
  ...
  switch (n.type) {
    ...
    case "MatchObjectPattern": {
      ...
      return (
        n.rest && s.push(r("rest")), l(["{", m([f, L([",", A], s)]), n.rest ? "" : P(","), f, "}"])
      );
    }
...
function uD(e, t, r) {
  let { node: n } = e,
    { parent: s } = e,
    i =
      s.type !== "MatchStatementCase" &&
      s.type !== "MatchExpressionCase" &&
      s.type !== "MatchArrayPattern" &&
      s.type !== "MatchObjectPatternProperty" &&
      !Ee(t.originalText, n),
    o = oD(n),
    u = e.map(() => {
      let c = r();
  ...
  return ge(e, t)
    ? l([m([P([f]), p]), f])
    : s.type === "MatchArrayPattern" && s.elements.length > 1
      ? l([m([P(["(", f]), p]), f, P(")")])
      : l(i ? m(p) : p);
}
function aa(e, t, r) {
  let { node: n } = e,
    s = [Q(e), "opaque type ", r("id"), r("typeParameters")];
  if ((n.supertype && s.push(": ", r("supertype")), n.lowerBound || n.upperBound)) {
    let i = [];
    (n.lowerBound && i.push(m([A, "super ", r("lowerBound")])),
      n.upperBound && i.push(m([A, "extends ", r("upperBound")])),
      s.push(l(i)));
  }
...
function Ln(e, t, r) {
  ...
  return [
    ht(
      ...
      t,
      r,
      [Q(e), "type ", r("id"), r("typeParameters")],
      " =",
...
function aD(e, t, r) {
  ...
  return (
    ...
    !(t.filepath && t.filepath.endsWith(".ts"))
  );
}
function Gt(e, t, r, n) {
  let { node: s } = e;
  ...
  let i = It(e.grandparent),
    o = e.match(
      (c) => !(c[n].length === 1 && Je(c[n][0])),
      void 0,
      (c, y) => y === "typeAnnotation",
      (c) => c.type === "Identifier",
      Bs,
    );
  if (
    s[n].length === 0 ||
    (!o && (i || (s[n].length === 1 && (s[n][0].type === "NullableTypeAnnotation" || Jo(s[n][0])))))
  )
    return ["<", L(", ", e.map(r, n)), pD(e, t), ">"];
...
function On(e, t, r) {
  ...
  if (
    ...
    n.out && s.push("out "),
    s.push(i),
    n.bound && (n.usesExtendsBound && s.push(" extends "), s.push(G(e, r, "bound"))),
    n.constraint)
  ) {
...
function _n({ node: e }, t) {
  return ["typeof ", t(e.type === "TSTypeQuery" ? "exprName" : "argument"), t("typeArguments")];
}
function pa(e, t, r) {
  let { node: n } = e;
...
function ca(e, t, r) {
  let { node: n } = e,
    s = n.parameters.length > 1 ? P(ie(t) ? "," : "") : "",
    i = l([m([f, L([", ", f], e.map(r, "parameters"))]), s, f]);
  return [
...
function Da(e, t, r) {
  let { node: n } = e,
    s = !(q(n.expression) || se(n.expression)),
    i = l(["<", m([f, r("typeAnnotation")]), f, ">"]),
    o = [P("("), m([f, r("expression")]), f, P(")")];
  return s
    ? nt([
        [i, r("expression")],
        [i, l(o, { shouldBreak: !0 })],
...
function mD(e, t, r, n) {
  ...
  let { node: s } = e,
    i = nr(e) ? t.originalText.slice(w(s), I(s)) : cD(e, t, r, n);
  if (!i) return "";
  if (lD(s)) return i;
  let o = R(s.decorators),
    u = Fu(e, t, r),
    p = s.type === "ClassExpression";
