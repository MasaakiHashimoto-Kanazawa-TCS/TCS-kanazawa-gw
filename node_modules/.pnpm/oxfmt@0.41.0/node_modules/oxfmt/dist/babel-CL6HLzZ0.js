...
var Dt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED",
  ...
  be = (a) => (a.type === "UpdateExpression" ? Mt.UpdateExpression[`${a.prefix}`] : Mt[a.type]),
  Gs = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
    ...
    InvalidLhsOptionalChaining: ({ ancestor: a }) =>
      `Invalid optional chaining in the left-hand side of ${be(a)}.`,
  ...
  Zs = Object.assign(
    {
      ...
      PipeUnparenthesizedBody: ({ type: a }) =>
        `Hack-style pipe body cannot be an unparenthesized ${be({ type: a })}; please wrap it in parentheses.`,
    },
    {},
  ),
  ei = ["message"];
...
var ai = (a) =>
    class extends a {
      ...
      cloneEstreeStringLiteral(e) {
        let { start: s, end: i, loc: r, range: n, raw: o, value: h } = e,
          l = Object.create(e.constructor.prototype);
        return (
          (l.type = "Literal"),
          (l.start = s),
          (l.end = i),
      ...
      parseBlockBody(e, s, i, r, n) {
        ...
        ((e.body = e.directives.map((h) => this.directiveToStmt(h)).concat(e.body)),
          delete e.directives);
      }
      parsePrivateName() {
      ...
      parseMethod(e, s, i, r, n, o, h = !1) {
        ...
        u &&
          (delete e.typeParameters, (l.typeParameters = u), this.resetStartLocationFromNode(l, u));
        return (
          (e.value = this.castNodeTo(
            l,
            this.hasPlugin("typescript") && !l.body
              ? "TSEmptyBodyFunctionExpression"
              : "FunctionExpression",
          )),
          o === "ClassPrivateMethod" && (e.computed = !1),
          this.hasPlugin("typescript") && e.abstract
            ? (delete e.abstract, this.finishNode(e, "TSAbstractMethodDefinition"))
            : o === "ObjectMethod"
      ...
      parseClassProperty(...e) {
        ...
        return (
          s.abstract && this.hasPlugin("typescript")
            ? (delete s.abstract, this.castNodeTo(s, "TSAbstractPropertyDefinition"))
      ...
      parseClassPrivateProperty(...e) {
        ...
        return (
          s.abstract && this.hasPlugin("typescript")
            ? this.castNodeTo(s, "TSAbstractPropertyDefinition")
            : this.castNodeTo(s, "PropertyDefinition"),
          (s.computed = !1),
          s
        );
      ...
      parseClassAccessorProperty(e) {
        ...
        return (
          s.abstract && this.hasPlugin("typescript")
            ? (delete s.abstract, this.castNodeTo(s, "TSAbstractAccessorProperty"))
...
function P(a, t = {}) {
  return (
    ...
    mt.push(a),
    yt.push(t.binop ?? -1),
    xt.push(t.beforeExpr ?? !1),
    Pt.push(t.startsExpr ?? !1),
    gt.push(t.prefix ?? !1),
    dt.push(new we(a, t)),
    pe
  );
    ...
    : a <= 90
      ...
      : a < 97
        ...
        : a <= 122
          ? !0
          : a <= 65535
            ? a >= 170 && Pi.test(String.fromCharCode(a))
            : Ke(a, Yt);
}
function K(a) {
  return a < 48
        ...
        : a <= 90
          ...
          : a < 97
            ...
            : a <= 122
              ? !0
              : a <= 65535
                ? a >= 170 && gi.test(String.fromCharCode(a))
                : Ke(a, Yt) || Ke(a, Ti);
}
var At = {
    keyword: [
  ...
  bi = new Set(At.keyword),
  Ai = new Set(At.strict),
  Si = new Set(At.strictBind);
function Qt(a, t) {
  ...
  Mi = (a) =>
    class extends a {
      ...
      flowParseRestrictedIdentifier(e, s) {
        return (
          this.checkReservedType(this.state.value, this.state.startLoc, s), this.parseIdentifier(e)
        );
      }
      ...
      flowParseTypeParameterInstantiation() {
        ...
        return (
          ...
          (this.state.inType = s),
          !this.state.inType && this.curContext() === E.brace && this.reScan_lt_gt(),
          this.expect(48),
      ...
      flowParseTypeParameterInstantiationCallOrNew() {
        ...
        return (
          this.expect(48), (this.state.inType = s), this.finishNode(e, "TypeParameterInstantiation")
        );
      }
      ...
      flowParseObjectType({
        ...
        for (
          s && this.match(6)
            ? (this.expect(6), (l = 9), (u = !0))
            : (this.expect(5), (l = 8), (u = !1)),
            h.exact = u;
          !this.match(l);
        ) {
          let x = !1,
            ...
            (A != null && this.unexpected(A),
              this.eat(0)
                ? (C && this.unexpected(C.loc.start),
                  h.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, x)))
                : h.indexers.push(this.flowParseObjectTypeIndexer(N, x, C)));
          else if (this.match(10) || this.match(47))
            (A != null && this.unexpected(A),
              C && this.unexpected(C.loc.start),
              h.callProperties.push(this.flowParseObjectTypeCallProperty(N, x)));
          else {
            let I = "init";
            if (this.isContextual(99) || this.isContextual(104))
              Jt(this.lookahead().type) && ((I = this.state.value), this.next());
          ...
          (this.flowObjectTypeSemicolon(),
            k &&
              !this.match(8) &&
              !this.match(9) &&
              this.raise(g.UnexpectedExplicitInexactInObject, k));
        }
      ...
      parseConditional(e, s, i) {
        ...
        let r = this.state.clone(),
          ...
          [u, f] = this.getArrowLikeExpressions(h);
        if (l || f.length > 0) {
          let d = [...n];
          if (f.length > 0) {
          ...
          (l && u.length > 1 && this.raise(g.AmbiguousConditionalArrow, r.startLoc),
            l &&
              u.length === 1 &&
              ((this.state = r),
              d.push(u[0].start),
      ...
      getArrowLikeExpressions(e, s) {
        ...
        return s
          ...
          : Li(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
      }
          ...
          : this.state.inType && (e === 62 || e === 60)
            ...
            : this.state.inType && e === 63
              ? s === 46
                ? this.finishOp(18, 2)
                : this.finishOp(17, 1)
              : Ci(e, s, this.input.charCodeAt(this.state.pos + 2))
      ...
      toReferencedList(e, s) {
        for (let i = 0; i < e.length; i++) {
          let r = e[i];
          r &&
            r.type === "TypeCastExpression" &&
            !r.extra?.parenthesized &&
            (e.length > 1 || !s) &&
            this.raise(g.TypeCastInPattern, r.typeAnnotation);
        }
        return e;
      }
      parseArrayLike(e, s, i) {
        ...
        return (
          i != null && !this.state.maybeInArrowParameters && this.toReferencedList(r.elements), r
        );
      }
      isValidLVal(e, s, i, r) {
      ...
      parseClassSuper(e) {
        if (
          ...
          e.superClass &&
            ...
            (e.superTypeArguments = this.flowParseTypeParameterInstantiationInExpression()),
      ...
      parseImportSpecifierLocal(e, s, i) {
        ((s.local = Rt(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier()),
      ...
      parseImportSpecifier(e, s, i, r, n) {
        ...
        if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
          ...
          h !== null && !O(this.state.type)
            ? ((e.imported = f), (e.importKind = h), (e.local = this.cloneIdentifier(f)))
          ...
          this.eatContextual(93)
            ...
            : ((l = !0), (e.local = this.cloneIdentifier(e.imported)));
        }
        let u = Rt(e);
        return (
          i && u && this.raise(g.ImportTypeShorthandOnlyInPureImport, e),
          (i || u) && this.checkReservedType(e.local.name, e.local.loc.start, !0),
          l && !i && !u && this.checkReservedWord(e.local.name, e.loc.start, !0, !0),
      ...
      parseMaybeAssign(e, s) {
        ...
        if (this.hasPlugin("jsx") && (this.match(143) || this.match(47))) {
          if (
            ((i = this.state.clone()),
            (r = this.tryParse(() => super.parseMaybeAssign(e, s), i)),
            !r.error)
          )
            return r.node;
        ...
        if (r?.error || this.match(47)) {
          ...
          let n,
            o = this.tryParse((l) => {
              ...
              return (
                f.type !== "ArrowFunctionExpression" && l(),
                (f.typeParameters = n),
                this.resetStartLocationFromNode(f, n),
                u
              );
            }, i),
            h = null;
          if (
            o.node &&
            this.maybeUnwrapTypeCastExpression(o.node).type === "ArrowFunctionExpression"
          ) {
            if (!o.error && !o.aborted)
              return (
                o.node.async && this.raise(g.UnexpectedTypeParameterBeforeAsyncArrowFunction, n),
                o.node
              );
            h = o.node;
          }
          ...
          throw r?.thrown
            ...
            : o.thrown
              ? o.error
              : this.raise(g.UnexpectedTokenAfterTypeParameter, n);
        }
      ...
      parseSubscripts(e, s, i) {
        if (
          ...
          let r = this.startNodeAt(s);
          ((r.callee = e),
            (r.arguments = super.parseCallExpressionArguments()),
        ...
        if (this.match(18) && this.isLookaheadToken_lt()) {
          ...
          let o = this.tryParse(
            () => (
              ...
              this.expect(10),
              (n.arguments = super.parseCallExpressionArguments()),
      ...
      flowEnumMembers({ enumName: e, explicitType: s }) {
        ...
        for (; !this.match(8); ) {
          ...
          (/^[a-z]/.test(u) &&
            ...
            i.has(u) &&
              this.raise(g.EnumDuplicateMemberName, h, {
                memberName: u,
                enumName: e,
              }),
            i.add(u));
      ...
      flowEnumBody(e, s) {
        ...
        switch (((e.hasUnknownMembers = h), n)) {
          ...
          case "symbol":
            return (
              (e.members = o.defaultedMembers), this.expect(8), this.finishNode(e, "EnumSymbolBody")
            );
          default: {
            ...
            if (!f && !d && u >= x) {
              for (let A of o.defaultedMembers)
                this.flowEnumErrorBooleanMemberNotInitialized(A.loc.start, {
                  enumName: i,
              ...
              for (let A of o.defaultedMembers)
                this.flowEnumErrorNumberMemberNotInitialized(A.loc.start, {
                  enumName: i,
                  memberName: A.id.name,
                });
              return (
                (e.members = o.numberMembers), this.expect(8), this.finishNode(e, "EnumNumberBody")
              );
      ...
      jsxReadToken() {
        ...
        for (;;) {
          ...
          switch (i) {
            ...
            case 62:
            case 125:
              this.raise(U.UnexpectedToken, this.state.curPosition(), {
...
`))
        ...
        switch (this.state.type) {
          case 5:
            return (
              ...
              e.expression.type === "JSXEmptyExpression" && this.raise(U.AttributeIsEmpty, e),
              e
            );
          case 143:
          case 134:
      ...
      jsxParseExpressionContainer(e, s) {
        if (this.match(8)) e.expression = this.jsxParseEmptyExpression();
          ...
          (i.type === "SequenceExpression" &&
            ...
            this.raise(U.UnexpectedSequenceExpression, i.expressions[1]),
            (e.expression = i));
        }
        return (
          this.setContext(s),
      ...
      jsxParseElementAt(e) {
        ...
        if (!r.selfClosing) {
          ...
          V(r) && !V(n) && n !== null
            ? this.raise(U.MissingClosingTagFragment, n)
            : !V(r) && V(n)
              ? this.raise(U.MissingClosingTagElement, n, { openingTagName: J(r.name) })
              : !V(r) &&
                !V(n) &&
                J(n.name) !== J(r.name) &&
                this.raise(U.MissingClosingTagElement, n, { openingTagName: J(r.name) });
      ...
      updateContext(e) {
        ...
        if (i === 56 && e === 143)
          ...
          (r === E.j_oTag && e === 56) || r === E.j_cTag
            ? (s.pop(), (this.state.canStartJSXElement = s[s.length - 1] === E.j_expr))
            : (this.setContext(E.j_expr), (this.state.canStartJSXElement = !0));
...
var Qe = class extends Ye {
    ...
    finalizeComment(t) {
      ...
      if (t.leadingNode !== null || t.trailingNode !== null)
        (t.leadingNode !== null && ss(t.leadingNode, e),
          t.trailingNode !== null && Ri(t.trailingNode, e));
      else {
        let s = t.containingNode,
          i = t.start;
  ...
  Ze = class a {
    ...
    init({ strictMode: t, sourceType: e, startIndex: s, startLine: i, startColumn: r }) {
      ((this.strict = t === !1 ? !1 : t === !0 ? !0 : e === "module"),
        ...
        (this.curLine = i),
        (this.lineStart = -r),
        (this.startLoc = this.endLoc = new R(i, r, s)));
    }
    errors = [];
    potentialArrowAt = -1;
    noArrowAt = [];
...
`);
    ...
    case 120: {
      let l;
      return (
        ({ code: l, pos: t } = et(a, t, e, s, 2, !1, n, r)),
    ...
    case 117: {
      let l;
      return (
        ({ code: l, pos: t } = rs(a, t, e, s, n, r)), o(l === null ? null : String.fromCodePoint(l))
      );
    }
    case 116:
      return o("	");
...
function et(a, t, e, s, i, r, n, o) {
  let h = t,
    l;
  return (
    ({ n: l, pos: t } = is(a, t, e, s, 16, i, r, !1, o, !n)),
...
function is(a, t, e, s, i, r, n, o, h, l) {
  let u = t,
    f = i === 16 ? _t.hex : _t.decBinOct,
    d = i === 16 ? Te.hex : i === 10 ? Te.dec : i === 8 ? Te.oct : Te.bin,
    x = !1,
    A = 0;
  for (let k = 0, N = r ?? Infinity; k < N; ++k) {
    let C = a.charCodeAt(t),
      I;
    if (C === 95 && o !== "bail") {
      let Pe = a.charCodeAt(t - 1),
        ae = a.charCodeAt(t + 1);
      if (o) {
  ...
  st = class extends Qe {
    ...
    next() {
      (this.checkKeywordEscapes(),
        this.optionFlags & 256 && this.pushToken(new tt(this.state)),
    ...
    skipBlockComment(t) {
      ...
      for (
        this.state.pos = i + t.length, ge.lastIndex = s + 2;
        ge.test(this.input) && ge.lastIndex <= i;
      )
    ...
    skipLineComment(t) {
      ...
      if (this.state.pos < this.length)
        for (; !G(i) && ++this.state.pos < this.length; ) i = this.input.charCodeAt(this.state.pos);
      if (this.isLookahead) return;
      ...
      for (; r < this.length; ) {
        ...
        if (Vi.has(l))
          (l === 118
            ...
            o.includes(u) && this.raise(p.DuplicateRegExpFlags, h()));
    ...
    readNumber(t) {
      ...
      if (
        ...
        (h === 69 || h === 101) &&
          ...
          (h = this.input.charCodeAt(this.state.pos))),
        h === 110 &&
          ((i || o) && this.raise(p.InvalidBigIntLiteral, s), ++this.state.pos, (r = !0)),
        B(this.codePointAtPos(this.state.pos)))
      )
        throw this.raise(p.NumberIdentifier, this.state.curPosition());
    ...
    readTemplateToken() {
      ...
      ((this.state.pos = i + 1),
        ...
        s &&
          (this.state.firstInvalidTemplateEscapePos = new R(
            s.curLine,
            s.pos - s.lineStart,
    ...
    checkKeywordEscapes() {
      ...
      Tt(t) &&
        ...
        this.raise(p.InvalidEscapedReservedWord, this.state.startLoc, { reservedWord: z(t) });
    }
    raise(t, e, s = {}) {
    ...
    raiseOverwrite(t, e, s = {}) {
      let i = e instanceof R ? e : e.loc.start,
        r = i.index,
        n = this.state.errors;
    ...
    errorHandlers_readInt = {
      invalidDigit: (t, e, s, i) =>
        this.optionFlags & 2048 ? (this.raise(p.InvalidDigit, he(t, e, s), { radix: i }), !0) : !1,
    ...
    errorHandlers_readStringContents_template = Object.assign(
      {},
      this.errorHandlers_readCodePoint,
      {
...
var nt = class extends st {
    ...
    checkExpressionErrors(t, e) {
      ...
      (s != null && this.raise(p.InvalidCoverInitializedName, s),
        ...
        o != null && this.raise(p.InvalidCoverDiscardElement, o));
    }
    ...
    initializeScopes(t = this.options.sourceType === "module") {
      ...
      return (
        (this.expressionScope = new at(this)),
        () => {
          ((this.state.labels = e),
  ...
  de = class {
    constructor(t, e, s) {
      ((this.start = e),
        (this.end = 0),
        (this.loc = new Q(s)),
        t?.optionFlags & 128 && (this.range = [e, 0]),
  ...
  ht = (a) => (a.type === "ParenthesizedExpression" ? ht(a.expression) : a),
  ct = class extends ot {
    toAssignable(t, e = !1) {
      let s;
      switch (
        ((t.type === "ParenthesizedExpression" || t.extra?.parenthesized) &&
          ((s = ht(t)),
          e
            ? s.type === "Identifier"
        ...
        case "ObjectExpression":
          ...
          for (let i = 0, r = t.properties.length, n = r - 1; i < r; i++) {
            let o = t.properties[i],
              h = i === n;
            (this.toAssignableObjectExpressionProp(o, h, e),
              h &&
                o.type === "RestElement" &&
        ...
        case "ArrayExpression":
          (this.castNodeTo(t, "ArrayPattern"),
            this.toAssignableList(t.elements, t.extra?.trailingCommaLoc, e));
          break;
        case "AssignmentExpression":
          (t.operator !== "=" && this.raise(p.MissingEqInAssignment, t.left.loc.end),
            this.castNodeTo(t, "AssignmentPattern"),
            delete t.operator,
            t.left.type === "VoidPattern" && this.raise(p.VoidPatternInitializer, t.left),
    ...
    toAssignableList(t, e, s) {
      ...
      for (let r = 0; r <= i; r++) {
        ...
        n &&
          ...
          n.type === "RestElement" &&
            (r < i ? this.raise(p.RestTrailingComma, n) : e && this.raise(p.RestTrailingComma, e)));
      }
    }
    ...
    parseRestBinding() {
      ...
      return (
        e.type === "VoidPattern" && this.raise(p.UnexpectedVoidPattern, e),
        (t.argument = e),
      ...
      for (; !this.eat(t); )
        if ((n ? (n = !1) : this.expect(12), i && this.match(12))) r.push(null);
          ...
          if (this.match(21)) {
            ...
            if (
              (s & 2 && (o = this.parseFunctionParamType(o)),
              r.push(o),
    ...
    parseBindingRestProperty(t) {
      return (
        this.next(),
        this.hasPlugin("discardBinding") && this.match(88)
          ? ((t.argument = this.parseVoidPattern(null)),
            this.raise(p.UnexpectedVoidPattern, t.argument))
    ...
    parseBindingElement(t, e) {
      ...
      return (
        t & 2 && this.parseFunctionParamType(s),
    ...
    parseMaybeDefault(t, e) {
      ...
      return (
        e.type === "VoidPattern" && this.raise(p.VoidPatternInitializer, e),
        (s.left = e),
    ...
    checkLVal(t, e, s = 64, i = !1, r = !1, n = !1, o = !1) {
      ...
      if (h === "Identifier") {
        ...
        h === "VoidPattern" &&
          e.type === "CatchClause" &&
          this.raise(p.VoidPatternCatchClauseParam, t);
      let u = ht(t);
      o ||
        (o =
          u.type === "CallExpression" && (u.callee.type === "Import" || u.callee.type === "Super"));
      let f = this.isValidLVal(
        h,
        o,
        !(n || t.extra?.parenthesized) && e.type === "AssignmentExpression",
        s,
      );
      if (f === !0) return;
      if (f === !1) {
      ...
      let A = h === "ArrayPattern" || h === "ObjectPattern" ? { type: h } : e,
        k = t[d];
...
function lt(a) {
  ...
  switch (a.type) {
    case "Identifier":
      return !0;
    case "MemberExpression":
      return !a.computed && lt(a.object);
    case "TSInstantiationExpression":
      return lt(a.expression);
    default:
      return !1;
  }
}
  ...
  class extends a {
    ...
    tsParseModifiers(
      ...
      let o = (l, u, f, d) => {
        ...
        h = (l, u, f, d) => {
          ((n[f] && u === d) || (n[d] && u === f)) &&
            this.raise(y.IncompatibleModifiers, l, { modifiers: [f, d] });
        };
      for (;;) {
        let { startLoc: l } = this.state,
          u = this.tsParseModifier(e.concat(s ?? []), i, n.static);
        if (!u) break;
        (qt(u)
          ? n.accessibility
            ? this.raise(y.DuplicateAccessibilityModifier, l, { modifier: u })
            : (o(l, u, u, "override"),
              o(l, u, u, "static"),
              o(l, u, u, "readonly"),
              (n.accessibility = u))
          : Wi(u)
            ? (n[u] && this.raise(y.DuplicateModifier, l, { modifier: u }),
              (n[u] = !0),
              o(l, u, "in", "out"))
            : (Object.prototype.hasOwnProperty.call(n, u)
                ? this.raise(y.DuplicateModifier, l, { modifier: u })
                : (o(l, u, "static", "readonly"),
                  o(l, u, "static", "override"),
                  o(l, u, "override", "readonly"),
                  o(l, u, "abstract", "override"),
                  h(l, u, "declare", "override"),
                  h(l, u, "static", "abstract")),
              (n[u] = !0)),
          s?.includes(u) && this.raise(r, l, { modifier: u }));
      }
    }
    ...
    tsParseImportType() {
      ...
      return (
        ...
        this.expect(10),
        this.match(134)
          ? (e.argument = this.tsParseLiteralTypeNode())
          : (this.raise(y.UnsupportedImportTypeArgument, this.state.startLoc),
            (e.argument = this.tsParseNonConditionalType())),
        this.eat(12) ? (e.options = this.tsParseImportTypeOptions()) : (e.options = null),
        this.expect(11),
        this.eat(16) && (e.qualifier = this.tsParseEntityName(3)),
        this.match(47) && (e.typeArguments = this.tsParseTypeArguments()),
    ...
    tsParseImportTypeWithPropertyValue() {
      ...
      for (this.expect(5); !this.match(8); ) {
        ...
        (w(i) || i === 134 ? s.push(super.parsePropertyDefinition(null)) : this.unexpected(),
          this.eat(12));
      }
    ...
    tsParseTupleElementType() {
      let e = this.state.startLoc,
        ...
        o,
        h,
        u = O(this.state.type) ? this.lookaheadCharCode() : null;
      if (u === 58)
        ((r = !0),
          (o = !1),
        ...
        this.lookaheadCharCode() === 58
          ? ((r = !0),
            (n = this.createIdentifier(this.startNodeAt(i), f)),
            this.expect(17),
            this.expect(14),
            (h = this.tsParseType()))
          : ((r = !1), (h = d), this.expect(17));
      } else ((h = this.tsParseType()), (o = this.eat(17)), (r = this.eat(14)));
      if (r) {
        let f;
        (n
          ? ((f = this.startNodeAt(i)),
            (f.optional = o),
            (f.label = n),
            (f.elementType = h),
            this.eat(17) &&
              ((f.optional = !0), this.raise(y.TupleOptionalAfterType, this.state.lastTokStartLoc)))
          : ((f = this.startNodeAt(i)),
            (f.optional = o),
            this.raise(y.InvalidTupleMemberLabel, h),
            (f.label = h),
            (f.elementType = this.tsParseType())),
          (h = this.finishNode(f, "TSNamedTupleMember")));
      } else if (o) {
    ...
    tsParseTemplateLiteralType() {
      {
        let e = this.state.startLoc,
          s = this.parseTemplateElement(!1),
          i = [s];
        if (s.tail) {
          let r = this.startNodeAt(e),
            n = this.startNodeAt(e);
          return (
            (n.expressions = []),
            (n.quasis = i),
            (r.literal = this.finishNode(n, "TemplateLiteral")),
            this.finishNode(r, "TSLiteralType")
          );
        } else {
          let r = [];
          for (; !s.tail; )
            (r.push(this.tsParseType()),
              this.readTemplateContinuation(),
              i.push((s = this.parseTemplateElement(!1))));
    ...
    tsParseTypeOperatorOrHigher() {
      return mi(this.state.type) && !this.state.containsEsc
        ...
        i = this.tsParseDelimitedList("HeritageClauseElement", () => {
          {
            ...
            return (
              (o.expression = r),
              (this.match(47) || this.match(51)) &&
                (o.typeArguments = this.tsParseTypeArgumentsInExpression()),
              this.finishNode(o, n)
            );
          }
        });
    ...
    tsParseModuleOrNamespaceDeclaration(e, s = !1) {
      return (
        (e.id = this.tsParseEntityName(1)),
        e.id.type === "Identifier" && this.checkIdentifier(e.id, 1024),
        ...
        switch (s) {
          ...
          case 74:
            return !this.match(75) || !this.isLookaheadContextual("enum")
              ? ((e.declare = !0), this.parseVarStatement(e, this.state.value, !0))
              : (this.expect(75),
          ...
          case 107:
            if (this.isUsing())
              return (
                this.raise(y.InvalidModifierOnUsingDeclaration, this.state.startLoc, "declare"),
                (e.declare = !0),
    ...
    parseBindingElement(e, s) {
      ...
      if (n || h || o) {
        let f = this.startNodeAt(i);
        return (
          s.length && (f.decorators = s),
          n && (f.accessibility = n),
          h && (f.readonly = h),
          o && (f.override = o),
          u.type !== "Identifier" &&
            u.type !== "AssignmentPattern" &&
            this.raise(y.UnsupportedParameterPropertyKind, f),
          (f.parameter = u),
        ...
        let o,
          h = this.tsTryParseAndCatch(() => {
            ...
            if (!i && this.eat(10)) {
              ...
              return (
                (d.callee = e),
                (d.arguments = this.parseCallExpressionArguments()),
        ...
        if ((o && this.unexpected(o, 10), h))
          return (
            h.type === "TSInstantiationExpression" &&
              ...
              !this.match(16) &&
                !this.match(18) &&
                (h.expression = super.stopParseSubscript(e, r))),
            h
          );
      }
      return super.parseSubscript(e, s, i, r);
    ...
    parseNewCallee(e) {
      super.parseNewCallee(e);
      let { callee: s } = e;
      s.type === "TSInstantiationExpression" &&
        !s.extra?.parenthesized &&
        ((e.typeArguments = s.typeArguments), (e.callee = s.expression));
    }
    parseExprOp(e, s, i) {
      let r;
      if (
        ...
        return (
          ...
          (n.typeAnnotation = this.tsInType(
            () => (
              this.next(),
              this.match(75)
                ? (r && this.raise(p.UnexpectedKeyword, this.state.startLoc, { keyword: "const" }),
      ...
      for (let { id: o, init: h } of n.declarations)
        h &&
          (s === "var" || s === "let" || o.typeAnnotation
            ...
            : Xi(h, this.hasPlugin("estree")) ||
              this.raise(y.ConstInitializerMustBeStringOrNumericLiteralOrLiteralEnumReference, h));
      return n;
    }
        ...
        switch (this.state.type) {
          ...
          case 125:
            if (this.nextTokenIsIdentifierAndNotTSRelationalOperatorOnSameLine()) {
              ...
              return n
                ? (i === 125 && (n.declare = !0), n)
                : ((r.expression = this.createIdentifier(
                    this.startNodeAt(r.loc.start),
                    i === 125 ? "declare" : "abstract",
                  )),
                  this.semicolon(!1),
                  this.finishNode(r, "ExpressionStatement"));
            }
            break;
          case 126:
    ...
    pushClassMethod(e, s, i, r, n, o) {
      ...
      (l && (u === "get" || u === "set") && this.raise(y.DeclareAccessor, s, { kind: u }),
    ...
    parseClassSuper(e) {
      (super.parseClassSuper(e),
        e.superClass &&
          (this.match(47) || this.match(51)) &&
          (e.superTypeArguments = this.tsParseTypeArgumentsInExpression()),
    ...
    parseMaybeAssign(e, s) {
      ...
      let o,
        h = this.tryParse((l) => {
          ...
          if (
            ((u.type !== "ArrowFunctionExpression" || u.extra?.parenthesized) && l(),
            o?.params.length !== 0 && this.resetStartLocationFromNode(u, o),
            (u.typeParameters = o),
            this.hasPlugin("jsx") &&
              u.typeParameters.params.length === 1 &&
              !u.typeParameters.extra?.trailingComma)
          ) {
            let f = u.typeParameters.params[0];
            f.constraint ||
              this.raise(y.SingleTypeParameterWithoutTrailingComma, D(f.loc.end, 1), {
                typeParameterName: f.name.name,
              });
          }
          return u;
        }, i);
      ...
      if (
        !r &&
        (zt(!this.hasPlugin("jsx")),
        (n = this.tryParse(() => super.parseMaybeAssign(e, s), i)),
        !n.error)
      )
        return n.node;
      if (r?.node) return ((this.state = r.failState), r.node);
    ...
    parseMethod(e, s, i, r, n, o, h) {
      ...
      if (
        (l.abstract || l.type === "TSAbstractMethodDefinition") &&
        (this.hasPlugin("estree") ? l.value : l).body
      ) {
        let { key: d } = l;
        this.raise(y.AbstractMethodHasImplementation, l, {
          methodName:
            d.type === "Identifier" && !l.computed
              ? d.name
              : `[${this.input.slice(this.offsetToSourcePos(d.start), this.offsetToSourcePos(d.end))}]`,
        });
      }
      return l;
    }
    ...
    parseTypeOnlyImportExportSpecifier(e, s, i) {
      ...
      if (this.isContextual(93)) {
        ...
        if (this.isContextual(93)) {
          ...
          O(this.state.type)
            ? ((u = !1), (h = s ? this.parseIdentifier() : this.parseModuleExportName()))
            : ((l = !0), (o = x));
      } else
        O(this.state.type) &&
          ((l = !0),
      ...
      (l &&
        i &&
        this.raise(s ? y.TypeModifierIsUsedInTypeImports : y.TypeModifierIsUsedInTypeExports, f),
        (e[r] = o),
        (e[n] = h));
...
function Xi(a, t) {
  ...
  return !!(
    ns(a, t) ||
    Yi(a, t) ||
    (e === "TemplateLiteral" && a.expressions.length === 0) ||
    Gi(a)
  );
}
function ns(a, t) {
...
var $t = F`placeholders`({
  ...
  Qi = (a) =>
    class extends a {
      ...
      isExportDefaultSpecifier() {
        if (this.match(65)) {
          ...
          if (
            ...
            this.input.startsWith(z(133), this.nextTokenStartSince(e + 4))
          )
            return !0;
        }
      ...
      checkExport(e) {
        let { specifiers: s } = e;
        (s?.length && (e.specifiers = s.filter((i) => i.exported.type === "Placeholder")),
          super.checkExport(e),
          (e.specifiers = s));
      }
      parseImport(e) {
      ...
      assertNoSpace() {
        this.state.start > this.offsetToSourcePos(this.state.lastTokEndLoc.index) &&
          this.raise($t.UnexpectedSpace, this.state.lastTokEndLoc);
      }
    },
  Zi = (a) =>
    class extends a {
...
function er(a) {
  ...
  if (a.has("pipelineOperator")) {
    ...
    if (t === "hack") {
      ...
      if (!Ht.includes(e)) {
        ...
        throw new Error(
          `"pipelineOperator" in "proposal": "hack" mode also requires a "topicToken" option whose value must be one of: ${s}.`,
        );
      }
    }
  }
  ...
  if (a.has("importAssertions"))
    throw new Error(
      "`importAssertions` has been removed in Babel 8, please use import attributes instead. To use the non-standard `assert` syntax you can enable the `deprecatedImportAssert` parser plugin.",
    );
  if (
  ...
  if (a.has("discardBinding") && a.get("discardBinding").syntaxType !== "void")
    throw new Error(
  ...
  pt = class extends ct {
    ...
    parseMaybeAssign(t, e) {
      ...
      if ((e && (o = e.call(this, o, s)), li(this.state.type))) {
        ...
        if (((h.operator = l), this.match(29))) {
          ...
          let u = s.index;
          (t.doubleProtoLoc != null && t.doubleProtoLoc.index >= u && (t.doubleProtoLoc = null),
            t.shorthandAssignLoc != null &&
              t.shorthandAssignLoc.index >= u &&
              (t.shorthandAssignLoc = null),
            t.privateKeyLoc != null &&
              t.privateKeyLoc.index >= u &&
              (this.checkDestructuringPrivate(t), (t.privateKeyLoc = null)),
            t.voidPatternLoc != null && t.voidPatternLoc.index >= u && (t.voidPatternLoc = null));
        } else h.left = o;
        return (
          this.next(),
      ...
      if (i) {
        ...
        if (
          (this.hasPlugin("v8intrinsic") ? ce(h) : ce(h) && !this.match(54)) &&
    ...
    parseExprOp(t, e, s) {
      if (this.isPrivateName(t)) {
        ...
        ((s >= Ae(58) || !this.prodParam.hasIn || !this.match(58)) &&
    ...
    parseHackPipeBody() {
      ...
      return (
        Qs.has(e.type) &&
          ...
          this.raise(p.PipeUnparenthesizedBody, t, { type: e.type }),
        this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, t),
        e
      );
    }
    ...
    parseCoverCallAndAsyncArrowHead(t, e, s, i) {
      ...
      (h && (this.expressionScope.enter($i()), (n = new Y())),
        l && (o.optional = i),
        i
          ? (o.arguments = this.parseCallExpressionArguments())
          : (o.arguments = this.parseCallExpressionArguments(t.type !== "Super", o, n)));
      ...
      return (
        h && this.shouldParseAsyncArrow() && !i
          ? ((s.stop = !0),
            ...
            (u = this.parseAsyncArrowFromCallExpression(this.startNodeAt(e), u)))
    ...
    parseAsyncArrowFromCallExpression(t, e) {
      return (
        ...
        this.expect(19),
        this.parseArrowExpression(t, e.arguments, !0, e.extra?.trailingCommaLoc),
        e.innerComments && X(t, e.innerComments),
        e.callee.trailingComments && X(t, e.callee.trailingComments),
        t
      );
    }
    parseNoCallExpr() {
    ...
    parseSuper() {
      ...
      return (
        ...
        this.match(10) && !this.scope.allowDirectSuper
          ...
          : this.scope.allowSuper || this.raise(p.UnexpectedSuper, t),
    ...
    parseLiteralAtNode(t, e, s) {
      return (
        ...
        this.addExtra(s, "raw", this.input.slice(this.offsetToSourcePos(s.start), this.state.end)),
        (s.value = t),
        this.next(),
        this.finishNode(s, e)
      );
    ...
    parseRegExpLiteral(t) {
      let e = this.startNode();
      return (
        this.addExtra(e, "raw", this.input.slice(this.offsetToSourcePos(e.start), this.state.end)),
        (e.pattern = t.pattern),
        (e.flags = t.flags),
        this.next(),
    ...
    parseParenAndDistinguishExpression(t) {
      ...
      for (; !this.match(11); ) {
        ...
        if (this.match(21)) {
          ...
          if (
            ...
            o.push(this.parseParenItem(this.parseRestBinding(), A)),
      ...
      return t && this.shouldParseArrow(o) && (x = this.parseArrow(x))
        ? (this.checkDestructuringPrivate(h),
          this.expressionScope.validateAsPattern(),
          this.expressionScope.exit(),
          this.parseArrowExpression(x, o, !1),
          x)
        : (this.expressionScope.exit(),
...
`,
    ...
    parseObjectLike(t, e, s, i) {
      ...
      for (h.properties = [], this.next(); !this.match(t); ) {
        ...
        (e
          ...
          : ((u = this.parsePropertyDefinition(i)), (n = this.checkProto(u, s, n, i))),
          s &&
            !this.isObjectProperty(u) &&
            u.type !== "SpreadElement" &&
            this.raise(p.InvalidRecordProperty, u),
          h.properties.push(u));
      }
      ...
      if ((this.parsePropertyName(s, t), !o && !h && this.maybeAsyncOrAccessorProp(s))) {
        ...
        (u === "async" &&
          ...
          (u === "get" || u === "set") &&
            ...
            this.match(55) &&
              ((o = !0),
              this.raise(p.AccessorIsGenerator, this.state.curPosition(), { kind: u }),
              this.next()),
            this.parsePropertyName(s)));
      }
    ...
    checkGetterSetterParams(t) {
      let e = this.getGetterSetterExpectedParamCount(t),
        s = this.getObjectOrClassMethodParams(t);
      (s.length !== e && this.raise(t.kind === "get" ? p.BadGetterArity : p.BadSetterArity, t),
        t.kind === "set" &&
      ...
      if (((t.shorthand = !1), this.eat(14)))
        return (
          (t.value = s
            ...
            : this.parseMaybeAssignAllowInOrVoidPattern(8, i)),
    ...
    parseMethod(t, e, s, i, r, n, o = !1) {
      (this.initFunction(t, s),
        ...
        this.prodParam.enter(Se(s, t.generator)),
    ...
    parseArrayLike(t, e, s) {
      ...
      return (
        this.next(),
        (r.elements = this.parseExprList(t, !e, s, r)),
        (this.state.inFSharpPipelineDirectBody = i),
        this.finishNode(r, e ? "TupleExpression" : "ArrayExpression")
      );
    }
    ...
    parseExprListItem(t, e, s, i) {
      let r;
      if (this.match(12))
        (e || this.raise(p.UnexpectedToken, this.state.curPosition(), { unexpected: "," }),
          (r = null));
        ...
        (this.expectPlugin("partialApplication"),
          i || this.raise(p.UnexpectedArgumentPlaceholder, this.state.startLoc));
        let n = this.startNode();
    ...
    parseImportCall(t) {
      if (
        (this.next(), (t.source = this.parseMaybeAssignAllowIn()), (t.options = null), this.eat(12))
      ) {
        if (this.match(11)) this.addTrailingCommaExtraToNode(t.source);
        else if (
          ((t.options = this.parseMaybeAssignAllowIn()),
          this.eat(12) && (this.addTrailingCommaExtraToNode(t.options), !this.match(11)))
        ) {
    ...
    parseVoidPattern(t) {
      ...
      let e = this.startNode();
      return (
        t != null && (t.voidPatternLoc = this.state.startLoc),
        this.next(),
        this.finishNode(e, "VoidPattern")
      );
    }
...
var ut = class extends pt {
    parseTopLevel(t, e) {
      return (
        (t.program = this.parseProgram(
          e,
          140,
          this.options.sourceType === "module" ? "module" : "script",
        )),
        (t.comments = this.comments),
        this.optionFlags & 256 && (t.tokens = rr(this.tokens, this.input, this.startIndex)),
    ...
    parseStatementContent(t, e) {
      ...
      switch (s) {
        ...
        case 96:
          if (this.isAwaitUsing())
            return (
              this.allowsUsing()
                ? r
                  ? this.recordAwaitIfAllowed() || this.raise(p.AwaitUsingNotInAsyncContext, i)
        ...
        case 100: {
          ...
          let u = this.nextTokenStart(),
            f = this.codePointAtPos(u);
          if (
            f !== 91 &&
            ((!r && this.hasFollowingLineBreak()) ||
              (!this.chStartsBindingIdentifier(f, u) && f !== 123))
          )
            break;
        }
        case 75:
        ...
        case 82: {
          ...
          let u;
          return (
            s === 83 ? (u = this.parseImport(i)) : (u = this.parseExport(i, e)),
      ...
      return w(s) && l.type === "Identifier" && this.eat(14)
    ...
    parseForStatement(t) {
      ...
      {
        let h = this.isAwaitUsing(),
          l = h || this.isForUsing(),
          u = (s && this.hasFollowingBindingAtom()) || l;
        if (this.match(74) || this.match(75) || u) {
          ...
          (h
            ...
            this.next(),
            this.parseVar(f, !0, d));
          let x = this.finishNode(f, "VariableDeclaration"),
            A = this.match(58);
          return (
            A && l && this.raise(p.ForInUsing, x),
            (A || this.isContextual(102)) && x.declarations.length === 1
              ? this.parseForIn(t, x, e)
              : (e !== null && this.unexpected(e), this.parseFor(t, x))
          );
        }
      }
    ...
    parseLabeledStatement(t, e, s, i) {
      ...
      return (
        ...
        (t.body =
          i & 8 ? this.parseStatementOrSloppyAnnexBFunctionDeclaration(!0) : this.parseStatement()),
        this.state.labels.pop(),
        (t.label = s),
          ...
          n.init === null &&
            ...
            (n.id.type !== "Identifier" && !(e && (this.match(58) || this.isContextual(102)))
              ...
              : (s === "const" || s === "using" || s === "await using") &&
                ...
                this.raise(p.DeclarationMissingInitializer, this.state.lastTokEndLoc, { kind: s })),
    ...
    parseVarId(t, e) {
      ...
      (e === "using" || e === "await using"
        ...
        : s.type === "VoidPattern" && this.raise(p.UnexpectedVoidPattern, s.loc.start),
    ...
    parseFunction(t, e = 0) {
      ...
      return (
        ...
        this.prodParam.enter(Se(n, t.generator)),
    ...
    parseClassMemberWithIsStatic(t, e, s, i) {
      ...
      let d = !this.state.containsEsc && w(this.state.type),
        x = this.parseClassElementName(e),
        A = d ? x.name : null,
        k = this.isPrivateName(x),
      ...
      if ((this.parsePostMemberNameModifiers(f), this.isClassMethod())) {
        ...
        (C &&
          ...
          s.hadConstructor &&
            ...
            this.raise(p.DuplicateConstructor, x),
          C && this.hasPlugin("typescript") && e.override && this.raise(p.OverrideOnConstructor, x),
          (s.hadConstructor = !0),
          (I = s.hadSuperClass)),
          this.pushClassMethod(t, r, !1, !1, C, I));
      } else if (this.isClassProperty())
    ...
    parseClassStaticBlock(t, e) {
      ...
      (this.parseBlockOrModuleBlockBody(i, void 0, !1, 8),
        ...
        e.decorators?.length && this.raise(p.DecoratorStaticBlock, e));
    }
    ...
    parseExport(t, e) {
      ...
      if (l || u || f) {
        let d = t;
        if ((this.checkExport(d, !0, !1, !!d.source), d.declaration?.type === "ClassDeclaration"))
    ...
    isExportDefaultSpecifier() {
      ...
      if (w(t)) {
        ...
        if ((t === 130 || t === 129) && !this.state.containsEsc) {
          ...
          if (
            r === 123 ||
            (this.chStartsBindingIdentifier(r, i) && !this.input.startsWith("from", i))
          )
        ...
        if (s) {
          if ((this.checkDuplicateExports(t, "default"), this.hasPlugin("exportDefaultFrom"))) {
            ...
            r.type === "Identifier" &&
              ...
              r.end - r.start === 4 &&
              !r.extra?.parenthesized &&
              this.raise(p.ExportDefaultFromAsIdentifier, r);
          }
          ...
          for (let r of t.specifiers) {
            ...
            if ((this.checkDuplicateExports(r, o), !i && r.local)) {
              let { local: h } = r;
              h.type !== "Identifier"
                ? this.raise(p.ExportBindingIsString, r, {
                    localName: h.value,
                    exportName: o,
                  })
                : (this.checkReservedWord(h.name, h.loc.start, !0, !1),
                  this.scope.checkLocalExport(h));
            }
          }
          ...
          if (r.type === "FunctionDeclaration" || r.type === "ClassDeclaration") {
            ...
            for (let n of r.declarations) this.checkDeclaration(n.id);
        }
      }
    }
    checkDeclaration(t) {
      ...
      t.phase === "source"
        ...
        : t.phase === "defer"
          ...
          : t.module &&
            ...
            t.assertions?.length > 0 && this.raise(p.ImportReflectionHasAssertion, e[0].loc.start));
    }
    ...
    parseMaybeImportPhase(t, e) {
      ...
      let s = this.startNode(),
        ...
        { type: r } = this.state;
      return (O(r) ? r !== 98 || this.lookaheadCharCode() === 102 : r !== 12)
  ...
  Ee = class extends ut {
    constructor(t, e, s) {
      ...
      (i.allowAwaitOutsideFunction && (r |= 1),
        ...
        i.ranges && (r |= 128),
        i.tokens && (r |= 256),
        i.createImportExpressions && (r |= 512),
        i.createParenthesizedExpressions && (r |= 1024),
        i.errorRecovery && (r |= 2048),
        i.attachComment && (r |= 4096),
        i.annexB && (r |= 8192),
        (this.optionFlags = r));
    }
    getScopeHandler() {
...
var ee =
  (a, t) =>
  (e, s, ...i) =>
    e | 1 && s == null ? void 0 : (t.call(s) ?? s[a]).apply(s, i);
var ur =
...
function M(a) {
  let t = a.range?.[0] ?? a.start,
    e = (a.declaration?.decorators ?? a.decorators)?.[0];
...
var te = yr;
var se = te(["Block", "CommentBlock", "MultiLine"]);
var gs = te([
  "Line",
  "CommentLine",
  "SingleLine",
...
function gr(a) {
  return (
    St.has(a) || St.set(a, se(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/u.test(a.value)),
    St.get(a)
  );
}
var Ts = gr;
  ...
  for (let e = a.length - 1; e >= 0; e--) {
    ...
    if (
      (t &&
        ...
        Ct(s) &&
        Ct(t) &&
        (a.splice(e + 1, 1), (s.value += "*//*" + t.value), (s.range = [M(s), L(t)])),
      !gs(s) && !se(s))
    )
...
function Ir(a, t) {
  ...
  (n.interpreter && (i.unshift(n.interpreter), delete n.interpreter),
    ...
    (a = Es(a, {
      ...
      onLeave(h) {
        switch (h.type) {
          ...
          case "TSImportType":
            !h.source &&
              h.argument.type === "TSLiteralType" &&
              ((h.source = h.argument.literal), delete h.argument);
            break;
        }
      },
    })),
...
var Ns = Ir;
function Nr(a, t) {
  let e = /* @__PURE__ */ new SyntaxError(
...
function kr(a) {
  ...
  return (
    ...
    t.startsWith(ks) && (t = t.slice(ks.length)),
    De(t, {
      loc: {
        start: {
          line: i,
...
`,
  ...
  let s = Object.create(null),
    i = xe(0, a, Ls, "").replace(vs, "").trimEnd(),
    r;
  for (; (r = Ls.exec(a)); ) {
    let n = xe(0, r[2], Fr, "");
...
function $r(a, t, e) {
  let s = a(t, e),
    i = s.errors.find((r) => !Hr.has(r.reasonCode));
  if (i) throw i;
  return s;
}
function Kr({ isExpression: a = !1, optionsCombinations: t }) {
  return (e, s = {}) => {
    ...
    if (
      ...
      (s.parser === "babel" || s.parser === "__babel_estree") && qr(e, i))
    )
      return ((s.parser = "babel-flow"), qs.parse(e, s));
    let r = t,
      n = s.__babelSourceType ?? _s(i);
    n &&
      n !== Oe &&
      (r = r.map((u) => ({
        ...u,
    ...
    let o = /%[A-Z]/u.test(e);
    e.includes("|>")
      ? (r = (o ? [...Vs, js] : Vs).flatMap((f) => r.map((d) => _([f], d))))
      : o && (r = r.map((u) => _([js], u)));
    let h = a ? Ne : Ie,
      l;
    try {
...
var Hr = new Set([
  ...
  zs = [_(["jsx"])],
  Wr = ie({ optionsCombinations: zs }),
  Jr = ie({ optionsCombinations: [_(["jsx", "typescript"]), _(["typescript"])] }),
  Gr = ie({
    isExpression: !0,
  ...
  qs = ie({ optionsCombinations: [_(["jsx", ["flow", { all: !0 }], "flowComments"])] }),
...
function Be(a, t = {}) {
  ...
  return (
    ...
    i.node.type === "File" ? delete i.node : re(i.node),
    i
  );
}
function q(a, t) {
  ...
  return De(`${t} is not allowed in JSON.`, {
    loc: {
      start: e,
      end: s,
    },
