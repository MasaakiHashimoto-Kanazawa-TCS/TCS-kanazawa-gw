  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH)
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        )
          throw new Error(
            `Native binding package version mismatch, expected 0.41.0 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
          );
        return binding;
      } catch (e) {
        loadErrors.push(e);
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-android-arm-eabi/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      loadErrors.push(
        /* @__PURE__ */ new Error(`Unsupported architecture on Android ${process.arch}`),
      );
    ...
    if (process.arch === "x64")
      if (
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-win32-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-win32-x64-msvc/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-win32-ia32-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-win32-arm64-msvc/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      loadErrors.push(
        /* @__PURE__ */ new Error(`Unsupported architecture on Windows: ${process.arch}`),
      );
    ...
    if (process.arch === "x64") {
      ...
      loadErrors.push(
        /* @__PURE__ */ new Error(`Unsupported architecture on macOS: ${process.arch}`),
      );
    ...
    if (process.arch === "x64") {
      ...
      loadErrors.push(
        /* @__PURE__ */ new Error(`Unsupported architecture on FreeBSD: ${process.arch}`),
      );
    ...
    if (process.arch === "x64")
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-x64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-x64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-arm64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-arm64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-arm-musleabihf/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-arm-gnueabihf/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-loong64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-loong64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      if (isMusl()) {
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-riscv64-musl/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
        ...
        try {
          ...
          const bindingPackageVersion =
            require("@oxfmt/binding-linux-riscv64-gnu/package.json").version;
          if (
            bindingPackageVersion !== "0.41.0" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-linux-ppc64-gnu/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-linux-s390x-gnu/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      loadErrors.push(
        /* @__PURE__ */ new Error(`Unsupported architecture on Linux: ${process.arch}`),
      );
    ...
    if (process.arch === "arm64") {
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-openharmony-arm64/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-openharmony-x64/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      try {
        ...
        const bindingPackageVersion =
          require("@oxfmt/binding-openharmony-arm/package.json").version;
        if (
          bindingPackageVersion !== "0.41.0" &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== "0"
      ...
      loadErrors.push(
        /* @__PURE__ */ new Error(`Unsupported architecture on OpenHarmony: ${process.arch}`),
      );
  else
    loadErrors.push(
      /* @__PURE__ */ new Error(
