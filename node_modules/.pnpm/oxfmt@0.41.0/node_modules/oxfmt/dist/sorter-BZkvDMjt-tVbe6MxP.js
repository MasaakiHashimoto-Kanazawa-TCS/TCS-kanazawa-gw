...
async function getTailwindConfig(options) {
  ...
  if (!stylesheet && !(mod === null || mod === void 0 ? void 0 : mod.__unstable__loadDesignSystem))
  ...
  if (mod && mod.__unstable__loadDesignSystem && pkgDir)
    stylesheet ?? (stylesheet = `${pkgDir}/theme.css`);
