      ...
      showSourceCode(e) {
        ...
        return o.slice(u, a).map((f, h) => {
          ...
          if (c === this.line) {
            if (f.length > 160) {
              let d = 20,
                p = Math.max(0, this.column - d),
                m = Math.max(this.column + d, this.endColumn + d),
                y = f.slice(p, m),
                v =
                  r(g.replace(/\d/g, " ")) +
                  f.slice(0, Math.min(this.column - 1, d - 1)).replace(/[^\t]/g, " ");
              return (
                n(">") +
                r(g) +
                i(y) +
    ...
    positionBy(e = {}) {
      ...
      if (e.index) s = this.positionInside(e.index);
        ...
        let r =
          ...
          i = r.slice(ee(r, this.source.start), ee(r, this.source.end)).indexOf(e.word);
...
var fe = w((wx, zi) => {
  ...
  z.rebuild = (t) => {
    (t.type === "atrule"
      ...
      : t.type === "rule"
        ? Object.setPrototypeOf(t, ps.prototype)
        : t.type === "decl"
          ? Object.setPrototypeOf(t, Ui.prototype)
          : t.type === "comment"
            ? Object.setPrototypeOf(t, Bi.prototype)
            : t.type === "root" && Object.setPrototypeOf(t, Gi.prototype),
      (t[$i] = !0),
      t.nodes &&
        t.nodes.forEach((e) => {
          z.rebuild(e);
...
var Hi = w((vx, ji) => {
  var $c = "useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict",
    Wc =
      (t, e = 21) =>
      (s = e) => {
        let r = "",
...
var Ue = w((Sx, to) => {
  "use strict";
  var { nanoid: Yc } = Hi(),
    { isAbsolute: ys, resolve: gs } = {},
    { SourceMapConsumer: Vc, SourceMapGenerator: zc } = Ki(),
    { fileURLToPath: Xi, pathToFileURL: Kt } = {},
    Ji = zt(),
    jc = hs(),
    ds = as(),
    ms = Symbol("lineToIndexCache"),
    Hc = !!(Vc && zc),
    Zi = !!(gs && ys);
  function eo(t) {
    if (t[ms]) return t[ms];
...
`),
  ...
  var Be = class {
    ...
    constructor(e, s = {}) {
      ...
      (this.file || (this.id = "<input css " + Yc(6) + ">"),
    ...
    error(e, s, r, n = {}) {
      ...
      return (
        ...
        this.file && (Kt && (l.input.url = Kt(this.file).toString()), (l.input.file = this.file)),
        l
      );
    }
    ...
    mapResolve(e) {
      return /^\w+:\/\//.test(e)
        ? e
        : gs(this.map.consumer().sourceRoot || this.map.root || ".", e);
    }
    origin(e, s, r, n) {
      if (!this.map) return !1;
      let i = this.map.consumer(),
        o = i.originalPositionFor({
          column: s,
          line: e,
        });
      ...
      ys(o.source)
        ? (a = Kt(o.source))
        : (a = new URL(o.source, this.map.consumer().sourceRoot || Kt(this.map.mapFile)));
      let l = {
        column: o.column,
    ...
    function H(W) {
      ...
      switch (((i = r.charCodeAt(p)), i)) {
        ...
        case 40:
          if (
            ...
            ((a = r.indexOf(")", p + 1)),
              ...
              a === -1 || Qc.test(o)
                ? (f = ["(", "(", p])
                : ((f = ["brackets", o, p, a]), (p = a)));
          break;
        case 39:
        case 34:
          ((l = i === 39 ? "'" : '"'), (a = p));
          do {
            if (((h = !1), (a = r.indexOf(l, a + 1)), a === -1))
              if (n || A) {
                a = p + 1;
                break;
              } else O("string");
        ...
        case 64:
          ((Jt.lastIndex = p + 1),
            Jt.test(r),
            Jt.lastIndex === 0 ? (a = r.length - 1) : (a = Jt.lastIndex - 2),
            (f = ["at-word", r.slice(p, a + 1), p, a]),
            (p = a));
          break;
        case 92:
          ...
          break;
        default:
          i === 47 && r.charCodeAt(p + 1) === 42
            ? ((a = r.indexOf("*/", p + 2) + 1),
              a === 0 && (n || A ? (a = r.length) : O("comment")),
              (f = ["comment", r.slice(p, a + 1), p, a]),
              (p = a))
            : ((Zt.lastIndex = p + 1),
              Zt.test(r),
              Zt.lastIndex === 0 ? (a = r.length - 1) : (a = Zt.lastIndex - 2),
              (f = ["word", r.slice(p, a + 1), p, a]),
              m.push(f),
              (p = a));
          break;
      }
    ...
    decl(e, s) {
      ...
      for (
        n[0] === ";" && ((this.semicolon = !0), e.pop()),
          r.source.end = this.getPosition(n[3] || n[2] || rf(e)),
          r.source.end.offset++;
        e[0][0] !== "word";
      )
      ...
      (e.some((l) => l[0] !== "space" && l[0] !== "comment") &&
        ((r.raws.between += o.map((l) => l[1]).join("")), (o = [])),
      ...
      for (let c = 0; c < u; c += 1)
        ((i = r[c]),
          ...
          o === "space" && c === u - 1 && !n
            ? (l = !1)
            : o === "comment"
              ? ((h = r[c - 1] ? r[c - 1][0] : "empty"),
                (f = r[c + 1] ? r[c + 1][0] : "empty"),
                !mo[h] && !mo[f] ? (a.slice(-1) === "," ? (l = !1) : (a += i[1])) : (l = !1))
              : (a += i[1]));
      if (!l) {
...
`),
        ...
        return (
          ...
          n && ((this.input = new uf(n)), (this.tokenizer = af(this.input))),
          !0
        );
      } else if (t[1] === "/") {
        let e = this.tokenizer.nextToken({ ignoreUnclosed: !0 });
        if (e[0] === "comment" && e[1].startsWith("/*"))
          return (
            (e[0] = "word"),
            (e[1] = e[1].slice(1)),
            (t[1] = "//"),
            this.tokenizer.back(e),
            xs.exports.isInlineComment.bind(this)(t)
          );
      }
      return !1;
    },
...
var Po = w((Bx, No) => {
  ...
  No.exports = class extends mf {
    ...
    mixin(e) {
      let [s] = e,
        r = s[1].slice(0, 1),
        n = e.findIndex((l) => l[0] === "brackets"),
        i = e.findIndex((l) => l[0] === "("),
        o = "";
      if ((n < 0 || n > 3) && i > 0) {
        let l = e.reduce((v, O, q) => (O[0] === ")" ? q : v)),
          h = e
            .slice(i, l + i)
            .map((v) => v[1])
            .join(""),
      ...
      if (u.length) {
        let [l] = u,
          ...
          c = [l[2], l[3]],
          g = [h[4], h[5]],
          d = ["word", u.map((p) => p[1]).join("")].concat(c, g);
        ...
        r.root.walk((n) => {
          ...
          if (
            ...
            let a = i + n.source.end.offset,
              l = s.fromOffset(i + n.source.end.offset);
            n.source.end = {
              offset: a,
              line: l.line,
              column: l.col,
    ...
    he = class t {
      ...
      constructor(e, s, r) {
        ...
        if (typeof s == "object" && s !== null && (s.type === "root" || s.type === "document"))
          n = ks(s);
        else if (s instanceof t || s instanceof Vo)
          ((n = ks(s.root)),
            s.map &&
      ...
      switch (((i = r.charCodeAt(d)), i)) {
        ...
        case 34:
          for (
            ...
            i === 92 ? (f = !f) : f ? (f = !1) : i === 35 && c === 123 && H();
          ((g = ["string", r.slice(d, o + 1), d, o]), (d = o));
          break;
        case 64:
          ((or.lastIndex = d + 1),
            or.test(r),
            or.lastIndex === 0 ? (o = r.length - 1) : (o = or.lastIndex - 2),
            (g = ["at-word", r.slice(d, o + 1), d, o]),
            (d = o));
          break;
        case 92:
        ...
        default:
          ((c = r.charCodeAt(d + 1)),
            i === 35 && c === 123
              ? ((o = d), H(), (a = r.slice(d, o + 1)), (g = ["word", a, d, o]), (d = o))
              : i === 47 && c === 42
                ? ((o = r.indexOf("*/", d + 2) + 1),
                  o === 0 && (n || k ? (o = r.length) : O("comment")),
                  (g = ["comment", r.slice(d, o + 1), d, o]),
                  (d = o))
                : i === 47 && c === 47
                  ? ((ur.lastIndex = d + 1),
                    ur.test(r),
                    ur.lastIndex === 0 ? (o = r.length - 1) : (o = ur.lastIndex - 2),
                    (a = r.slice(d, o + 1)),
                    (g = ["comment", a, d, o, "inline"]),
                    (d = o))
                  : ((ar.lastIndex = d + 1),
                    ar.test(r),
                    ar.lastIndex === 0 ? (o = r.length - 1) : (o = ar.lastIndex - 2),
                    (g = ["word", r.slice(d, o + 1), d, o]),
                    p.push(g),
                    (d = o)));
          break;
      }
...
var qs = w((Is) => {
  ...
  vt.prototype.walk = function (e, s) {
    for (
      ...
      var u = this.nodes[o];
      if (
        ((r ? i.test(u.type) : !0) && n && n(u, o, this.nodes) === !1) ||
        (u.nodes && u.walk(e, s) === !1)
      )
        return !1;
    }
    return !0;
    ...
    for (var u = 0; u < t.length; u++) {
      ...
      (n
        ...
        n &&
          ...
          i.type === "media-feature-expression" && (i.nodes = va(i.value, i.sourceIndex)),
          s.push(Array.isArray(i.nodes) ? new Ls.default(i) : new ga.default(i)),
          (i = o()),
          (n = !1)));
    }
    for (var l = 0; l < s.length; l++)
      if (((i = s[l]), l > 0 && (s[l - 1].after = i.before), i.type === void 0)) {
        if (l > 0) {
          ...
          s[l - 1].type === "media-type" &&
            (s[l + 1]
              ? (i.type =
                  s[l + 1].type === "media-feature-expression"
                    ? "keyword"
        ...
        if (l === 0) {
          ...
          if (
            s[l + 1] &&
            (s[l + 1].type === "media-feature-expression" || s[l + 1].type === "keyword")
          ) {
            i.type = "media-type";
            continue;
          }
...
var Us = w((m_, Sa) => {
  Sa.exports = function (e, s) {
    if (((s = typeof s == "number" ? s : Infinity), !s))
  ...
  function tm(t) {
    for (
      ...
      switch (((r = s.charCodeAt(m)), r === _t && ((d = m), (p += 1)), r)) {
        ...
        case Ys:
          n = m;
          do ((n += 1), (r = s.charCodeAt(n)), r === _t && ((d = n), (p += 1)));
        ...
        case Vd:
          ...
          do
            for (
              c = !1, n = s.indexOf(i, n + 1), n === -1 && y("quote", i), g = n;
              s.charCodeAt(g - 1) === Ws;
            )
              ((g -= 1), (c = !c));
          while (c);
        ...
        case em:
          ((Tr.lastIndex = m + 1),
            Tr.test(s),
            Tr.lastIndex === 0 ? (n = s.length - 1) : (n = Tr.lastIndex - 2),
            e.push(["at-word", s.slice(m, n + 1), p, m - d, p, n - d, m]),
            (m = n));
          break;
        case Ws:
          for (n = m, l = !0; s.charCodeAt(n + 1) === Ws; ) ((n += 1), (l = !l));
          ((r = s.charCodeAt(n + 1)),
            l && r !== nu && r !== Gs && r !== _t && r !== Vs && r !== zs && r !== Ys && (n += 1),
            e.push(["word", s.slice(m, n + 1), p, m - d, p, n - d, m]),
            (m = n));
          break;
        default:
          r === nu && s.charCodeAt(m + 1) === lu
            ? ((n = s.indexOf("*/", m + 2) + 1),
              n === 0 && y("comment", "*/"),
              (a = s.slice(m, n + 1)),
              (o = a.split(`
`)),
              (u = o.length - 1),
              u > 0 ? ((f = p + u), (h = n - o[u].length)) : ((f = p), (h = d)),
              e.push(["comment", a, p, m - d, f, n - h, m]),
              (d = h),
              (p = f),
              (m = n))
            : ((Ar.lastIndex = m + 1),
              Ar.test(s),
              Ar.lastIndex === 0 ? (n = s.length - 1) : (n = Ar.lastIndex - 2),
              e.push(["word", s.slice(m, n + 1), p, m - d, p, n - d, m]),
              (m = n));
          break;
      }
  ...
  Cr.default = (function () {
    function t(e) {
      (Mm(this, t),
        ...
        (this.position = 0),
        (this.root = new lm.default()));
      var s = new Hs.default();
      return (
        this.root.append(s),
        (this.current = s),
        this.lossy
          ? (this.tokens = (0, pu.default)({
              safe: e.safe,
              css: e.css.trim(),
            }))
          : (this.tokens = (0, pu.default)(e)),
        this.loop()
      );
    }
    return (
      (t.prototype.attribute = function () {
        ...
        if (
          ...
          var a = i[2].split(/(\s+i\s*?)$/),
            l = a[0].trim();
          ((r.value = this.lossy ? l : a[0]),
            a[1] && ((r.insensitive = !0), this.lossy || (r.raws.insensitive = a[1])),
            (r.quoted = l[0] === "'" || l[0] === '"'),
            (r.raws.unquoted = r.quoted ? l.slice(1, -1) : l));
        }
  ...
  Xu.exports = function (e, s) {
    ...
    for (; a < i; ) {
      switch (((h = n.charCodeAt(a)), h === 10 && ((o = a), (u += 1)), h)) {
        ...
        case 12:
          c = a;
          do ((c += 1), (h = n.charCodeAt(c)), h === 10 && ((o = c), (u += 1)));
        ...
        case 34:
          ...
          do
            for (
              O = !1, c = n.indexOf(g, c + 1), c === -1 && ne("quote", g), q = c;
              n.charCodeAt(q - 1) === 92;
            )
              ((q -= 1), (O = !O));
          while (O);
        ...
        case 64:
          ((Wr.lastIndex = a + 1),
            Wr.test(n),
            Wr.lastIndex === 0 ? (c = n.length - 1) : (c = Wr.lastIndex - 2),
            r.push(["atword", n.slice(a, c + 1), u, a - o, u, c - o, a]),
            (a = c));
          break;
        case 92:
          ((c = a),
            (h = n.charCodeAt(c + 1)),
            r.push(["word", n.slice(a, c + 1), u, a - o, u, c - o, a]),
            (a = c));
          break;
        case 43:
        case 45:
        ...
        default:
          if (
            ...
            if (n.charCodeAt(a + 1) === 42)
              ((c = n.indexOf("*/", a + 2) + 1), c === 0 && ne("comment", "*/"));
            else {
              let N = n.indexOf(
                `
`,
...
`)),
              (d = b.length - 1),
              d > 0 ? ((y = u + d), (v = c - b[d].length)) : ((y = u), (v = o)),
              r.push(["comment", p, u, a - o, y, c - v, a]),
              (o = v),
              (u = y),
              (a = c));
          } else if (h === 35 && !dy.test(n.slice(a + 1, a + 2)))
            ((c = a + 1), r.push(["#", n.slice(a, c), u, a - o, u, c - o, a]), (a = c - 1));
          else if ((h === 117 || h === 85) && n.charCodeAt(a + 1) === 43) {
            c = a + 2;
            do ((c += 1), (h = n.charCodeAt(c)));
            while (c < i && my.test(n.slice(c, c + 1)));
            (r.push(["unicoderange", n.slice(a, c), u, a - o, u, c - o, a]), (a = c - 1));
          } else if (h === 47)
            ((c = a + 1), r.push(["operator", n.slice(a, c), u, a - o, u, c - o, a]), (a = c - 1));
          else {
            let k = hy;
            if (
              (h >= 48 && h <= 57 && (k = ze),
              (k.lastIndex = a + 1),
              k.test(n),
              k.lastIndex === 0 ? (c = n.length - 1) : (c = k.lastIndex - 2),
              k === ze || h === 46)
            ) {
              let N = n.charCodeAt(c),
                tn = n.charCodeAt(c + 1),
                rn = n.charCodeAt(c + 2);
              (N === 101 || N === 69) &&
                (tn === 45 || tn === 43) &&
                ...
                ((ze.lastIndex = c + 2),
                ze.test(n),
                ze.lastIndex === 0 ? (c = n.length - 1) : (c = ze.lastIndex - 2));
            }
...
var nl = w((rb, sl) => {
  ...
  sl.exports = class {
    constructor(e, s) {
      ((this.cache = []),
        (this.input = e),
        (this.options = Object.assign({}, { loose: !1 }, s)),
        (this.position = 0),
        (this.unbalanced = 0),
        (this.root = new yy()));
      let n = new gy();
        ...
        o.forEach((u, a) => {
          ...
          if (~i.indexOf(u))
            ...
            ((h = new (e && e[0] === "(" ? by : rl)({
              ...
              h.type === "word"
                ? ((h.isHex = /^#(.+)/.test(f)),
                  (h.isColor = /^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/i.test(f)))
...
var bt =
  (t, e) =>
  (s, r, ...n) =>
    s | 1 && r == null ? void 0 : (e.call(r) ?? r[t]).apply(r, n);
var Ol =
...
var je = "string",
  ...
  kt = "indent-if-break",
  Oe = "line-suffix",
  Tt = "line-suffix-boundary",
  X = "line",
  At = "label",
  Ce = "break-parent",
  Ot = new Set([Et, ie, Ae, St, oe, ae, me, kt, Oe, Tt, X, At, Ce]);
function Il(t) {
...
function Yl(t, e) {
  let { preferred: s, alternate: r } = e === !0 || e === "'" ? Wl : Gl,
    { length: n } = t,
    i = 0,
    o = 0;
  for (let u = 0; u < n; u++) {
...
function mn(t, e, s) {
  if (
    ...
    s.type === "css-root" &&
    s.nodes.length > 0 &&
    (((s.nodes[0] === t || (Re(s.nodes[0]) && s.nodes[1] === t)) &&
      (delete e.text, /^\*\s*@(?:format|prettier)\s*$/u.test(t.text))) ||
      (s.type === "css-root" && G(0, s.nodes, -1) === t))
  )
    return null;
  if (
    ...
    (t.type === "media-feature" ||
      ...
      t.value &&
      (e.value = Jl(t.value)),
    t.type === "selector-combinator" && (e.value = E(0, e.value, /\s+/gu, " ")),
    t.type === "media-feature" && (e.value = E(0, e.value, " ", "")),
    ((t.type === "value-word" &&
      ((t.isColor && t.isHex) ||
    ...
    t.type === "value-unknown" && (e.value = E(0, e.value, /;$/gu, "")),
    t.type === "selector-attribute" &&
    ...
    let { value: r } = e;
    (/\s[a-zA-Z]$/u.test(r) &&
      ((e.__prettier_attribute_selector_flag = G(0, r, -1)), (r = r.slice(0, -1))),
      (r = r.trim()),
      (r = r.replace(/^(?<quote>["'])(?<value>.*?)\k<quote>$/u, "$<value>")),
      (e.value = r),
      delete e.quoted);
  }
  if (
    ((t.type === "media-value" ||
      ...
      t.type === "selector-tag") &&
      t.value &&
      (e.value = E(0, e.value, /([\d+.e-]+)([a-z]*)/giu, (r, n, i) => {
        let o = Number(n);
  ...
  if (
    ...
    t.groups.some(
      (r) =>
        (r.type === "value-atword" && (r.value.endsWith("[") || r.value.endsWith("]"))) ||
        (r.type === "value-word" && (r.value.startsWith("]") || r.value.startsWith("["))),
    )
  )
    return {
      type: "value-atword",
...
function ec(t, e = "type") {
  ...
  function s(r) {
    let n = r[e],
      i = t[n];
    if (!Array.isArray(i))
      throw Object.assign(/* @__PURE__ */ new Error(`Missing visitor keys for '${n}'.`), {
        node: r,
      });
    return i;
  }
...
function Sn(t, e) {
  ...
  if (typeof t.sourceIndex == "number")
    return t.type === "value-word" ? En(t, t.sourceIndex) : t.sourceIndex;
...
function sc(t) {
  ...
  return (
    ...
    t.type !== "css-atrule" && typeof t.raws?.between == "string" && (e += t.raws.between.length),
    e
  );
}
function Tn(t) {
...
var P = (t) => t.source?.startOffset,
  R = (t) => t.source?.endOffset;
var nc = /\*\/$/,
  ic = /^\/\*\*?/,
  Nn = /^\s*(\/\*\*?(.|\r?\n)*?\*\/)/,
  oc = /(^|\s+)\/\/([^\n\r]*)/g,
...
function Wn(t) {
  let { shebang: e, text: s, pragmas: r, comments: n } = Jr(t),
    i = In(s),
    o = Ln({
      pragmas: {
        [Bn]: "",
...
var fc = new Set(["initial", "inherit", "unset", "revert"]);
function jn(t) {
...
function Hn(t, e) {
  return (
    t
      .findAncestor((r) => r.type === "css-atrule")
      ?.name?.toLowerCase()
      .endsWith("keyframes") && ["from", "to"].includes(e.toLowerCase())
  );
}
function Ie(t) {
  return t.includes("$") ||
...
function Qn(t) {
  ...
  return (
    ...
    e.groups.length === 2 &&
    t.findAncestor((s) => s.type === "css-atrule")?.name === "import"
  );
}
function Xn(t) {
...
function ai(t) {
  return (
    t.value?.type === "value-root" &&
    t.value.group?.type === "value-value" &&
    t.prop.toLowerCase() === "composes"
  );
}
function ui(t) {
  return (
    t.value?.group?.group?.type === "value-paren_group" &&
...
function ts(t, e) {
  ...
  return !Zr(s) && !(r && Zr(r))
    ? !1
    : !!(
        t.findAncestor((i) => i.type === "css-decl")?.prop?.startsWith("$") ||
        Zr(r) ||
        r.type === "value-func"
      );
}
...
function hc(t, e, s) {
  let { node: r } = t,
    ...
    a = t.findAncestor((p) => p.type === "css-atrule"),
    l = a && Je(a, e),
    f = r.groups.some((p) => Ze(p)),
    h = t.map(s, "groups"),
    c = [""],
    g = qe(t, "url"),
    b = !1,
  ...
  for (let p = 0; p < r.groups.length; ++p) {
    ...
    if (
      ...
      (we(t, "utility") &&
        ...
        v.value === "*") ||
      !v ||
      (y.type === "value-word" && tt(v) && R(y) === P(v))
    )
      continue;
    if (y.type === "value-string" && y.quoted) {
      let k = y.value.lastIndexOf("#{"),
        N = y.value.lastIndexOf("}");
    ...
    if (
      ...
      $t(y) ||
      $t(v) ||
      (y.type === "value-atword" && (y.value === "" || y.value.endsWith("["))) ||
      (v.type === "value-word" && v.value.startsWith("]")) ||
      y.value === "~" ||
      (e.parser === "less" &&
        ((v?.type === "value-word" && v.value === "[") ||
          (y.type === "value-word" &&
            y.value === "[" &&
            (v?.type === "value-atword" || v?.type === "value-word")) ||
          (y.type === "value-word" && y.value === "][" && v?.type === "value-word"))) ||
      (y.type !== "value-string" &&
        y.value &&
        y.value.includes("\\") &&
        v &&
      ...
      (m?.value &&
        m.value.indexOf("\\") === m.value.length - 1 &&
        y.type === "value-operator" &&
        y.value === "/") ||
      y.value === "\\" ||
      oi(y, v) ||
      Ut(y) ||
    ...
    if (
      (((q && Ut(v)) || (H && Ft(y))) && Z(v)) ||
      (!m && ve(y)) ||
      (qe(t, "calc") && (J(y) || J(v) || xe(y) || xe(v)) && Z(v))
    )
      continue;
    let ne =
      (J(y) || xe(y)) && p === 0 && (v.type === "value-number" || v.isHex) && i && fi(i) && !Z(v);
    if (e.parser === "scss" && q && y.value === "-" && v.type === "value-func" && R(y) !== P(v)) {
      c.push([c.pop(), " "]);
      continue;
    }
    let W = O?.type === "value-func" || (O && et(O)) || y.type === "value-func" || et(y),
      A = v.type === "value-func" || et(v) || m?.type === "value-func" || (m && et(m));
    if (
      !(
        !(Lt(v) || Lt(y)) &&
        !qe(t, "calc") &&
        !ne &&
        ((ve(v) && !W) || (ve(y) && !A) || (J(v) && !W) || (J(y) && !A) || xe(v) || xe(y)) &&
        (Z(v) || (q && (!m || (m && Dt(m)))))
      ) &&
      !(
      ...
      if (u) {
        y.source && v.source && y.source.start.line !== v.source.start.line
          ? (c.push(T, ""), (d = !0))
          : c.push([c.pop(), " "]);
        continue;
      }
      if (
        ...
        if (v?.value !== "..." && !(tt(y) && tt(v) && R(y) === P(v))) {
          ...
          if (!(y.value?.endsWith("#") && v.value === "{" && rt(v.group)) && !(Ze(v) && !O)) {
            if (
              !a &&
              y.type === "value-comment" &&
              !y.inline &&
              r.groups.slice(0, p).every((k) => k.type === "value-comment")
            ) {
              c.push(le(C), "");
              continue;
            }
  ...
  return (
    f && c.push([c.pop(), Ne]), d && c.unshift("", T), l ? D(L(c)) : Qn(t) ? D(Pe(c)) : D(L(Pe(c)))
  );
}
function hi(t) {
  ...
  return (
    e === "var" || e === "calc" || e === "min" || e === "max" || e === "clamp" || e.startsWith("--")
  );
}
var di = hc;
function dc(t) {
...
var yi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu,
  wc = new RegExp(
    yi.source +
      `|(${/[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu.source})?(${/(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu.source})(${/[a-z]+/giu.source})?`,
    "giu",
  );
function V(t, e) {
...
function gi(t, e) {
  let s = e.singleQuote ? "'" : '"',
    r = "",
    n = t.match(/^(?<value>.+?)\s+(?<flag>[a-zA-Z])$/u);
  return (
    n && ({ value: t, flag: r } = n.groups),
    (t.includes('"') || t.includes("'") ? t : s + t + s) + (r ? ` ${r}` : "")
  );
}
function _e(t) {
  return E(0, t, wc, (e, s, r, n, i) =>
    !r && n && (i ?? (i = ""), (i = i.toLowerCase()), !i || i === "n" || Wt.has(i))
      ? ns(n) + (i ? ss(i) : "")
      : e,
  );
}
...
function kc(t, e) {
  return Jn(t.grandparent) && Sc(t, e)
    ? ","
...
function bi(t, e, s) {
  let { node: r, parent: n } = t,
    i = t.map(({ node: g }) => (typeof g == "string" ? g : s()), "groups");
  if (
    n &&
    Xn(n) &&
    (r.groups.length === 1 ||
  ...
  let o = t.map(({ node: g, isLast: b, index: d }) => {
      ...
      Bt(g) &&
        ...
        g.groups[2]?.type === "value-paren_group" &&
        ue(p) === oe &&
        ue(p.contents) === ie &&
        ue(p.contents.contents) === ae &&
        (p = D(le(p)));
      let m = [p, b ? kc(t, e) : ","];
    ...
    f = a || (l && !u),
    h = a || u,
    c = D([r.open ? s("open") : "", L([M, Y(C, o)]), M, r.close ? s("close") : ""], {
      shouldBreak: f,
    });
  return h ? le(c) : c;
}
...
function Oc(t, e, s) {
  ...
  return (
    t.each(() => {
      ...
      if (
        (i?.type === "css-comment" && i.text.trim() === "prettier-ignore"
        ...
        return;
      let { next: o } = t;
      (o.type === "css-comment" && !Yt(e.originalText, P(o), { backwards: !0 }) && !Re(n)) ||
      (o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment")
        ? r.push(" ")
        : (r.push(e.__isHTMLStyleAttribute ? C : T),
          Vt(e.originalText, R(n)) && !Re(n) && r.push(T));
    }, "nodes"),
    r
  );
}
  ...
  switch (r.type) {
    case "css-root": {
      ...
      return (
        ...
        [
          r.frontMatter ? [s("frontMatter"), T, r.nodes.length > 0 ? T : ""] : "",
          n,
          i ? ` ${i}` : "",
          r.nodes.length > 0 ? T : "",
        ]
    ...
    case "css-comment": {
      let n = r.inline || r.raws.inline,
        i = e.originalText.slice(P(r), R(r));
    ...
    case "css-rule":
      return [
        ...
        r.nodes
          ? [
              r.selector?.type === "selector-unknown" && Le(r.selector.value)
                ? C
                : r.selector
                  ? " "
                  : "",
    ...
    case "css-decl": {
      let n = t.parent,
        ...
        o = i.trim(),
        u = o === ":",
        a = typeof r.value == "string" && /^ *$/u.test(r.value),
        l = typeof r.value == "string" ? r.value : s("value");
      return (
        (l = ai(r) ? on(l) : l),
        !u && Le(o) && !t.call(() => is(t), "value", "group", "group") && (l = L([T, le(l)])),
        [
          ...
          r.nodes
            ? [" {", L([M, De(t, e, s)]), M, "}"]
            : ii(r) && !n.raws.semicolon && e.originalText[R(r) - 1] !== ";"
              ? ""
    ...
    case "css-atrule": {
      let n = t.parent,
        i = Mt(r) && !n.raws.semicolon && e.originalText[R(r) - 1] !== ";";
      if (e.parser === "less") {
        if (r.mixin) return [s("selector"), r.important ? " !important" : "", i ? "" : ";"];
        if (r.function)
          return [r.name, typeof r.params == "string" ? r.params : s("params"), i ? "" : ";"];
        if (r.variable)
          return [
            "@",
            r.name,
            ...
            r.nodes ? ["{", L([r.nodes.length > 0 ? M : "", De(t, e, s)]), M, "}"] : "",
            i ? "" : ";",
          ];
      }
      let o =
        r.name === "import" && r.params?.type === "value-unknown" && r.params.value.endsWith(";");
      return [
        "@",
          ...
          ? [
              Je(r, e)
                ...
                : (r.selector &&
                      ...
                      Le(r.selector.value)) ||
                    (!r.selector && typeof r.params == "string" && Le(r.params))
                  ? C
                  : " ",
              "{",
    ...
    case "selector-root":
      return D([
        we(t, "custom-selector")
          ? [t.findAncestor((n) => n.type === "css-atrule").customSelector, C]
          : "",
        Y([",", we(t, ["extend", "custom-selector", "nest"]) ? C : T], t.map(s, "nodes")),
      ]);
    case "selector-selector":
      return D((r.nodes.length > 2 ? L : (i) => i)(t.map(s, "nodes")));
    ...
    case "selector-tag":
      return [
        ...
        t.previous?.type === "selector-nesting"
          ? r.value
          : _e(Hn(t, r.value) ? r.value.toLowerCase() : r.value),
      ];
    case "selector-id":
      return ["#", r.value];
    case "selector-class":
    ...
    case "selector-pseudo":
      return [
        Ie(r.value),
        ce(r.nodes) ? D(["(", L([M, Y([",", C], t.map(s, "nodes"))]), M, ")"]) : "",
      ];
    case "selector-nesting":
      return r.value;
    case "selector-unknown": {
      if (t.findAncestor((u) => u.type === "css-rule")?.isSCSSNesterProperty)
        return _e(V(Ie(r.value), e));
      let i = t.parent;
      if (i.raws?.selector) {
        let u = P(i),
          a = u + i.raws.selector.length;
      ...
      if (i.type === "value-paren_group" && o?.type === "value-func" && o.value === "selector") {
        let u = R(i.open) + 1,
          a = P(i.close),
          l = e.originalText.slice(u, a).trim();
        return Le(l) ? [Ne, l] : l;
      }
      return r.value;
    }
    ...
    case "value-colon": {
      ...
      return D([
        r.value,
        (typeof n?.value == "string" && n.value.endsWith("\\")) || qe(t, "url") ? "" : C,
      ]);
    }
    case "value-string":
...
var dl = Te(ht(), 1),
  ...
  yl = Te(da(), 1);
function gp(t, e) {
  let s = /* @__PURE__ */ new SyntaxError(
  ...
  for (let a = 0; a < s.length; ++a) {
    ...
    if (
      (e.parser === "scss" &&
        ...
        l.unit === ".." &&
        l.value.endsWith(".") &&
        ((l.value = l.value.slice(0, -1)), (l.unit = "...")),
      l.type === "func" &&
        l.value === "selector" &&
        (l.group.groups = [
          se(Gr(t).text.slice(l.group.open.sourceIndex + 1, l.group.close.sourceIndex)),
        ]),
      l.type === "func" && l.value === "url")
    ) {
      let f = l.group?.groups ?? [],
        h = [];
    ...
    if (l.type === "paren" && l.value === "(")
      ...
      if ((o.groups.length > 0 && r.groups.push(o), (r.close = l), u.length === 1))
...
function fl(t, e) {
  if (Se(t))
    for (let s in t)
      s !== "parent" && (fl(t[s], e), s === "nodes" && ((t.group = Yr(By(t, e))), delete t[s]));
  return t;
}
function Uy(t, e) {
...
var de = Uy;
var Fy = new Set(["import", "use", "forward"]);
function $y(t) {
  return Fy.has(t);
}
var pl = $y;
  ...
  if (Se(t)) {
    ...
    if (
      ...
      if (t.value.trimEnd().endsWith("}")) {
        let o = e.originalText.slice(0, t.source.start.offset),
          u =
    ...
    typeof t.selector == "string" &&
      ((s = t.raws.selector ? (t.raws.selector.scss ?? t.raws.selector.raw) : t.selector),
      t.raws.between && t.raws.between.trim().length > 0 && (s += t.raws.between),
      (t.raws.selector = s));
    let r = "";
    typeof t.value == "string" &&
      ((r = t.raws.value ? (t.raws.value.scss ?? t.raws.value.raw) : t.value),
      (t.raws.value = r.trim()));
    let n = "";
    if (
      (typeof t.params == "string" &&
        ((n = t.raws.params ? (t.raws.params.scss ?? t.raws.params.raw) : t.params),
        t.raws.afterName && t.raws.afterName.trim().length > 0 && (n = t.raws.afterName + n),
        t.raws.between && t.raws.between.trim().length > 0 && (n = n + t.raws.between),
        (n = n.trim()),
        (t.raws.params = n)),
      s.trim().length > 0)
    )
      return s.startsWith("@") && s.endsWith(":")
        ...
        : t.mixin
          ? ((t.selector = de(s, e)), t)
          : (hl(t, e) && (t.isSCSSNesterProperty = !0), (t.selector = se(s)), t);
    if (r.trim().length > 0) {
      let i = r.match(Gy);
      i &&
        ((r = r.slice(0, i.index)),
        (t.scssDefault = !0),
        i[0].trim() !== "!default" && (t.raws.scssDefault = i[0]));
      let o = r.match(Yy);
      if (
        (o &&
          ((r = r.slice(0, o.index)),
          (t.scssGlobal = !0),
          o[0].trim() !== "!global" && (t.raws.scssGlobal = o[0])),
        r.startsWith("progid:"))
      )
        return {
          type: "value-unknown",
    ...
    if (
      (e.parser === "less" &&
        ...
        t.extend && !t.selector && (delete t.value, (t.selector = se(r.slice(7, -1))))),
      t.type === "css-atrule")
    ) {
      if (e.parser === "less") {
        if (t.mixin)
          return (
            (t.selector = se(t.raws.identifier + t.name + t.raws.afterName + t.raws.params)),
            delete t.params,
            t
          );
      ...
      if (e.parser === "css" && t.name === "custom-selector") {
        ...
        return (
          (t.customSelector = i),
          (t.selector = se(t.params.slice(i.length).trim())),
          delete t.params,
          t
        );
      }
    ...
    if (t.type === "css-atrule" && n.length > 0) {
      ...
      return i === "warn" || i === "error"
        ? ((t.params = {
          ...
          t)
        : i === "extend" || i === "nest"
          ? ((t.selector = se(n)), delete t.params, t)
          : i === "at-root"
            ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(n)
                ? (t.params = de(n, e))
                : ((t.selector = se(n)), delete t.params),
              t)
            : pl(o)
              ? ((t.import = !0), delete t.filename, (t.params = de(n, e)), t)
              : [
                    "namespace",
                    "supports",
                    "if",
                ...
                ? ((n = n.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2")),
                  (n = n.replace(/^(?!if)([^"'\s(]+)(\s+)\(/u, "$1($2")),
                  (t.value = de(n, e)),
                  delete t.params,
                  t)
                : ["media", "custom-media"].includes(o)
                  ? n.includes("#{")
                    ? {
                        type: "media-unknown",
                        value: n,
...
function Js(t, e, s) {
  let { frontMatter: r, content: n } = ge(e),
    i;
  try {
    i = t(n, { map: !1 });
  } catch (o) {
    let { name: u, reason: a, line: l, column: f } = o;
    throw typeof l != "number"
      ? o
      : ma(`${u}: ${a}`, {
          loc: {
            start: {
