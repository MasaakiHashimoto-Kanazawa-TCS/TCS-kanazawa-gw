//#region ../../node_modules/.pnpm/prettier@3.8.1/node_modules/prettier/plugins/graphql.mjs
...
var me =
  (e, t) =>
  (n, i, ...r) =>
    n | 1 && i == null ? void 0 : (t.call(i) ?? i[e]).apply(i, r);
var lt =
    ...
    case "Field":
      return y([
        ...
        i.arguments.length > 0
          ? y(["(", x([l, E([I("", ", "), l], g(e, t, n, "arguments"))]), l, ")"])
          : "",
        _(e, n, i),
        i.selectionSet ? " " : "",
        n("selectionSet"),
...
`,
    ...
    case "InterfaceTypeDefinition": {
      let { kind: r } = i,
        s = [];
      return (
        r.endsWith("TypeDefinition") ? s.push(A(e, t, n)) : s.push("extend "),
        ...
        !r.startsWith("InputObjectType") &&
          ...
          s.push(" implements ", ...kt(e, t, n)),
        s.push(_(e, n, i)),
        i.fields.length > 0 && s.push([" {", x([f, E(f, g(e, t, n, "fields"))]), f, "}"]),
        s
      );
    }
    ...
    case "EnumTypeDefinition":
      return [
        ...
        n("name"),
        _(e, n, i),
        i.values.length > 0 ? [" {", x([f, E(f, g(e, t, n, "values"))]), f, "}"] : "",
      ];
...
function Be(e, t) {
  let { node: n } = e;
  return se(n.variableDefinitions)
    ? y(["(", x([l, E([I("", ", "), l], e.map(t, "variableDefinitions"))]), l, ")"])
    : "";
}
function Ue(e, t) {
  e.kind === "StringValue" &&
...
var Q = class e extends Error {
  constructor(t, ...n) {
    ...
    (super(t),
      ...
      (this.nodes = Qe(Array.isArray(a) ? a : a ? [a] : void 0)));
    let O = Qe(
    ...
    ((this.source = u ?? (O == null || (r = O[0]) === null || r === void 0 ? void 0 : r.source)),
      (this.positions = p ?? O?.map((N) => N.start)),
      (this.locations = p && u ? p.map((N) => M(u, N)) : O?.map((N) => M(N.source, N.start))));
    let re = Xe(d?.extensions) ? d?.extensions : void 0;
    ((this.extensions = (s = D ?? re) !== null && s !== void 0 ? s : Object.create(null)),
...
function Ze(e) {
  ...
  for (let a = 0; a < e.length; ++a) {
    ...
    let u = e[a],
      p = Pt(u);
    p !== u.length &&
      ((i = (s = i) !== null && s !== void 0 ? s : a), (r = a), a !== 0 && p < n && (n = p));
  }
  return e
...
function wt(e, t) {
  ...
  for (; r < i; ) {
    ...
    switch (s) {
      ...
      case 34:
        return n.charCodeAt(r + 1) === 34 && n.charCodeAt(r + 2) === 34 ? Yt(e, r) : Vt(e, r);
    }
...
function Mt(e, t, n) {
  ...
  if ((s === 45 && (s = i.charCodeAt(++r)), s === 48)) {
    if (((s = i.charCodeAt(++r)), b(s)))
      throw h(e.source, r, `Invalid number, unexpected digit after 0: ${R(e, r)}.`);
  } else ((r = le(e, r, s)), (s = i.charCodeAt(r)));
  if (
    (s === 46 && ((a = !0), (s = i.charCodeAt(++r)), (r = le(e, r, s)), (s = i.charCodeAt(r))),
    (s === 69 || s === 101) &&
      ((a = !0),
      (s = i.charCodeAt(++r)),
    ...
    throw h(e.source, r, `Invalid number, expected digit but got: ${R(e, r)}.`);
...
var fe = class {
  constructor(t, n = {}) {
    let { lexer: i, ...r } = n;
    if (i) this._lexer = i;
    else this._lexer = new z(st(t) ? t : new B(t));
  ...
  parseSchemaCoordinate() {
    let t = this._lexer.token,
      n = this.expectOptionalToken(o.AT),
      i = this.parseName(),
      r;
    ...
    return (
      (n || r) &&
        this.expectOptionalToken(o.PAREN_L) &&
        ((s = this.parseName()), this.expectToken(o.COLON), this.expectToken(o.PAREN_R)),
      n
        ? s
          ? this.node(t, {
