...
var Jt =
  (e, t) =>
  (r, s, ...n) =>
    r | 1 && s == null ? void 0 : (t.call(s) ?? s[e]).apply(s, n);
var Mn =
...
var Ot = "string",
  ...
  re = "label",
  xt = "break-parent",
  ne = new Set([$t, kt, Et, Xt, vt, wt, Tt, Zt, te, ee, Q, re, xt]);
function Wn(e) {
...
function rs(e, t) {
  let { preferred: r, alternate: s } = t === !0 || t === "'" ? ts : es,
    { length: n } = e,
    i = 0,
    a = 0;
  for (let o = 0; o < n; o++) {
...
function Yr(e, t = "unexpected unreachable branch") {
  throw (
    Mr.log("unreachable", e),
    Mr.log(`${t} :: ${JSON.stringify(e)} (${e})`),
    /* @__PURE__ */ new Error("code reached unreachable")
  );
}
var Vt = (function () {
  var e = function (X, b, S, y) {
    ...
    t = [2, 52],
    r = [1, 20],
    s = [5, 14, 15, 19, 29, 34, 39, 44, 47, 48, 53, 57, 61],
    n = [1, 44],
    i = [1, 40],
    a = [1, 43],
    o = [1, 33],
    ...
    g = [1, 42],
    E = [1, 46],
    T = [14, 15, 19, 29, 34, 39, 44, 47, 48, 53, 57, 61],
    D = [14, 15, 19, 29, 34, 44, 47, 48, 53, 57, 61],
    B = [15, 18],
    O = [14, 15, 19, 29, 34, 47, 48, 53, 57, 61],
    z = [33, 67, 73, 75, 84, 85, 86, 87, 88, 89],
    P = [23, 33, 56, 67, 68, 73, 75, 77, 79, 84, 85, 86, 87, 88, 89],
    U = [1, 62],
    C = [1, 63],
    $ = [23, 33, 56, 68, 73, 79],
    W = [23, 33, 56, 67, 68, 73, 75, 77, 79, 84, 85, 86, 87, 88, 89, 92, 93],
    Sr = [2, 51],
    kr = [1, 64],
    Er = [67, 73, 75, 77, 84, 85, 86, 87, 88, 89],
    vr = [56, 67, 73, 75, 84, 85, 86, 87, 88, 89],
    wr = [1, 75],
    we = [1, 76],
    Te = [1, 83],
    dt = [33, 67, 73, 75, 79, 84, 85, 86, 87, 88, 89],
    ...
    Ne = {
      ...
      performAction: function (b, S, y, m, w, l, bt) {
        ...
        switch (w) {
          ...
          case 18:
            ...
            break;
          case 19:
            var Z = m.prepareBlock(l[u - 2], l[u - 1], l[u], l[u], !1, this._$),
              Lt = m.prepareProgram([Z], l[u - 1].loc);
            ((Lt.chained = !0),
              (this.$ = {
                strip: l[u - 2].strip,
                program: Lt,
          ...
          case 21:
            ...
            break;
          case 22:
            this.$ = m.prepareMustache(
              m.syntax.hash(l[u - 1], m.locInfo(this._$), {
                yy: m,
                syntax: "expr",
              }),
              [],
      ...
      table: [
        e([5, 14, 15, 19, 29, 34, 48, 53, 57, 61], t, {
          3: 1,
          4: 2,
          6: 3,
        }),
        ...
        e([5, 14, 15, 18, 19, 29, 34, 39, 44, 47, 48, 53, 57, 61], [2, 10]),
        {
          20: 52,
          64: 53,
          65: 38,
        ...
        e(W, [2, 30]),
        e(W, [2, 31]),
        e([23, 33, 56, 67, 68, 73, 75, 79, 84, 85, 86, 87, 88, 89, 92, 93], Sr, { 74: kr }),
        e(P, [2, 49], {
          91: 65,
          92: U,
          93: C,
      ...
      parse: function (b) {
        var S = this,
          ...
          qn = 2,
          Pr = 1,
          Vn = l.slice.call(arguments, 1),
          x = Object.create(this.lexer),
          ot = { yy: {} };
        for (var Pe in this.yy)
          Object.prototype.hasOwnProperty.call(this.yy, Pe) && (ot.yy[Pe] = this.yy[Pe]);
        (x.setInput(b, ot.yy),
          (ot.yy.lexer = x),
          (ot.yy.parser = this),
        ...
        for (
          ...
          if (
            ((lt = y[y.length - 1]),
            this.defaultActions[lt]
              ? (q = this.defaultActions[lt])
              : ((L === null || typeof L > "u") && (L = Hn()), (q = bt[lt] && bt[lt][L])),
            typeof q > "u" || !q.length || !q[0])
          ) {
            var De = "";
            Qt = [];
            for (jt in bt[lt])
              this.terminals_[jt] && jt > qn && Qt.push("'" + this.terminals_[jt] + "'");
            (x.showPosition
              ? (De =
                  "Parse error on line " +
                  (Z + 1) +
...
Expecting ` +
              ...
              : (De =
                  ...
                  (Z + 1) +
                  ": Unexpected " +
                  (L == Pr ? "end of input" : "'" + (this.terminals_[L] || L) + "'")),
              this.parseError(De, {
                text: x.match,
          ...
          if (q[0] instanceof Array && q.length > 1)
            throw new Error(
              "Parse Error: multiple actions possible at state: " + lt + ", token: " + L,
            );
          switch (q[0]) {
            case 1:
              (y.push(L),
            ...
            case 2:
              if (
                ...
                Fn && (yt._$.range = [l[l.length - (j || 1)].range[0], l[l.length - 1].range[1]]),
                (Le = this.performAction.apply(yt, [u, Lt, Z, ot.yy, q[1], w, l].concat(Vn))),
                typeof Le < "u")
              )
                return Le;
              (j &&
                ((y = y.slice(0, -1 * j * 2)), (w = w.slice(0, -1 * j)), (l = l.slice(0, -1 * j))),
                y.push(this.productions_[q[1]][0]),
                w.push(yt.$),
                l.push(yt._$),
                (Cr = bt[y[y.length - 2]][y[y.length - 1]]),
                y.push(Cr));
              break;
            case 3:
              return !0;
    ...
    return {
      ...
      unput: function (b) {
        ...
        return (
          ...
          this.options.ranges && (this.yylloc.range = [w[0], w[0] + this.yyleng - S]),
...
` +
      ...
      next: function () {
        ...
        for (var w = this._currentRules(), l = 0; l < w.length; l++)
          if (((y = this._input.match(this.rules[w[l]])), y && (!S || y[0].length > S[0].length))) {
        ...
        return S
          ? ((b = this.test_match(S, w[m])), b !== !1 ? b : !1)
          : this._input === ""
            ? this.EOF
            : this.parseError(
                "Lexical error on line " +
...
function Ge(e, t) {
  ...
  r &&
    ...
    (a = r.end.column),
    (e += " - " + s + ":" + i));
  for (var o = Error.prototype.constructor.call(this, e), c = 0; c < Ye.length; c++)
    this[Ye[c]] = o[Ye[c]];
...
G.prototype.Program = function (e) {
  ...
  for (var s = e.body, n = 0, i = s.length; n < i; n++) {
    ...
    if (o) {
      var c = Ke(s, n, r),
        h = We(s, n, r),
        f = o.openStandalone && c,
        p = o.closeStandalone && h,
        g = o.inlineStandalone && c && h;
      (o.close && ht(s, n, !0),
        o.open && et(s, n, !0),
        t &&
          g &&
        ...
        t && f && (ht((a.program || a.inverse).body), et(s, n)),
        t && p && (ht(s, n), et((a.inverse || a.program).body)));
    }
  }
  return e;
};
G.prototype.BlockStatement =
  G.prototype.DecoratorBlock =
  G.prototype.PartialBlockStatement =
    function (e) {
      ...
      if ((e.openStrip.close && ht(t.body, null, !0), r)) {
        ...
        (a.open && et(t.body, null, !0),
          a.close && ht(s.body, null, !0),
          e.closeStrip.open && et(n.body, null, !0),
          !this.options.ignoreStandalone && Ke(t.body) && We(s.body) && (et(t.body), ht(s.body)));
...
function he(e, t) {
  ...
  ((Vt.yy = Qr),
    (Vt.yy.locInfo = function (o) {
      return new Qe(t && t.srcName, o);
    }));
  var i;
  typeof ((r = t?.syntax) === null || r === void 0 ? void 0 : r.square) == "function"
    ? (i = t.syntax.square)
    : ((s = t?.syntax) === null || s === void 0 ? void 0 : s.square) === "node"
      ? (i = Es)
      : (i = "string");
  var a;
  return (
    typeof ((n = t?.syntax) === null || n === void 0 ? void 0 : n.hash) == "function"
      ? (a = t.syntax.hash)
      : (a = vs),
    (Vt.yy.syntax = {
      square: i,
        ...
        afterDoctypeName: function () {
          ...
          if (!_(n))
            if (n === ">")
              ...
              var i =
                  n.toUpperCase() + this.input.substring(this.index, this.index + 5).toUpperCase(),
...
(function () {
  function e(t, r) {
    (r === void 0 && (r = {}),
      ...
      (this.startColumn = 0),
      (this.tokens = []),
      (this.tokenizer = new Xe(this, t, r.mode)),
...
var ar = class {
  ...
  Mt = class {
    ...
    locDidUpdate({ start: t, end: r }) {
      (t !== void 0 &&
        (this.updateProvided(t, "start"), (this.hbsPositions.start = new at(this.source, t, null))),
        r !== void 0 &&
          (this.updateProvided(r, "end"), (this.hbsPositions.end = new at(this.source, r, null))));
    }
    asString() {
      let t = this.toCharPosSpan();
  ...
  K = ln((e) =>
    e
      ...
      .when("IS_INVISIBLE", "MATCH_ANY", (t) => new J(t.kind, nt).wrap())
      .when("MATCH_ANY", "IS_INVISIBLE", (t, r) => new J(r.kind, nt).wrap()),
  ),
  it = "BROKEN",
  Pt = class e {
  ...
  at = class {
    constructor(t, r, s = null) {
      ((this.source = t),
        (this.hbsPos = r),
        (this.kind = "HbsPosition"),
        (this._charPos = s === null ? null : new ft(t, s)));
    }
    toCharPos() {
      let t = this._charPos;
      if (t === null) {
  ...
  Rs = ln((e) =>
    e
      ...
      .when("CharPosition", "HbsPosition", ({ offset: t }, r) => t === r.toCharPos()?.offset)
      .when("HbsPosition", "CharPosition", (t, { offset: r }) => t.toCharPos()?.offset === r)
...
function ye(e, t) {
  let r,
    ...
    c = (function (h, f) {
      if (h.Program && ((f === "Template" && !h.Template) || (f === "Block" && !h.Block)))
        return h.Program;
      let p = h[f];
  ...
  if ((c !== void 0 && ((r = cn(c)), (s = un(c))), r !== void 0 && (n = r(i, t)), n != null)) {
    if (JSON.stringify(i) !== JSON.stringify(n))
      return Array.isArray(n) ? (hn(e, n, a, o), n) : ye(e, new Ct(n, a, o)) || n;
    n = void 0;
  }
  if (n === void 0) {
    let h = be[i.type];
...
var Us = {
  ...
  element: function (e, t = {}) {
    ...
    typeof e == "string"
      ? e.endsWith("/")
        ? ((r = rt(e.slice(0, -1))), (s = !0))
        : (r = rt(e))
      : "type" in e
        ? (e.type, e.type, (r = e))
        : "path" in e
          ? (e.path.type, e.path.type, (r = e.path), (s = e.selfClosing))
          : ((r = rt(e.name)), (s = e.selfClosing));
    let g = i?.map((T) => (typeof T == "string" ? rn(T) : T)),
      E = null;
    return (
      f ? (E = v(f)) : f === void 0 && (E = s || Os(r.original) ? null : v(null)),
      d.element({
        path: r,
        selfClosing: s || !1,
        attributes: n || [],
  ...
  d = new (class {
    ...
    mustache({ path: e, params: t, hash: r, trusting: s, loc: n, strip: i = fe }) {
      return (function ({ path: a, params: o, hash: c, trusting: h, strip: f, loc: p }) {
        ...
        return (
          Object.defineProperty(g, "escaped", {
            enumerable: !1,
            get() {
  ...
  cr = class {
    constructor(t, r = new $e($r), s = "precompile") {
      ((this.elementStack = []),
        ...
        (this.tokenizer = new Xe(this, r, s)));
    }
    offset() {
  ...
  ur = class extends cr {
    ...
    BlockStatement(t) {
      ...
      if (t.program.blockParams?.length) {
        ...
        ((p = t.program.loc
          ? p.withEnd(this.source.spanFor(t.program.loc).getStart())
          : t.program.body[0]
            ? p.withEnd(this.source.spanFor(t.program.body[0].loc).getStart())
            : p.withEnd(i.getEnd())),
          (a = an(this.source, t, p)));
        let g = p.asString(),
          E = g.indexOf("|") + 1,
          T = g.indexOf("|", E);
        for (let D of t.program.blockParams) {
          let B, O;
          ((B = E >= T ? -1 : g.indexOf(D, E)),
            B === -1 || B + D.length > T
              ? ((E = T), (O = this.source.spanFor(sr)))
              : ((E = B),
                (O = p.sliceStartChars({
                  skipStart: E,
                  chars: D.length,
    ...
    MustacheStatement(t) {
      ...
      if ("original" in t.path && t.path.original === "...attributes")
        throw k("Illegal use of ...attributes", this.source.spanFor(t.loc));
      if (pn(t.path))
        s = d.mustache({
...
function an(e, t, r) {
  if (!t.program.loc) {
    let n = V(0, t.program.body, 0),
      i = V(0, t.program.body, -1);
    if (n && i)
      t.program.loc = {
        ...n.loc,
        end: i.loc.end,
...
`
            ...
            : i.move(-1)),
          (this.currentAttr.currentPart = d.text({
            chars: t,
            loc: i.collapsed(),
          })));
      }
    ...
    parsePossibleBlockParams() {
      ...
      let r = this.currentStartTag,
        ...
        i = {
          ...
          Error: (o) => {
            if ((n.state, o === "" || o === "/" || o === ">" || Nt(o)))
              throw k(n.message, n.start.until(this.offset()));
            this.tokenizer.consume();
          },
          Done: () => {},
        },
    ...
    validateEndTag(t, r, s) {
      if (de.has(t.name) && !s)
        throw k(`<${t.name}> elements do not need end tags. You should remove it`, t.loc);
...
function mn(e, t = {}) {
  let r,
    ...
    i = t.mode || "precompile";
  (typeof e == "string"
    ? ((r = new pt(e, t.meta?.moduleName)),
      (s = i === "codemod" ? he(e, t.parseOptions) : Je(e, t.parseOptions)))
    : e instanceof pt
      ? ((r = e),
        (s = i === "codemod" ? he(e.source, t.parseOptions) : Je(e.source, t.parseOptions)))
      : ((r = new pt("", t.meta?.moduleName)), (s = e)),
    i === "codemod" && (n = new pr()));
  ...
  if (t.plugins?.ast)
    for (let c of t.plugins.ast) Hs(o, c(ze({}, t, { syntax: Ms }, { plugins: void 0 })).visitor);
  return o;
}
var dn = Ur(be);
var mt = (e) => e.loc.start.offset,
...
function gn(e) {
  return (
    e?.type === "MustacheCommentStatement" &&
...
function js(e, t, r) {
  ...
  switch (s.type) {
    ...
    case "Program":
    case "Template":
      return I(e.map(r, "body"));
    case "ElementNode": {
      let n = t.htmlWhitespaceSensitivity !== "ignore",
        i = [!n && e.previous?.type === "ElementNode" ? H : "", I([Js(e, r)])];
      if (dr(s)) return [i];
      let a = ["</", s.tag, ">"],
        o = s.tag === "style";
    ...
    case "BlockStatement":
      return Pn(e)
        ? [ni(e, r), En(e, t, r), vn(e, t, r)]
        : [ti(e, r), I([En(e, t, r), vn(e, t, r), si(e, t, r)])];
    case "ElementModifierStatement":
      return I(["{{", Tn(e, r), "}}"]);
    case "MustacheStatement":
      return I([ke(s), Tn(e, r), Ee(s)]);
    case "SubExpression":
      return I(["(", ui(e, r), H, ")"]);
    case "AttrNode": {
      let { name: n, value: i } = s,
        a = i.type === "TextNode";
      if (a && i.chars === "" && mt(i) === Gt(i)) return n;
      let c = a
          ? oe(i.chars, t.singleQuote)
          : i.type === "ConcatStatement"
            ? oe(i.parts.map((f) => (f.type === "TextNode" ? f.chars : "")).join(""), t.singleQuote)
            : "",
        h = r("value");
    ...
    case "TextNode": {
      ...
      if (a) {
        if (a === "class") {
          let D = n.trim().split(/\s+/u).join(" "),
            B = !1,
            O = !1;
          return (
            e.parent.type === "ConcatStatement" &&
              (e.previous?.type === "MustacheStatement" && /^\s/u.test(n) && (B = !0),
              e.next?.type === "MustacheStatement" && /\s$/u.test(n) && D !== "" && (O = !0)),
            [B ? N : "", D, O ? N : ""]
          );
        }
        return ie(n);
      }
      let o = R.isWhitespaceOnly(n),
        { isFirst: c, isLast: h } = e;
      if (t.htmlWhitespaceSensitivity !== "ignore") {
        let D = h && e.parent.type === "Template",
          B = c && e.parent.type === "Template";
        if (o) {
          if (B || D) return "";
          let C = [N],
            $ = _t(n);
        ...
        let O = R.getLeadingWhitespace(n),
          z = [];
        if (O) {
          z = [N];
          let C = _t(O);
        ...
        let P = R.getTrailingWhitespace(n),
          U = [];
        if (P) {
          if (!D) {
            U = [N];
      ...
      o && f
        ? ((p = Math.min(f, xn)), (g = 0))
        : ((e.next?.type === "BlockStatement" || e.next?.type === "ElementNode") &&
            (g = Math.max(g, 1)),
          (e.previous?.type === "BlockStatement" || e.previous?.type === "ElementNode") &&
            (p = Math.max(p, 1)));
      let E = "",
        T = "";
      return (
        g === 0 && e.next?.type === "MustacheStatement" && (T = " "),
        p === 0 && e.previous?.type === "MustacheStatement" && (E = " "),
        c && ((p = 0), (E = "")),
        h && ((g = 0), (T = "")),
        R.hasLeadingWhitespace(n) && (n = E + R.trimStart(n)),
        R.hasTrailingWhitespace(n) && (n = R.trimEnd(n) + T),
        [...Kt(p), qe(wn(n)), ...Kt(g)]
      );
    }
    case "MustacheCommentStatement": {
      let n = mt(s),
        i = Gt(s),
        a = t.originalText.charAt(n + 2) === "~",
        o = t.originalText.charAt(i - 3) === "~",
        c = s.value.includes("}}") ? "--" : "";
...
function Js(e, t) {
  let { node: r } = e,
    s = ["attributes", "modifiers", "comments"].filter((i) => Bt(r[i])),
    n = s.flatMap((i) => r[i]).sort(Qs);
  for (let i of s)
    e.each(({ node: a }) => {
      let o = n.indexOf(a);
      n.splice(o, 1, [N, t()]);
...
function ti(e, t) {
  ...
  return (
    n && s.push(I(n)),
    Bt(r.program.blockParams) && s.push(br(r.program)),
    I([Xs(r), gr(e, t), s.length > 0 ? F([N, ct(N, s)]) : "", H, Zs(r)])
  );
}
function ei(e, t) {
  return [t.htmlWhitespaceSensitivity === "ignore" ? ut : "", Nn(e), "else", An(e)];
}
var ri = ({ path: e }, { path: t }) =>
  [e, t].every((r) => r.type === "PathExpression" && r.head.type === "VarHead") &&
  e.head.name === t.head.name;
function Pn(e) {
  if (
    !e.match(
      (r) => r.type === "BlockStatement",
      (r, s) => s === "body" && r.type === "Block" && r.body.length === 1,
      (r, s) => s === "inverse" && r.type === "BlockStatement",
    )
  )
    return !1;
  let { node: t } = e;
  return (
    (t.path.type === "PathExpression" &&
      t.path.head.type === "VarHead" &&
      t.path.head.name === "if") ||
    ri(t, e.grandparent)
  );
}
function ni(e, t) {
  ...
  return I([
    ...
    F([N, I(ve(e, t)), ...(Bt(r.program.blockParams) ? [N, br(r.program)] : [])]),
    H,
    An(s),
  ]);
}
...
function vn(e, t, r) {
  ...
  if (!s.inverse) return "";
  let n = r("inverse"),
    i = t.htmlWhitespaceSensitivity === "ignore" ? [ut, n] : n;
...
function li(e, t) {
  let {
    ...
    s = oe(r, ci(e) ? !t.singleQuote : t.singleQuote);
...
function ve(e, t) {
  ...
  return (
    ...
    r.hash?.pairs.length > 0 && s.push(t("hash")),
    s.length === 0 ? "" : ct(N, s)
  );
}
function br(e) {
...
var hi = /* @__PURE__ */ new Set("!\"#%&'()*+,./;<=>@[\\]^`{|}~"),
  pi = new Set(["true", "false", "null", "undefined"]),
  fi = (e, t) =>
    t === 0 && e.startsWith("@")
      ? !1
      : (t !== 0 && pi.has(e)) ||
        /\s/u.test(e) ||
        /^\d/u.test(e) ||
        Array.prototype.some.call(e, (r) => hi.has(r));
function mi(e) {
  return e.tail.length === 0 && e.original.includes("/")
    ? e.original
    : [e.head.original, ...e.tail].map((r, s) => (fi(r, s) ? `[${r}]` : r)).join(".");
}
var _n = {
  features: {
...
function wi(e) {
  let { frontMatter: t, content: r } = In(e),
    s;
  try {
    s = mn(r, vi);
  } catch (n) {
...
function Ti(e) {
  let { message: t } = e,
    r = t.split(`
`);
  return r.length >= 4 && /^Parse error on line \d+:$/u.test(r[0]) && /^-*\^$/u.test(V(0, r, -2))
    ? V(0, r, -1)
    : r.length >= 4 &&
        /:\s?$/u.test(r[0]) &&
        /^\(error occurred in '.*?' @ line \d+ : column \d+\)$/u.test(V(0, r, -1)) &&
        r[1] === "" &&
        V(0, r, -2) === "" &&
