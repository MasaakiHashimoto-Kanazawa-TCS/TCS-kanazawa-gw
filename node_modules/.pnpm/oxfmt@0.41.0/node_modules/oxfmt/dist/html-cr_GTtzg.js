//#region ../../node_modules/.pnpm/prettier@3.8.1/node_modules/prettier/plugins/html.mjs
...
var ir = (e, t, r) => ks(e, typeof t != "symbol" ? t + "" : t, r),
  xs = (e, t, r) => t.has(e) || Zr("Cannot " + r);
var $e = (e, t, r) => (xs(e, t, "read from private field"), r ? r.call(e) : t.get(e)),
  tn = (e, t, r) =>
    t.has(e)
      ? Zr("Cannot add the same private member more than once")
...
var xe =
  (e, t) =>
  (r, n, ...i) =>
    r | 1 && n == null ? void 0 : (t.call(n) ?? n[e]).apply(n, i);
var As =
    String.prototype.replaceAll ??
    function (e, t) {
      return e.global ? this.replace(e, t) : this.split(e).join(t);
    },
  w = xe("replaceAll", function () {
    if (typeof this == "string") return As;
  });
function Ns(e) {
  return this[e < 0 ? this.length + e : e];
}
var F = xe("at", function () {
...
var Ye = "string",
  ...
  Oe = "indent-if-break",
  Ct = "line-suffix",
  vt = "line-suffix-boundary",
  Y = "line",
  Tt = "label",
  De = "break-parent",
  bt = new Set([St, Ae, ye, Et, Ne, Le, Pe, Oe, Ct, vt, Y, Tt, De]);
function Os(e) {
...
function Hs(e, t) {
  let { preferred: r, alternate: n } = t === !0 || t === "'" ? Fs : qs,
    { length: i } = e,
    s = 0,
    a = 0;
  for (let o = 0; o < i; o++) {
...
var lr = class {
  ...
  split(t, r = !1) {
    let n = `[${or([...this.#e].join(""))}]+`,
      i = new RegExp(r ? `(${n})` : n, "u");
    return t.split(i);
  }
...
var Ws = new Set([
  ...
  Gs = new Set(["if", "else if", "for", "switch", "case"]);
function fn(e, t, r) {
  ...
  if ((e.kind === "yaml" && delete t.value, e.kind === "attribute")) {
    ...
    n === "style" ||
    n === "class" ||
    (n === "srcset" && (r.fullName === "img" || r.fullName === "source")) ||
    (n === "allow" && r.fullName === "iframe") ||
    n.startsWith("on") ||
    n.startsWith("@") ||
    n.startsWith(":") ||
    n.startsWith(".") ||
    n.startsWith("#") ||
    n.startsWith("v-") ||
    (n === "vars" && r.fullName === "style") ||
    ((n === "setup" || n === "generic") && r.fullName === "script") ||
    n === "slot-scope" ||
    n.startsWith("(") ||
    n.startsWith("[") ||
    n.startsWith("*") ||
  ...
  if (
    (e.kind === "docType" && (t.value = w(0, e.value.toLowerCase(), /\s+/gu, " ")),
    e.kind === "angularControlFlowBlock" && e.parameters?.children)
  )
    for (let n of t.parameters.children)
      Gs.has(e.name) ? delete n.expression : (n.expression = n.expression.trim());
  ...
  return (
    ...
    (r.type === "ObjectExpression" ||
      ...
      ((t.parser === "__vue_expression" ||
        ...
        t.parser === "__ng_binding" ||
        t.parser === "__ng_directive") &&
...
function $s(e, t, r, n) {
  let { node: i } = r,
    s = n.originalText.slice(i.sourceSpan.start.offset, i.sourceSpan.end.offset);
  return /^\s*$/u.test(s)
    ? ""
    : x(
        s,
...
function vn(e, t) {
  ...
  return (
    e.find(({ filenames: n }) => n?.some((i) => i.toLowerCase() === r)) ??
    e.find(({ extensions: n }) => n?.some((i) => r.endsWith(i)))
  );
}
function Zs(e, t) {
  if (t)
...
function Nt(e, t) {
  return !!(
    (e.kind === "ieConditionalComment" &&
      e.lastChild &&
      !e.lastChild.isSelfClosing &&
      !e.lastChild.endSourceSpan) ||
    (e.kind === "ieConditionalComment" && !e.complete) ||
    (pe(e) && e.children.some((r) => r.kind !== "text" && r.kind !== "interpolation")) ||
    (Ot(e, t) && !H(e, t) && e.kind !== "interpolation")
  );
}
function he(e) {
...
function H(e, t) {
  return (
    ...
    (e.fullName === "script" ||
      ...
      (ue(e) && (e.name === "script" || e.name === "style")))
  );
}
function xn(e, t) {
...
function yn(e, t) {
  ...
  function n() {
    return ce(e) || e.kind === "angularControlFlowBlock"
      ? !1
      : (e.kind === "text" || e.kind === "interpolation") &&
          e.prev &&
          (e.prev.kind === "text" || e.prev.kind === "interpolation")
        ? !0
            ...
            : !(
                (!e.prev &&
                  (e.parent.kind === "root" ||
                    ...
                    H(e.parent, t) ||
                    Je(e.parent, t) ||
                    !ma(e.parent.cssDisplay))) ||
                (e.prev && !ga(e.prev.cssDisplay))
              );
  }
}
function Nn(e, t) {
  return ce(e) || e.kind === "angularControlFlowBlock"
    ...
    : (e.kind === "text" || e.kind === "interpolation") &&
        e.next &&
        (e.next.kind === "text" || e.next.kind === "interpolation")
      ? !0
      : !e.parent || e.parent.cssDisplay === "none"
        ? !1
        : pe(e.parent)
          ...
          : !(
              (!e.next &&
                (e.parent.kind === "root" ||
                  ...
                  H(e.parent, t) ||
                  Je(e.parent, t) ||
                  !fa(e.parent.cssDisplay))) ||
              (e.next && !da(e.next.cssDisplay))
            );
}
function Ln(e, t) {
...
function Pn(e) {
  return (
    ...
    (e.kind === "element" &&
      e.children.length > 0 &&
      (["body", "script", "style"].includes(e.name) || e.children.some((t) => ca(t)))) ||
    (e.firstChild &&
      e.firstChild === e.lastChild &&
      e.firstChild.kind !== "text" &&
      Dn(e.firstChild) &&
      (!e.lastChild.isTrailingSpaceSensitive || In(e.lastChild)))
  );
}
function gr(e) {
  return (
...
function Bn(e, t) {
  ...
  if (e.kind === "element" && e.namespace === "svg")
    if (Sa(e, (n) => n.fullName === "svg:foreignObject")) r = !0;
  ...
  switch (t.htmlWhitespaceSensitivity) {
    ...
    default:
      if (
        e.kind === "element" &&
        (!e.namespace || r || ue(e)) &&
        Object.prototype.hasOwnProperty.call(hr, e.name)
      )
        return hr[e.name];
  }
  return bn;
...
function Fn(e) {
  return e.kind === "element" &&
    (!e.namespace || ue(e)) &&
    Object.prototype.hasOwnProperty.call(mr, e.name)
    ? mr[e.name]
    : wn;
}
function Sr(e) {
...
var Ea = new Set(["template", "style", "script"]);
function Je(e, t) {
...
function Rt(e, t) {
  ...
  let { value: r } = e;
  return (
    /^PRETTIER_HTML_PLACEHOLDER_\d+_\d+_IN_JS$/u.test(r) ||
    (t.parser === "lwc" && r.startsWith("{") && r.endsWith("}"))
  );
}
var Vn = /\{\{(.+?)\}\}/su,
  Un = ({ node: { value: e } }) => Vn.test(e);
async function Wn(e, t, r) {
  let n = b(r.node),
    i = [];
  for (let [s, a] of n.split(Vn).entries())
    if (s % 2 === 0) i.push(L(a));
    else
      try {
        i.push(
    ...
    },
    {
      test(e) {
        ...
        return (
          ...
          /^bind(?:on)?-/u.test(t) ||
          /^ng-(?:if|show|hide|class|style)$/u.test(t)
        );
      },
...
var $n = ({ node: e }, t) => !t.parentParser && e.fullName === "class" && !e.value.includes("{{"),
  zn = (e, t, r) => b(r.node).trim().split(/\s+/u).join(" ");
var wa = new Set([
    "onabort",
    "onafterprint",
    "onauxclick",
  ...
  Yn = ({ node: e }, t) => wa.has(e.fullName) && !t.parentParser && !e.value.includes("{{"),
  jn = (e, t, r) =>
    x(
      b(r.node),
      e,
...
function Pa(e) {
  ...
  function d() {
    for (u(xa), i = "", s = "in descriptor"; ; ) {
      if (((a = e.charAt(o)), s === "in descriptor"))
        if (Jn(a)) i && (n.push(i), (i = ""), (s = "after descriptor"));
        else if (a === ",") {
          ((o += 1), i && n.push(i), S());
          return;
        ...
        if (a === ")") ((i += a), (s = "in descriptor"));
        else if (a === "") {
          (n.push(i), S());
          return;
        } else i += a;
      else if (s === "after descriptor" && !Jn(a))
        if (a === "") {
          S();
          return;
  ...
  function S() {
    ...
    for (z = 0; z < n.length; z++)
      ((ee = n[z]),
        (_t = ee[ee.length - 1]),
        (ke = ee.substring(0, ee.length - 1)),
        (Ge = parseInt(ke, 10)),
        (nr = parseFloat(ke)),
        Zn.test(ke) && _t === "w"
          ? ((g || E) && (m = !0), Ge === 0 ? (m = !0) : (g = Ge))
          : La.test(ke) && _t === "x"
            ? ((g || E || P) && (m = !0), nr < 0 ? (m = !0) : (E = nr))
            : Zn.test(ke) && _t === "h"
              ? ((P || E) && (m = !0), Ge === 0 ? (m = !0) : (P = Ge))
              : (m = !0));
    if (!m)
      ((le.source = {
        value: r,
...
var ei = Pa;
var ti = (e) =>
    e.node.fullName === "srcset" && (e.parent.fullName === "img" || e.parent.fullName === "source"),
  ri = {
    width: "w",
    height: "h",
    density: "x",
...
function ni(e, t, r) {
  let i = ei(b(r.node)),
    s = Oa.filter((m) => i.some((g) => Object.prototype.hasOwnProperty.call(g, m)));
  if (s.length > 1) throw new Error("Mixed descriptor in srcset is not supported");
  let [a] = s,
    o = ri[a],
    c = i.map((m) => m.source.value),
    u = Math.max(...c.map((m) => m.length)),
    p = i.map((m) => (m[a] ? String(m[a].value) : "")),
    d = p.map((m) => {
      let g = m.indexOf(".");
...
function Da(e, t) {
  ...
  return (
    vr.has(r) ||
      vr.set(
        r,
        r.children.some((n) => It(n, t) && ["ts", "typescript"].includes(n.attrMap.lang)),
      ),
    vr.get(r)
  );
}
...
async function li(e, t, r, n) {
  let { left: s, operator: a, right: o } = Ia(b(r.node)),
    c = G(r, n);
  return [
    C(
      await x(`function _(${s}) {}`, e, {
...
function Ia(e) {
  ...
  let s = { for: i[3].trim() };
  if (!s.for) return;
  let a = w(0, i[1].trim(), n, ""),
    o = a.match(r);
  o
    ? ((s.alias = a.replace(r, "")),
      (s.iterator1 = o[1].trim()),
      o[2] && (s.iterator2 = o[2].trim()))
    : (s.alias = a);
  let c = [s.alias, s.iterator1, s.iterator2];
  if (!c.some((u, p) => !u && (p === 0 || c.slice(p + 1).some(Boolean))))
    return {
...
var Ra = [
  ...
  {
    test: (e, t) => e.node.fullName === "generic" && It(e.parent, t),
    print: ai,
  },
  {
...
async function Ma(e, t, r, n) {
  ...
  return x(b(r.node), e, { parser: G(r, n) ? "__vue_ts_event_binding" : "__vue_event_binding" }, W);
}
function Ba(e, t, r, n) {
  return x(b(r.node), e, { parser: G(r, n) ? "__vue_ts_expression" : "__vue_expression" }, W);
}
function ci(e, t, r, n) {
  return x(b(r.node), e, { parser: G(r, n) ? "__ts_expression" : "__js_expression" }, W);
}
var Fa = [
  {
    test: ti,
...
function Ha(e) {
  return async (t, r, n, i) => {
    ...
    if (s)
      return (
        (s = ar(s, (a) => (typeof a == "string" ? w(0, a, '"', "&quot;") : a))),
        [n.node.rawName, '="', C(s), '"']
      );
  };
}
...
function Ga(e, t, r) {
  ...
  let i = n.prev?.kind === "comment" && Wa(n.prev.value),
    s =
      typeof i == "boolean" ? () => i : Array.isArray(i) ? (d) => i.includes(d.rawName) : () => !1,
    a = e.map(({ node: d }) => (s(d) ? L(t.originalText.slice(Q(d), te(d))) : r()), "attrs"),
    o =
      n.kind === "element" &&
      n.fullName === "script" &&
      n.attrs.length === 1 &&
      ...
      n.children.length === 0,
    u = t.singleAttributePerLine && n.attrs.length > 1 && !me(n, t) ? v : _,
    p = [A([o ? " " : _, q(u, a)])];
  return (
    (n.firstChild && tt(n.firstChild)) || (n.isSelfClosing && ge(n.parent)) || o
      ? p.push(n.isSelfClosing ? " " : "")
      : p.push(t.bracketSameLine ? (n.isSelfClosing ? " " : "") : n.isSelfClosing ? _ : k),
    p
  );
}
function $a(e) {
...
function za(e, t) {
  ...
  return (
    e.lastChild && _e(e.lastChild)
      ? (n += Mt(e, t).length)
      : ge(e) && (n -= de(e.lastChild, t).length),
    t.originalText.slice(r, n)
  );
}
var qt = za;
var Ya = new Set(["if", "else if", "for", "switch", "case"]);
function ja(e, t) {
  let { node: r } = e;
  switch (r.kind) {
    case "element":
          ...
          ? async (i, s) => {
              ...
              return (
                o ||
                  ...
                  (o = c === "")),
                [U(r, t), C(rt(e, t, s)), o ? "" : v, c, o ? "" : v, Ze(r, t), V(r, t)]
              );
            }
          : void 0;
      }
    ...
    case "text":
      if (H(r.parent, t)) {
        ...
        if (n)
          return async (i) => {
            let s =
                n === "markdown" ? y.dedentString(r.value.replace(/^[^\S\n]*\n/u, "")) : r.value,
              a = {
                parser: n,
                __embeddedInHtml: !0,
              };
            if (t.parser === "html" && n === "babel") {
              ...
              (c &&
                (c.type === "module" ||
                  ((c.type === "text/babel" || c.type === "text/jsx") &&
                    c["data-type"] === "module")) &&
                (o = "module"),
        ...
        return async (n) => {
          ...
          return (
            t.parser === "angular"
              ? (i.parser = "__ng_interpolation")
              : t.parser === "vue"
                ? (i.parser = G(e, t) ? "__vue_ts_expression" : "__vue_expression")
                : (i.parser = "__js_expression"),
            [A([_, await n(r.value, i)]), r.parent.next && $(r.parent.next) ? " " : _]
          );
        };
      break;
    case "attribute":
...
function Ka(e, t = "type") {
  ...
  function r(n) {
    let i = n[t],
      s = e[i];
    if (!Array.isArray(s))
      throw Object.assign(/* @__PURE__ */ new Error(`Missing visitor keys for '${i}'.`), {
        node: n,
      });
    return s;
  }
...
function ki(e) {
  let t = te(e);
  return e.kind === "element" && !e.endSourceSpan && Ie(e.children)
    ? Math.max(t, ki(F(0, e.children, -1)))
    : t;
}
function st(e, t, r) {
  let n = e.node;
      ...
      L(
        y.trimEnd(
          t.originalText.slice(
            Q(n) + (n.prev && et(n.prev) ? Bt(n).length : 0),
            i - (n.next && $(n.next) ? de(n, t).length : 0),
          ),
        ),
      ),
      V(n, t),
  ...
  return O(e) && O(t)
    ...
    : (et(e) &&
          (he(t) ||
            t.firstChild ||
            t.isSelfClosing ||
            (t.kind === "element" && t.attrs.length > 0))) ||
        (e.kind === "element" && e.isSelfClosing && $(t))
      ? ""
...
function Re(e, t, r) {
  ...
  return e.map(({ node: s, index: a }) => {
    ...
    let o = [],
      ...
      u = [],
      p = [],
      d = s.prev ? Ht(s.prev, s) : "",
      S = s.next ? Ht(s, s.next) : "";
    return (
      d &&
        (Ke(s.prev)
          ? o.push(v, v)
...
function xi(e, t, r) {
  ...
  if (
    (eo(e) && i.push("} "),
    i.push("@", n.name),
    n.parameters && i.push(" (", C(r("parameters")), ")"),
    !Za(n))
  ) {
    i.push(" {");
    let s = Ai(n);
...
var Ja = (e) =>
  e?.kind === "angularControlFlowBlock" && (e.name === "case" || e.name === "default");
function Za(e) {
...
function Ni(e, t, r) {
  ...
  return [
    ...
    C([
      ...
      ", ",
      n.type,
      n.cases.length > 0 ? [",", A([_, q(_, e.map(r, "cases"))])] : "",
      k,
    ]),
    fe(n, t),
  ];
    ...
    C([
      A([
        ...
        e.map(({ node: i, isLast: s }) => {
          ...
          return (
            i.kind === "text" &&
              (i.hasLeadingSpaces && a.unshift(_), i.hasTrailingSpaces && !s && a.push(_)),
            a
          );
        }, "expression"),
      ]),
...
function Pi(e, t, r) {
  ...
  let i =
    ...
    s = Symbol("element-attr-group-id"),
    a = (p) => C([C(rt(e, t, r), { id: s }), p, Ze(n, t)]),
    o = (p) =>
      i
        ? ln(p, { groupId: s })
        : (H(n, t) || Je(n, t)) &&
    ...
    u = () =>
      (n.next ? $(n.next) : ge(n.parent))
        ...
        : i
          ...
          : n.lastChild.hasTrailingSpaces && n.lastChild.isTrailingSpaceSensitive
            ? _
            : (n.lastChild.kind === "comment" ||
                  (n.lastChild.kind === "text" &&
                    n.isWhitespaceSensitive &&
                    n.isIndentationSensitive)) &&
                new RegExp(`\\n[\\t ]{${t.tabWidth * (e.ancestors.length - 1)}}$`, "u").test(
                  n.lastChild.value,
                )
              ? ""
              : k;
...
function Ar() {
  return (
    Vt ||
      ((Vt = {}),
      ot(re.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]),
      ot(re.STYLE, ["*|style"]),
      ot(re.URL, [
        "*|formAction",
        "area|href",
...
var ro = "boolean",
  ...
  oo = Array.from(Ii).reduce((e, [t, r]) => (e.set(t, r), e), /* @__PURE__ */ new Map()),
  Ri = class extends Di {
    constructor() {
      (super(),
    ...
    hasProperty(e, t, r) {
      if (r.some((n) => n.name === xr.name)) return !0;
      if (e.indexOf("-") > -1) {
    ...
    hasElement(e, t) {
      return t.some((r) => r.name === xr.name) ||
        (e.indexOf("-") > -1 && (br(e) || wr(e) || t.some((r) => r.name === kr.name)))
        ? !0
...
var f = class {
    constructor({
      ...
      ((this.closedByChildren = {}),
        ...
        e && e.length > 0 && e.forEach((c) => (this.closedByChildren[c] = !0)),
        (this.isVoid = i),
...
function Be(e) {
  return (
    lt ||
      ...
      new Ri().allKnownElementNames().forEach((t) => {
        !lt[t] && Me(t) === null && (lt[t] = new f({ canSelfClose: !1 }));
      })),
    lt[e] ?? Mi
  );
}
...
function Wt(e, t, r = null) {
  let n = [],
    i = e.visit ? (s) => e.visit(s, r) || s.visit(e, r) : (s) => s.visit(e, r);
  return (
    t.forEach((s) => {
      let a = i(s);
      a && n.push(a);
    ...
    constructor(e, t, r) {
      ((this._getTagContentType = t),
        ...
        (this._leadingTriviaCodePoints =
          r.leadingTriviaChars && r.leadingTriviaChars.map((i) => i.codePointAt(0) || 0)),
      ...
      ((this._cursor = r.escapedString ? new Uo(e, n) : new is(e, n)),
...
`,
    ...
    _getBlockName() {
      ...
      return (
        this._attemptCharCodeUntilFn((r) => (ct(r) ? !e : Ho(r) ? ((e = !0), !1) : !0)),
    ...
    _consumeBlockStart(e) {
      ...
      this._attemptCharCode(123)
        ? (this._beginToken(l.BLOCK_OPEN_END), this._endToken([]))
        : this._isBlockStart() && (t.parts[0] === "case" || t.parts[0] === "default")
          ? (this._beginToken(l.BLOCK_OPEN_END),
            this._endToken([]),
            this._beginToken(l.BLOCK_CLOSE),
            this._endToken([]))
          : (t.type = l.INCOMPLETE_BLOCK_OPEN);
    }
    _consumeBlockEnd(e) {
    ...
    _consumeLetDeclaration(e) {
      if ((this._requireStr("@let"), this._beginToken(l.LET_START, e), ct(this._cursor.peek())))
        this._attemptCharCodeUntilFn(T);
      else {
      ...
      (this._attemptCharCodeUntilFn((r) => T(r) && !pt(r)),
        this._consumeLetDeclarationValue(),
        this._cursor.peek() === 59
          ? (this._beginToken(l.LET_END), this._endToken([]), this._cursor.advance())
          : ((t.type = l.INCOMPLETE_LET), (t.sourceSpan = this._cursor.getSpan(e))));
    }
    ...
    _consumeLetDeclarationValue() {
      ...
      for (this._beginToken(l.LET_VALUE, e); this._cursor.peek() !== 0; ) {
        ...
        (Ut(t) &&
          (this._cursor.advance(),
          this._attemptCharCodeUntilFn((r) => (r === 92 ? (this._cursor.advance(), !1) : r === t))),
          this._cursor.advance());
      }
    ...
    _tokenizeExpansionForm() {
      ...
      if (Fo(this._cursor.peek()) && this._isInExpansionForm())
    ...
    handleError(e) {
      if (
        (e instanceof Vr && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))),
        e instanceof ne)
      )
        this.errors.push(e);
      else throw e;
    ...
    _attemptCharCodeCaseInsensitive(e) {
      return qo(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
    }
    _requireCharCode(e) {
      let t = this._cursor.clone();
      ...
      for (;;) {
        ...
        e && this._cursor.peek() === 38
          ? (this._endToken([this._processCarriageReturns(r.join(""))]),
            (r.length = 0),
            this._consumeEntity(l.ESCAPABLE_RAW_TEXT),
            this._beginToken(l.ESCAPABLE_RAW_TEXT))
          : r.push(this._readChar());
      }
      this._endToken([this._processCarriageReturns(r.join(""))]);
    }
    _consumeComment(e) {
      (this._beginToken(l.COMMENT_START, e),
        this._endToken([]),
        this._consumeRawText(!1, () => this._attemptStr("-->")),
        this._beginToken(l.COMMENT_END),
        this._requireStr("-->"),
        this._endToken([]));
    }
    ...
    _consumeCdata(e) {
      (this._beginToken(l.CDATA_START, e),
        this._endToken([]),
        this._consumeRawText(!1, () => this._attemptStr("]]>")),
        this._beginToken(l.CDATA_END),
        this._requireStr("]]>"),
        this._endToken([]));
    }
    _consumeDocType(e) {
      (this._beginToken(l.DOC_TYPE_START, e),
        this._endToken([]),
        this._consumeRawText(!1, () => this._cursor.peek() === 62),
        this._beginToken(l.DOC_TYPE_END),
        this._cursor.advance(),
        this._endToken([]));
    }
    _consumePrefixAndName(e) {
      ...
      (this._cursor.peek() === 58
        ? ((r = this._cursor.getChars(t)), this._cursor.advance(), (n = this._cursor.clone()))
        : (n = t),
        this._requireCharCodeUntilFn(e, r === "" ? 0 : 1));
      let i = this._cursor.getChars(n);
      return [r, i];
    }
    _consumeTagOpen(e) {
      let t,
        ...
        s = [];
      try {
        if (this._selectorlessEnabled && zt(this._cursor.peek()))
          ((i = this._consumeComponentOpenStart(e)),
            ([n, r, t] = i.parts),
            r && (n += `:${r}`),
            t && (n += `:${t}`),
            this._attemptCharCodeUntilFn(T));
        else {
          if (!Fe(this._cursor.peek()))
        ...
        if (o instanceof ne) {
          i
            ? (i.type =
                i.type === l.COMPONENT_OPEN_START
                  ? l.INCOMPLETE_COMPONENT_OPEN
                  : l.INCOMPLETE_TAG_OPEN)
            : (this._beginToken(l.TEXT, e), this._endToken(["<"]));
          return;
        }
        throw o;
      }
      if (this._canSelfClose && this.tokens[this.tokens.length - 1].type === l.TAG_OPEN_END_VOID)
        return;
      let a = this._getTagContentType(t, r, this._fullNameStack.length > 0, s);
      (this._handleFullNameStackForTagOpen(r, t),
        a === R.RAW_TEXT
          ? this._consumeRawTextWithTagClose(r, i, n, !1)
          : a === R.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(r, i, n, !0));
    }
    _consumeRawTextWithTagClose(e, t, r, n) {
      (this._consumeRawText(n, () =>
        ...
        (this._attemptCharCodeUntilFn(T),
        !this._attemptStrCaseInsensitive(e && t.type !== l.COMPONENT_OPEN_START ? `${e}:${r}` : r))
          ? !1
          : (this._attemptCharCodeUntilFn(T), this._attemptCharCode(62)),
      ),
        this._beginToken(t.type === l.COMPONENT_OPEN_START ? l.COMPONENT_CLOSE : l.TAG_CLOSE),
        this._requireCharCodeUntilFn((i) => i === 62, 3),
        this._cursor.advance(),
    ...
    _consumeComponentName() {
      ...
      return (
        this._cursor.peek() === 58 &&
          (this._cursor.advance(), ([r, n] = this._consumePrefixAndName(we))),
        [t, r, n]
      );
    }
    _consumeAttribute() {
      ...
      return (
        ...
        this._attemptCharCode(61) &&
          (this._attemptCharCodeUntilFn(T), (r = this._consumeAttributeValue())),
        this._attemptCharCodeUntilFn(T),
        {
          prefix: e,
          name: t,
    ...
    _consumeAttributeValue() {
      ...
      if (this._cursor.peek() === 39 || this._cursor.peek() === 34) {
        ...
        ((e = this._consumeWithInterpolation(l.ATTR_VALUE_TEXT, l.ATTR_VALUE_INTERPOLATION, r, r)),
          this._consumeQuote(t));
      } else {
    ...
    _consumeTagClose(e) {
      ...
      if (
        (this._beginToken(l.TAG_CLOSE, e),
        this._attemptCharCodeUntilFn(T),
    ...
    _consumeExpansionFormStart() {
      (this._beginToken(l.EXPANSION_FORM_START),
        this._requireCharCode(123),
        this._endToken([]),
        this._expansionCaseStack.push(l.EXPANSION_FORM_START),
        this._beginToken(l.RAW_TEXT));
    ...
    _consumeExpansionCaseStart() {
      ...
      (this._endToken([e]),
        this._attemptCharCodeUntilFn(T),
        this._beginToken(l.EXPANSION_CASE_EXP_START),
        this._requireCharCode(123),
        this._endToken([]),
        this._attemptCharCodeUntilFn(T),
        this._expansionCaseStack.push(l.EXPANSION_CASE_EXP_START));
    }
    _consumeExpansionCaseEnd() {
      (this._beginToken(l.EXPANSION_CASE_EXP_END),
    ...
    _consumeExpansionFormEnd() {
      (this._beginToken(l.EXPANSION_FORM_END),
        this._requireCharCode(125),
        this._endToken([]),
        this._expansionCaseStack.pop());
    }
    _consumeWithInterpolation(e, t, r, n) {
      ...
      for (; !r(); ) {
        ...
        this._attemptStr(ft.start)
          ? (this._endToken([this._processCarriageReturns(i.join(""))], a),
            (i.length = 0),
    ...
    _consumeDirective(e, t) {
      for (this._requireCharCode(64), this._cursor.advance(); es(this._cursor.peek()); )
        this._cursor.advance();
      ...
      if ((this._endToken([r]), this._attemptCharCodeUntilFn(T), this._cursor.peek() === 40)) {
        for (
          this._openDirectiveCount++,
            this._beginToken(l.DIRECTIVE_OPEN),
            this._cursor.advance(),
            this._endToken([]),
            this._attemptCharCodeUntilFn(T);
          !ts(this._cursor.peek()) && this._cursor.peek() !== 41;
        )
          this._consumeAttribute();
        if (
          (this._attemptCharCodeUntilFn(T), this._openDirectiveCount--, this._cursor.peek() !== 41)
        ) {
          if (this._cursor.peek() === 62 || this._cursor.peek() === 47) return;
          throw this._createError(be(this._cursor.peek()), this._cursor.getSpan(e));
        }
        (this._beginToken(l.DIRECTIVE_CLOSE),
          this._cursor.advance(),
          this._endToken([]),
          this._attemptCharCodeUntilFn(T));
      }
    ...
    _isInExpansionCase() {
      return (
        ...
        this._expansionCaseStack[this._expansionCaseStack.length - 1] === l.EXPANSION_CASE_EXP_START
      );
    }
    _isInExpansionForm() {
      return (
        this._expansionCaseStack.length > 0 &&
        this._expansionCaseStack[this._expansionCaseStack.length - 1] === l.EXPANSION_FORM_START
      );
    }
    isExpansionFormStart() {
      if (this._cursor.peek() !== 123) return !1;
      let e = this._cursor.clone(),
        t = this._attemptStr(ft.start);
...
function Vo(e) {
  ...
  for (let n = 0; n < e.length; n++) {
    let i = e[n];
    (r && r.type === l.TEXT && i.type === l.TEXT) ||
    (r && r.type === l.ATTR_VALUE_TEXT && i.type === l.ATTR_VALUE_TEXT)
      ? ((r.parts[0] += i.parts[0]), (r.sourceSpan.end = i.sourceSpan.end))
      : ((r = i), t.push(r));
  }
  return t;
}
var is = class Br {
    ...
    advanceState(t) {
      if (t.offset >= this.end)
        throw ((this.state = t), new Vr('Unexpected character "EOF"', this));
  ...
  Uo = class Fr extends is {
    ...
    decodeHexDigits(t, r) {
      let n = this.input.slice(t.internalState.offset, t.internalState.offset + r),
        i = parseInt(n, 16);
      if (isNaN(i))
        throw ((t.state = t.internalState), new Vr("Invalid hexadecimal escape sequence", t));
      return i;
    }
  },
...
var N = class os extends ne {
  ...
  ls = class {
    ...
    parse(e, t, r, n = !1, i) {
      let s =
          ...
          (g, ...E) =>
            m(g.toLowerCase(), ...E),
        a = n ? this.getTagDefinition : s(this.getTagDefinition),
        o = (m) => a(m).getContentType(),
        c = n ? i : s(i),
        u = ns(
          e,
          t,
  ...
  Go = class cs {
    constructor(t, r, n, i, s) {
      ((this.tokens = t),
        (this.tagDefinitionResolver = r),
        (this.canSelfClose = n),
        (this.allowHtmComponentClosingTags = i),
    ...
    build() {
      for (; this._peek.type !== l.EOF; )
        this._peek.type === l.TAG_OPEN_START || this._peek.type === l.INCOMPLETE_TAG_OPEN
          ? this._consumeElementStartTag(this._advance())
          : this._peek.type === l.TAG_CLOSE
            ? (this._closeVoidElement(), this._consumeElementEndTag(this._advance()))
            : this._peek.type === l.CDATA_START
              ? (this._closeVoidElement(), this._consumeCdata(this._advance()))
              : this._peek.type === l.COMMENT_START
                ? (this._closeVoidElement(), this._consumeComment(this._advance()))
                : this._peek.type === l.TEXT ||
                    this._peek.type === l.RAW_TEXT ||
                    this._peek.type === l.ESCAPABLE_RAW_TEXT
                  ? (this._closeVoidElement(), this._consumeText(this._advance()))
                  : this._peek.type === l.EXPANSION_FORM_START
                    ? this._consumeExpansion(this._advance())
                    : this._peek.type === l.BLOCK_OPEN_START
                      ? (this._closeVoidElement(), this._consumeBlockOpen(this._advance()))
                      : this._peek.type === l.BLOCK_CLOSE
                        ? (this._closeVoidElement(), this._consumeBlockClose(this._advance()))
                        : this._peek.type === l.INCOMPLETE_BLOCK_OPEN
                          ? (this._closeVoidElement(),
                            this._consumeIncompleteBlock(this._advance()))
                          : this._peek.type === l.LET_START
                            ? (this._closeVoidElement(), this._consumeLet(this._advance()))
                            : this._peek.type === l.DOC_TYPE_START
                              ? this._consumeDocType(this._advance())
                              : this._peek.type === l.INCOMPLETE_LET
                                ? (this._closeVoidElement(),
                                  this._consumeIncompleteLet(this._advance()))
                                : this._peek.type === l.COMPONENT_OPEN_START ||
                                    this._peek.type === l.INCOMPLETE_COMPONENT_OPEN
                                  ? this._consumeComponentStartTag(this._advance())
                                  : this._peek.type === l.COMPONENT_CLOSE
                                    ? this._consumeComponentEndTag(this._advance())
                                    : this._advance();
      for (let t of this._containerStack)
        t instanceof ve &&
          this.errors.push(N.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`));
    }
    _advance() {
      let t = this._peek;
      return (
    ...
    _consumeCdata(t) {
      let r = this._advance(),
        n = this._getText(r),
        i = this._advanceIf(l.CDATA_END);
      this._addToParent(new Vi(n, new h(t.sourceSpan.start, (i || r).sourceSpan.end), [r]));
    }
    _consumeComment(t) {
      let r = this._advanceIf(l.RAW_TEXT),
        n = this._advanceIf(l.COMMENT_END),
        i = r != null ? r.parts[0].trim() : null,
        s =
          n == null
            ? t.sourceSpan
            : new h(t.sourceSpan.start, n.sourceSpan.end, t.sourceSpan.fullStart);
      this._addToParent(new $i(i, s));
    }
    _consumeDocType(t) {
      let r = this._advanceIf(l.RAW_TEXT),
        n = this._advanceIf(l.DOC_TYPE_END),
        i = r != null ? r.parts[0].trim() : null,
        s = new h(t.sourceSpan.start, (n || r || t).sourceSpan.end);
    ...
    _parseExpansionCase() {
      let t = this._advance();
      if (this._peek.type !== l.EXPANSION_CASE_EXP_START)
        return (
          this.errors.push(
            N.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'."),
          ),
      ...
      let a = new h(t.sourceSpan.start, i.sourceSpan.end, t.sourceSpan.fullStart),
        o = new h(r.sourceSpan.start, i.sourceSpan.end, r.sourceSpan.fullStart);
      return new Wi(t.parts[0], s.rootNodes, a, t.sourceSpan, o);
    }
    _collectExpansionExpTokens(t) {
      let r = [],
        n = [l.EXPANSION_CASE_EXP_START];
      for (;;) {
        if (
          ((this._peek.type === l.EXPANSION_FORM_START ||
            this._peek.type === l.EXPANSION_CASE_EXP_START) &&
            n.push(this._peek.type),
          this._peek.type === l.EXPANSION_CASE_EXP_END)
        )
          if (ss(n, l.EXPANSION_CASE_EXP_START)) {
            if ((n.pop(), n.length === 0)) return r;
          } else
            return (
              this.errors.push(N.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")),
              null
            );
        if (this._peek.type === l.EXPANSION_FORM_END)
          if (ss(n, l.EXPANSION_FORM_START)) n.pop();
          else
            return (
              this.errors.push(N.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")),
              null
            );
        if (this._peek.type === l.EOF)
          return (
            this.errors.push(N.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")),
            null
          );
...
`
        ...
        i != null &&
          i.children.length == 0 &&
          !((n = this._getTagDefinition(i)) === null || n === void 0) &&
          n.ignoreFirstLf &&
          (r = r.substring(1));
      }
      return r;
...
`
        ...
        a != null &&
          a.children.length === 0 &&
          !((s = this._getTagDefinition(a)) === null || s === void 0) &&
          s.ignoreFirstLf &&
          ((i = i.substring(1)),
          (r[0] = {
            type: t.type,
      ...
      for (
        ;
        this._peek.type === l.INTERPOLATION ||
        this._peek.type === l.TEXT ||
        this._peek.type === l.ENCODED_ENTITY;
      )
        ((t = this._advance()),
          r.push(t),
          t.type === l.INTERPOLATION
            ? (i += t.parts.join("").replace(/&([^;]+);/g, as))
            : t.type === l.ENCODED_ENTITY
              ? (i += t.parts[0])
              : (i += t.parts.join("")));
      if (i.length > 0) {
        let a = t.sourceSpan;
    ...
    _closeVoidElement() {
      ...
      r !== null &&
        !((t = this._getTagDefinition(r)) === null || t === void 0) &&
        t.isVoid &&
    ...
    _consumeElementStartTag(t) {
      ...
      let s = this._getElementFullName(t, this._getClosestElementLikeParent()),
        a = this._getTagDefinition(s),
        o = !1;
      ...
      let c = this._peek.sourceSpan.fullStart,
        u = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart),
        p = new h(t.sourceSpan.start, c, t.sourceSpan.fullStart),
        d = new h(t.sourceSpan.start.moveBy(1), t.sourceSpan.end),
        S = new ie(s, n, i, [], o, u, p, void 0, d, a?.isVoid ?? !1),
        m = this._getContainer(),
        g =
          m !== null &&
          !!(
            !((r = this._getTagDefinition(m)) === null || r === void 0) && r.isClosedByChild(S.name)
          );
      (this._pushContainer(S, g),
        o
          ? this._popContainer(s, ie, u)
          : t.type === l.INCOMPLETE_TAG_OPEN &&
            (this._popContainer(s, ie, null),
            this.errors.push(N.create(s, u, `Opening tag "${s}" not terminated.`))));
    }
    _consumeComponentStartTag(t) {
      ...
      let a = this._getClosestElementLikeParent(),
        o = this._getComponentTagName(t, a),
        c = this._getComponentFullName(t, a),
        u = this._peek.type === l.COMPONENT_OPEN_END_VOID;
      this._advance();
      let p = this._peek.sourceSpan.fullStart,
        d = new h(t.sourceSpan.start, p, t.sourceSpan.fullStart),
        m = new J(
          n,
          o,
          c,
          ...
          u,
          d,
          new h(t.sourceSpan.start, p, t.sourceSpan.fullStart),
          void 0,
        ),
        ...
        E =
          ...
          m.tagName !== null &&
          !!(
            !((r = this._getTagDefinition(g)) === null || r === void 0) &&
            r.isClosedByChild(m.tagName)
          );
      (this._pushContainer(m, E),
        u
          ? this._popContainer(c, J, d)
          : t.type === l.INCOMPLETE_COMPONENT_OPEN &&
            (this._popContainer(c, J, null),
            this.errors.push(N.create(c, d, `Opening tag "${c}" not terminated.`))));
    }
    _consumeAttributesAndDirectives(t, r) {
      for (; this._peek.type === l.ATTR_NAME || this._peek.type === l.DIRECTIVE_NAME; )
        this._peek.type === l.DIRECTIVE_NAME
          ? r.push(this._consumeDirective(this._peek))
    ...
    _consumeComponentEndTag(t) {
      ...
      if (!this._popContainer(r, J, t.sourceSpan)) {
        let n = this._containerStack[this._containerStack.length - 1],
          i;
        n instanceof J && n.componentName === t.parts[0]
          ? (i = `, did you mean "${n.fullName}"?`)
          : (i = ". It may happen when the tag has already been closed by another tag.");
    ...
    _consumeElementEndTag(t) {
      ...
      let n =
        this.allowHtmComponentClosingTags && t.parts.length === 0
          ? null
          : this._getElementFullName(t, this._getClosestElementLikeParent());
      if (n && !((r = this._getTagDefinition(n)) === null || r === void 0) && r.isVoid)
        this.errors.push(
          N.create(n, t.sourceSpan, `Void elements do not have end tags "${t.parts[1]}"`),
        );
    ...
    _popContainer(t, r, n) {
      ...
      for (let a = this._containerStack.length - 1; a >= 0; a--) {
        ...
        let o = this._containerStack[a],
          c = o instanceof J ? o.fullName : o.name;
        if (Me(c) ? c === t : (c === t || t === null) && o instanceof r)
          return (
            (o.endSourceSpan = n),
            (o.sourceSpan.end = n !== null ? n.end : o.sourceSpan.end),
            this._containerStack.splice(a, this._containerStack.length - a),
            !i
          );
        (o instanceof ve ||
          !(!((s = this._getTagDefinition(o)) === null || s === void 0) && s.closedByParent)) &&
          (i = !0);
      }
      return !1;
    }
    _consumeAttr(t) {
      let r = Ee(t.parts[0], t.parts[1]),
        n = t.sourceSpan.end,
        i;
      ...
      let s = "",
        ...
        o,
        c;
      if (this._peek.type === l.ATTR_VALUE_TEXT)
        for (
          o = this._peek.sourceSpan, c = this._peek.sourceSpan.end;
          this._peek.type === l.ATTR_VALUE_TEXT ||
          this._peek.type === l.ATTR_VALUE_INTERPOLATION ||
          this._peek.type === l.ENCODED_ENTITY;
        ) {
          let p = this._advance();
          (a.push(p),
            p.type === l.ATTR_VALUE_INTERPOLATION
              ? (s += p.parts.join("").replace(/&([^;]+);/g, as))
              : p.type === l.ENCODED_ENTITY
                ? (s += p.parts[0])
                : (s += p.parts.join("")),
      ...
      let u =
        o && c && new h(i?.sourceSpan.start ?? o.start, c, i?.sourceSpan.fullStart ?? o.fullStart);
      return new Gi(
        r,
        s,
        new h(t.sourceSpan.start, n, t.sourceSpan.fullStart),
        t.sourceSpan,
        u,
        a.length > 0 ? a : void 0,
        void 0,
    ...
    _consumeDirective(t) {
      ...
      if ((this._advance(), this._peek.type === l.DIRECTIVE_OPEN)) {
        for (n = this._peek.sourceSpan.end, this._advance(); this._peek.type === l.ATTR_NAME; )
          r.push(this._consumeAttr(this._advance()));
        this._peek.type === l.DIRECTIVE_CLOSE
          ? ((i = this._peek.sourceSpan), this._advance())
          : this.errors.push(N.create(null, t.sourceSpan, "Unterminated directive definition"));
      }
      let s = new h(t.sourceSpan.start, n, t.sourceSpan.fullStart),
        a = new h(s.start, i === null ? t.sourceSpan.end : i.end, s.fullStart);
    ...
    _consumeBlockOpen(t) {
      ...
      let n = this._peek.sourceSpan.fullStart,
        i = new h(t.sourceSpan.start, n, t.sourceSpan.fullStart),
        s = new h(t.sourceSpan.start, n, t.sourceSpan.fullStart),
        a = new ve(t.parts[0], r, [], i, t.sourceSpan, s);
      this._pushContainer(a, !1);
    }
    _consumeBlockClose(t) {
      this._popContainer(null, ve, t.sourceSpan) ||
        this.errors.push(
          N.create(
            null,
            t.sourceSpan,
    ...
    _consumeIncompleteBlock(t) {
      ...
      let n = this._peek.sourceSpan.fullStart,
        ...
        a = new ve(t.parts[0], r, [], i, t.sourceSpan, s);
      (this._pushContainer(a, !1),
        this._popContainer(null, ve, null),
        this.errors.push(
          N.create(
            t.parts[0],
            i,
    ...
    _consumeLet(t) {
      ...
      let s = i.sourceSpan.fullStart,
        a = new h(t.sourceSpan.start, s, t.sourceSpan.fullStart),
        o = t.sourceSpan.toString().lastIndexOf(r),
        c = new h(t.sourceSpan.start.moveBy(o), t.sourceSpan.end),
        u = new Lr(r, n.parts[0], a, c, n.sourceSpan);
      this._addToParent(u);
    }
    _consumeIncompleteLet(t) {
      let r = t.parts[0] ?? "",
        n = r ? ` "${r}"` : "";
      if (r.length > 0) {
        let i = t.sourceSpan.toString().lastIndexOf(r),
          s = new h(t.sourceSpan.start.moveBy(i), t.sourceSpan.end),
          a = new h(t.sourceSpan.start, t.sourceSpan.start.moveBy(0)),
          o = new Lr(r, "", t.sourceSpan, s, a);
        this._addToParent(o);
      }
      this.errors.push(
        N.create(
    ...
    _getPrefix(t, r) {
      ...
      if (
        ...
        t.type === l.INCOMPLETE_COMPONENT_OPEN ||
        t.type === l.COMPONENT_CLOSE
          ? ((i = t.parts[1]), (s = t.parts[2]))
          : ((i = t.parts[0]), (s = t.parts[1])),
        (i =
          i ||
          ((n = this._getTagDefinition(s)) === null || n === void 0
            ? void 0
            : n.implicitNamespacePrefix) ||
          ""),
        !i && r)
      ) {
...
function Xo(e) {
  let t = (r) =>
    r.kind === "element" &&
    r.prev?.kind === "ieConditionalStartComment" &&
    r.prev.sourceSpan.end.offset === r.startSourceSpan.start.offset &&
    r.firstChild?.kind === "ieConditionalEndComment" &&
    ...
    if (r.children)
      for (let n = 0; n < r.children.length; n++) {
        ...
        let s = i.prev,
          a = i.firstChild;
        (r.removeChild(s), n--);
        let o = new h(s.sourceSpan.start, a.sourceSpan.end),
          c = new h(o.start, i.sourceSpan.end);
    ...
    if (n.children)
      for (let i = 0; i < n.children.length; i++) {
        ...
        !a ||
          a.kind !== "text" ||
          ((a.value += s.value),
          (a.sourceSpan = new h(a.sourceSpan.start, s.sourceSpan.end)),
          n.removeChild(s),
          i--);
      }
  });
...
function Jo(e) {
  let t = (r) =>
    ...
    r.attrs.length === 0 &&
    r.children.length === 1 &&
    r.firstChild.kind === "text" &&
    !y.hasWhitespaceCharacter(r.children[0].value) &&
  ...
  e.walk((r) => {
    if (r.children)
      for (let n = 0; n < r.children.length; n++) {
        ...
        let s = i.prev,
          a = i.next;
        ((s.value += `<${i.rawName}>` + i.firstChild.value + `</${i.rawName}>` + a.value),
          (s.sourceSpan = new h(s.sourceSpan.start, a.sourceSpan.end)),
          (s.isTrailingSpaceSensitive = a.isTrailingSpaceSensitive),
          (s.hasTrailingSpaces = a.hasTrailingSpaces),
          r.removeChild(i),
          n--,
          r.removeChild(a));
      }
...
function el(e, t) {
  e.walk((r) => {
    ...
    if (
      n.length === 0 ||
      (n.length === 1 && n[0].kind === "text" && y.trim(n[0].value).length === 0)
    ) {
    ...
    if (!i)
      for (let a = 0; a < n.length; a++) {
        ...
        let { leadingWhitespace: c, text: u, trailingWhitespace: p } = kn(o.value),
          d = o.prev,
          S = o.next;
        u
          ? ((o.value = u),
            (o.sourceSpan = new h(
              o.sourceSpan.start.moveBy(c.length),
              o.sourceSpan.end.moveBy(-p.length),
            )),
            c && (d && (d.hasTrailingSpaces = !0), (o.hasLeadingSpaces = !0)),
            p && ((o.hasTrailingSpaces = !0), S && (S.hasLeadingSpaces = !0)))
          : (r.removeChild(o),
            a--,
            (c || p) && (d && (d.hasTrailingSpaces = !0), S && (S.hasLeadingSpaces = !0)));
      }
...
function il(e, t) {
  e.walk((r) => {
    ...
    if (n) {
      ...
      for (let i of n)
        ((i.isLeadingSpaceSensitive = yn(i, t)), (i.isTrailingSpaceSensitive = Nn(i, t)));
      for (let i = 0; i < n.length; i++) {
        let s = n[i];
        ((s.isLeadingSpaceSensitive =
          (i === 0 || s.prev.isTrailingSpaceSensitive) && s.isLeadingSpaceSensitive),
          (s.isTrailingSpaceSensitive =
            (i === n.length - 1 || s.next.isLeadingSpaceSensitive) && s.isTrailingSpaceSensitive));
      }
    }
  });
}
...
function sl(e, t, r) {
  ...
  switch (n.kind) {
    ...
    case "docType":
      return [
        C([Se(n, t), " ", w(0, n.value.replace(/^html\b/iu, "html"), /\s+/gu, " ")]),
        fe(n, t),
      ];
    case "comment":
...
function ll(e, t) {
  let r = /* @__PURE__ */ new SyntaxError(
...
((oe = /* @__PURE__ */ new WeakSet()),
  ($r = function () {
    return this.kind === "angularIcuCase"
      ? "expression"
      : this.kind === "angularIcuExpression"
        ? "cases"
        : "children";
  }),
  (zr = function () {
...
function hl(e, t, r) {
  let { openingTagSuffix: n, condition: i, data: s } = t.groups,
    a = 4 + n.length,
...
function dl(e) {
  if (e.kind === "block") {
    if (
      ((e.name = w(0, e.name.toLowerCase(), /\s+/gu, " ").trim()),
      (e.kind = "angularControlFlowBlock"),
      !Ie(e.parameters))
    ) {
      delete e.parameters;
...
function _l(e) {
  (e.kind === "expansion" && (e.kind = "angularIcuExpression"),
    e.kind === "expansionCase" && (e.kind = "angularIcuCase"));
}
function Cs(e, t) {
  let r = e.toLowerCase();
  return t(r) ? r : e;
        ...
        (vs(t),
          t.valueSpan
            ? ((t.value = t.valueSpan.toString()),
              /["']/u.test(t.value[0]) && (t.value = t.value.slice(1, -1)))
            : (t.value = null));
      break;
    case "comment":
...
function El(e, t) {
  if (e.kind === "element") {
    ...
    !e.namespace || e.namespace === r.implicitNamespacePrefix || ue(e)
      ? (e.tagDefinition = r)
      : (e.tagDefinition = Be(""));
  }
}
function Cl(e) {
  e.sourceSpan &&
    e.endSourceSpan &&
    (e.sourceSpan = new h(e.sourceSpan.start, e.endSourceSpan.end));
}
function vl(e, t) {
  if (
    e.kind === "element" &&
    (t.normalizeTagName &&
      (!e.namespace || e.namespace === e.tagDefinition.implicitNamespacePrefix || ue(e)) &&
      (e.name = Cs(e.name, (r) => _s.has(r))),
    ...
    for (let r of e.attrs)
      r.namespace ||
        (r.name = Cs(
          r.name,
          (n) => Zt.has(e.name) && (Zt.get("*").has(n) || Zt.get(e.name).has(n)),
        ));
}
function Xr(e, t) {
...
function bs(e, t) {
  let r = Gr(t),
    { rootNodes: n, errors: i } = Qt(e, r);
  if (
    n.some(
      (u) =>
        (u.kind === "docType" && u.value === "html") ||
        (u.kind === "element" && u.name.toLowerCase() === "html"),
    )
  )
    return Xr(e, rr);
  let a,
    ...
    c = (u) => {
      ...
      return (
        o().rootNodes.find((d) => d.kind === "element" && d.startSourceSpan.start.offset === p) ?? u
      );
    };
  for (let [u, p] of n.entries())
    if (p.kind === "element") {
      if (p.isVoid) ((i = o().errors), (n[u] = c(p)));
      else if (Tl(p)) {
        let { endSourceSpan: d, startSourceSpan: S } = p,
          m = o().errors.find(
            (g) => g.span.start.offset > S.start.offset && g.span.start.offset < d.end.offset,
          );
        (m && jr(m), (n[u] = c(p)));
      }
    }
...
function bl(e, t, r, n, i, s) {
  ...
  return (
    u.length === a
      ? c.children.shift()
      : ((u.sourceSpan = new h(u.sourceSpan.start.moveBy(a), u.sourceSpan.end)),
        (u.value = u.value.slice(a))),
    c
  );
}
function Kr(e, t, r, n = {}) {
  let { frontMatter: i, content: s } = r.shouldParseFrontMatter ? pr(e) : { content: e },
    a = new mt(e, n.filepath),
    o = new qe(a, 0, 0, 0),
    c = o.moveBy(e.length),
    { parseOptions: u, rootNodes: p } = t(s, r),
    d = {
      kind: "root",
      sourceSpan: new h(o, c),
      children: p,
...
var wl = gt(rr),
  kl = new Set(["mj-style", "mj-raw"]),
  xl = gt({
    ...rr,
    name: "mjml",
    shouldParseAsRawText: (e) => kl.has(e),
  }),
  Al = gt({
    name: "angular",
  ...
  yl = gt({
    ...
    shouldParseAsRawText(e, t, r, n) {
      return (
        ...
        (e !== "template" ||
          n.some(
            ({ name: i, value: s }) => i === "lang" && s !== "html" && s !== "" && s !== void 0,
          ))
      );
    },
  }),
