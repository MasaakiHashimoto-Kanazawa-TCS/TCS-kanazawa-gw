  ...
  var OperationMergerBackend = class {
    constructor(provider, syncProvider, providerContext) {
      ...
      this.provide = this._provider
        ? (path, options, callback) => {
            ...
            if (
              ...
              callback(
                /* @__PURE__ */ new TypeError("path must be a string, Buffer, URL or number"),
              );
              return;
            }
      ...
      this.provideSync = this._syncProvider
        ? (path, options) => this._syncProvider.call(this._providerContext, path, options)
        : null;
    }
    purge() {}
    purgeParent() {}
            ...
            ((path, callback) => {
              this.readFile(path, (err, buffer) => {
                ...
                if (!buffer || buffer.length === 0)
                  return callback(/* @__PURE__ */ new Error("No file content"));
                let data;
                try {
    ...
    apply(resolver) {
      ...
      resolver
        ...
        .tapAsync("AliasFieldPlugin", (request, resolveContext, callback) => {
          ...
          const data = Object.prototype.hasOwnProperty.call(fieldData, innerRequest)
  ...
  const getType = (maybePath) => {
    switch (maybePath.length) {
      ...
      case 2: {
        ...
        if (
          maybePath.charCodeAt(1) === CHAR_COLON &&
            ...
            if (matchRequest || matchWildcard) {
              const resolveWithAlias = (alias, callback) => {
                ...
                if (matchRequest && innerRequest !== alias && !innerRequest.startsWith(`${alias}/`))
                  newRequestStr = alias + innerRequest.slice(item.name.length);
...
var require_identifier = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function parseIdentifier(identifier) {
    ...
    if (fragmentStart < 0) {
      if (queryStart < 0) return [identifier, "", ""];
...
var require_entrypoints = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function findMatch(request, field) {
    if (
      ...
      return [field[request], "", false, false, request];
    let bestMatch = "";
    ...
    return [target, bestMatchSubpath, isSubpathMapping, isPattern, bestMatch];
  }
  ...
  function assertExportTarget(exp, expectFolder) {
    ...
    if ((relativePath.charCodeAt(relativePath.length - 1) === slashCode) !== expectFolder)
      throw new Error(
        expectFolder
  ...
  function assertImportTarget(imp, expectFolder) {
    ...
    if ((relativePath.charCodeAt(relativePath.length - 1) === slashCode) !== expectFolder)
      throw new Error(
        expectFolder
          ? `Expecting folder to folder mapping. ${JSON.stringify(imp)} should end with "/"`
          : `Expecting file to file mapping. ${JSON.stringify(imp)} should not end with "/"`,
      );
  }
...
var require_JoinRequestPartPlugin = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  module.exports = class JoinRequestPartPlugin {
    ...
    apply(resolver) {
      ...
      resolver
        .getHook(this.source)
        .tapAsync("JoinRequestPartPlugin", (request, resolveContext, callback) => {
      ...
      resolver
        ...
        .tapAsync("JoinRequestPlugin", (request, resolveContext, callback) => {
          ...
          const obj = {
            ...
            relativePath:
              request.relativePath && resolver.join(request.relativePath, requestRequest),
            request: void 0,
          };
          resolver.doResolve(target, obj, null, resolveContext, callback);
        });
...
var require_ModulesInHierarchicalDirectoriesPlugin = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
    const forEachBail = require_forEachBail();
            ...
            (request, resolveContext, callback) => {
              ...
              forEachBail(
                getPaths(request.path)
                  .paths.map((path) =>
                    this.directories.map((directory) => resolver.join(path, directory)),
                  )
                  .reduce((array, path) => {
                    array.push(...path);
                    return array;
...
var require_Hook = /* @__PURE__ */ __commonJSMin((exports, module) => {
  const deprecateContext = __require("util").deprecate(
    () => {},
  ...
  var HookCodeFactory = class {
    ...
    contentWithInterceptors(options) {
      if (this.options.interceptors.length > 0) {
        ...
        for (let i = 0; i < this.options.interceptors.length; i++) {
          ...
          if (interceptor.call)
            code += `${this.getInterceptor(i)}.call(${this.args({ before: interceptor.context ? "_context" : void 0 })});\n`;
        }
        code += this.content(
          Object.assign(options, {
            onError:
              ...
              ((err) => {
                let code = "";
                for (let i = 0; i < this.options.interceptors.length; i++)
                  if (this.options.interceptors[i].error)
            ...
            onResult:
              ...
              ((result) => {
                let code = "";
                for (let i = 0; i < this.options.interceptors.length; i++)
                  if (this.options.interceptors[i].result)
            ...
            onDone:
              ...
              (() => {
                let code = "";
                for (let i = 0; i < this.options.interceptors.length; i++)
                  if (this.options.interceptors[i].done)
    ...
    callTap(tapIndex, { onError, onResult, onDone, rethrowIfPossible }) {
      ...
      switch (tap.type) {
        case "sync":
          ...
          if (onResult)
            code += `var _result${tapIndex} = _fn${tapIndex}(${this.args({ before: tap.context ? "_context" : void 0 })});\n`;
          else
            code += `_fn${tapIndex}(${this.args({ before: tap.context ? "_context" : void 0 })});\n`;
          if (!rethrowIfPossible) {
            code += "} catch(_err) {\n";
    ...
    callTapsLooping({ onError, onDone, rethrowIfPossible }) {
      ...
      for (let i = 0; i < this.options.interceptors.length; i++) {
        const interceptor = this.options.interceptors[i];
        if (interceptor.loop)
          code += `${this.getInterceptor(i)}.loop(${this.args({ before: interceptor.context ? "_context" : void 0 })});\n`;
      }
  ...
  module.exports = class Resolver {
    ...
    ensureHook(name) {
      ...
      if (name.startsWith("before"))
        return this.ensureHook(name[6].toLowerCase() + name.slice(7)).withOptions({ stage: -10 });
      if (name.startsWith("after"))
        return this.ensureHook(name[5].toLowerCase() + name.slice(6)).withOptions({ stage: 10 });
    ...
    getHook(name) {
      ...
      name = toCamelCase(name);
      if (name.startsWith("before"))
        return this.getHook(name[6].toLowerCase() + name.slice(7)).withOptions({ stage: -10 });
      if (name.startsWith("after"))
        return this.getHook(name[5].toLowerCase() + name.slice(6)).withOptions({ stage: 10 });
      const hook = this.hooks[name];
    ...
    resolve(context, path, request, resolveContext, callback) {
      if (!context || typeof context !== "object")
        return callback(/* @__PURE__ */ new Error("context argument is not an object"));
      if (typeof path !== "string")
        return callback(/* @__PURE__ */ new Error("path argument is not a string"));
      if (typeof request !== "string")
        return callback(/* @__PURE__ */ new Error("request argument is not a string"));
      if (!resolveContext)
        return callback(/* @__PURE__ */ new Error("resolveContext argument is not set"));
      const obj = {
        context,
        path,
        request,
    ...
    doResolve(hook, request, message, resolveContext, callback) {
      ...
      if (resolveContext.stack) {
        ...
        if (resolveContext.stack.has(stackEntry)) {
          const recursionError = /* @__PURE__ */ new Error(
    ...
    apply(resolver) {
      ...
      resolver
        ...
        .tapAsync("SelfReferencePlugin", (request, resolveContext, callback) => {
          ...
          const req = request.request;
          if (!req) return callback();
          if (!DescriptionFileUtils.getField(request.descriptionFileData, this.fieldName))
            return callback();
          const name = DescriptionFileUtils.getField(request.descriptionFileData, "name");
          if (typeof name !== "string") return callback();
          if (
            req.startsWith(name) &&
            (req.length === name.length || req.charCodeAt(name.length) === slashCode)
          ) {
        ...
        .tapAsync("SymlinkPlugin", (request, resolveContext, callback) => {
          ...
          forEachBail(
            ...
            (err, idx) => {
              ...
              const result = (
                typeof idx === "number" ? pathSegments.slice(0, idx + 1) : [...pathSegments]
              ).reduceRight((a, b) => resolver.join(a, b));
              const obj = {
                ...request,
                path: result,
              };
...
var require_ResolverFactory = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  function createOptions(options) {
    ...
    return {
      ...
      cacheWithContext:
        typeof options.cacheWithContext !== "undefined" ? options.cacheWithContext : true,
      ...
      enforceExtension:
        options.enforceExtension === void 0
  ...
  module.exports.createResolver = function createResolver(options) {
    ...
    plugins.push(
      new DescriptionFilePlugin("parsed-resolve", descriptionFiles, false, "described-resolve"),
    );
    ...
    for (const exportsField of exportsFields)
      plugins.push(
        new ExportsFieldPlugin("resolve-in-package", conditionNames, exportsField, "relative"),
      );
    ...
    plugins.push(
      new DescriptionFilePlugin("relative", descriptionFiles, true, "described-relative"),
    );
    plugins.push(new NextPlugin("after-relative", "described-relative"));
    if (resolveToContext) plugins.push(new NextPlugin("described-relative", "directory"));
    else {
      plugins.push(
        new ConditionalPlugin("described-relative", { directory: false }, null, true, "raw-file"),
      );
      plugins.push(
        new ConditionalPlugin(
          "described-relative",
    ...
    if (resolveToContext)
      ...
      for (const item of mainFiles)
        plugins.push(
          new UseFilePlugin("undescribed-existing-directory", item, "undescribed-raw-file"),
        );
      for (const item of mainFields)
        plugins.push(
          new MainFieldPlugin("existing-directory", item, "resolve-in-existing-directory"),
        );
      for (const item of mainFiles)
        plugins.push(new UseFilePlugin("existing-directory", item, "undescribed-raw-file"));
      plugins.push(
        new DescriptionFilePlugin("undescribed-raw-file", descriptionFiles, true, "raw-file"),
      );
    ...
    for (const plugin of plugins)
      if (typeof plugin === "function") plugin.call(resolver, resolver);
