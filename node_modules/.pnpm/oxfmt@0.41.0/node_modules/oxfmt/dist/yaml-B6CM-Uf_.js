//#region ../../node_modules/.pnpm/prettier@3.8.1/node_modules/prettier/plugins/yaml.mjs
    ...
    return (
      typeof t == "string"
        ...
        : (Array.isArray(t) && (t = t[0]),
          t &&
            t.context &&
            (t.lineStarts || (t.lineStarts = Wr(t.context.src)),
            (e = t.lineStarts),
            (n = t.context.src))),
      {
        lineStarts: e,
...
`)
      ...
      get hasComment() {
        if (this.context) {
          ...
          for (let n = 0; n < this.props.length; ++n)
            if (e[this.props[n].start] === ie.COMMENT) return !0;
        }
        return !1;
      }
      get hasProps() {
      ...
      get jsonLike() {
        return (
          [st.FLOW_MAP, st.FLOW_SEQ, st.QUOTE_DOUBLE, st.QUOTE_SINGLE].indexOf(this.type) !== -1
        );
      }
      get rangeAsLinePos() {
...
` &&
          (i = t.endOfLine(s, n, r)),
        (this.valueRange = new xe(n, i)),
        (i = oe.endOfWhiteSpace(s, i)),
...
` ||
          ...
          if (
            ...
            (c = u.Node.normalizeOffset(s, g.range.end)),
            (l = s[c]),
            (f = !1),
            (m = g.includesTrailingLines),
            l)
          ) {
            let h = c - 1,
              d = s[h];
...
`
        ...
        return (
          this.chomping !== le.KEEP && (i = r[o] ? o + 1 : o),
  ...
  var _n = class t {
    ...
    constructor(
      ...
      (u._defineProperty(this, "parseNode", (c, l) => {
        ...
        let f = new t(this, c),
          { props: m, type: g, valueStart: y } = f.parseProps(l),
          h = So(g, m),
          d = h.parse(f, y);
        if (
          ((h.range = new u.Range(l, d)),
          d <= l &&
            ((h.error = /* @__PURE__ */ new Error("Node#parse consumed no characters")),
            (h.error.parseEnd = d),
            (h.error.source = h),
            (h.range.end = l + 1)),
...
`
          ...
          let m = l - (f + this.indent),
            g = r.type === u.Type.SEQ_ITEM && r.context.atLineStart;
...
` + n.replace(/^/gm, `${e || ""}#`)
  ...
  var Xr = (t) => t == null || (typeof t == "object" && t[Symbol.iterator]().next().done),
    Q = class t extends j {
      constructor(e) {
      ...
      hasAllNullValues() {
        return this.items.every((e) => {
          ...
          return (
            n == null ||
            (n instanceof x && n.value == null && !n.commentBefore && !n.comment && !n.tag)
          );
        });
      }
      hasIn([e, ...n]) {
        ...
        let y = !1,
          ...
          d = this.items.reduce((P, A, C) => {
            ...
            (A &&
              ...
              A.commentBefore &&
                A.commentBefore.match(/^.*$/gm).forEach((Mi) => {
                  P.push({
                    type: "comment",
                    str: `#${Mi}`,
                  });
    ...
    T = class t extends j {
      ...
      toString(e, n, r) {
        ...
        let f =
            ...
            (!a ||
              ...
              (a instanceof j
                ...
                : typeof a == "object")),
          { doc: m, indent: g, indentStep: y, stringify: h } = e;
        e = Object.assign({}, e, {
          implicitKey: !f,
          indent: g + y,
        });
        ...
        if (e.allNullValues && !o)
          return (
            this.comment ? ((w = Re(w, e.indent, this.comment)), n && n()) : d && !l && r && r(),
            e.inFlow && !f ? w : `? ${w}`
          );
        ((w = f
          ? `? ${w}
${g}:`
          : `${w}:`),
          this.comment && ((w = Re(w, e.indent, this.comment)), n && n()));
        let P = "",
          A = null;
        if (c instanceof j) {
          if (
...
${R}`;
        ...
        ((e.implicitKey = !1),
          !f && !this.comment && c instanceof x && (e.indentAtStart = w.length + 1),
          (d = !1),
          !i &&
            s >= 2 &&
            !e.inFlow &&
    ...
    we = class t extends j {
      ...
      toJSON(e, n) {
        ...
        if (
          s >= 0 &&
          ((i.count += 1),
          i.aliasCount === 0 && (i.aliasCount = xt(this.source, r)),
  ...
  var ct = class extends Q {
    ...
    $t = class extends T {
      constructor(e) {
        if (e instanceof T) {
          let n = e.value;
          (n instanceof ue || ((n = new ue()), n.items.push(e.value), (n.range = e.value.range)),
            super(e.key, n),
            (this.range = e.range));
...
${e}${t.slice(L + 1, R)}`));
  ...
  var Dn = ({ indentAtStart: t }) => (t ? Object.assign({ indentAtStart: t }, be.fold) : be.fold),
    Bt = (t) => /^(%|---|\.\.\.)/m.test(t);
  function Co(t, e, n) {
    if (!e || e < 0) return !1;
    let r = e - n,
...
${n}`,
  ...
  function Dt({ comment: t, type: e, value: n }, r, s, i) {
    ...
    let o = r.indent || (r.forceBlockIndent || Bt(n) ? "  " : ""),
      a = o ? "2" : "1",
      c =
        e === p.Type.BLOCK_FOLDED
          ...
          : e === p.Type.BLOCK_LITERAL
            ? !0
            : !Co(n, be.fold.lineWidth, o.length),
      l = c ? "|" : ">";
    if (!n)
      return (
        l +
...
` + s)
  ...
  function Do(t, e) {
    let n = {
      ...
      r = !1,
      s = !1,
      i = Ro(e.context.parent) ? e.context.parent.props.concat(e.props) : e.props;
  ...
  function pe(t, e) {
    ...
    if (e.type === p.Type.ALIAS && (r || s))
      t.errors.push(new p.YAMLSemanticError(e, "An alias node must not specify any properties"));
    let i = $o(t, e);
    if (i) {
...
${a}`
  ...
  function Yo(t, e) {
    ...
    let { comments: n, items: r } = e.type === p.Type.FLOW_MAP ? Uo(t, e) : qo(t, e),
      s = new ct();
    ((s.items = r), ss(s, n));
    let i = !1;
...
`
        ...
        case p.Type.MAP_VALUE:
          {
            ...
            (Fo(a, l),
              r.push(l),
              s && typeof i == "number" && a.range.start > i + 1024 && t.errors.push(rs(e, s)),
              (s = void 0),
              (i = null));
          }
          break;
        default:
          ...
          e: for (let c = o + 1; ; ++c) {
            ...
            switch (l && l.type) {
              ...
              default:
                t.errors.push(
                  new p.YAMLSemanticError(a, "Implicit map keys need to be followed by map values"),
                );
                break e;
            }
          }
          if (a.valueRangeContainsNewline)
            t.errors.push(
              new p.YAMLSemanticError(a, "Implicit map keys need to be on a single line"),
            );
      }
    }
    return (
  ...
  function Vo(t, e) {
    ...
    let { comments: n, items: r } = e.type === p.Type.FLOW_SEQ ? Ko(t, e) : Wo(t, e),
      s = new ue();
    if (
      ((s.items = r),
      ss(s, n),
      !t.options.mapAsMap && r.some((i) => i instanceof T && i.key instanceof Q))
    )
      t.warnings.push(
        new p.YAMLWarning(
          e,
    ...
    for (let r = 0; r < n.items.length; ++r) {
      ...
      if (!(s instanceof O.Pair)) {
        if (s instanceof O.YAMLMap) {
          if (s.items.length > 1)
            throw new G.YAMLSemanticError(e, "Each pair must have its own sequence indicator");
...
${i.comment}`
  ...
  var Qo = {
    ...
    $e = class t extends O.YAMLSeq {
      constructor() {
        (super(),
          G._defineProperty(this, "add", O.YAMLMap.prototype.add.bind(this)),
          G._defineProperty(this, "delete", O.YAMLMap.prototype.delete.bind(this)),
          G._defineProperty(this, "get", O.YAMLMap.prototype.get.bind(this)),
          G._defineProperty(this, "has", O.YAMLMap.prototype.has.bind(this)),
          G._defineProperty(this, "set", O.YAMLMap.prototype.set.bind(this)),
          (this.tag = t.tag));
      }
      toJSON(e, n) {
    ...
    for (let { key: s } of n.items)
      if (s instanceof O.Scalar)
        if (r.includes(s.value))
          throw new G.YAMLSemanticError(e, "Ordered maps must not include duplicate keys");
        else r.push(s.value);
  ...
  function Xo(t, e) {
    ...
    if (!n.hasAllNullValues())
      throw new G.YAMLSemanticError(e, "Set items must all have null values");
...
var Kn = ne((bs) => {
  ...
  var Vt = {
    ...
    Wn = (t, e, n) => (E.intOptions.asBigInt ? BigInt(t) : parseInt(e, n));
  function us(t, e, n) {
    let { value: r } = t;
  ...
  var ps = {
    ...
    ca = Vn.concat([ps, ms, hs, ds, gs, ys, Es, Ss]),
    ls = (t) => typeof t == "bigint" || Number.isInteger(t),
    Ft = ({ value: t }) => JSON.stringify(t),
    ws = [
      ft,
      Vt,
      {
  ...
  var fs = ({ value: t }) => (t ? E.boolOptions.trueStr : E.boolOptions.falseStr),
    lt = (t) => typeof t == "bigint" || Number.isInteger(t);
  function qt(t, e, n) {
    let r = e.replace(/_/g, "");
  ...
  var da = (t, e) => (t.key < e.key ? -1 : t.key > e.key ? 1 : 0),
    ut = class t {
      constructor({ customTags: e, merge: n, schema: r, sortMapEntries: s, tags: i }) {
        ((this.merge = !!n),
          (this.name = r),
          (this.sortMapEntries = s === !0 ? da : s || null),
          !e && i && $.warnOptionDeprecation("tags", "customTags"),
          (this.tags = ha(fa, ua, e || i, r)));
      }
      createNode(e, n, r, s) {
        let i = {
...
var Ls = ne((Gt) => {
  ...
  function Sa(t, e, { anchors: n, doc: r }) {
    ...
    return (
      i && ((n[i] = t), s.push(`&${i}`)),
      t.tag ? s.push(Os(r, t.tag)) : e.default || s.push(Os(r, e.tag)),
      s.join(" ")
    );
  }
  function Kt(t, e, n, r) {
    ...
    jt = (t, e) => {
      if (t && typeof t == "object") {
        ...
        t instanceof S.Collection
          ? (n && (e[n] = !0), t.items.forEach((r) => jt(r, e)))
          : t instanceof S.Pair
            ? (jt(t.key, e), jt(t.value, e))
...
`) || null;
  ...
  function Na({ tagPrefixes: t }, e) {
    ...
    if (!n || !r)
      throw new Y.YAMLSemanticError(e, "Insufficient parameters given for %TAG directive");
    if (t.some((s) => s.handle === n))
      throw new Y.YAMLSemanticError(
        e,
  ...
  function Oa(t, e) {
    ...
    if ((e.name === "YAML:1.0" && (n = "1.0"), !n))
      throw new Y.YAMLSemanticError(e, "Insufficient parameters given for %YAML directive");
    if (!As[n]) {
...
`) || null;
  ...
  var Qt = class t {
    constructor(e) {
      ((this.anchors = new jn(e.anchorPrefix)),
    ...
    deleteIn(e) {
      return S.isEmptyPath(e)
        ...
        : (Be(this.contents), this.contents.deleteIn(e));
    }
    getDefaults() {
...
var Ms = ne((Cs) => {
  ...
  function Ts(t, e) {
    let n = Qn.parse(t),
      r = new Fe(e).parse(n[0]);
    if (n.length > 1)
      r.errors.unshift(
        new Ta.YAMLSemanticError(
          n[1],
...
var mt =
  (t, e) =>
  (n, r, ...s) =>
    n | 1 && r == null ? void 0 : (e.call(r) ?? r[t]).apply(r, s);
function Ri(t) {
  return this[t < 0 ? this.length + t : t];
}
var D = mt("at", function () {
...
var Qe = "string",
  ...
  wt = "label",
  ke = "break-parent",
  bt = new Set([dt, gt, Ae, yt, Le, Te, Ce, Et, Me, St, re, wt, ke]);
function Fi(t) {
...
function Ar(t, e) {
  switch (t.type) {
    ...
    case "quoteSingle":
      ...
      break;
    case "document":
      (e.directivesEndMarker || delete e.directivesEndMarker,
        e.documentEndMarker || delete e.documentEndMarker);
      break;
  }
}
...
`)
  ...
  for (let [i, o] of r.entries()) {
    ...
    r[i - 1].length > 0 &&
    a.length > 0 &&
    !(t === "quoteDouble" && D(0, D(0, s, -1), -1).endsWith("\\"))
      ? (s[s.length - 1] = [...D(0, s, -1), ...a])
      : s.push(a);
  }
...
`)
  ...
  return (
    (a = a.map((l) => {
      let f = [];
      for (let m of l)
        f.length > 0 && /\s$/u.test(D(0, f, -1)) ? (f[f.length - 1] += " " + m) : f.push(m);
      return f;
    })),
    r.proseWrap === "never" && (a = a.map((l) => [l.join(" ")])),
    c(a)
  );
  function c(l) {
...
function kt(t, e) {
  let { node: n, root: r } = t,
    s;
  return (
    yn.has(r) ? (s = yn.get(r)) : ((s = /* @__PURE__ */ new Set()), yn.set(r, s)),
    !s.has(n.position.end.line) && (s.add(n.position.end.line), _r(n, e) && !En(t.parent)) ? Lt : ""
  );
}
function En(t) {
...
function Zi(t, e, n) {
  ...
  (r.indent !== null && o.push(r.indent.toString()),
    ...
    gn(r) && o.push(" ", n("indicatorComment")));
  let a = $r(r, {
      parentIndent: s,
      isLastDescendant: i,
      options: e,
  ...
  for (let [l, f] of a.entries())
    (l === 0 && c.push(N),
      c.push(At(v(se, f))),
      l !== a.length - 1
        ? c.push(f.length === 0 ? N : ur(He))
        : r.chomping === "keep" && i && c.push(cn(f.length === 0 ? N : He)));
...
function Pt(t, e, n) {
  ...
  let c = D(0, r.children, -1),
    l = c?.type === "flowMappingItem" && _e(c.key) && _e(c.value);
  return [
    i,
    _(e.tabWidth, [
      a,
...
function eo(t, e, n) {
  return t.map(
    ({ isLast: r, node: s, next: i }) => [
      ...
      r
        ? ""
        : [",", se, s.position.start.line !== i.position.start.line ? kt(t, e.originalText) : ""],
    ],
    "children",
  );
}
function to(t, e, n) {
  ...
  if (c)
    return r.type === "flowMappingItem" && s.type === "flowMapping"
      ...
      : r.type === "mappingItem" &&
          Sn(i.content, e) &&
          !K(i.content) &&
          s.tag?.value !== "tag:yaml.org,2002:set"
        ? [l, f, ":"]
        : ["? ", _(2, l)];
  let m = n("value");
  if (a) return [": ", _(2, m)];
  if (te(o) || !nt(i.content))
    return ["? ", _(2, l), N, ...t.map(() => [n(), N], "value", "leadingComments"), ": ", _(2, m)];
  if (
    ro(i.content) &&
    !te(i.content) &&
    !ae(i.content) &&
    ...
    return [l, f, ": ", m];
  let g = Symbol("mappingKey"),
    y = Pe([ze("? "), Pe(_(2, l), { id: g })]),
    h = [N, ": ", _(2, m)],
    d = [f, ":"];
  (I(o) &&
  o.content &&
  W(o.content, ["flowMapping", "flowSequence"]) &&
  o.content.children.length === 0
    ? d.push(" ")
    : te(o.content) ||
        (I(o) && o.content && !W(o.content, ["mapping", "sequence"])) ||
        (s.type === "mapping" && K(i.content) && nt(o.content)) ||
        (W(o.content, ["mapping", "sequence"]) &&
          o.content.tag === null &&
  ...
  return Sn(i.content, e) && !te(i.content) && !ae(i.content) && !K(i.content) && !I(i)
    ? ln([[l, w]])
    : ln([[y, ze(h, w, { groupId: g })]]);
}
function Sn(t, e) {
  if (!t) return !0;
  switch (t.type) {
...
function oo(t, e, n) {
  ...
  let a = "";
  return (
    W(r, ["mapping", "sequence", "comment", "directive", "mappingItem", "sequenceItem"]) &&
      !Ct(t) &&
      (a = kt(t, e.originalText)),
    (i || o) && (W(r, ["sequence", "mapping"]) && !ae(r) ? s.push(N) : s.push(" ")),
    ae(r) && s.push([r.middleComments.length === 1 ? "" : N, v(N, t.map(n, "middleComments")), N]),
    xr(t)
      ? s.push(cr(e.originalText.slice(r.position.start.offset, r.position.end.offset).trimEnd()))
      : s.push(Pe(ao(t, e, n))),
    K(r) &&
      !W(r, ["document", "documentHead"]) &&
      s.push(
        mr([
          r.type === "mappingValue" && !r.content ? "" : " ",
          t.parent.type === "mappingKey" && t.getParentNode(2).type === "mapping" && nt(r)
            ? ""
            : Xe,
          n("trailingComment"),
        ]),
    ...
    En(r) &&
      s.push(
        _(r.type === "sequenceItem" ? 2 : 0, [
          N,
          v(
            N,
            t.map(({ node: c }) => [pn(e.originalText, tt(c)) ? N : "", n()], "endComments"),
          ),
        ]),
      ),
    s.push(a),
...
function ao(t, e, n) {
  ...
  switch (r.type) {
    case "root": {
      let s = Mt(r),
        i = !(W(s, ["blockLiteral", "blockFolded"]) && s.chomping === "keep"),
        o = [];
      return (
        t.each(({ node: a, isFirst: c }) => {
          (c || o.push(N),
            o.push(n()),
            lo(t) && (i && o.push(N), o.push("..."), K(a) && o.push(" ", n("trailingComment"))));
        }, "children"),
        i && o.push(N),
        o
      );
    ...
    case "quoteSingle": {
      ...
      if (o.includes('"'))
        return [
          ...
          rt(
            r.type,
            r.type === "quoteDouble" ? ht(0, ht(0, o, '\\"', '"'), "'", "'".repeat(2)) : o,
            e,
          ),
          "'",
        ];
      if (o.includes("'"))
        return ['"', rt(r.type, r.type === "quoteSingle" ? ht(0, o, "''", "'") : o, e), '"'];
      let a = e.singleQuote ? "'" : '"';
...
function F(t, e = null) {
  ("children" in t && t.children.forEach((n) => F(n, t)),
    "anchor" in t && t.anchor && F(t.anchor, t),
    "tag" in t && t.tag && F(t.tag, t),
    "leadingComments" in t && t.leadingComments.forEach((n) => F(n, t)),
    "middleComments" in t && t.middleComments.forEach((n) => F(n, t)),
    "indicatorComment" in t && t.indicatorComment && F(t.indicatorComment, t),
    "trailingComment" in t && t.trailingComment && F(t.trailingComment, t),
    "endComments" in t && t.endComments.forEach((n) => F(n, t)),
...
function xa(t, e, n) {
  ...
  if (s) {
    if (s.trailingComment)
      throw new Error(`Unexpected multiple trailing comment at ${Oe(t.position.start)}`);
  ...
  switch (t.type) {
    case "DOCUMENT":
      for (let e = t.contents.length - 1; e >= 0; e--)
        t.contents[e].type === "BLANK_LINE" ? t.contents.splice(e, 1) : pt(t.contents[e]);
...
function Da(t, e, n) {
  ...
  if (i.length > 1)
    throw new Error(`Unexpected multiple document trailing comments at ${Oe(i[1].position.start)}`);
  if (o.length > 1)
    throw new Error(
      `Unexpected multiple documentHead trailing comments at ${Oe(o[1].position.start)}`,
    );
  return {
    comments: r,
    endComments: s,
...
function $a(t, e, n) {
  let r = Xt(n.text.slice(t.valueRange.origEnd), /^\.\.\./),
...
function Zs(t, e) {
  let n = t.cstNode,
    { directives: r, comments: s, endComments: i } = Ya(n, e),
    { position: o, documentEndMarkererPoint: a } = Ba(n, r, e);
  return (
    e.comments.push(...s, ...i),
    {
...
function ei(t, e) {
  let { createDocumentHeadWithTrailingComment: n, documentHeadEndMarkerPoint: r } = Zs(t, e),
    {
      documentBody: s,
      documentEndPoint: i,
      documentTrailingComment: o,
  ...
  let i = e.transformNode(t.key),
    ...
    c =
      o || s
        ...
        : null;
  return n(
    X(a ? a.position.start : c.position.start, c ? c.position.end : a.position.end),
    a || Xn(Hn(c.position.start), null),
    c || zn(Hn(a.position.end), null),
  );
}
function ni(t, e) {
  let n = de(t.cstNode.items, e),
    r = nn(n),
    s = t.items.map((a, c) => {
      let l = r[c],
        { additionalKeyRange: f, additionalValueRange: m } = en(l);
...
var Zn,
  er = class {
    ...
    #n(e) {
      ...
      if (
        (this.#t ?? (this.#t = { root: { context: { src: this.text } } }),
        this.text === "" && e.origStart === 0 && e.origEnd === 0)
      )
        return {
          start: {
            offset: 0,
...
function rr(t) {
  ...
  let n = nr(t.position, qa, Ua, Ka),
    r = nr(t.position, Va, Wa, ja);
  "endComments" in t &&
    t.endComments.length !== 0 &&
    (n(t.endComments[0].position.start), r(V(t.endComments).position.end));
...
function Ai(t) {
  let e = sr.default.parseCST(t),
    n = new bi(e, t);
  n.setOrigRanges();
  let r = e.map((i) =>
    new sr.default.Document({
      merge: !1,
      keepCstNodes: !0,
    }).parse(i),
  );
  for (let i of r)
    for (let o of i.errors)
      if (!(o instanceof vs && o.message === 'Map keys must be unique; "<<" is repeated'))
        throw Oi(o, n);
