"use strict";
var ImportType;
((exports.initSync = exports.init = exports.ImportType = void 0),
  (exports.parse = parse),
...
function parse(E, g = "@") {
  ...
  for (; C.ri(); ) {
    const A = C.is(),
      ...
      K = C.se();
    let D;
    (C.ip() && (D = k(E.slice(-1 === I ? A - 1 : A, -1 === I ? Q + 1 : Q))),
      o.push({ n: D, t: B, s: A, e: Q, ss: w, se: K, d: I, a: g }));
  }
  for (; C.re(); ) {
    const A = C.es(),
      Q = C.ee(),
