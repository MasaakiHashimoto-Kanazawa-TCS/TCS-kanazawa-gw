...
You may use `sirv` as a _very_ fast and lightweight alternative to [`serve-static`](https://www.npmjs.com/package/serve-static).
...
Enable "dev" mode, which disables/skips caching. Instead, `sirv` will traverse the file system **_on every request_**.
...
lookup([
  ...
  "/foobar.jpg",
  "/foobar.jpg.html.gz",
  "/foobar.jpg/index.html.gz",
  "/foobar.jpg.htm.gz",
  "/foobar.jpg/index.htm.gz",
  "/foobar.jpg.html",
  "/foobar.jpg/index.html",
  "/foobar.jpg.htm",
  "/foobar.jpg/index.htm",
]);

// Request: [Accept-Encoding: gzip] "/"
lookup(["/index.html.gz", "/index.htm.gz", "/index.html", "/index.htm"]);
```
...
Finally, you may set `ignores: false` to disable **_all_** ignores, including the defaults. Put differently, this will fallback **_all_** unknown pathnames to your `index.html` (or custom `opts.single` value).
