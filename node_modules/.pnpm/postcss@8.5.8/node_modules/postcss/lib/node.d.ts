...
declare namespace Node {
  ...
  export type AnyNode = AtRule.default | Comment | Declaration | Document | Root | Rule;

  export type ChildProps = AtRuleProps | CommentProps | DeclarationProps | RuleProps;
...
declare abstract class Node_ {
   ...
   */
  after(newNode: Node | Node.ChildProps | readonly Node[] | string | undefined): this;
   ...
   * @return This node for methods chain.
   */
  before(newNode: Node | Node.ChildProps | readonly Node[] | string | undefined): this;
   ...
   * @return Range.
   */
  rangeBy(opts?: Pick<WarningOptions, "end" | "endIndex" | "index" | "start" | "word">): Node.Range;
