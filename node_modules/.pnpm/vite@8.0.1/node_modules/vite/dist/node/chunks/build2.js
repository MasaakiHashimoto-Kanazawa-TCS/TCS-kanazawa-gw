...
var require_createICSSRules = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const createExports = (exports$7, postcss, mode = "rule") => {
    const declarations = Object.keys(exports$7).map((key) =>
      postcss.decl({
        prop: key,
        value: exports$7[key],
        raws: { before: "\n  " },
  ...
  const createICSSRules = (imports, exports$8, postcss, mode) => [
    ...createImports(imports, postcss, mode),
    ...createExports(exports$8, postcss, mode),
  ];
...
var require_FileSystemLoader = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Core = class Core {
    ...
    async load(sourceString, sourcePath, trace, pathFetcher) {
      ...
      return {
        injectableSource: (
          await (0, _postcss$1.default)(plugins).process(sourceString, { from: sourcePath })
        ).css,
  ...
  var FileSystemLoader = class {
    ...
    async fetch(_newPath, relativeTo, _trace) {
      ...
      let fileRelativePath =
        fileResolvedPath ||
        _path.default.resolve(_path.default.resolve(this.root, relativeDir), newPath);
  ...
  module.exports = (options = {}) => {
    ...
    const createImportedName =
      typeof options.createImportedName !== "function"
        ? (importName) => `i__imported_${importName.replace(/\W/g, "_")}_${importIndex++}`
        ...
        return {
          Once(root, postcss) {
            ...
            if (importsOrder instanceof Error)
              throw importDecls[
                importsOrder.nodes.find((importPath) => importDecls.hasOwnProperty(importPath))
              ].error(
                "Failed to resolve order of composed modules " +
                  importsOrder.nodes.map((importPath) => "`" + importPath + "`").join(", ") +
                  ".",
                {
  ...
  module.exports = function createGenerator(pattern, options) {
    ...
    return function generate(localName, filepath) {
      ...
      return interpolateName({ resourcePath: filepath }, name, {
        content:
          hashPrefix + path.relative(context, filepath).replace(/\\/g, "/") + "\0" + localName,
        context,
      })
        .replace(/* @__PURE__ */ new RegExp("[^a-zA-Z0-9\\-_\xA0-￿]", "g"), "-")
        .replace(/^((-?[0-9])|--)/, "_$1");
    };
  };
});
      ...
      if (numSingleQuotes + numDoubleQuotes === 0) {
        ...
        if (escaped === v) return Attribute.NO_QUOTE;
          ...
          if (pref === Attribute.NO_QUOTE) {
            ...
            if ((0, _cssesc["default"])(v, CSSESC_QUOTE_OPTIONS[quote]).length < escaped.length)
              return quote;
          }
          return pref;
        }
  ...
  const isNodeWithoutDeclarations = (rule) => {
    if (rule.nodes.length > 0)
      return !rule.nodes.every(
        (item) =>
          item.type === "rule" || (item.type === "atrule" && !isNodeWithoutDeclarations(item)),
      );
    return true;
  };
  module.exports = (options = {}) => {
...
var require_src$1 = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const unescapeRegExp = /* @__PURE__ */ new RegExp(
    "\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)",
    "ig",
  );
    ...
    return {
      ...
      Once(root, { rule }) {
        ...
        function exportScopedName(name, rawName, node) {
          ...
          const { key, value } = generateExportEntry(
            rawName ? rawName : name,
            scopedName,
            root.source.input.from,
            root.source.input.css,
...
var require_src = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  module.exports = (options) => {
    ...
    const createImportedName =
      ...
      ((importName) => `i__const_${importName.replace(/\W/g, "_")}_${importIndex++}`);
    return {
...
var require_pluginFactory = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function getDefaultPluginsList(opts, inputFile) {
    ...
    const generateScopedName = (0, _scoping.getScopedNameGenerator)(
  ...
  function getLoader(opts, plugins) {
    ...
    return typeof opts.Loader === "function"
      ...
      : new _FileSystemLoader.default(root, plugins, opts.resolve);
  }
    ...
    return {
      ...
      async OnceExit(css, { result }) {
        ...
        const loader = getLoader(opts, [
          ...result.processor.plugins.slice(0, resultPluginIndex),
          ...pluginList,
        ]);
        ...
        if (opts.localsConvention) {
          const reducer = (0, _localsConvention.makeLocalsConventionReducer)(
