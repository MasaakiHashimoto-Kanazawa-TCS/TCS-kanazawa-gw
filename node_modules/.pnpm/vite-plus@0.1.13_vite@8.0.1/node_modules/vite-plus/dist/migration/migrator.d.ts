...
export declare function detectEslintProject(
  projectPath: string,
...
export declare function migrateEslintToOxlint(
  projectPath: string,
  interactive: boolean,
...
export declare function detectPrettierProject(
  projectPath: string,
  packages?: WorkspacePackage[],
): {
  hasDependency: boolean;
...
export declare function migratePrettierToOxfmt(
  projectPath: string,
  interactive: boolean,
 ...
 */
export declare function rewriteStandaloneProject(
  projectPath: string,
 ...
 */
export declare function rewriteMonorepo(
  workspaceInfo: WorkspaceInfo,
  skipStagedMigration?: boolean,
  silent?: boolean,
  report?: MigrationReport,
 ...
 * @param projectPath - The path to the project
 */
export declare function rewriteMonorepoProject(
  projectPath: string,
...
export declare function rewritePackageJson(
  pkg: {
 ...
 */
export declare function mergeViteConfigFiles(
  projectPath: string,
  silent?: boolean,
  report?: MigrationReport,
): void;
 ...
 */
export declare function injectLintTypeCheckDefaults(
  projectPath: string,
  silent?: boolean,
  report?: MigrationReport,
): void;
 ...
 */
export declare function mergeStagedConfigToViteConfig(
  projectPath: string,
 ...
 */
export declare function setupGitHooks(
  projectPath: string,
  oldHooksDir?: string,
  silent?: boolean,
  report?: MigrationReport,
