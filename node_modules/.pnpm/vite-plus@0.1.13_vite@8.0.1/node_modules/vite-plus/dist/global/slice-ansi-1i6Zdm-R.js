import { a as ansiStyles, i as isWide, r as isFullWidth } from "./strip-ansi-DbamwI77.js";
...
function reduceAnsiCodes(codes) {
  ...
  for (const code of codes)
    if (code.code === ansiStyles.reset.open) returnValue = [];
    else if (endCodesSet.has(code.code))
      returnValue = returnValue.filter((returnValueCode) => returnValueCode.endCode !== code.code);
    else {
      returnValue = returnValue.filter(
        (returnValueCode) => returnValueCode.endCode !== code.endCode,
      );
