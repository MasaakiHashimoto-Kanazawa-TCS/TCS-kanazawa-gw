...
import {
  ...
  n as parse,
  y as Scalar,
} from "./browser-09BZLUYM.js";
import {
  a as editJsonFile,
  d as VITE_PLUS_OVERRIDE_PACKAGES,
  f as VITE_PLUS_VERSION,
  l as BASEURL_TSCONFIG_WARNING,
  o as isJsonFile,
  s as readJsonFile,
  t as detectPackageMetadata,
  u as VITE_PLUS_NAME,
} from "./package-D0VpX-8d.js";
...
const at = (t) =>
  ...
  X = (t, e = {}, s = {}) => {
    const i = e.limit ?? Infinity,
      r = e.ellipsis ?? "",
      n = e?.ellipsisWidth ?? (r ? X(r, ft, s).width : 0),
      u = s.ansiWidth ?? 0,
      a = s.controlWidth ?? 0,
      l = s.tabWidth ?? 8,
      E = s.ambiguousWidth ?? 1,
      g = s.emojiWidth ?? 2,
      m = s.fullWidthWidth ?? 2,
      A = s.regularWidth ?? 1,
      V = s.wideWidth ?? 2;
    let h = 0,
      o = 0,
    ...
    t: for (;;) {
      if (w > C || (o >= p && o > h)) {
        ...
        for (const Y of ut.replaceAll(ct, "")) {
          ...
          if (
            (lt($) ? (f = m) : ht($) ? (f = V) : E !== A && at($) ? (f = E) : (f = A),
            c + f > b && (d = Math.min(d, Math.max(C, h) + v)),
            c + f > i)
          ) {
            F = !0;
            break t;
      ...
      if (((M.lastIndex = o), M.test(t))) {
        if (
          ((v = M.lastIndex - o),
          (f = v * A),
          c + f > b && (d = Math.min(d, o + Math.floor((b - c) / A))),
          c + f > i)
        ) {
          F = !0;
          break;
      ...
      if (((L.lastIndex = o), L.test(t))) {
        if (
          ((v = L.lastIndex - o),
          (f = v * l),
          c + f > b && (d = Math.min(d, o + Math.floor((b - c) / l))),
          c + f > i)
        ) {
          F = !0;
          break;
  ...
  G = (t, e, s) => {
    ...
    for (; !l.done; ) {
      const m = l.value,
        A = S(m);
      (a + A <= s ? (t[t.length - 1] += m) : (t.push(m), (a = 0)),
        (m === T || m === Z) && ((r = !0), (n = e.startsWith(U, g + 1))),
        r
          ? n
            ? m === j && ((r = !1), (n = !1))
            : m === tt && (r = !1)
          : ((a += A), a === s && !E.done && (t.push(""), (a = 0))),
        (l = E),
        (E = i.next()),
        (g += m.length));
    }
    ((u = t.at(-1)),
      !a && u !== void 0 && u.length > 0 && t.length > 1 && (t[t.length - 2] += t.pop()));
  },
  vt = (t) => {
    const e = t.split(" ");
    let s = e.length;
  ...
  Et = (t, e, s = {}) => {
    ...
    for (const [h, o] of u.entries()) {
      ...
      if (
        (h !== 0 &&
          (p >= e && (s.wordWrap === !1 || s.trim === !1) && (l.push(""), (p = 0)),
          (p > 0 || s.trim === !1) && ((l[l.length - 1] += " "), p++)),
        s.hard && a[h] > e)
      ) {
        const v = e - p,
          F = 1 + Math.floor((a[h] - v - 1) / e);
...
const _ = {
  actions: new Set(["up", "down", "left", "right", "space", "enter", "cancel"]),
  aliases: new Map([
    ["k", "up"],
    ["j", "down"],
    ["h", "left"],
...
const bt = globalThis.process.platform.startsWith("win"),
...
function xt({ input: t = stdin, output: e = stdout, overwrite: s = !0, hideCursor: i = !0 } = {}) {
  ...
  return (
    i && e.write(import_src.cursor.hide),
    t.once("keypress", n),
    () => {
      (t.off("keypress", n),
        i && e.write(import_src.cursor.show),
        t instanceof ReadStream && t.isTTY && !bt && t.setRawMode(!1),
        (r.terminal = !1),
        r.close());
    }
  );
...
var B = class {
  ...
  prompt() {
    return new Promise((e) => {
      ...
      ((this.rl = c.createInterface({
        ...
        this.render(),
        this.once("submit", () => {
          (this.output.write(import_src.cursor.show),
  ...
  onKeypress(e, s) {
    if (
      ...
      s?.name &&
        (!this._track && _.aliases.has(s.name) && this.emit("cursor", _.aliases.get(s.name)),
        _.actions.has(s.name) && this.emit("cursor", s.name)),
      e &&
        (e.toLowerCase() === "y" || e.toLowerCase() === "n") &&
        this.emit("confirm", e.toLowerCase() === "y"),
      this.emit("key", e?.toLowerCase(), s),
      s?.name === "return")
    ) {
    ...
    (H([e, s?.name, s?.sequence], "cancel") && (this.state = "cancel"),
...
`),
  ...
  restoreCursor() {
    const e =
      K(this._prevFrame, process.stdout.columns, {
        hard: !0,
        trim: !1,
      }).split(`
`).length - 1;
  ...
  render() {
    ...
    if (e !== this._prevFrame) {
      if (this.state === "initial") this.output.write(import_src.cursor.hide);
        ...
        const s = _t(this._prevFrame, e),
          i = nt(this.output);
        if ((this.restoreCursor(), s)) {
          const r = Math.max(0, s.numLinesAfter - i),
            n = Math.max(0, s.numLinesBefore - i);
          ...
          if (s.lines.length === 1) {
            (this.output.write(import_src.cursor.move(0, u - n)),
              this.output.write(import_src.erase.lines(1)));
            const a = e.split(`
`);
            (this.output.write(a[u]),
              (this._prevFrame = e),
              this.output.write(import_src.cursor.move(0, a.length - u - 1)));
            return;
...
var kt = class extends B {
  ...
  constructor(e) {
    (super(e, !1),
      ...
      this.on("confirm", (s) => {
        (this.output.write(import_src.cursor.move(0, -1)),
          (this.value = s),
          (this.state = "submit"),
          this.close());
      }),
...
let Lt = class extends B {
  ...
  toggleAll() {
    ...
    this.value =
      this.value !== void 0 && this.value.length === e.length ? [] : e.map((i) => i.value);
  }
  toggleInvert() {
    const e = this.value;
    if (!e) return;
  ...
  toggleValue() {
    ...
    this.value = this.value.includes(this._value)
      ? this.value.filter((s) => s !== this._value)
      : [...this.value, this._value];
  }
  constructor(e) {
    (super(e, !1), (this.options = e.options), (this.value = [...(e.initialValues ?? [])]));
    const s = Math.max(
      this.options.findIndex(({ value: i }) => i === e.cursorAt),
      0,
    );
    ((this.cursor = this.options[s].disabled ? x(s, 1, this.options) : s),
      this.on("key", (i) => {
...
var Tt = class extends B {
  ...
  constructor(e) {
    ...
    const s = this.options.findIndex(({ value: r }) => r === e.initialValue),
      i = s === -1 ? 0 : s;
    ((this.cursor = this.options[i].disabled ? x(i, 1, this.options) : i),
      this.changeValue(),
      this.on("cursor", (r) => {
        switch (r) {
          case "left":
...
var $t = class extends B {
  get userInputWithCursor() {
    ...
    const s = e.slice(0, this.cursor),
      [i, ...r] = e.slice(this.cursor);
...
const getStringTruncatedWidth = (input, truncationOptions = {}, widthOptions = {}) => {
  ...
  const ELLIPSIS_WIDTH =
    ...
    (ELLIPSIS ? getStringTruncatedWidth(ELLIPSIS, NO_TRUNCATION$1, widthOptions).width : 0);
...
const limitOptions = (params) => {
  ...
  if (lineCount > outputMaxItems) {
    ...
    const trimLinesLocal = (startIndex, endIndex) =>
...
const confirm = (opts) => {
  ...
  return new kt({
    ...
    render() {
      ...
      switch (this.state) {
        case "submit":
          return `${title}${hasGuide ? `${color.gray(S_BAR)} ` : nestedPrefix}${color.dim(value)}\n`;
        case "cancel":
          return `${title}${hasGuide ? `${color.gray(S_BAR)} ` : nestedPrefix}${color.strikethrough(color.dim(value))}${hasGuide ? `\n${color.gray(S_BAR)}` : ""}\n`;
        default: {
  ...
  message: (
    ...
    if (messageParts.length > 0) {
      ...
      for (const ln of lines)
        if (ln.length > 0) parts.push(`${secondaryPrefix}${ln}`);
...
const multiselect = (opts) => {
  const opt = (option, state) => {
    ...
    if (state === "cancelled")
      return computeLabel$1(label, (text) => color.strikethrough(color.dim(text)));
  ...
  return new Lt({
    ...
    validate(selected) {
      if (required && (selected === void 0 || selected.length === 0))
    ...
    render() {
      ...
      const wrappedMessage = hasGuide
        ? Bt(opts.output, opts.message, `${symbolBar(this.state)} `, `${symbol(this.state)} `)
...
const spinner = ({
  ...
  const handleExit = (code) => {
    const msg =
      code > 1 ? (errorMessage ?? _.messages.error) : (cancelMessage ?? _.messages.cancel);
    isCancelled = code === 1;
    if (isSpinnerActive) {
      _stop(msg, code);
...
const select = (opts) => {
  const opt = (option, state) => {
    ...
    switch (state) {
      ...
      default:
        return withMarker(color.dim(" "), label, (text) => text, hint);
    }
  };
  return new Tt({
    options: opts.options,
...
const stream = {
  message: async (iterable, { symbol = "" } = {}) => {
    ...
    for await (let chunk of iterable) {
      ...
      if (chunk.includes("\n"))
        lineWidth =
          initialWidth + stripVTControlCharacters(chunk.slice(chunk.lastIndexOf("\n"))).length;
  ...
  return new $t({
    ...
    render() {
      ...
      switch (this.state) {
        ...
        default:
          return `${title}${hasGuide ? `${color.blue(S_BAR)} ` : nestedPrefix}${userInput}\n${hasGuide ? color.blue(S_BAR_END) : ""}\n`;
      }
    },
  }).prompt();
};
...
function hasBaseUrlInTsconfig(projectPath) {
  try {
    return (
      JSON.parse(fs.readFileSync(path.join(projectPath, "tsconfig.json"), "utf-8"))?.compilerOptions
        ?.baseUrl !== void 0
    );
  } catch {
    return false;
...
function detectConfigs(projectPath) {
  ...
  for (const config of [".oxlintrc.json"])
    if (fs.existsSync(path.join(projectPath, config))) {
      configs.oxlintConfig = config;
      break;
    }
  for (const config of [".oxfmtrc.json", ".oxfmtrc.jsonc"])
    if (fs.existsSync(path.join(projectPath, config))) {
...
async function migrateEslintToOxlint(
  projectPath,
  interactive,
  eslintConfigFile,
  packages,
...
async function migratePrettierToOxfmt(
  projectPath,
  interactive,
  prettierConfigFile,
  packages,
 ...
 * @param projectPath - The path to the project
 */
function rewriteStandaloneProject(
  projectPath,
  workspaceInfo,
  skipStagedMigration,
  silent = false,
 ...
 * @param projectPath - The path to the project
 */
function rewriteMonorepoProject(
  projectPath,
  packageManager,
  skipStagedMigration,
  silent = false,
...
function rewritePnpmWorkspaceYaml(projectPath) {
  ...
  editYamlFile(pnpmWorkspaceYamlPath, (doc) => {
    ...
    if (doc.has("minimumReleaseAge")) {
      ...
      if (!minimumReleaseAgeExclude) minimumReleaseAgeExclude = new YAMLSeq();
      const existing = new Set(minimumReleaseAgeExclude.items.map((n) => n.value));
      for (const exclude of excludes)
        if (!existing.has(exclude)) minimumReleaseAgeExclude.add(scalarString(exclude));
    ...
    if (!hasStagedConfigInViteConfig(projectPath)) {
      ...
      if (
        !mergeStagedConfigToViteConfig(
          projectPath,
          updated ? JSON.parse(updated) : config,
          true,
          report,
        )
      )
  ...
  if (errors > 0)
    if (report)
      ...
      for (const error of result.errors)
        log.error(`  ${displayRelative(error.path)}: ${error.message}`);
    }
}
/**
...
function checkUnsupportedHuskyVersion(deps, prodDeps) {
  ...
  return import_semver.default.satisfies(
    import_semver.default.coerce(huskyVersion) ?? "0.0.0",
    "<9.0.0",
  );
}
...
function setupGitHooks(projectPath, oldHooksDir, silent = false, report) {
  ...
  editJsonFile(packageJsonPath, (pkg) => {
    ...
    else if (!pkg.scripts.prepare.includes("vp config") && !/\bhusky\b/.test(pkg.scripts.prepare))
  ...
  if (!stagedMerged && !hasStandaloneConfig) {
    ...
    stagedMerged = mergeStagedConfigToViteConfig(
      projectPath,
      updated ? JSON.parse(updated) : stagedConfig,
      silent,
      report,
    );
  }
...
function resolveSingleAgentTargetPath(agent) {
  ...
  return (
    ...
    )?.targetPath ?? AGENTS[AGENTS.length - 1].targetPath
  );
}
/**
    ...
    if (fs.existsSync(destinationPath)) {
      ...
      if (
        replaceMarkedAgentInstructionsSection(
          await fsPromises.readFile(destinationPath, "utf-8"),
          incomingContent,
        ) !== void 0
      ) {
...
//#endregion
export {
  displayRelative as A,
  outro as B,
  defaultInteractive as C,
  runViteInstall as D,
  runViteFmt as E,
  cancel as F,
  spinner as H,
  ...
  select as V,
  Ct as W,
  rewriteMonorepoProject as _,
  writeAgentInstructions as a,
  editYamlFile as b,
  detectEslintProject as c,
  installGitHooks as d,
  mergeViteConfigFiles as f,
  rewriteMonorepo as g,
  preflightGitHooksSetup as h,
  updateExistingAgentInstructions as i,
  templatesDir as j,
  upgradeYarn as k,
  detectPrettierProject as l,
  migratePrettierToOxfmt as m,
  detectExistingAgentTargetPaths as n,
  checkViteVersion as o,
  migrateEslintToOxlint as p,
  selectAgentTargetPaths as r,
  checkVitestVersion as s,
  detectAgentConflicts as t,
  ensurePreCommitHook as u,
  rewriteStandaloneProject as v,
  downloadPackageManager$1 as w,
  readYamlFile as x,
  createMigrationReport as y,
  multiselect as z,
};
