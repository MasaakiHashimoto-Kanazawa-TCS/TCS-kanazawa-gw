...
const VITE_PLUS_OVERRIDE_PACKAGES = process.env.VITE_PLUS_OVERRIDE_PACKAGES
...
const BASEURL_TSCONFIG_WARNING =
...
function detectPackageMetadata(projectPath, packageName) {
  try {
    const pkgFilePath = createRequire(path.join(projectPath, "noop.js")).resolve(
...
export {
  editJsonFile as a,
  writeJsonFile as c,
  VITE_PLUS_OVERRIDE_PACKAGES as d,
  VITE_PLUS_VERSION as f,
  readNearestPackageJson as i,
  BASEURL_TSCONFIG_WARNING as l,
  getScopeFromPackageName as n,
  isJsonFile as o,
  hasVitePlusDependency as r,
  readJsonFile as s,
  detectPackageMetadata as t,
  VITE_PLUS_NAME as u,
};
