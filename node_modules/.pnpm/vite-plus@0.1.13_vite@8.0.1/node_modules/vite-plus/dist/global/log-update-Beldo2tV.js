import { t as stripAnsi } from "./strip-ansi-DbamwI77.js";
...
!isBrowser &&
  (process$1.env.TERM?.startsWith("screen") ||
    process$1.env.TERM?.startsWith("tmux") ||
    process$1.env.TMUX);
...
const { onExit, load, unload } = signalExitWrap(
  processOk(process$2) ? new SignalExit(process$2) : new SignalExitFallback(),
);
//#endregion
//#region ../../node_modules/.pnpm/restore-cursor@5.1.0/node_modules/restore-cursor/index.js
const terminal = process$1.stderr.isTTY
  ? process$1.stderr
  : process$1.stdout.isTTY
    ? process$1.stdout
    : void 0;
const restoreCursor = terminal
  ? onetime(() => {
      onExit(
        () => {
