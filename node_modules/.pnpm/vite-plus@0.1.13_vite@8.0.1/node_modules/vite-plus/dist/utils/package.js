...
export function getScopeFromPackageName(packageName) {
  if (packageName.startsWith("@")) {
    return packageName.split("/")[0];
  }
  return "";
}
export function detectPackageMetadata(projectPath, packageName) {
  try {
 ...
 */
export function readNearestPackageJson(currentDir) {
  do {
