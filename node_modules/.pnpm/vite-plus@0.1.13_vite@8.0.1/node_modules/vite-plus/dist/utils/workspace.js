...
import { DependencyType, PackageManager } from "../types/index.js";
...
export function findPackageJsonFilesFromPatterns(patterns, cwd) {
...
export async function detectWorkspace(rootDir) {
  ...
  if (bindingResult.packageManagerName) {
    result.packageManager = bindingResult.packageManagerName;
  }
...
export function discoverWorkspacePackages(workspacePatterns, rootDir) {
  const packages = [];
...
export function updatePackageJsonWithDeps(rootDir, projectDir, dependencies, dependencyType) {
...
export function updateWorkspaceConfig(projectPath, workspaceInfo) {
