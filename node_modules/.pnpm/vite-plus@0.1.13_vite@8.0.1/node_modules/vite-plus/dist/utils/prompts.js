...
export function cancelAndExit(message = "Operation cancelled", exitCode = 0) {
...
export async function downloadPackageManager(packageManager, version, interactive, silent = false) {
...
export async function upgradeYarn(cwd, interactive, silent = false) {
  const spinner = silent ? getSilentSpinner() : getSpinner(interactive);
...
export function getSpinner(interactive) {
  if (interactive) {
