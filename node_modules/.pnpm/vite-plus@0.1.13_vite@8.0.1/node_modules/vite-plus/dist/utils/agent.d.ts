...
export declare function selectAgentTargetPaths({
  interactive,
  agent,
  onCancel,
}: {
...
export declare function selectAgentTargetPath({
  interactive,
  agent,
  onCancel,
}: {
 ...
 */
export declare function updateExistingAgentInstructions(projectRoot: string): void;
 ...
 */
export declare function detectAgentConflicts({
  projectRoot,
  targetPaths,
}: {
  projectRoot: string;
...
export declare function writeAgentInstructions({
  projectRoot,
  targetPath,
  targetPaths,
  interactive,
...
export declare function replaceMarkedAgentInstructionsSection(
  existing: string,
  incoming: string,
): string | undefined;
