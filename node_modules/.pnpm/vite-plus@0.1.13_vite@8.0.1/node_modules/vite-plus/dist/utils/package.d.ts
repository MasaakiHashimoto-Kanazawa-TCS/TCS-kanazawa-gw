...
export declare function detectPackageMetadata(
  projectPath: string,
  packageName: string,
 ...
 */
export declare function readNearestPackageJson<T = Record<string, unknown>>(
  currentDir: string,
): T | null;
export declare function hasVitePlusDependency(
  pkg?: {
