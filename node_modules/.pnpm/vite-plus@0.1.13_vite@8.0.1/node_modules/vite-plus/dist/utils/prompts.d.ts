...
export declare function selectPackageManager(
  interactive?: boolean,
  silent?: boolean,
...
export declare function downloadPackageManager(
  ...
  interactive?: boolean,
  silent?: boolean,
): Promise<import("../../binding/index.cjs").DownloadPackageManagerResult>;
export declare function runViteInstall(
  cwd: string,
  interactive?: boolean,
  extraArgs?: string[],
  options?: {
...
>;
export declare function runViteFmt(
  cwd: string,
  interactive?: boolean,
  paths?: string[],
  options?: {
...
>;
export declare function upgradeYarn(
  cwd: string,
  interactive?: boolean,
  silent?: boolean,
): Promise<void>;
...
export declare function getSpinner(interactive?: boolean):
  | prompts.SpinnerResult
  | {
