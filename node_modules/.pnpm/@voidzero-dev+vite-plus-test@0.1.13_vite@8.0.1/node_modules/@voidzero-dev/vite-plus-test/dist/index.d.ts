import {
  M as ModuleDefinitionDurationsDiagnostic,
  U as UntrackedModuleDefinitionDiagnostic,
  S as SerializedTestSpecification,
  a as ModuleDefinitionDiagnostic,
  b as ModuleDefinitionLocation,
  c as SourceModuleDiagnostic,
  d as SourceModuleLocations,
} from "./chunks/browser.d.X3SXoOCV.js";
...
export {
  ...
  T as TestExecutionMethod,
  W as WorkerGlobalState,
} from "./chunks/worker.d.B84sVRy0.js";
import {
  S as SerializedConfig,
  F as FakeTimerInstallOpts,
  R as RuntimeOptions,
} from "./chunks/config.d.EJLVE3es.js";
export { b as RuntimeConfig, a as SerializedCoverageConfig } from "./chunks/config.d.EJLVE3es.js";
import {
  U as UserConsoleLog,
  L as LabelColor,
  M as ModuleGraphData,
  P as ProvidedContext,
} from "./chunks/rpc.d.BFMWpdph.js";
export {
...
export {
  NodeBenchmarkRunner as BenchmarkRunner,
  VitestTestRunner as TestRunner,
} from "./runners.js";
export {
  a as BenchFunction,
  b as Benchmark,
  c as BenchmarkAPI,
  B as BenchmarkResult,
} from "./chunks/benchmark.d.DAaHLpsq.js";
...
interface VitestUtils {
  ...
  doMock<T>(
    module: Promise<T>,
    factory?: ModuleMockFactoryWithHelper<T> | ModuleMockOptions,
  ): Disposable;
  /**
