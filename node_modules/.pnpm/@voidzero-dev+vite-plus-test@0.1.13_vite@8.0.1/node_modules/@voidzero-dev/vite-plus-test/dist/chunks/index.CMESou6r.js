        ...
        case "install-metadata": {
          for (const metadata of Object.keys(INSTALL_METADATA)) {
            ...
            if (await pathExists(path.join(directory, metadata), fileOrDir)) {
              ...
              const agent =
                name === "yarn" ? (isMetadataYarnClassic(metadata) ? "yarn" : "yarn@berry") : name;
              return { name, agent };
            }
          }
          break;
...
async function installPackage(names, options = {}) {
  ...
  return x(
    agent,
    [agent === "yarn" ? "add" : "install", options.dev ? "-D" : "", ...args, ...names].filter(
      Boolean,
    ),
    {
      nodeOptions: {
...
async function uninstallPackage(names, options = {}) {
  ...
  return x(
    agent,
    [agent === "yarn" ? "remove" : "uninstall", options.dev ? "-D" : "", ...args, ...names].filter(
      Boolean,
    ),
    {
      nodeOptions: {
