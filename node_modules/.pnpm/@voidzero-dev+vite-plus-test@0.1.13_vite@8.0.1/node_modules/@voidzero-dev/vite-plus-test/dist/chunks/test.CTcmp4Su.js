...
import {
  g as getWorkerState,
  i as isChildProcess,
  w as waitForImportsToResolve,
  r as resetModules,
} from "./utils.BX5Fg8C4.js";
import {
  chai,
  wrapAssertion,
  recordAsyncExpect,
              ...
              while (true) {
                ...
                try {
                  ...
                  if (
                    isLastAttempt ||
                    (executionPhase === "assertion" &&
                      chai.util.flag(assertion, "_poll.assert_once"))
                  ) {
                    await onSettled?.({
                      assertion,
                      status: "fail",
...
const SnapshotPlugin = (chai, utils) => {
  ...
  for (const key of ["matchSnapshot", "toMatchSnapshot"])
    utils.addMethod(
      ...
      key,
      wrapAssertion(utils, key, function (properties, message) {
  ...
  utils.addMethod(
    ...
    wrapAssertion(
      utils,
      "toMatchInlineSnapshot",
      function __INLINE_SNAPSHOT_OFFSET_3__(properties, inlineSnapshot, message) {
  ...
  utils.addMethod(
    chai.Assertion.prototype,
    "toThrowErrorMatchingSnapshot",
    wrapAssertion(utils, "toThrowErrorMatchingSnapshot", function (properties, message) {
  ...
  utils.addMethod(
    ...
    wrapAssertion(
      utils,
      "toThrowErrorMatchingInlineSnapshot",
      function __INLINE_SNAPSHOT_OFFSET_3__(inlineSnapshot, message) {
        if (utils.flag(this, "negate"))
...
class TestRunner {
  ...
  extendTaskContext(context) {
    ...
    if (this.config.expect.requireAssertions)
      this.assertionsErrors.set(
        context.task,
        /* @__PURE__ */ new Error("expected any number of assertion, but got none"),
      );
    let _expect;
  ...
  getImportDurations() {
    ...
    const sortedEntries = [...(this.workerState.moduleExecutionInfo?.entries() || [])]
