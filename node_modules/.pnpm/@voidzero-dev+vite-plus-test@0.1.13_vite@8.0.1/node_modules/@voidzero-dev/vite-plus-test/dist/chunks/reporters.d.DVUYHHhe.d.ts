...
import {
  ...
  ParsedStack,
  Awaitable,
} from "../@vitest/utils/index.js";
import {
  A as AfterSuiteRunMeta,
  U as UserConsoleLog,
  b as AsyncLeak,
  P as ProvidedContext,
  L as LabelColor,
} from "./rpc.d.BFMWpdph.js";
import { Writable } from "node:stream";
import {
  DevEnvironment,
  TransformResult as TransformResult$1,
  ViteDevServer,
  Plugin,
  UserConfig as UserConfig$1,
...
import {
  S as SerializedTestSpecification,
  c as SourceModuleDiagnostic,
  B as BrowserTesterOptions,
} from "./browser.d.X3SXoOCV.js";
import {
  B as BrowserTraceViewMode,
  S as SerializedConfig,
  F as FakeTimerInstallOpts,
} from "./config.d.EJLVE3es.js";
...
import {
  c as ContextTestEnvironment,
  d as WorkerExecuteContext,
  e as WorkerTestEnvironment,
} from "./worker.d.B84sVRy0.js";
...
import { CDPSession, BrowserCommands } from "../@vitest/browser/context.js";
...
type HappyDOMOptions = Omit<
  NonNullable<ConstructorParameters<typeof happyDomTypes.Window>[0]>,
  "console"
>;

type JSDOMOptions = ConstructorOptionsOverride &
...
declare function experimental_getRunnerTask(
...
type ResolvedCoverageOptions<T extends CoverageProviderName = CoverageProviderName> =
  CoverageOptions<T> &
...
interface CustomProviderOptions extends Pick<
  BaseCoverageOptions,
  FieldsWithDefaultValues | "changed"
> {
...
interface BrowserCommand<Payload extends unknown[] = [], ReturnValue = any> {
...
declare class TestProject {
  ...
  private _provided;
  constructor(vitest: Vitest, options?: InitializeProjectOptions, tmpDir?: string);
  /**
  ...
  createSpecification(
    moduleId: string,
    locationsOrOptions?: number[] | TestSpecificationOptions,
    pool?: string,
  ): TestSpecification;
...
interface BenchmarkUserOptions {
  ...
  outputFile?:
    | string
    | (Partial<Record<BenchmarkBuiltinReporters, string>> & Record<string, string>);
  /**
...
type ResolveSnapshotPathHandler = (
  testPath: string,
...
> {
  ...
  cliExclude?: string[];
  project: string[];
  benchmark?: Required<Omit<BenchmarkUserOptions, "outputFile" | "compare" | "outputJson">> &
...
export {
  ...
  Vitest as V,
  DotReporter as a1,
  GithubActionsReporter as a3,
  HangingProcessReporter as a5,
  JUnitReporter as a7,
  TestModule as aB,
  TestSuite as aM,
  VerboseBenchmarkReporter as aR,
  VerboseReporter as aS,
  VitestPackageInstaller as aU,
  experimental_getRunnerTask as aX,
  CoverageMap as aY,
  JsonReporter as aa,
  ReportersMap as ap,
  TapFlatReporter as av,
  TapReporter as aw,
  TestCase as ay,
  TestCollection as az,
  TestSpecification as i,
  AgentReporter as m,
  BaseReporter as n,
  BenchmarkReporter as p,
  BenchmarkReportsMap as q,
};
export type {
  ApiConfig as A,
  BaseCoverageOptions as B,
  CoverageV8Options as C,
  BrowserProviderOption as D,
  BrowserScript as E,
  BrowserServerFactory as F,
  BrowserServerOptions as G,
  BrowserServerState as H,
  InlineConfig as I,
  BrowserServerStateSession as J,
  BuiltinEnvironment as K,
  BuiltinReporterOptions as M,
  BuiltinReporters as N,
  CSSModuleScopeStrategy as O,
  PoolWorker as P,
  CoverageIstanbulOptions as Q,
  ResolvedCoverageOptions as R,
  CoverageOptions as S,
  UserWorkspaceConfig as U,
  WatcherTriggerPattern as W,
  CoverageProvider as X,
  CoverageProviderModule as Y,
  CoverageReporter as Z,
  CustomProviderOptions as _,
  TestProjectConfiguration as a,
  DepsOptimizationOptions as a0,
  EnvironmentOptions as a2,
  HTMLOptions as a4,
  JUnitOptions as a6,
  JsonAssertionResult as a8,
  JsonOptions as a9,
  TestDiagnostic as aA,
  TestModuleState as aC,
  TestResult as aD,
  TestResultFailed as aE,
  TestResultPassed as aF,
  TestResultSkipped as aG,
  TestRunEndReason as aH,
  TestRunResult as aI,
  TestSequencerConstructor as aJ,
  TestSpecificationOptions as aK,
  TestState as aL,
  TestSuiteState as aN,
  ToMatchScreenshotComparators as aO,
  ToMatchScreenshotOptions as aP,
  TypecheckConfig as aQ,
  VitestEnvironment as aT,
  WorkerResponse as aV,
  _BrowserNames as aW,
  JsonTestResult as ab,
  JsonTestResults as ac,
  ModuleDiagnostic as ad,
  OnServerRestartHandler as ae,
  OnTestsRerunHandler as af,
  ParentProjectBrowser as ag,
  Pool as ah,
  PoolRunnerInitializer as ai,
  PoolTask as aj,
  ProjectBrowser as ak,
  ProjectConfig as al,
  ReportContext as am,
  ReportedHookContext as an,
  Reporter as ao,
  ResolveSnapshotPathHandler as aq,
  ResolveSnapshotPathHandlerContext as ar,
  ResolvedBrowserOptions as as,
  ResolvedProjectConfig as at,
  SerializedTestProject as au,
  TaskOptions as ax,
  UserProjectConfigFn as b,
  UserProjectConfigExport as c,
  TestProjectInlineConfiguration as d,
  UserConfig as e,
  ResolvedConfig as f,
  VitestRunMode as g,
  VitestOptions as h,
  ...
  WorkerRequest as k,
  TestSequencer as l,
  BenchmarkBuiltinReporters as o,
  BenchmarkUserOptions as r,
  BrowserBuiltinProvider as s,
  BrowserCommand as t,
  BrowserCommandContext as u,
  BrowserConfigOptions as v,
  BrowserInstanceOption as w,
  BrowserModuleMocker as x,
  BrowserOrchestrator as y,
  BrowserProvider as z,
};
