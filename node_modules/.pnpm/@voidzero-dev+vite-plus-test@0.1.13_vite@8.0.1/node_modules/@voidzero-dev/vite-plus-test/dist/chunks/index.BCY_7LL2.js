...
import {
  fileURLToPath as fileURLToPath$1,
  pathToFileURL as pathToFileURL$1,
  URL as URL$1,
} from "node:url";
...
function emitInvalidSegmentDeprecation(
  ...
  process$1.emitWarning(
    `Use of deprecated ${
      ...
      `request "${request}" ${request === match ? "" : `matched to "${match}" `}in the "${
...
function throwInvalidSubpath(request, match, packageJsonUrl, internal, base) {
  ...
  throw new ERR_INVALID_MODULE_SPECIFIER(request, reason, base && fileURLToPath$1(base));
}
...
function _resolve$1(id, options = {}) {
  ...
  const _urls = (Array.isArray(options.url) ? options.url : [options.url])
    .filter(Boolean)
