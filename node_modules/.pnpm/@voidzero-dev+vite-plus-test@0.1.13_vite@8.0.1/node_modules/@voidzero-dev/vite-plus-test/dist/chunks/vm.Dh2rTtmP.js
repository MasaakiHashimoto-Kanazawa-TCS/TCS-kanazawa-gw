...
class CommonjsExecutor {
  ...
  createRequire = (filename) => {
    ...
    const require = (id) => {
      ...
      if (extname(resolved) === ".node" || isBuiltin(resolved))
  ...
  // }
  require(identifier) {
    if (extname(identifier) === ".node" || isBuiltin(identifier))
...
class ExternalModulesExecutor {
  ...
  getModuleInformation(identifier) {
    ...
    if (this.vite.canResolve(fileUrl)) type = "vite";
      ...
      type = findNearestPackageData(normalize(pathUrl)).type === "module" ? "module" : "commonjs";
    return {
      type,
      path: pathUrl,
      url: fileUrl,
