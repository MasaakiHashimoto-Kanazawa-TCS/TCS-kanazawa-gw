(function () {
  ...
  function normalizeWindowsPath(input = "") {
    return (
      input && input.replace(/\\/g, "/").replace(_DRIVE_LETTER_START_RE, (r) => r.toUpperCase())
    );
  }
  ...
  const MODULE_RUNNER_SOURCEMAPPING_REGEXP = /* @__PURE__ */ RegExp(
  ...
  var EvaluatedModuleNode = class {
    ...
    EvaluatedModules = class {
      ...
      getModuleSourceMapById(id) {
        ...
        let mapString = MODULE_RUNNER_SOURCEMAPPING_REGEXP.exec(
