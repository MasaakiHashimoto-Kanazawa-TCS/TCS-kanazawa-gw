...
type Node$4 = NodeMap[keyof NodeMap];
...
interface TemplateElement extends BaseNode {
  ...
  tail: boolean;
  value: {
    /** It is null when the template literal is tagged and the text has an invalid escape (e.g. - tag`\unicode and \u{55}`) */ cooked?:
      | string
      | null
      | undefined;
    raw: string;
...
//#endregion
//#region ../../node_modules/.pnpm/estree-walker@3.0.3/node_modules/estree-walker/types/walker.d.ts
type Node$3 = Node$4;
type WalkerContext$2 = {
  skip: () => void;
  remove: () => void;
  replace: (node: Node$3) => void;
};
//#endregion
//#region ../../node_modules/.pnpm/estree-walker@3.0.3/node_modules/estree-walker/types/sync.d.ts
type Node$2 = Node$4;
type WalkerContext$1 = WalkerContext$2;
type SyncHandler$1 = (
  this: WalkerContext$1,
  node: Node$2,
  parent: Node$2 | null,
...
//#endregion
//#region ../../node_modules/.pnpm/estree-walker@3.0.3/node_modules/estree-walker/types/async.d.ts
type Node$1 = Node$4;
type WalkerContext = WalkerContext$2;
type AsyncHandler$1 = (
  this: WalkerContext,
  node: Node$1,
  parent: Node$1 | null,
...
//#endregion
//#region ../../node_modules/.pnpm/estree-walker@3.0.3/node_modules/estree-walker/types/index.d.ts
/**
...
type Node = Node$4;
type SyncHandler = SyncHandler$1;
type AsyncHandler = AsyncHandler$1;
//#endregion
export { AsyncHandler, Node, SyncHandler, asyncWalk, walk };
