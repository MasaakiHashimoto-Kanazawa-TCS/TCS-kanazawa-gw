 ...
 */
type ExtendsExcludingAnyOrNever<Left, Right> =
...
type StrictEqualUsingTSInternalIdenticalToOperator<L, R> =
  (<T>() => T extends (L & T) | T ? true : false) extends <T>() => T extends (R & T) | T
    ? true
    : false
 ...
 */
type TuplifyUnion<Union, LastElement = LastOf<Union>> =
 ...
 */
type IsUselessOverloadInfo<FunctionType> = StrictEqualUsingTSInternalIdenticalToOperator<
  FunctionType,
  UnknownFunction
>;
/**
 ...
 * @see {@link https://github.com/microsoft/TypeScript/issues/28867 | Related}
 */
type TSPre53OverloadsInfoUnion<FunctionType> =
 ...
 */
type OverloadsInfoUnion<FunctionType> =
 ...
 */
type SelectOverloadsInfo<Union extends UnknownFunction, Args extends unknown[]> =
 ...
 */
type OverloadsNarrowedByParameters<
  FunctionType,
 ...
 */
type IsUselessConstructorOverloadInfo<FunctionType> = StrictEqualUsingTSInternalIdenticalToOperator<
  FunctionType,
  UnknownConstructor
>;
/**
 ...
 * @see {@link https://github.com/microsoft/TypeScript/issues/28867 | Related}
 */
type TSPre53ConstructorOverloadsInfoUnion<ConstructorType> =
 ...
 * falls back to the more complicated utility.
 */
type ConstructorOverloadsUnion<ConstructorType> =
 ...
 */
type MismatchInfo<Actual, Expected> =
 ...
 */
type Optionalify<T, TOptionalKeys> = [TOptionalKeys] extends [never]
  ? T
 ...
 */
interface PositiveExpectTypeOf<Actual> extends BaseExpectTypeOf<
  Actual,
  {
    positive: true;
    branded: false;
...
> {
   ...
   */
  toExtend: <
    Expected extends Extends<Actual, Expected> extends true
      ? unknown
  ...
  toEqualTypeOf: {
    ...
    >(
      ...
      ...MISMATCH: MismatchArgs<
        StrictEqualUsingTSInternalIdenticalToOperator<Actual, Expected>,
        true
      >
    ): true;
    /**
 ...
 */
interface NegativeExpectTypeOf<Actual> extends BaseExpectTypeOf<
  Actual,
  {
    positive: false;
  }
...
> {
   ...
   */
  parameter: <Index extends number>(
    index: Index,
   ...
   * ```
   */
  resolves: Actual extends PromiseLike<infer ResolvedType>
    ? ExpectTypeOf<ResolvedType, Options>
    : never;
  /**
...
export {
  ...
  IsUnion,
  IsUnknown,
  IsUselessConstructorOverloadInfo,
  IsUselessOverloadInfo,
  LastOf,
  MismatchArgs,
  MismatchInfo,
  MutuallyExtends,
  ...
  StrictEqualUsingTSInternalIdenticalToOperator,
  TSPost53ConstructorOverloadsInfoUnion,
  TSPost53OverloadsInfoUnion,
  TSPre53ConstructorOverloadsInfoUnion,
  TSPre53OverloadsInfoUnion,
  Tuplify,
  TuplifyUnion,
  UnionToIntersection,
  UnionToTuple,
