...
let _lazyMatch = () => {
  var __lib__ = (() => {
    var m = Object.defineProperty,
      ...
      J = (r) => H(m({}, "__esModule", { value: true }), r),
      w = {};
    q(w, { default: () => re });
    var A = (r) => Array.isArray(r),
      d = (r) => typeof r == "function",
      Q = (r) => r.length === 0,
      W = (r) => typeof r == "number",
      K = (r) => typeof r == "object" && r !== null,
      X = (r) => r instanceof RegExp,
      b = (r) => typeof r == "string",
      h = (r) => r === void 0,
      Y = (r) => {
      ...
      i = (r, e) => (A(r) ? er(r, e) : b(r) ? ar(r, e) : nr(r, e)),
      er = (r, e) => {
        const n = {};
        for (const a of r) {
        ...
        return (a) => {
          ...
          if (u > t) {
            if (!h(e) && !a.options.silent) {
              const s = a.input.slice(t, u),
                c = d(e) ? e(s, o, String(t)) : e;
              h(c) || a.output.push(c);
            }
      ...
      g = (() => {
        ...
        return (e) => {
          ...
          return (t) => {
            ...
            const u = t.index,
              s = (o = t.cache)[a] || (o[a] = /* @__PURE__ */ new Map()),
              c = s.get(u);
            if (c === false) return false;
            if (W(c)) return ((t.index = c), true);
            if (c)
              return ((t.index = c.index), c.output?.length && t.output.push(...c.output), true);
            {
      ...
      or = (r, e, n) => S(r, e).map((a) => String(a).padStart(n, "0")),
      R = (r, e) => S(O(r), O(e)).map(ir),
      p = (r) => r,
      z = (r) => ur((e) => rr(e, r, { memoization: false }).join("")),
      ur = (r) => {
        const e = {};
      ...
      cr = i(
        /^\*\*\/(\*)?([ a-zA-Z0-9._-]+)$/,
        (r, e, n) => `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}`,
      ),
      lr = i(
        /^\*\*\/(\*)?([ a-zA-Z0-9._-]*)\{([ a-zA-Z0-9._-]+(?:,[ a-zA-Z0-9._-]+)*)\}$/,
        (r, e, n, a) =>
          `.*${e ? "" : "(?:^|/)"}${n.replaceAll(".", "\\.")}(?:${a.replaceAll(",", "|").replaceAll(".", "\\.")})`,
      ),
      y = i(/\\./, p),
      pr = i(/[$.*+?^(){}[\]|]/, (r) => `\\${r}`),
      vr = i(/./, p),
      ...
      I = x([
        ...
        l([
          ...
          i(/([A-Z]+)\.\.([A-Z]+)/, (r, e, n) =>
            R(e.toLowerCase(), n.toLowerCase()).join("|").toUpperCase(),
          ),
        ]),
        Or,
      ]),
      ...
      Fr = i(/[$.*+?^(){[\]|]/, (r) => `\\${r}`),
      Lr = i(/[^}]/, p),
      F = x([kr, f(l([j, N, k, B, I, E(() => F), y, Fr, Ir, Lr])), Br]),
      L = z(f(l([sr, cr, lr, fr, j, N, k, B, I, F, y, pr, vr]))),
      Tr = i(/\\./, p),
      qr = i(/./, p),
      Yr = z(
        f(
      ...
      $ = (r, e) => {
        ...
        const a = n.map($.compile),
          t = n.every((s) => /(\/(?:\*\*)?|\[\/\])$/.test(s)),
          o = e.replace(/[\\/]+/g, "/").replace(/\/$/, t ? "/" : "");
