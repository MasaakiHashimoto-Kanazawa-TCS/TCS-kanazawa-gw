...
function interpretTaskModes(
  ...
  const traverseSuite = (suite, parentIsOnly, parentMatchedWithLocation) => {
    ...
    const hasSomeTasksOnly =
      onlyMode &&
      suite.tasks.some((t) => t.mode === "only" || (t.type === "suite" && someTasksAreOnly(t)));
...
class TokenStream {
  ...
  unexpectedToken() {
    ...
    throw new Error(
      `Invalid tags expression: unexpected "${formatToken(token)}" in "${this.expr}"`,
    );
  }
}
...
export {
  createChainable as a,
  createFileTask as b,
  calculateSuiteHash as c,
  createTagsFilter as d,
  createTaskName as e,
  findTestFileStackTrace as f,
  generateFileHash as g,
  generateHash as h,
  getFullName as i,
  getNames as j,
  getSuites as k,
  ...
  hasFailed as o,
  hasTests as p,
  interpretTaskModes as q,
  isTestCase as r,
  limitConcurrency as s,
  partitionSuiteChildren as t,
  someTasksAreOnly as u,
  validateTags as v,
  getChainableContext as w,
  createNoTagsError as x,
};
