...
declare function diffLinesUnified(
  aLines: Array<string>,
  bLines: Array<string>,
  options?: DiffOptions,
): string;
declare function diffLinesUnified2(
...
declare function diffStringsRaw(
  a: string,
  b: string,
  cleanup: boolean,
  options?: DiffOptions,
...
declare function replaceAsymmetricMatcher(
  actual: any,
  expected: any,
  actualReplaced?: WeakSet<WeakKey>,
  expectedReplaced?: WeakSet<WeakKey>,
): {
  replacedActual: any;
