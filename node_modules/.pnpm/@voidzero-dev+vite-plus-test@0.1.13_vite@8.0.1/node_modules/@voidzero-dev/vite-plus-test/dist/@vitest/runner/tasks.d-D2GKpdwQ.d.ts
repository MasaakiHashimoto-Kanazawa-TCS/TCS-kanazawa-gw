 ...
 * ```
 */
declare function beforeAll<ExtraContext = object>(
  this: unknown,
 ...
 * ```
 */
declare function afterAll<ExtraContext = object>(
  this: unknown,
 ...
 * ```
 */
declare function beforeEach<ExtraContext = object>(
 ...
 * ```
 */
declare function afterEach<ExtraContext = object>(
 ...
 * ```
 */
declare function aroundAll<ExtraContext = object>(
  this: unknown,
 ...
 * ```
 */
declare function aroundEach<ExtraContext = object>(
...
declare function createChainable<T extends string, Args extends any[], R = any>(
  keys: T[],
...
type TestFunction<ExtraContext = object> = (
  context: TestContext & ExtraContext,
) => Awaitable<any> | void;
...
type TestAPI<ExtraContext = object> = ChainableTestAPI<ExtraContext> &
...
export {
  ...
  beforeEach as ad,
  onTestFailed as ae,
  onTestFinished as af,
  createChainable as ah,
};
export type {
  TestFunction as $,
  AfterAllListener as A,
  BeforeAllListener as B,
  CancelReason as C,
  TaskBase as D,
  TaskCustomOptions as E,
  FileSpecification as F,
  TaskEventPack as G,
  TaskHook as H,
  ImportDuration as I,
  TaskMeta as J,
  ...
  TaskResultPack as M,
  TaskState as N,
  OnTestFailedHandler as O,
  TestAnnotation as P,
  TestAnnotationArtifact as Q,
  Retry as R,
  Suite as S,
  TestArtifact as T,
  TestAnnotationLocation as U,
  VitestRunner as V,
  TestArtifactBase as W,
  TestArtifactLocation as X,
  TestArtifactRegistry as Y,
  TestAttachment as Z,
  TestContext as _,
  Test as a,
  TestOptions as a0,
  TestTagDefinition as a1,
  TestTags as a2,
  Use as a3,
  VisualRegressionArtifact as a4,
  VitestRunnerConfig as a5,
  VitestRunnerConstructor as a6,
  VitestRunnerImportSource as a7,
  ChainableFunction as ag,
  SuiteHooks as b,
  File as c,
  TaskUpdateEvent as d,
  Task as e,
  TestAPI as f,
  SuiteAPI as g,
  SuiteCollector as h,
  AfterEachListener as i,
  AroundAllListener as j,
  AroundEachListener as k,
  BeforeEachListener as l,
  FailureScreenshotArtifact as m,
  Fixture as n,
  FixtureFn as o,
  FixtureOptions as p,
  Fixtures as q,
  InferFixturesTypes as r,
  OnTestFinishedHandler as s,
  RunMode as t,
  RuntimeContext as u,
  SequenceHooks as v,
  SequenceSetupFiles as w,
  SerializableRetry as x,
  SuiteFactory as y,
  SuiteOptions as z,
};
