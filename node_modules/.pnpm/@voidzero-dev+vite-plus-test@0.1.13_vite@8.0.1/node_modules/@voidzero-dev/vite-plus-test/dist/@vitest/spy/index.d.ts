...
type MockReturnType<T extends Procedure | Constructable> = T extends Constructable
  ...
  : T extends Procedure
    ? ReturnType<T>
    : never;
type MockProcedureContext<T extends Procedure | Constructable> = T extends Constructable
  ? InstanceType<T>
  : ThisParameterType<T>;
...
type Properties<T> = { [K in keyof T]: T[K] extends Procedure ? never : K }[keyof T] &
  (string | symbol);
type Classes<T> = {
...
type PartialResultFunction<T> = T extends Constructable
  ...
  : T extends Procedure
    ...
    : T;
type PartialMock<T extends Procedure | Constructable = Procedure> = Mock<
...
type PartiallyMockedFunction<T extends Procedure | Constructable> = PartialMock<T> & {
  [K in keyof T]: T[K];
};
type MockedFunctionDeep<T extends Procedure | Constructable> = Mock<T> & MockedObjectDeep<T>;
type PartiallyMockedFunctionDeep<T extends Procedure | Constructable> = DeepPartialMock<T> &
  MockedObjectDeep<T>;
...
type MaybeMockedDeep<T> = T extends Procedure | Constructable
  ? MockedFunctionDeep<T>
  : T extends object
    ? MockedObjectDeep<T>
    : T;
type MaybePartiallyMockedDeep<T> = T extends Procedure | Constructable
  ? PartiallyMockedFunctionDeep<T>
  : T extends object
    ? MockedObjectDeep<T>
    : T;
type MaybeMocked<T> = T extends Procedure | Constructable
  ? MockedFunction<T>
  : T extends object
    ? MockedObject<T>
    : T;
type MaybePartiallyMocked<T> = T extends Procedure | Constructable
...
declare function fn<T extends Procedure | Constructable = Procedure>(
  originalImplementation?: T,
): Mock<T>;
declare function spyOn<T extends object, S extends Properties<Required<T>>>(
  object: T,
  key: S,
  accessor: "get",
): Mock<() => T[S]>;
declare function spyOn<T extends object, G extends Properties<Required<T>>>(
  object: T,
  key: G,
  accessor: "set",
): Mock<(arg: T[G]) => void>;
declare function spyOn<T extends object, M extends Classes<Required<T>> | Methods<Required<T>>>(
  object: T,
  key: M,
