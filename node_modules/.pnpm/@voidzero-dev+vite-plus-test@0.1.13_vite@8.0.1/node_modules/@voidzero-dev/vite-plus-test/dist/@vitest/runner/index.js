...
import {
  w as getChainableContext,
  a as createChainable,
  v as validateTags,
  e as createTaskName,
  x as createNoTagsError,
  f as findTestFileStackTrace,
  d as createTagsFilter,
  b as createFileTask,
  c as calculateSuiteHash,
  u as someTasksAreOnly,
  q as interpretTaskModes,
  s as limitConcurrency,
  t as partitionSuiteChildren,
  p as hasTests,
  o as hasFailed,
} from "./chunk-tasks.js";
...
const now$1 = globalThis.performance
  ? globalThis.performance.now.bind(globalThis.performance)
  : Date.now;
  ...
  for (const spec of specs) {
    ...
    await $("collect_spec", { "code.file.path": filepath }, async () => {
      ...
      const testTagsFilter =
        typeof spec === "object" && spec.testTagsFilter
