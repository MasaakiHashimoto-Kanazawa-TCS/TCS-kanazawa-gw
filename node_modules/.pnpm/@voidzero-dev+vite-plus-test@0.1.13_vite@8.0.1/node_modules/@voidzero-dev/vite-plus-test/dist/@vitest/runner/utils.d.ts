 ...
 */
declare function interpretTaskModes(
  file: Suite,
  namePattern?: string | RegExp,
  testLocations?: number[],
  testIds?: string[],
  testTagsFilter?: (testTags: string[]) => boolean,
  onlyMode?: boolean,
...
declare function createFileTask(
  filepath: string,
  root: string,
...
declare function findTestFileStackTrace(
  testFilePath: string,
  error: string,
...
declare function createTagsFilter(
  tagsExpr: string[],
...
// Merged from module augmentation: declare module "@vitest/runner"
