...
type MatchersObject<T extends MatcherState = MatcherState> = Record<string, RawMatcherFn<T>> &
  ThisType<T> & { [K in keyof Matchers<T>]?: RawMatcherFn<T, Parameters<Matchers<T>[K]>> };
...
interface Assertion<T = any>
  extends VitestAssertion<Chai.Assertion, T>, JestAssertion<T>, ChaiMockAssertion, Matchers<T> {
  /**
...
declare function iterableEquality(
  a: any,
  b: any,
  customTesters?: Array<Tester>,
  aStack?: Array<any>,
...
declare function subsetEquality(
  object: unknown,
  subset: unknown,
  customTesters?: Array<Tester>,
): boolean | undefined;
...
declare function sparseArrayEquality(
  a: unknown,
  b: unknown,
  customTesters?: Array<Tester>,
): boolean | undefined;
declare function generateToBeMessage(
...
declare function getObjectSubset(
  object: any,
  subset: any,
  customTesters: Array<Tester>,
): {
...
declare function setState<State extends MatcherState = MatcherState>(
  state: Partial<State>,
  expect: ExpectStatic,
): void;

declare function createAssertionMessage(
  util: Chai.ChaiUtils,
  assertion: Assertion,
  hasArgs: boolean,
): string;
declare function recordAsyncExpect(
  _test: any,
  promise: Promise<any>,
  assertion: string,
  error: Error,
...
declare function wrapAssertion(
  utils: Chai.ChaiUtils,
  name: string,
  fn: (this: Chai.AssertionStatic & Assertion, ...args: any[]) => void | PromiseLike<void>,
): (this: Chai.AssertionStatic & Assertion, ...args: any[]) => void | PromiseLike<void>;
...
// Merged from module augmentation: declare module "@vitest/expect"
