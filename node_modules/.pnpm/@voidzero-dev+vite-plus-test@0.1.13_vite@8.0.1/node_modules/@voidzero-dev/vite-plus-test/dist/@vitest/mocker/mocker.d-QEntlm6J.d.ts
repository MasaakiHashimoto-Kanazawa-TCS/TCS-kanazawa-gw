...
declare class ModuleMocker implements TestModuleMocker {
  ...
  private mockedIds;
  constructor(
    interceptor: ModuleMockerInterceptor,
    rpc: ModuleMockerRPC,
    createMockInstance: CreateMockInstanceProcedure,
    config: ModuleMockerConfig,
  );
...
export type {
  CompilerHintsOptions as C,
  ModuleMockerInterceptor as M,
  ResolveIdResult as R,
  ModuleMockerCompilerHints as a,
  ModuleMockerConfig as c,
  ModuleMockerRPC as d,
  ResolveMockResult as e,
};
