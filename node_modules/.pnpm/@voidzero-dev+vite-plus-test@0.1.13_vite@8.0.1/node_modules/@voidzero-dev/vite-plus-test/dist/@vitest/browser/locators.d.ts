...
declare function getByLabelSelector(
  text: string | RegExp,
  options?: {
    exact?: boolean;
  },
): string;
declare function getByAltTextSelector(
  text: string | RegExp,
  options?: {
    exact?: boolean;
  },
): string;
declare function getByTitleSelector(
  text: string | RegExp,
  options?: {
    exact?: boolean;
  },
): string;
declare function getByPlaceholderSelector(
  text: string | RegExp,
  options?: {
    exact?: boolean;
  },
): string;
declare function getByTextSelector(
  text: string | RegExp,
  options?: {
    exact?: boolean;
  },
...
declare function processTimeoutOptions<
  T extends {
    timeout?: number;
  },
...
declare abstract class Locator {
  ...
  screenshot(
    options: Omit<LocatorScreenshotOptions, "base64"> & {
      base64: true;
    },
  ): Promise<{
    path: string;
