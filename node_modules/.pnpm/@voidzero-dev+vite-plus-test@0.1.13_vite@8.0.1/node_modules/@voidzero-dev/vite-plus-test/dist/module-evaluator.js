...
class VitestModuleEvaluator {
  ...
  async runExternalModule(id) {
    ...
    const namespace = await this._otel
      .$("vitest.module.external", { attributes: { "code.file.path": file } }, () =>
  ...
  _createCJSGlobals(context, module, span) {
    ...
    return {
      ...
      module: {
        set exports(value) {
          span.addEvent(
            "`module.exports` is assigned directly, copying all properties to `exports`",
          );
          exportAll(cjsExports, value);
          exportsObject.default = value;
          moduleExports = value;
...
function exportAll(exports$1, sourceModule) {
  ...
  for (const key in sourceModule)
    if (key !== "default" && !(key in exports$1))
      try {
