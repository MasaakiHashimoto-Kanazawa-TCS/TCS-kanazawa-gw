...
var D = (s, n, t) =>
  n in s ? $(s, n, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (s[n] = t);
var O = (s, n, t) => D(s, typeof n != "symbol" ? n + "" : n, t),
  q = (s, n, t) => n.has(s) || C("Cannot " + t);
  ...
  k = (s, n, t) =>
    n.has(s)
      ...
      : n instanceof WeakSet
        ? n.add(s)
        : n.set(s, t),
  f = (s, n, t, e) => (q(s, n, "write to private field"), e ? e.call(s, t) : n.set(s, t), t);
var F = (s, n, t, e) => ({
  set _(r) {
    f(s, n, r, t);
  },
...
var M = class {
  ...
  g = class {
    ...
    enqueue(n) {
      let t = new M(n);
      (d(this, m) ? ((d(this, w).next = t), f(this, w, t)) : (f(this, m, t), f(this, w, t)),
        F(this, E)._++);
    }
    dequeue() {
      let n = d(this, m);
...
function y(s) {
  ...
  let n = new g(),
    ...
    i = (h, p, a) => {
      (n.enqueue(r.bind(void 0, h, p, a)),
        (async () => (await Promise.resolve(), t < s && n.size > 0 && n.dequeue()()))());
    },
    c = (h, ...p) =>
      new Promise((a) => {
        i(h, a, p);
...
// src/utils.ts
var J = (s) => s / 1e6,
  U = () => J(Number(process.hrtime.bigint())),
  B = () => performance.now();
function W(s) {
  ...
  async run() {
    ...
    if ((this.bench.teardown(this, "run"), t)) {
      ...
      let h = c / this.runs,
        ...
        R = Math.sqrt(P),
        I = R / Math.sqrt(a),
        _ = N[String(Math.round(l) || 1)] || N.infinity,
        K = I * _,
        j = (K / v) * 100,
        H = t[Math.ceil(a * 0.75) - 1],
        V = t[Math.ceil(a * 0.99) - 1],
        Q = t[Math.ceil(a * 0.995) - 1],
        Y = t[Math.ceil(a * 0.999) - 1];
