...
var W = (n, s, t) =>
  s in n ? x(n, s, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (n[s] = t);
var X = (n, s) => {
    for (var t in s) x(n, t, { get: s[t], enumerable: !0 });
  },
  Z = (n, s, t, e) => {
    if ((s && typeof s == "object") || typeof s == "function")
      for (let r of J(s))
        !U.call(n, r) &&
          r !== t &&
          x(n, r, { get: () => s[r], enumerable: !(e = G(s, r)) || e.enumerable });
    return n;
  };
var tt = (n) => Z(x({}, "__esModule", { value: !0 }), n);
var M = (n, s, t) => W(n, typeof s != "symbol" ? s + "" : s, t),
  S = (n, s, t) => s.has(n) || q("Cannot " + t);
var d = (n, s, t) => (S(n, s, "read from private field"), t ? t.call(n) : s.get(n)),
  L = (n, s, t) =>
    s.has(n)
      ...
      : s instanceof WeakSet
        ? s.add(n)
        : s.set(n, t),
  f = (n, s, t, e) => (S(n, s, "write to private field"), e ? e.call(n, t) : s.set(n, t), t);
var N = (n, s, t, e) => ({
  set _(r) {
    f(n, s, r, t);
  },
...
var B = class {
  ...
  g = class {
    ...
    enqueue(s) {
      let t = new B(s);
      (d(this, m) ? ((d(this, E).next = t), f(this, E, t)) : (f(this, m, t), f(this, E, t)),
        N(this, b)._++);
    }
    dequeue() {
      let s = d(this, m);
      if (s) return (f(this, m, d(this, m).next), N(this, b)._--, s.value);
    }
    clear() {
...
function y(n) {
  ...
  let s = new g(),
    ...
    i = (h, p, a) => {
      (s.enqueue(r.bind(void 0, h, p, a)),
        (async () => (await Promise.resolve(), t < n && s.size > 0 && s.dequeue()()))());
    },
    c = (h, ...p) =>
      new Promise((a) => {
        i(h, a, p);
...
// src/utils.ts
var st = (n) => n / 1e6,
  z = () => st(Number(process.hrtime.bigint())),
  A = () => performance.now();
function nt(n) {
  return n !== null && typeof n == "object" && typeof n.then == "function";
}
var j = (n, s) => n.reduce((e, r) => e + (r - s) ** 2, 0) / (n.length - 1) || 0,
  rt = (async () => {}).constructor,
  it = (n) => n.constructor === rt,
  H = async (n) => {
    if (it(n.fn)) return !0;
    try {
...
var v = class extends EventTarget {
  ...
  async loop(t, e) {
    var T;
    let r = this.bench.concurrency === "task",
      { threshold: i } = this.bench,
      c = 0,
      h = [];
    ...
    let p = await H(this),
      a = async () => {
        ...
        (h.push(u),
          (c += u),
          this.opts.afterEach != null && (await this.opts.afterEach.call(this)));
      },
      l = y(i);
    try {
      let u = [];
      for (
        ;
        (c < t || h.length + l.activeCount + l.pendingCount < e) &&
        !((T = this.bench.signal) != null && T.aborted);
      )
  ...
  async run() {
    ...
    if ((this.bench.teardown(this, "run"), t)) {
      ...
      let h = c / this.runs,
        ...
        I = Math.sqrt(R),
        _ = I / Math.sqrt(a),
        K = P[String(Math.round(l) || 1)] || P.infinity,
        C = _ * K,
        V = (C / w) * 100,
        Q = t[Math.ceil(a * 0.75) - 1],
        Y = t[Math.ceil(a * 0.99) - 1],
        $ = t[Math.ceil(a * 0.995) - 1],
        D = t[Math.ceil(a * 0.999) - 1];
    ...
    return (
      this.dispatchEvent(o("cycle", this)),
      this.bench.dispatchEvent(o("cycle", this)),
      this.dispatchEvent(o("complete", this)),
      this
    );
  }
  /**
  ...
  async warmup() {
    ...
    if (
      (this.bench.teardown(this, "warmup"), t && (this.setResult({ error: t }), this.bench.throws))
    )
      throw t;
  }
...
var k = class extends EventTarget {
  constructor(t = {}) {
    ...
    this.iterations = 10;
    this.now = A;
    ((this.now = (e = t.now) != null ? e : this.now),
      (this.warmupTime = (r = t.warmupTime) != null ? r : this.warmupTime),
      (this.warmupIterations = (i = t.warmupIterations) != null ? i : this.warmupIterations),
      (this.time = (c = t.time) != null ? c : this.time),
      (this.iterations = (h = t.iterations) != null ? h : this.iterations),
      (this.signal = t.signal),
      (this.throws = (p = t.throws) != null ? p : !1),
      (this.setup = (a = t.setup) != null ? a : () => {}),
    ...
    return this.tasks.map((e) => {
      if (e.result) {
        ...
        return (
          (t == null ? void 0 : t(e)) || {
            "Task Name": e.name,
            "ops/sec": e.result.error
              ? "NaN"
              : parseInt(e.result.hz.toString(), 10).toLocaleString(),
