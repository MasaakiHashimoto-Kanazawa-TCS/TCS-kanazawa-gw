...
var require_webcontainer_fallback = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  const version = JSON.parse(
    fs.readFileSync(__require.resolve("rolldown/package.json"), "utf-8"),
  ).version;
    ...
    if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH)
      ...
      if (process.arch === "arm64") {
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-android-arm64/package.json",
          ).version;
          if (
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-android-arm-eabi/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
      ...
      if (process.arch === "x64")
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-win32-ia32-msvc/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-win32-arm64-msvc/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
      ...
      if (process.arch === "x64") {
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-freebsd-x64/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-freebsd-arm64/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
      ...
      if (process.arch === "x64")
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-linux-ppc64-gnu/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-linux-s390x-gnu/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
      ...
      if (process.arch === "arm64") {
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-openharmony-arm64/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-openharmony-x64/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
        ...
        try {
          ...
          const bindingPackageVersion = __require(
            "@rolldown/binding-openharmony-arm/package.json",
          ).version;
          if (
            bindingPackageVersion !== "1.0.0-rc.10" &&
            process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
