...
type ExportExportNameKind = /** `export { name } */ | "Name"
  | /** `export default expression` */ "Default"
  | /** `export * from "mod" */ "None";
...
type ExportImportNameKind = /** `export { name } */ | "Name"
  | /** `export * as ns from "mod"` */ "All"
  | /** `export * from "mod"` */ "AllButDefault"
  | /** Does not have a specifier. */ "None";
...
type ExportLocalNameKind = /** `export { name } */ | "Name"
  | /** `export default expression` */ "Default"
  /**
...
type ImportNameKind = /** `import { x } from "mod"` */ | "Name"
  | /** `import * as ns from "mod"` */ "NamespaceObject"
...
declare class ResolverFactory {
  constructor(options?: NapiResolveOptions | null);
...
declare function isolatedDeclarationSync(
  filename: string,
  sourceText: string,
  options?: IsolatedDeclarationsOptions | null,
 ...
 */
declare function moduleRunnerTransform(
  filename: string,
  sourceText: string,
  options?: ModuleRunnerTransformOptions | null,
...
declare class BindingMagicString {
  constructor(source: string, options?: BindingMagicStringOptions | null);
  get original(): string;
  ...
  indent(indentor?: string | null, options?: BindingIndentOptions | null): this;
   ...
   */
  generateDecodedMap(options?: BindingSourceMapOptions | null): BindingDecodedMap;
}
declare class BindingNormalizedOptions {
  ...
  get banner(): string | undefined | null;
  get footer(): string | undefined | null;
  get intro(): string | undefined | null;
  get outro(): string | undefined | null;
  get postBanner(): string | undefined | null;
  get postFooter(): string | undefined | null;
...
//#endregion
export {
  ExternalMemoryStatus as A,
  ResolveResult as B,
  BindingViteManifestPluginConfig as C,
  BindingViteResolvePluginConfig as D,
  BindingViteReporterPluginConfig as E,
  MinifyResult as F,
  isolatedDeclaration as G,
  SourceMap as H,
  NapiResolveOptions as I,
  isolatedDeclarationSync as K,
  ParseResult as L,
  IsolatedDeclarationsResult as M,
  JsxOptions as N,
  BindingViteTransformPluginConfig as O,
  MinifyOptions as P,
  ParserOptions as R,
  BindingViteJsonPluginConfig as S,
  BindingViteReactRefreshWrapperPluginConfig as T,
  TransformOptions as U,
  ResolverFactory as V,
  TsconfigCache as W,
  BindingTsconfigRawOptions as _,
  BindingEnhancedTransformOptions as a,
  BindingViteDynamicImportVarsPluginConfig as b,
  BindingHookResolveIdExtraArgs as c,
  BindingPluginContextResolveOptions as d,
  BindingRebuildStrategy as f,
  BindingTsconfigCompilerOptions as g,
  BindingTransformHookExtraArgs as h,
  BindingClientHmrUpdate as i,
  IsolatedDeclarationsOptions as j,
  BindingWatcherBundler as k,
  BindingIsolatedDeclarationPluginConfig as l,
  BindingReplacePluginConfig as m,
  BindingBundleAnalyzerPluginConfig as n,
  BindingEnhancedTransformResult as o,
  BindingRenderedChunk as p,
  moduleRunnerTransform as q,
  BindingBundleState as r,
  BindingEsmExternalRequirePluginConfig as s,
  BindingBuiltinPluginName as t,
  BindingMagicString as u,
  BindingTsconfigResult as v,
  BindingViteModulePreloadPolyfillPluginConfig as w,
  BindingViteImportGlobPluginConfig as x,
  BindingViteBuildImportAnalysisPluginConfig as y,
  PreRenderedChunk as z,
};
