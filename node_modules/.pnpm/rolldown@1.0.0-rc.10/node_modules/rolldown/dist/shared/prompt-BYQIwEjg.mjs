...
const iD = sD(),
  ...
  R = "m",
  y = `${rD}8;;`,
  V$1 = (t) => `${v.values().next().value}${W$1}${t}${R}`,
  z = (t) => `${v.values().next().value}${y}${t}${w$1}`,
  ED = (t) => t.split(" ").map((u) => A$1(u)),
  _ = (t, u, F) => {
    const e = [...u];
    let s = false,
      i = false,
      D = A$1(T$1(t[t.length - 1]));
...
`),
    ...
    for (const [E, a] of o.entries()) {
      if (((e += a), v.has(a))) {
        const { groups: B } = new RegExp(`(?:\\${W$1}(?<code>\\d+)m|\\${y}(?<uri>.*)${w$1})`).exec(
          o.slice(E).join(""),
        ) || { groups: {} };
        if (B.code !== void 0) {
...
var AD = Object.defineProperty,
  pD = (t, u, F) =>
    u in t
      ...
      : (t[u] = F),
  h = (t, u, F) => (pD(t, typeof u != "symbol" ? u + "" : u, F), F);
var x = class {
  constructor(u, F = true) {
    (h(this, "input"),
      ...
      h(this, "_track", false),
      h(this, "_prevFrame", ""),
      h(this, "_subscribers", /* @__PURE__ */ new Map()),
      h(this, "_cursor", 0),
  ...
  prompt() {
    return new Promise((u, F) => {
      ...
      ((e._write = (s, i, D) => {
        ...
        f.emitKeypressEvents(this.input, this.rl),
        this.rl.prompt(),
        ...
        this.render(),
        this.once("submit", () => {
          (this.output.write(srcExports.cursor.show),
            this.output.off("resize", this.render),
            d$1(this.input, false),
            u(this.value));
        }),
        this.once("cancel", () => {
          (this.output.write(srcExports.cursor.show),
  ...
  onKeypress(u, F) {
    if (
      ...
      u &&
        (u.toLowerCase() === "y" || u.toLowerCase() === "n") &&
        this.emit("confirm", u.toLowerCase() === "y"),
      u === "	" &&
        this.opts.placeholder &&
        (this.value ||
          (this.rl?.write(this.opts.placeholder), this.emit("value", this.opts.placeholder))),
    ...
    (k$1([u, F?.name, F?.sequence], "cancel") && (this.state = "cancel"),
    ...
    if (u !== this._prevFrame) {
      if (this.state === "initial") this.output.write(srcExports.cursor.hide);
        ...
        if ((this.restoreCursor(), F && F?.length === 1)) {
          const e = F[0];
          (this.output.write(srcExports.cursor.move(0, e)),
            this.output.write(srcExports.erase.lines(1)));
          const s = u.split(`
`);
          (this.output.write(s[e]),
            (this._prevFrame = u),
            this.output.write(srcExports.cursor.move(0, s.length - e - 1)));
          return;
        }
        if (F && F?.length > 1) {
          const e = F[0];
...
var fD = class extends x {
  ...
  constructor(u) {
    (super(u, false),
      ...
      this.on("confirm", (F) => {
        (this.output.write(srcExports.cursor.move(0, -1)),
          (this.value = F),
          (this.state = "submit"),
          this.close());
      }),
...
var bD = Object.defineProperty,
  mD = (t, u, F) =>
    u in t
      ...
      : (t[u] = F),
  Y = (t, u, F) => (mD(t, typeof u != "symbol" ? u + "" : u, F), F);
...
var SD = Object.defineProperty,
  $D = (t, u, F) =>
    u in t
      ...
      : (t[u] = F),
  q = (t, u, F) => ($D(t, typeof u != "symbol" ? u + "" : u, F), F);
...
var PD = class extends x {
  get valueWithCursor() {
    ...
    const u = this.value.slice(0, this.cursor),
      [F, ...e$1] = this.value.slice(this.cursor);
...
function ce() {
  return process$1.platform !== "win32"
    ? process$1.env.TERM !== "linux"
    : !!process$1.env.CI ||
        !!process$1.env.WT_SESSION ||
        !!process$1.env.TERMINUS_SUBLIME ||
...
const V = ce(),
  ...
  B = (t) => {
    const { cursor: n, options: s, style: r } = t,
      i = t.maxItems ?? Number.POSITIVE_INFINITY,
      a = Math.max(process.stdout.rows - 4, 0),
      c = Math.min(a, Math.max(i, 5));
    let l = 0;
    n >= l + c - 3
      ? (l = Math.max(Math.min(n - c + 3, s.length - c), 0))
      : n < l + 2 && (l = Math.max(n - 2, 0));
    const $ = c < s.length && l > 0,
      p = c < s.length && l + c < s.length;
...
`,
          s = t.placeholder
            ? e.inverse(t.placeholder[0]) + e.dim(t.placeholder.slice(1))
            : e.inverse(e.hidden("_")),
          r = this.value ? this.valueWithCursor : s;
        switch (this.state) {
          case "error":
            return `${n.trim()}
${e.yellow(o)} ${r}
...
`;
          ...
          case "cancel":
            return `${n}${e.gray(o)} ${e.strikethrough(e.dim(this.value ?? ""))}${
              this.value?.trim()
                ? `
${e.gray(o)}`
                : ""
...
`,
        ...
        switch (this.state) {
          case "submit":
            return `${r}${e.gray(o)} ${e.dim(i)}`;
          case "cancel":
            return `${r}${e.gray(o)} ${e.strikethrough(e.dim(i))}
${e.gray(o)}`;
          default:
            return `${r}${e.cyan(o)} ${this.value ? `${e.green(k)} ${n}` : `${e.dim(P)} ${e.dim(n)}`} ${e.dim("/")} ${this.value ? `${e.dim(P)} ${e.dim(s)}` : `${e.green(k)} ${s}`}
${e.cyan(d)}
`;
        }
      },
...
`;
  ...
  fe = (t) => {
    const n = (s, r) => {
      const i = s.label ?? String(s.value);
      return r === "active"
        ? `${e.cyan(A)} ${i} ${s.hint ? e.dim(`(${s.hint})`) : ""}`
        : r === "selected"
          ? `${e.green(T)} ${e.dim(i)}`
          : r === "cancelled"
            ? `${e.strikethrough(e.dim(i))}`
            : r === "active-selected"
              ? `${e.green(T)} ${i} ${s.hint ? e.dim(`(${s.hint})`) : ""}`
              : r === "submitted"
                ? `${e.dim(i)}`
                : `${e.dim(F)} ${e.dim(i)}`;
    };
        ...
        switch (this.state) {
          ...
          case "cancel": {
            const i = this.options
              .filter(({ value: a }) => this.value.includes(a))
              .map((a) => n(a, "cancelled"))
              .join(e.dim(", "));
            return `${s}${e.gray(o)} ${
              i.trim()
