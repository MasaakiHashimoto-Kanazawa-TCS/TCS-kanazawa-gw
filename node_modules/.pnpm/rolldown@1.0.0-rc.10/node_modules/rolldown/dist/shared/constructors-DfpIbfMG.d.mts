import {
  D as BindingViteResolvePluginConfig,
  E as BindingViteReporterPluginConfig,
  S as BindingViteJsonPluginConfig,
  T as BindingViteReactRefreshWrapperPluginConfig,
  b as BindingViteDynamicImportVarsPluginConfig,
  l as BindingIsolatedDeclarationPluginConfig,
  s as BindingEsmExternalRequirePluginConfig,
  w as BindingViteModulePreloadPolyfillPluginConfig,
  x as BindingViteImportGlobPluginConfig,
  y as BindingViteBuildImportAnalysisPluginConfig,
} from "./binding-Dsq9Azhm.mjs";
import { N as BuiltinPlugin, Vt as StringOrRegExp } from "./define-config-CV9D_Qea.mjs";

//#region src/builtin-plugin/constructors.d.ts
declare function viteModulePreloadPolyfillPlugin(
...
declare function viteBuildImportAnalysisPlugin(
  config: BindingViteBuildImportAnalysisPluginConfig,
): BuiltinPlugin;
declare function viteResolvePlugin(
  config: Omit<BindingViteResolvePluginConfig, "yarnPnp">,
): BuiltinPlugin;
declare function isolatedDeclarationPlugin(
 ...
 */
declare function esmExternalRequirePlugin(
...
declare function viteReactRefreshWrapperPlugin(
  config: ViteReactRefreshWrapperPluginConfig,
): BuiltinPlugin;
//#endregion
export {
  viteDynamicImportVarsPlugin as a,
  viteLoadFallbackPlugin as c,
  viteReporterPlugin as d,
  viteResolvePlugin as f,
  viteBuildImportAnalysisPlugin as i,
  viteModulePreloadPolyfillPlugin as l,
  viteWebWorkerPostPlugin as m,
  isolatedDeclarationPlugin as n,
  viteImportGlobPlugin as o,
  viteWasmFallbackPlugin as p,
  oxcRuntimePlugin as r,
  viteJsonPlugin as s,
  esmExternalRequirePlugin as t,
  viteReactRefreshWrapperPlugin as u,
};
