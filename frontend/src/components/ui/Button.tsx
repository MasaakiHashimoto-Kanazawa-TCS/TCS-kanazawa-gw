...
const buttonVariants = {
  ...
  outline: 'border border-gray-300 bg-white hover:bg-gray-50 text-gray-700 shadow-sm dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700',
