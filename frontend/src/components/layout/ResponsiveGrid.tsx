...
export function ResponsiveGrid({
  ...
  return <div className={cn("grid", getColumnClass(), gapClasses[gap], className)}>{children}</div>;
}
...
export function ResponsiveCardGrid({
  children,
  minCardWidth: _minCardWidth = 300,
  maxColumns = 4,
  gap = "md",
  className,
  ...
  return <div className={cn("grid", getAutoColumns(), gapClasses[gap], className)}>{children}</div>;
}
...
export function ResponsiveContainer({
  ...
  return (
    <div className={cn("mx-auto", maxWidthClasses[maxWidth], getPaddingClass(), className)}>
      {children}
    </div>
  );
}
